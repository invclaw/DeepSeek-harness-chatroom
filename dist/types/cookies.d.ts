...
export declare function sessionCookie(name: string, token: string, maxAgeSeconds: number, path: string, secure?: boolean): string;
/** Expire the current browser identity. */
export declare function expiredSessionCookie(name: string, path: string, secure?: boolean): string;
