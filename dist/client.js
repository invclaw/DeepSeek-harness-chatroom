...
`,document.head.append(s);let c=bo(t),l=Ls(e.get(`settingsScope`)),u=lo(t.api,o),d=qo(o,n),f=po(o),p=a,m=!1,h=()=>{let e=p;if(e===void 0||m)return;let t=n.list.getSnapshot();ae(e,{current:t.current===void 0?void 0:String(t.current),byId:t.byId},e=>{n.open(e)})&&(m=!0,ne(e.parentSessionId),oe(e))},g=e=>{if(a===void 0||e.origin!==globalThis.location.origin||e.source!==globalThis.parent)return;let t=k(e.data);if(t!==void 0){if(p!==void 0&&te(p,t)){h();return}p=t,m=!1,le(),o.switchBranchFrame(t),h()}};globalThis.addEventListener(`message`,g);let _=()=>{h(),o.resumeOpen();let e=n.list.getSnapshot(),t=e.current,r=t===void 0?void 0:e.byId[t];t!==void 0&&r?.blank===!0&&r.origin!==`subagent`&&o.roomForSession(String(t))===void 0&&o.newSessionMode(String(t))===void 0&&o.registerNewSession(String(t)),o.activateSession(t===void 0?void 0:String(t),r?.displayTitle??`新会话`,a===void 0&&r?.origin!==`subagent`)},v=n.list.subscribe(_);return o.start().then(async()=>{if(_(),typeof location>`u`)return;let e=E(location,a);e!==void 0&&await o.selectRoom(e)}),()=>{v(),globalThis.removeEventListener(`message`,g),u(),f(),d(),l(),c(),o.stop(),s.remove(),i?.disconnect(),a!==void 0&&(le(),document.documentElement.removeAttribute(`data-dsh-chatroom-branch-frame`))}},`chatroom: browser state and styles`);let s=Hs(o),c=Us(o);e.effect(()=>i.registerSource(s),`chatroom: AI mention source`),e.effect(()=>i.registerSource(c),`chatroom: member mention source`),e.slots.inject(`shell.overlay`,()=>e.slots.register({name:`shell.overlay`,id:`chatroom`,order:0,inject:()=>({hooks:{chatroom:o},openRoom:o.openRoom,closeRoom:o.closeRoom,join:o.join,login:o.login,register:o.register,logout:o.logout,openAccount:o.openAccount,closeAccount:o.closeAccount,changePassword:o.changePassword,selectRoom:o.selectRoom,createRoom:o.createRoom,resetIdentity:o.resetIdentity,retry:o.retry,closeMembers:o.closeMembers,renameRoom:o.renameRoom,setMemberRole:o.setMemberRole,addRoomMembers:o.addRoomMembers,setRoomAutoTrigger:o.setRoomAutoTrigger,closeThread:o.closeThread,setThreadReply:o.setThreadReply,clearThreadReply:o.clearThreadReply,sendThreadMessage:o.sendThreadMessage,enableSystemNotifications:o.enableSystemNotifications,dismissToast:o.dismissToast,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,closeForward:o.closeForward,forwardSelected:o.forwardSelected,toggleMessageSelection:o.toggleMessageSelection,clearMessageSelection:o.clearMessageSelection,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect})},$i)),e.slots.inject(`settings.section`,()=>e.slots.register({name:`settings.section`,id:`chatroom`,order:30,label:()=>`群聊与账号`,inject:()=>({hooks:{chatroom:o},closeAccount:o.closeAccount,changePassword:o.changePassword,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect})},fe)),e.effect(()=>Ps(()=>`群聊与账号`),`chatroom: settings navigation icon`),e.slots.inject(`conversation.session.header.actions`,()=>e.slots.register({name:`conversation.session.header.actions`,id:`chatroom-identity`,order:-5,inject:()=>({hooks:{chatroom:o},openMembers:o.openMembers})},wo)),e.slots.inject(`conversation.input.left`,()=>e.slots.register({name:`conversation.input.left`,id:`chatroom-files`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},ua)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-group-setup`,order:-30,inject:()=>({hooks:{chatroom:o},registerNewSession:o.registerNewSession,newSessionMode:o.newSessionMode,chooseNewSessionMode:o.chooseNewSessionMode})},yo)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-composition`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},da)),e.slots.inject(`conversation.input.attachments`,()=>Bs(()=>e.slots.entries(`conversation.input.attachments`).find(e=>(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.input.attachments`,t),t=>e.slots.register({name:`conversation.input.attachments`,priority:-10,locale:`conversation`,inject:()=>({hooks:{chatroom:o},nativeAttachmentsView:t,clearReply:o.clearReply,resolveTarget:o.agentTargetForSession.bind(o)})},fa))),e.slots.inject(`conversation.chat.assistant-actions`,()=>e.slots.register({name:`conversation.chat.assistant-actions`,id:`chatroom-reply`,order:5,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),setReply:o.setReply,openThread:o.openThread,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,toggleMessageSelection:o.toggleMessageSelection})},oa)),e.slots.inject(`conversation.chat.node`,()=>Bs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`assistant-step`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`assistant-step`,priority:-10,locale:`conversation`,inject:()=>({nativeMessageView:t,resolveTarget:o.agentTargetForSession.bind(o)})},ca))),e.slots.inject(`conversation.chat.node`,()=>Bs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`user`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`user`,priority:-10,locale:`conversation`,inject:()=>Vs(o,t)},ja))),e.slots.inject(`conversation.chat.node`,()=>Bs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`steering`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`steering`,priority:-10,locale:`conversation`,inject:()=>Vs(o,t)},Ma)))}function Ls(e){if(!Rs(e))return()=>void 0;let t=e.describe();return!zs(t)||t.persistence!==`memory`?()=>void 0:(t.persistence=`host`,t.load(),()=>{t.persistence===`host`&&(t.persistence=`memory`)})}function Rs(e){return typeof e==`object`&&!!e&&typeof e.describe==`function`}function zs(e){return typeof e==`object`&&!!e&&(e.persistence===`host`||e.persistence===`memory`)&&typeof e.load==`function`}function Bs(e,t,n){let r,i,a=()=>{let t=e();if(t===r)return;let a=i;i=void 0,r=void 0,a?.(),t!==void 0&&(r=t,i=n(t))},o=t(a);return a(),()=>{o(),i?.(),i=void 0,r=void 0}}function Vs(e,t){return{hooks:{chatroom:e},resolveTarget:e.agentTargetForSession.bind(e),nativeMessageView:t,setReply:e.setReply,openThread:e.openThread,toggleReaction:e.toggleReaction,recallMessage:e.recallMessage,openForward:e.openForward,toggleMessageSelection:e.toggleMessageSelection}}function Hs(e){return{trigger:`@`,name:`AI 助手`,order:-100,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];let a=[{name:Gs(r?.aiDisplayName??`DeepSeek`),icon:`✦`,description:r===void 0?`创建群聊后立即回复`:`提及后回复`}],o=n.toLocaleLowerCase();return a.filter(e=>e.name.toLocaleLowerCase().includes(o))},lexicon(t){let n=e.roomForSession(String(t.sessionId));return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[`AI`,`DeepSeek`]:[]:[...new Set([`AI`,n.aiDisplayName])]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${Ks(e.name)} `}}}}function Us(e){return{trigger:`@`,name:`群聊成员`,order:-90,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];i&&e.getSnapshot().directPeers.length===0&&await e.loadDirectDirectory();let a=e.getSnapshot(),o=r===void 0?a.directPeers.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:Wa(e,a.directPeers),icon:_(e.avatarId,e.participantId).emoji,description:`创建群聊时自动邀请 · @${e.username}`})):a.members.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:e.displayName,icon:_(e.avatarId,e.participantId).emoji,description:e.online?`在线成员`:`群成员`})),s=n.toLocaleLowerCase();return o.filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t).filter(e=>e.name.toLocaleLowerCase().includes(s))},lexicon(t){let n=e.roomForSession(String(t.sessionId)),r=e.getSnapshot();return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[...new Set(r.directPeers.filter(e=>e.participantId!==r.identity?.participantId).map(e=>Wa(e,r.directPeers)))]:[]:[...new Set(r.members.filter(e=>e.participantId!==r.identity?.participantId).map(e=>e.displayName))]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${e.name} `}}}}let Ws=`（AI 助手）`;function Gs(e){return`${e}${Ws}`}function Ks(e){return e.endsWith(Ws)?e.slice(0,-7):e}var qs={inject:Fs,apply:Is};return n.activateRemoteSettingsMirror=Ls,n.apply=Is,n.createChatroomAiSource=Hs,n.createChatroomMemberSource=Us,n.default=qs,n.inject=Fs,n.mountAfterNativeMessageView=Bs,t.exports}});
