...
`&&t++,At(e,`---`,r))return{endPos:t,hasValidYaml:n};if(!n){let t=Kt(e,r,i);if(t<i){let r=e.charCodeAt(t);if(r>=J&&r<=mt||r>=K&&r<=q||r>=W&&r<=G||r===Me){for(t++;t<i&&(r=e.charCodeAt(t),r>=J&&r<=mt||r>=K&&r<=q||r>=W&&r<=G||r===Me||r===U||r===Ze);)t++;t<i&&e.charCodeAt(t)===Re&&(t++,t>=i?n=!0:(r=e.charCodeAt(t),(r===R||r===z)&&(n=!0)))}}}}return null}var vt=/&([a-zA-Z0-9]+|#[0-9]{1,7}|#x[0-9a-fA-F]{1,6});/gi,yt={class:`className`,for:`htmlFor`,allowfullscreen:`allowFullScreen`,allowtransparency:`allowTransparency`,autocomplete:`autoComplete`,autofocus:`autoFocus`,autoplay:`autoPlay`,cellpadding:`cellPadding`,cellspacing:`cellSpacing`,charset:`charSet`,classid:`classId`,colspan:`colSpan`,contenteditable:`contentEditable`,contextmenu:`contextMenu`,crossorigin:`crossOrigin`,enctype:`encType`,formaction:`formAction`,formenctype:`formEncType`,formmethod:`formMethod`,formnovalidate:`formNoValidate`,formtarget:`formTarget`,frameborder:`frameBorder`,hreflang:`hrefLang`,inputmode:`inputMode`,keyparams:`keyParams`,keytype:`keyType`,marginheight:`marginHeight`,marginwidth:`marginWidth`,maxlength:`maxLength`,mediagroup:`mediaGroup`,minlength:`minLength`,novalidate:`noValidate`,radiogroup:`radioGroup`,readonly:`readOnly`,rowspan:`rowSpan`,spellcheck:`spellCheck`,srcdoc:`srcDoc`,srclang:`srcLang`,srcset:`srcSet`,tabindex:`tabIndex`,usemap:`useMap`,viewbox:`viewBox`},bt={};function xt(e){if(!e)return bt;var t={};for(var n in e){var r=yt[n.toLowerCase()];if(r)t[r]=e[n];else{var i=n.indexOf(`:`);i===-1?t[n]=e[n]:t[n.slice(0,i)+n[i+1].toUpperCase()+n.slice(i+2)]=e[n]}}return t}var St=/(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s|^<(div|p|h[1-6]|ul|ol|li|blockquote|pre|table|thead|tbody|tr|td|th|dl|dt|dd|hr|address|article|aside|details|dialog|figure|figcaption|footer|form|header|main|menu|nav|section|summary|textarea|fieldset|legend|center|dir|hgroup|marquee|search|output|template)\b)/i;function Ct(e){return e.indexOf(`&`)===-1?e:e.replace(vt,(e,t)=>{var n=L(t);if(n)return n;if(t[0]===`#`){var r=t[1]===`x`||t[1]===`X`?Number.parseInt(t.slice(2),16):Number.parseInt(t.slice(1),10);return r===0||r>=55296&&r<=57343||r>1114111?`�`:r<=65535?String.fromCharCode(r):String.fromCharCode(55296+(r-65536>>10),56320+(r-65536&1023))}return e})}var wt=/(javascript|vbscript|data(?!:image)):/i;function Tt(e){if(wt.test(e))return null;if(e.indexOf(`%`)===-1)return e;try{let t=decodeURIComponent(e).replace(/[^A-Za-z0-9/:]/g,``);if(wt.test(t))return null}catch{return null}return e}var Et={},Dt,Ot;for(Dt=[192,193,194,195,196,197,224,225,226,227,228,229,230,198],Ot=0;Ot<Dt.length;Ot++)Et[Dt[Ot]]=`a`;for(Et[231]=Et[199]=`c`,Et[240]=Et[208]=`d`,Dt=[200,201,202,203,233,232,234,235],Ot=0;Ot<Dt.length;Ot++)Et[Dt[Ot]]=`e`;for(Dt=[207,239,206,238,205,237,204,236],Ot=0;Ot<Dt.length;Ot++)Et[Dt[Ot]]=`i`;for(Et[209]=Et[241]=`n`,Dt=[248,216,339,338,213,245,212,244,211,243,210,242],Ot=0;Ot<Dt.length;Ot++)Et[Dt[Ot]]=`o`;for(Dt=[220,252,219,251,218,250,217,249],Ot=0;Ot<Dt.length;Ot++)Et[Dt[Ot]]=`u`;Et[376]=Et[255]=Et[221]=Et[253]=`y`;function kt(e){for(var t=``,n=-1,r=e.length,i=0;i<r;i++){var a=e.charCodeAt(i);if(a>=J&&a<=mt||a>=W&&a<=G){n<0&&(n=i);continue}if(a>=K&&a<=q){n>=0&&(t+=e.slice(n,i),n=-1),t+=String.fromCharCode(a+gt);continue}if(a===R||a===U){n>=0&&(t+=e.slice(n,i),n=-1),t+=`-`;continue}n>=0&&(t+=e.slice(n,i),n=-1);var o=Et[a];o&&(t+=o)}return n>=0&&(t+=e.slice(n)),t}function At(e,t,n){return e.startsWith(t,n)}var jt=new Set([`area`,`base`,`br`,`col`,`embed`,`hr`,`img`,`input`,`link`,`meta`,`param`,`source`,`track`,`wbr`,`circle`,`ellipse`,`line`,`path`,`polygon`,`polyline`,`rect`,`use`,`stop`,`animate`,`set`]);function Mt(e){let t=e.toLowerCase();if(jt.has(t))return!0;let n=t.indexOf(`:`);return n!==-1&&(t=t.slice(n+1),jt.has(t))}var Nt=1,Pt=2,Ft=4,It=8,Lt=16,Rt=32,zt=64,Bt=(()=>{var e=new Uint8Array(128),t;for(e[z]=Nt,e[B]=Nt|Pt,e[qe]=Nt,e[Ce]=Nt|Pt,e[R]=Nt,t=Ie;t<=Qe;t++)e[t]=Ft;for(t=Re;t<=Pe;t++)e[t]=Ft;for(t=Te;t<=V;t++)e[t]=Ft;for(t=rt;t<=we;t++)e[t]=Ft;for(t=W;t<=G;t++)e[t]=Lt;for(t=K;t<=q;t++)e[t]=It;for(t=J;t<=mt;t++)e[t]=It;return e})(),Vt=/[\p{P}\p{S}]/u,Ht=/\p{Zs}/u,Ut=[];function Wt(e){var t=e.indexOf(`\r`),n=e.indexOf(`\0`);if(t===-1&&n===-1)return e;var r=e.length;Ut.length=0;var i=0,a=0;for(a=t===-1?n:n===-1||t<n?t:n;a<r;a++){var o=e.charCodeAt(a);o===Ce?(i<a&&Ut.push(e.slice(i,a)),a+1<r&&e.charCodeAt(a+1)===B&&a++,Ut.push(`
`),i=a+1):o===0&&(i<a&&Ut.push(e.slice(i,a)),Ut.push(`�`),i=a+1)}return i<r&&Ut.push(e.slice(i)),Ut.join(``)}function Gt(e){return e.replace(/>\s+</g,`><`).replace(/\n+/g,` `).trim()}function Kt(e,t,n){let r=n??e.length;for(;t<r&&(e[t]===` `||e[t]===`	`);)t++;return t}function qt(e){if(!e)return!1;for(var t in e)return!0;return!1}function Jt(e){return{attrs:{},children:[{type:Y.text,text:e}],c:!0,type:Y.htmlBlock,tag:`header`}}var Yt=/^\n+/;function Xt(e){for(var t=e.length;t>0&&(e[t-1]===`
`||e[t-1]===`\r`);)t--;return`${e.slice(0,t).replace(Yt,``)}

`}function Zt(e){if((e.type===Y.htmlSelfClosing||e.type===Y.htmlBlock)&&e.a)return[];if(e.type===Y.paragraph){var t=e.children;return t?t.flatMap(Zt):[]}return e.type===Y.text?e.text?.trim()?[e]:[]:e.type===Y.htmlBlock&&e.children?[{...e,children:e.children?.flatMap(Zt)}]:[e]}function Qt(e){for(var t=0;t<e.length;t++){if(e[t].type===Y.htmlBlock){var n=e[t],r=!1;if(n.c&&t===e.length-1){var i=n.j===void 0?n.a?n.e||``:(n.e||``)+(n.h||``):n.j,a=`</${String(n.tag).toLowerCase()}>`,o=i.toLowerCase().indexOf(a);o!==-1&&i.slice(o+a.length).replace(/<\/[a-z][a-z0-9-]*\s*>/gi,``).trim()&&(r=!0)}r||(n.c=!1)}`children`in e[t]&&e[t].children&&Qt(e[t].children)}}function $t(e,t){for(var n=0;n<e.length;n++){var r=e[n];if(r.type===Y.paragraph&&r.children)for(var i=r.children,a=0;a<i.length;a++){var o=i[a];if(o.type===Y.htmlSelfClosing&&o.a&&o.tag.toLowerCase()===t){var s=e.slice(0,n);a>0&&s.push({type:Y.paragraph,children:i.slice(0,a)});var c=[];if(a+1<i.length){var l=i.slice(a+1).filter(e=>!(e.type===Y.htmlSelfClosing&&e.a));l.length>0&&(c=l)}return c=c.concat(e.slice(n+1)),{found:!0,beforeClose:s,afterClose:c}}}if((r.type===Y.htmlSelfClosing||r.type===Y.htmlBlock)&&r.a&&r.tag.toLowerCase()===t)return{found:!0,beforeClose:e.slice(0,n),afterClose:e.slice(n+1)}}return{found:!1,beforeClose:e,afterClose:[]}}function en(e){var t=``;for(var n in e){var r=e[n];r===!0?t+=` ${n}`:r!==void 0&&r!=null&&r!==!1&&(t+=` ${n}="${String(r)}"`)}return t}function tn(e,t,n,r){var i;return i=t===void 0?en(n):t.length>0&&t.charCodeAt(0)>R?` ${t}`:t,`<${e}${i}${r}`}function nn(e){var t=e.tag,n=e.type===Y.htmlSelfClosing,r=e,i=r.b,a=`</${t}>`;if(!n&&r.a)return{kind:`literal`,literal:(r.h||a)+(r.e||``)};if(n){var o=e;return o.a?{kind:`literal`,literal:o.h||a}:o.m?{kind:`literal`,literal:o.m}:{kind:`literal`,literal:tn(t,i,e.attrs,` />`)}}var s=tn(t,i,e.attrs,`>`),c=r.children,l=c!=null&&c.length>0;if(r.c&&r.j!==void 0)return l?{kind:`sandwich`,open:s,close:a}:{kind:`literal`,literal:r.j};if(r.c&&!l)return{kind:`literal`,literal:s+(r.e||``)+(r.h||a)};if(c!=null&&c.length>0){for(var u=``,d=0;d<c.length;d++){var f=c[d];if(f.type!==Y.text)return{kind:`sandwich`,open:s,close:a};u+=f.text}return{kind:`literal`,literal:s+u+a}}var p=r.e||``;return p&&p.indexOf(a)!==-1?{kind:`literal`,literal:s+p}:{kind:`literal`,literal:s+p+a}}function rn(e,t,n){var r=[],i=e,a=n;if(i&&r.push(i),Array.isArray(t))for(var o=0;o<t.length;o++)r.push(t[o]);else t!=null&&r.push(t);a&&r.push(a);for(var s=[],c=0;c<r.length;c++){var l=r[c];typeof l==`string`&&s.length>0&&typeof s.at(-1)==`string`?s[s.length-1]=s.at(-1)+l:s.push(l)}return s}function an(e){return e==null||e.tagfilter!==!1}function on(e,t,n,r){var i=t(e,n,r);return i===null?null:ln(i)}function sn(e){var t=[];if(!e)return t;for(var n in e)n.charCodeAt(0)===94&&t.push({identifier:n,footnote:e[n].target});return t}function cn(e,t,n){if(t.indexOf(`.`)===-1)return e?.[t]||n;for(var r=e,i=t.split(`.`),a=0;a<i.length&&(r=r?.[i[a]],r!==void 0);)a++;return r||n}function ln(e){for(var t=!1,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r<=R||r===et||r===Oe||r===Ne||r===H||r===Te||r===Ae||r===Fe||r===Ee||r===V||r>=123){t=!0;break}}if(!t)return e;for(var i=``,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r===Oe&&n+2<e.length){var a=e.charCodeAt(n+1),o=e.charCodeAt(n+2);if((a>=W&&a<=G||a>=K&&a<=ze||a>=J&&a<=Be)&&(o>=W&&o<=G||o>=K&&o<=ze||o>=J&&o<=Be)){i+=e[n]+e[n+1]+e[n+2],n+=2;continue}}if(r>=55296&&r<=57343){if(r<=56319&&n+1<e.length){var s=e.charCodeAt(n+1);if(s>=56320&&s<=57343){i+=encodeURI(e[n]+e[n+1]),n++;continue}}i+=e[n];continue}i+=encodeURI(e[n])}return i}function un(...e){return e.filter(Boolean).join(` `)}var dn=new Set([`title`,`textarea`,`style`,`xmp`,`iframe`,`noembed`,`noframes`,`script`,`plaintext`]),fn=/<(\/?)(title|textarea|style|xmp|iframe|noembed|noframes|script|plaintext)(\s|>|\/)/gi;function pn(e){return dn.has(e.toLowerCase())}function mn(e){return fn.lastIndex=0,fn.test(e)}function hn(e){return fn.lastIndex=0,e.replace(fn,(e,t,n,r)=>`&lt;${t}${n}${r}`)}function gn(e,t){var n=e||{},r=n.slugify,i;if(r){var a=r;i=e=>a(e,kt)}else i=kt;return{disableAutoLink:n.disableAutoLink,disableFrontmatter:n.disableFrontmatter,disableParsingRawHTML:n.disableParsingRawHTML,enforceAtxHeadings:n.enforceAtxHeadings,evalUnserializableExpressions:n.evalUnserializableExpressions,forceBlock:n.forceBlock,forceInline:t===void 0?n.forceInline:t,ignoreHTMLBlocks:n.ignoreHTMLBlocks,optimizeForStreaming:n.optimizeForStreaming,preserveFrontmatter:n.preserveFrontmatter,sanitizer:n.sanitizer||Tt,slugify:i,tagfilter:an(n)}}var _n=/^<([a-zA-Z][a-zA-Z0-9-]*)\s[^>]*>/,vn=/^<[A-Z]/,yn=[`script`,`pre`,`style`,`textarea`],bn=new Set(yn),xn=/<(?:pre|script|style|textarea)\b/i,Sn=/<(?:pre|script|style|textarea)\b/iy,Cn=/^(\s{0,3}#[#\s]|\s{0,3}[-*+]\s|\s{0,3}\d+\.\s|\s{0,3}>\s|\s{0,3}```)/m,wn=/^<([a-z][^ >/\n\r]*) ?([^>]*?)>/im,Tn=new Uint8Array(128);(()=>{for(var e=[V,je,Me,we,ke,Te,Ie,Ne,Ae,Le,B,Ve,He,Be],t=0;t<e.length;t++)Tn[e[t]]=1})();var En=/([a-zA-Z_][a-zA-Z0-9_-]*)=(?:"([^"]*)"|'([^']*)')/g;function Dn(e){return bn.has(e)}function On(e){return xn.test(e)}function kn(e,t,n){for(var r=t,i=n;r<i&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;if(r>=i)return!1;e.charCodeAt(r)===nt&&r++;for(var a=0;r<i;){for(;r<i&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;if(r>=i)break;if(e.charCodeAt(r)===nt&&a>0){for(var o=r+1;o<i&&(e.charCodeAt(o)===R||e.charCodeAt(o)===z);)o++;if(o>=i)return!0}if(e.charCodeAt(r)===Re&&r++,r>=i||e.charCodeAt(r)!==U)return!1;for(;r<i&&e.charCodeAt(r)===U;)r++;for(r<i&&e.charCodeAt(r)===Re&&r++,a++;r<i&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;if(r<i){if(e.charCodeAt(r)===nt)r++;else return!1}}return a>0}var An=/[\u0000-\u001F\u007F]/g,jn={action:1,background:1,cite:1,data:1,formaction:1,href:1,longdesc:1,poster:1,src:1,"xlink:href":1},Mn=/&#(x[0-9a-f]+|[0-9]+);?/gi;function Nn(e){return e.indexOf(`&#`)===-1?e:e.replace(Mn,(e,t)=>{var n=t.charCodeAt(0)===dt||t.charCodeAt(0)===ft?Number.parseInt(t.slice(1),16):Number.parseInt(t,10);return n>0&&n<=1114111?String.fromCodePoint(n):e})}function Pn(e,t,n){if(n&&t.charCodeAt(0)===rt)return!1;var r=e.charCodeAt(0),i=e.charCodeAt(1);if((r===ut||r===lt)&&(i===ct||i===st))return!(n&&t===``);var a=e.toLowerCase();if(a===`srcdoc`)return!0;if(a===`style`)return/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(t);if(jn[a]===1){var o=Nn(Ct(t));if(Tt(o)===null)return!0;var s=o.replace(An,``);return s!==o&&Tt(s)===null}return!1}function Fn(e){return`<`+(e.f?`/`:``)+e.tag+e.g+e.b+(e.n?e.r?` />`:`/>`:`>`)}function In(e,t,n,r){for(var i=[],a=t,o=0;o<r.length;o+=2){var s=r[o];if(s>a){var c=e.slice(a,s).trim();c&&i.push(c)}a=r[o+1]}if(a<n){var l=e.slice(a,n).trim();l&&i.push(l)}return i.join(` `)}function Ln(e,t){if(e.charCodeAt(t)!==Ne)return null;let n=t+1,r=e.length,i=!1;e.charCodeAt(n)===Qe&&(n++,i=!0);let a=n,o=e.charCodeAt(n);if(!(o>=J&&o<=mt||o>=K&&o<=q))return null;for(;n<r&&(e.charCodeAt(n)>=J&&e.charCodeAt(n)<=mt||e.charCodeAt(n)>=K&&e.charCodeAt(n)<=q||e.charCodeAt(n)>=W&&e.charCodeAt(n)<=G||e.charCodeAt(n)===U);)n++;let s=e.slice(a,n);if(!s)return null;let c=s.charCodeAt(0),l=c>=K&&c<=q||s.indexOf(`-`)!==-1,u=n;for(;n<r&&(e.charCodeAt(n)===R||e.charCodeAt(n)===z||e.charCodeAt(n)===B);)n++;let d=e.slice(u,n);if(n===u&&n<r){var f=e.charCodeAt(n);if(f!==H&&f!==Qe)return null}let p=n,m={},h=!1;for(var g=null;n<r;){let t=e.charCodeAt(n);if(t===H){let t=g?In(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!1,g:d,attrs:m,end:n+1,tag:s}}if(t===R||t===z||t===B){n++;continue}if(t===Qe&&n+1<r&&e.charCodeAt(n+1)===H){h=n>p&&e.charCodeAt(n-1)===R;let t=g?In(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!0,g:d,attrs:m,end:n+2,tag:s}}var _=n,v=e.charCodeAt(n);if(!(v>=J&&v<=mt||v>=K&&v<=q||v===Me||v===Re))return null;for(n++;n<r;){var y=e.charCodeAt(n);if(y>=J&&y<=mt||y>=K&&y<=q||y>=W&&y<=G||y===Me||y===Ze||y===Re||y===U)n++;else break}for(var b=e.slice(_,n),x=n;n<r&&(e.charCodeAt(n)===R||e.charCodeAt(n)===z);)n++;var S,C;if(e.charCodeAt(n)===ke){for(n++;n<r&&(e.charCodeAt(n)===R||e.charCodeAt(n)===z);)n++;var w=e.charCodeAt(n);if(w===et||w===$e){n++;for(var T=n;n<r&&e.charCodeAt(n)!==w;)n++;if(n>=r)return null;if(S=e.slice(T,n),n++,n<r){var E=e.charCodeAt(n);if(E!==R&&E!==z&&E!==B&&E!==H&&E!==Qe)return null}C=n}else if(w===rt){var D=1,T=n;for(n++;n<r&&D>0;){var y=e.charCodeAt(n);y===rt?D++:y===it&&D--,n++}S=e.slice(T,n),C=n}else{for(var T=n;n<r;){var O=e.charCodeAt(n);if(O===R||O===z||O===H||O===B||O===et||O===$e||O===ke||O===Ne||O===V)break;n++}if(n===T)return null;S=e.slice(T,n),C=n}}else S=``,C=x;Pn(b,S,l)?(g===null&&(g=[]),g.push(_,C)):m[b]=S}return null}function Rn(e){var t=e.indexOf(`<`);if(t===-1)return e;for(var n=``,r=0,i=!1;t!==-1;){var a=Ln(e,t);a?(a.q&&(n+=e.slice(r,t)+Fn(a),r=a.end,i=!0),t=e.indexOf(`<`,a.end)):t=e.indexOf(`<`,t+1)}return i?n+e.slice(r):e}function zn(e,t,n){if(!n.optimizeForStreaming&&e.indexOf(`[`)===-1)return!1;for(var r=0,i=e.length,a=!1,o=!1;r<i;){for(var s=e.indexOf(`
`,r),c=s<0?i:s,l=r,u=0;l<c&&u<4;)if(e.charCodeAt(l)===R)u++,l++;else if(e.charCodeAt(l)===z)u+=4,l++;else break;if(l>=c){a=!1,r=s<0?i:s+1;continue}if(u<4){var d=e.charCodeAt(l);if(d===V||d===we){for(var f=d,p=0,m=l;m<c&&e.charCodeAt(m)===f;)p++,m++;if(p>=3){var h=!0;if(f===V){for(var g=m;g<c;g++)if(e.charCodeAt(g)===V){h=!1;break}}if(h){a=!1;for(var _=s<0?i:s+1;_<i;){for(var v=_,y=0;v<i&&y<4;){var b=e.charCodeAt(v);if(b===R)y++,v++;else if(b===z)y+=4,v++;else break}if(y<4&&v<i&&e.charCodeAt(v)===f){for(var x=0;v<i&&e.charCodeAt(v)===f;)x++,v++;if(x>=p){for(;v<i&&(e.charCodeAt(v)===R||e.charCodeAt(v)===z);)v++;if(v>=i||e.charCodeAt(v)===B){r=v>=i?i:v+1;break}}}for(;_<i&&e.charCodeAt(_)!==B;)_++;_<i&&_++}_>=i&&(r=i,o=!0);continue}}}}for(var S=l;S<c&&e.charCodeAt(S)===H;){S++,S<c&&e.charCodeAt(S)===R&&S++;for(var C=0;S<c&&C<4;)if(e.charCodeAt(S)===R)C++,S++;else if(e.charCodeAt(S)===z)C+=4,S++;else break;if(C>=4)break;a=!1}if(!a&&u<4&&S<c&&e.charCodeAt(S)===Te&&!(S+1<i&&e.charCodeAt(S+1)===Ee)){var w=Bn(e,S,t);if(w){r=w,a=!1;continue}}var T=e.charCodeAt(l);if(T===De&&u<4)a=!1;else if(u<4&&(T===U||T===je||T===Me)){for(var E=l,D=0;E<c;){var O=e.charCodeAt(E);if(O===T)D++;else if(O!==R&&O!==z)break;E++}a=!(D>=3&&E>=c)}else a=!0;r=s<0?i:s+1}return o}function Bn(e,t,n){let r=e.length;if(e.charCodeAt(t)!==Te)return null;let i=t+1<r&&e.charCodeAt(t+1)===Ee,a=t+1;for(;a<r;){var o=e.charCodeAt(a);if(o===Fe){a++;break}if(o===Te)return null;o===Ae&&a+1<r&&a++,a++}if(a>r||e.charCodeAt(a-1)!==Fe)return null;let s=e.slice(t+1,a-1);if(s.length>999)return null;let c=Wn(s);if(!c||a>=r||e.charCodeAt(a)!==Re)return null;a++;let l=!1;for(;a<r;){let t=e.charCodeAt(a);if(t===R||t===z)a++;else if(t===B&&!l)l=!0,a++;else break}if(i){let t=e.indexOf(`
`,a),i=t<0?r:t;return n[c]={target:e.slice(a,i).trim(),title:void 0},t<0?r:t+1}var u;if(a<r&&e.charCodeAt(a)===Ne){a++;for(var d=a;a<r&&e.charCodeAt(a)!==H&&e.charCodeAt(a)!==B;)e.charCodeAt(a)===Ae&&a+1<r&&a++,a++;if(a>=r||e.charCodeAt(a)!==H)return null;u=e.slice(d,a),a++;for(var f=e.indexOf(`
`,a),p=f<0?r:f,m=a;m<p&&(e.charCodeAt(m)===R||e.charCodeAt(m)===z);)m++;if(m<p){if(m===a)return null;var h=e.charCodeAt(m);if(h!==et&&h!==$e&&h!==at)return null}}else{for(var d=a,g=0;a<r;){var o=e.charCodeAt(a);if(o===at)g++;else if(o===ot){if(g===0)break;g--}else{if(o===R||o===z||o===B)break;o===Ae&&a+1<r&&a++}a++}if(u=e.slice(d,a),!u)return null}for(;a<r&&(e.charCodeAt(a)===R||e.charCodeAt(a)===z);)a++;var _=e.indexOf(`
`,a),v=_<0?r:_,y,b=!1,x=a,S=a;if(a===v&&a<r)for(S=a+1;S<r&&(e.charCodeAt(S)===R||e.charCodeAt(S)===z);)S++;if(S<r){var C=e.charCodeAt(S);if(C===et||C===$e||C===at){for(var w=C===at?41:C,T=S+1,E=T;T<r;){var D=e.charCodeAt(T);if(D===w){for(var O=T+1;O<r&&(e.charCodeAt(O)===R||e.charCodeAt(O)===z);)O++;(O>=r||e.charCodeAt(O)===B)&&(y=e.slice(E,T),b=!0,x=O<r?O+1:r);break}if(D===Ae&&T+1<r){T+=2;continue}if(D===B&&T+1<r&&e.charCodeAt(T+1)===B)break;T++}if(!b&&S===a)return null}}if(b)return n[c]||(n[c]={target:Ct(Kn(u)),title:y===void 0?y:Ct(Kn(y))}),x;for(;a<v&&(e.charCodeAt(a)===R||e.charCodeAt(a)===z);)a++;return a<v?null:(n[c]||(n[c]={target:Ct(Kn(u)),title:y}),_<0?r:_+1)}var Vn=new Uint8Array(Bt);for(Vn[De]|=Rt,Vn[H]|=Rt,Vn[U]|=Rt|zt,Vn[tt]|=Rt,Vn[je]|=Rt|zt,Vn[Me]|=Rt|zt,Vn[V]|=Rt|zt,Vn[we]|=Rt|zt,Vn[Ne]|=Rt|zt,Vn[Te]|=zt,Vn[Ie]|=zt,Vn[nt]|=Rt,Hn=W;Hn<=G;Hn++)Vn[Hn]|=Rt;var Hn;function Un(e){if(e.indexOf(`[`)<0&&e.indexOf(`]`)<0)return!1;for(var t=0;t<e.length;t++){if(e.charCodeAt(t)===Ae){t++;continue}if(e.charCodeAt(t)===Te||e.charCodeAt(t)===Fe)return!0}return!1}function Wn(e){for(var t=e.length,n=!0,r=t>0,i=0;i<t;i++){var a=e.charCodeAt(i);if(a===R){if(n){r=!1;break}n=!0}else if(a<33||a>126||a>=K&&a<=q){r=!1;break}else n=!1}if(r&&!n)return e;var o=e.replace(/\s+/g,` `).trim();return o.indexOf(`ẞ`)===-1?o.toLowerCase():o.replace(/\u1E9E/g,`ss`).toLowerCase()}function Gn(e){return e<ht?Vn[e]:e===Ke?Nt:0}function Kn(e){return e.indexOf(`\\`)===-1?e:e.replace(/\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,`$1`)}var qn=null,Jn=-1,Yn=-1;function Xn(e,t){if(t>=Jn&&t<=Yn&&e===qn)return Yn;var n=e.indexOf(`
`,t),r=n<0?e.length:n;return qn=e,Jn=t,Yn=r,r}function X(e,t){let n=Xn(e,t);return n<e.length?n+1:n}function Zn(e,t,n){for(;t<n;){let n=e.charCodeAt(t);if(n!==R&&n!==z)break;t++}return t}function Qn(e,t){let n=X(e,t);for(;n<e.length;){let t=Xn(e,n);if(nr(e,n,t))return n;n=X(e,n)}return e.length}function $n(e,t,n,r){let i=0;for(;t+i<n&&e.charCodeAt(t+i)===r;)i++;return i}var er=0,Z=0;function tr(e,t,n){for(er=0,Z=0;t+Z<n;){let n=e.charCodeAt(t+Z);if(n===z)er+=4-er%4;else if(n===R)er++;else break;Z++}}function nr(e,t,n){return Zn(e,t,n)>=n}function rr(e,t){if(!e)return e;var n=t.v||=Object.create(null),r=n[e];if(r===void 0)return n[e]=0,e;for(var i=r+1,a=`${e}-${i}`;n[a]!==void 0;)i++,a=`${e}-${i}`;return n[e]=i,n[a]=0,a}function ir(e,t,n,r){let i=Xn(e,t);if(tr(e,t,i),er>3)return null;let a=t+Z;if(e.charCodeAt(a)!==De)return null;let o=$n(e,a,i,35);if(o<1||o>6||(a+=o,a<i&&e.charCodeAt(a)!==R&&e.charCodeAt(a)!==z))return null;a=Zn(e,a,i);for(var s=i;s>a&&e.charCodeAt(s-1)===R;)s--;for(var c=s;s>a&&e.charCodeAt(s-1)===De;)s--;if(s<c){if(s===a||e.charCodeAt(s-1)===R)for(;s>a&&e.charCodeAt(s-1)===R;)s--;else s=c}let l=Mr(e.slice(a,s),!1,n,r);return{node:{type:Y.heading,level:o,children:l,id:``},end:X(e,i)}}function ar(e,t,n){var r=e.charCodeAt(t);if(r!==ke&&r!==U)return!1;for(var i=t;i<n&&e.charCodeAt(i)===r;)i++;for(;i<n&&(e.charCodeAt(i)===R||e.charCodeAt(i)===z);)i++;return i>=n}function or(e,t){let n=Xn(e,t);if(tr(e,t,n),er>3)return null;let r=t+Z,i=e.charCodeAt(r);if(i!==U&&i!==je&&i!==Me)return null;let a=0;for(;r<n;){let t=e.charCodeAt(r);if(t===i)a++;else if(t!==R&&t!==z)return null;r++}return a<3?null:{node:{type:Y.breakThematic},end:X(e,n)}}var sr=0,cr=0,lr=``;function ur(e,t,n){let r=Xn(e,t);if(tr(e,t,r),er>3)return null;let i=er,a=t+Z,o=e.charCodeAt(a);if(o!==V&&o!==we)return null;let s=$n(e,a,r,o);if(s<3)return null;a+=s;let c=Zn(e,a,r),l=r;if(o===V){for(let t=c;t<r;t++)if(e.charCodeAt(t)===V)return null}for(;l>c&&(e.charCodeAt(l-1)===R||e.charCodeAt(l-1)===z);)l--;let u=e.slice(c,l),d=``,f=``,p=u.indexOf(` `);p===-1?d=u:(d=u.slice(0,p),f=u.slice(p+1).trim()),d=Kn(d);var m;if(f){En.lastIndex=0;for(var h;(h=En.exec(f))!=null;)m||={},m[h[1]]=h[2]===void 0?h[3]:h[2]}let g=X(e,r),_=e.length,v=e.length;var y;o===sr&&s===cr?y=lr:(y=String.fromCharCode(o).repeat(s),sr=o,cr=s,lr=y);for(var b=g;b<e.length;){var x=e.indexOf(y,b);if(x===-1)break;for(var S=x,C=0;S>0&&C<4&&e.charCodeAt(S-1)===R;)S--,C++;if(C<=3&&(S===0||e.charCodeAt(S-1)===B)){for(var w=x+s;w<e.length&&e.charCodeAt(w)===o;)w++;var T=Xn(e,w);if(nr(e,w,T)){_=S,v=X(e,T);break}}b=x+1}var E;if(i===0)E=_>g&&e.charCodeAt(_-1)===B?e.slice(g,_-1):e.slice(g,_);else{E=``;for(var D=g;D<_;){var O=Xn(e,D);tr(e,D,O);var ee=Math.min(Z,i);E+=`${e.slice(D+ee,O)}
`,D=X(e,O)}E.length>0&&E.charCodeAt(E.length-1)===B&&(E=E.slice(0,-1))}return{node:{type:Y.codeBlock,lang:d||void 0,text:E,infoString:f||void 0,attrs:m},end:v}}function dr(e,t,n){for(var r=0,i=t;i<n&&r<4;)e.charCodeAt(i)===z?r+=4-r%4:r++,i++;if(r<4)return``;for(var a=``,o=4;o<r;o++)a+=` `;return a+e.slice(i,n)}function fr(e,t){if(tr(e,t,Xn(e,t)),er<4)return null;let n=``,r=t;for(;r<e.length;){let t=Xn(e,r);if(tr(e,r,t),nr(e,r,t)){for(var i=`${dr(e,r,t)}
`,a=X(e,t);a<e.length;){var o=Xn(e,a);if(nr(e,a,o)){i+=`${dr(e,a,o)}
`,a=X(e,o);continue}tr(e,a,o),er>=4&&(n+=i,r=a);break}if(r!==a)break;continue}if(er<4)break;let d=0,f=0;var s=0;for(let n=r;n<t&&f<4;n++){if(e.charCodeAt(n)===z){var c=4-f%4;f+c>4&&(s=f+c-4),f+=c}else f++;d++}var l=``;if(s>0)for(var u=0;u<s;u++)l+=` `;l+=e.slice(r+d,t),n+=`${l}
`,r=X(e,t)}for(;n.length>0&&n.charCodeAt(n.length-1)===B;)n=n.slice(0,-1);return n?{node:{type:Y.codeBlock,lang:void 0,text:n,infoString:void 0,attrs:void 0},end:r}:null}function pr(e,t,n,r){if(tr(e,t,Xn(e,t)),er>3)return null;let i=t+Z;if(e.charCodeAt(i)!==H)return null;let a=``,o=t,s,c=!1,l=!1,u=!1;for(;o<e.length;){let t=Xn(e,o);tr(e,o,t);let n=o+Z;if(e.charCodeAt(n)===H){let r=n+1;var d=er+1,f=!1;if(r<t){var p=e.charCodeAt(r);p===R?(r++,d++,f=!0):p===z&&(f=!0)}for(var m=``,h=!1,g=r;g<t;g++)if(e.charCodeAt(g)===z){h=!0;break}if(h){var _=d;if(f&&r<t&&e.charCodeAt(r)===z){for(var v=4-_%4,y=0;y<v-1;y++)m+=` `;_+=v,r++}for(var b=r;b<t;b++)if(e.charCodeAt(b)===z){for(var x=4-_%4,S=0;S<x;S++)m+=` `;_+=x}else m+=e[b],_++}else m=e.slice(r,t);if(!(a||s)){let n=m.match(/^\[!([A-Za-z]+)\]\s*$/);if(n){s=n[1].toUpperCase(),o=X(e,t);continue}}a+=`${m}
`;var C=m.trimStart();C.startsWith("```")||C.startsWith(`~~~`)?u=!u:(m.startsWith(`    `)||m.startsWith(`	`))&&(u=!0),l=C.length>0,o=X(e,t)}else if(a&&!nr(e,o,t)&&l){if(er<4){var w=o+Z,T=w<t?e.charCodeAt(w):0;if(T===De||T===H||T===V||T===we||T===Ne||(T===U||T===je||T===Me)&&or(e,o)||(T===U||T===je||T===tt)&&w+1<t&&(e.charCodeAt(w+1)===R||e.charCodeAt(w+1)===z))break;if(T>=W&&T<=G){for(var E=w;E<t&&e.charCodeAt(E)>=W&&e.charCodeAt(E)<=G;)E++;if(E<t&&(e.charCodeAt(E)===Ze||e.charCodeAt(E)===ot))break}}if(u)break;a+=`${e.slice(o,t)}
`,c=!0,o=X(e,t)}else break}if(!(a||s))return null;var{inBlockQuote:D,l:O}=n;n.inBlockQuote=!0,c&&(n.l=!0);var ee=n.i;n.i=ee||!nr(e,o,e.length);let k=_i(a||``,n,r);return n.i=ee,n.inBlockQuote=D,n.l=O,{node:{type:Y.blockQuote,children:k,alert:s||void 0},end:o}}function mr(e,t,n){for(var r=0,i=t;i<n;i++)e.charCodeAt(i)===z?r+=4-r%4:r++;return r}function hr(e,t,n){if(tr(e,t,n),er>3)return null;var r=t+Z;if(r>=n)return null;var i=e.charCodeAt(r),a=er,o=r,s=r;if(i===U||i===je||i===tt){if(o=r+1,o<n&&e.charCodeAt(o)!==R&&e.charCodeAt(o)!==z&&e.charCodeAt(o)!==B)return null}else if(i>=W&&i<=G){for(;s<n&&s-r<9;){var c=e.charCodeAt(s);if(c<W||c>G)break;s++}if(s>r&&s<n){var l=e.charCodeAt(s);if(l===Ze||l===ot){if(o=s+1,o<n&&e.charCodeAt(o)!==R&&e.charCodeAt(o)!==z&&e.charCodeAt(o)!==B)return null}else return null}else return null}else return null;var u=o,d=mr(e,t,o),f=0,p=u,m=d;if(u>=n)return{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:u,contentCol:d+1,markerCol:a,isEmpty:!0};for(;p<n&&(e.charCodeAt(p)===R||e.charCodeAt(p)===z);){if(e.charCodeAt(p)===z){var h=4-m%4;m+=h}else m++;p++,f++}var g=p>=n,_=m-d;return g||_>4?(m=d+1,p=u+1,f=1):f===0&&(m=d+1,p=u,f=1),{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:p,contentCol:m,markerCol:a,isEmpty:g}}var gr=0;function _r(e,t,n,r){var i=0,a=t;for(gr=0;a<n&&i<r;){var o=e.charCodeAt(a);if(o===z){var s=4-i%4;if(i+s>r){gr=i+s-r,a++,i=r;break}i+=s}else if(o===R)i++;else break;a++}return a}function vr(e,t,n,r){var i=Xn(e,t),a=hr(e,t,i);if(!a)return null;var o=[],s=t,c=a.contentCol,l=``,u=a.isEmpty,d=!1,f=!1;if(!a.isEmpty){for(var p=!1,m=a.contentStart;m<i;m++)if(e.charCodeAt(m)===z){p=!0;break}if(p){var h=``,g=mr(e,t,a.contentStart),_=g-a.contentCol;if(_>0)for(var v=0;v<_;v++)h+=` `;for(var y=a.contentStart;y<i;y++)if(e.charCodeAt(y)===z){for(var b=4-g%4,x=0;x<b;x++)h+=` `;g+=b}else h+=e[y],g++;l=`${h}
`}else l=`${e.slice(a.contentStart,i)}
`}for(s=X(e,i);s<e.length;){var S=Xn(e,s);tr(e,s,S);var C=e.charCodeAt(s+Z);if(er<c&&(C===U||C===je||C===Me)&&er<=3&&or(e,s))break;var w=hr(e,s,S);if(w&&w.ordered===a.ordered&&w.marker===a.marker&&w.markerCol<c){o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),d&&(f=!0),c=w.contentCol,u=w.isEmpty,d=!1,l=w.isEmpty?``:`${e.slice(w.contentStart,S)}
`,s=X(e,S);continue}if(nr(e,s,S)){var T=_r(e,s,S,c);if(gr>0||T<S){for(var E=``,D=0;D<gr;D++)E+=` `;l+=`${E+e.slice(T,S)}
`}else l+=`
`;s=X(e,S);for(var O=!1,ee=0;ee<l.length;ee++){var k=l.charCodeAt(ee);if(k!==B&&k!==Ce&&k!==R&&k!==z){O=!0;break}}if(u&&!O){if(s<e.length){var te=Xn(e,s),ne=hr(e,s,te);if(!ne||ne.ordered!==a.ordered||ne.marker!==a.marker)break;d=!0}else break}if(s<e.length){var re=Xn(e,s);tr(e,s,re);var ie=e.charCodeAt(s+Z);if((ie===U||ie===je||ie===Me)&&er<=3&&or(e,s))break;var ae=hr(e,s,re);if(ae&&ae.ordered===a.ordered&&ae.marker===a.marker&&ae.markerCol<c){d=!0;continue}if(!nr(e,s,re)&&er<c)break}continue}if(er>=c){var oe=_r(e,s,S,c);if(gr>0){for(var se=``,ce=c,le=0;le<gr;le++)se+=` `,ce++;for(var A=oe;A<S;A++)if(e.charCodeAt(A)===z){for(var j=4-ce%4,M=0;M<j;M++)se+=` `;ce+=j}else se+=e[A],ce++;l+=`${se}
`}else l+=`${e.slice(oe,S)}
`;s=X(e,S);continue}for(var ue=!1,de=0;de<l.length;de++){var fe=l.charCodeAt(de);if(fe!==B&&fe!==Ce&&fe!==R&&fe!==z){ue=!0;break}}if(!d&&ue&&!u){var N=s+Z,P=e.charCodeAt(N);if(!(P===De||P===H||P===Ne||P===V||P===we||(P===U||P===je||P===Me||P===tt)&&(or(e,s)!=null||hr(e,s,S)!=null)||P>=W&&P<=G&&hr(e,s,S)!=null)){l+=`${e.slice(N,S)}
`,s=X(e,S);continue}}break}if(o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),o.length===0)return null;var pe=f;if(!pe)for(var me=0;me<o.length;me++){if(o[me].hasBlankAfter&&me<o.length-1){pe=!0;break}if(!o[me].isEmpty){for(var he=o[me].raw,ge=he.length,F=0,_e=!1,ve=!1,ye=!1,be=!1,xe=0,I=0,Se=-1;F<ge;){var L=he.indexOf(`
`,F);if(L<0&&(L=ge),be){tr(he,F,L);for(var Ee=he.slice(F+Z,L),Oe=0;Oe<Ee.length&&Ee.charCodeAt(Oe)===xe;)Oe++;Oe>=I&&Ee.slice(Oe).trim()===``&&(be=!1),F=L<ge?L+1:ge;continue}if(nr(he,F,L)){Se>=0?ye=!0:_e&&(ve=!0),F=L<ge?L+1:ge;continue}if(tr(he,F,L),Se>=0){if(er>=Se){F=L<ge?L+1:ge;continue}var ke=hr(he,F,L);if(ke&&ke.markerCol<Se&&ke.contentCol<=Se){F=L<ge?L+1:ge;continue}if(ke){F=L<ge?L+1:ge;continue}Se=-1,ye&&=(ve=!0,!1)}var Ae=he.slice(F+Z,L),Pe=Ae.charCodeAt(0);if((Pe===V||Pe===we)&&er<=3){for(var Ie=0;Ie<Ae.length&&Ae.charCodeAt(Ie)===Pe;)Ie++;if(Ie>=3){if(ve&&_e){pe=!0;break}be=!0,xe=Pe,I=Ie,_e=!0,F=L<ge?L+1:ge;continue}}var Le=er<=3?hr(he,F,L):null;if(Le&&_e){if(ve){pe=!0;break}Se=Le.contentCol,ye=!1,F=L<ge?L+1:ge,_e=!0;continue}if(ve){pe=!0;break}_e=!0,F=L<ge?L+1:ge}if(pe)break}}for(var Re=[],ze=0;ze<o.length;ze++){for(var Be=o[ze],Ve=Be.raw,He=Ve.length;He>0&&Ve.charCodeAt(He-1)===B;)He--;var Ue=He<Ve.length?Ve.slice(0,He):Ve,We=null;if(Ue.length>=3&&Ue.charCodeAt(0)===Te){var Ge=Ue[1];(Ge===` `||Ge===`x`||Ge===`X`)&&Ue.charCodeAt(2)===Fe&&(We={type:Y.gfmTask,completed:Ge===`x`||Ge===`X`},Ue=Ue.slice(3))}var Ke;if(Be.isEmpty&&Ue.trim()===``)Ke=[];else if(pe){var qe=n.inList;n.inList=!0;var Je=n.i;n.i=Je||ze!==o.length-1,Ke=_i(Ue,n,r),n.i=Je,n.inList=qe}else{var Ye=n.inList;n.inList=!0;var Xe=n.i;if(n.i=Xe||ze!==o.length-1,Ke=_i(Ue,n,r),n.i=Xe,n.inList=Ye,Ke.length===1&&Ke[0].type===Y.paragraph)Ke=Ke[0].children;else if(n.p){var Ze=[];n.p.push({src:Ke,dest:Ze,unwrap:!0}),Ke=Ze}else{for(var Qe=[],$e=0;$e<Ke.length;$e++)if(Ke[$e].type===Y.paragraph)for(var et=Ke[$e].children,nt=0;nt<et.length;nt++)Qe.push(et[nt]);else Qe.push(Ke[$e]);Ke=Qe}}if(We){var rt=[We,{type:Y.text,text:` `}];if(n.p)n.p.push({src:Ke,dest:rt,unwrap:!1});else for(var it=0;it<Ke.length;it++)rt.push(Ke[it]);Re.push(rt)}else Re.push(Ke)}return{node:{type:a.ordered?Y.orderedList:Y.unorderedList,start:a.ordered?a.start:void 0,items:Re},end:s}}var yr=new Set(`address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul`.split(`.`));function br(e,t,n){let r={};for(let[o,s]of Object.entries(e)){let e=o.toLowerCase();if(e===`style`&&typeof s==`string`){let e={},t=[],n=0,i=0;for(let e=0;e<s.length;e++){let r=s.charCodeAt(e);r===at?n++:r===ot?n--:r===Ye&&n===0&&(t.push(s.slice(i,e)),i=e+1)}i<s.length&&t.push(s.slice(i));let a=!1;t.forEach(t=>{let n=t.indexOf(`:`);if(n===-1)return;let r=t.slice(0,n).trim(),i=t.slice(n+1).trim();if(r&&i){if(/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(i)){a=!0;return}let t=r.indexOf(`-`)===-1?r:r.replace(/-([a-z])/g,(e,t)=>t.toUpperCase());e[t]=i}}),!a&&Object.keys(e).length>0&&(r[o]=e)}else if((e===`href`||e===`src`)&&n?.sanitizer){let i=n.sanitizer(s,t,e);i!=null&&(r[o]=i)}else if(s===``)r[o]=!0;else if(s.length>=2&&s.charCodeAt(0)===rt&&s.charCodeAt(s.length-1)===it){var i=s.slice(1,-1);if(i.length>0){var a=i.charCodeAt(0);if(a===Te||a===rt)try{r[o]=JSON.parse(i);continue}catch{}}if(i===`true`){r[o]=!0;continue}if(i===`false`){r[o]=!1;continue}if(n?.evalUnserializableExpressions)try{r[o]=(0,eval)(`(${i})`);continue}catch{}r[o]=i}else r[o]=s}return r}function xr(e,t,n){let r=t.length;if(r===0)return n;var i=t.charCodeAt(0);if(!(i>=K&&i<=q||i>=J&&i<=mt)){for(var a=String.fromCharCode(i),o=e.length-r,s=n;s<=o;){var c=e.indexOf(a,s);if(c===-1||c>o)return-1;for(var l=!0,u=1;u<r;u++){var d=e.charCodeAt(c+u),f=t.charCodeAt(u);if(d>=K&&d<=q&&(d+=gt),f>=K&&f<=q&&(f+=gt),d!==f){l=!1;break}}if(l)return c;s=c+1}return-1}i>=K&&i<=q&&(i+=gt);for(let a=n;a<=e.length-r;a++){var p=e.charCodeAt(a);if(p>=K&&p<=q&&(p+=gt),p!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(a+i),o=t.charCodeAt(i);if(r>=K&&r<=q&&(r+=gt),o>=K&&o<=q&&(o+=gt),r!==o){n=!1;break}}if(n)return a}return-1}function Sr(e,t,n){let r=t.length;var i=t.charCodeAt(0);i>=K&&i<=q&&(i+=gt);for(let o=Math.min(n,e.length-r);o>=0;o--){var a=e.charCodeAt(o);if(a>=K&&a<=q&&(a+=gt),a!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(o+i),a=t.charCodeAt(i);if(r>=K&&r<=q&&(r+=gt),a>=K&&a<=q&&(a+=gt),r!==a){n=!1;break}}if(n)return o}return-1}var Cr=-1;function wr(e,t,n){let r=n.toLowerCase(),i=`<${r}`,a=`</${r}`,o=1,s=t,c=e.length;for(Cr=-1;s<c&&o>0;){let t=xr(e,i,s),n=xr(e,a,s);if(n===-1)return-1;if(t!==-1&&t<n){let n=Ln(e,t);n?(n.tag.toLowerCase()===r&&!n.f&&!n.n&&!Mt(n.tag)&&o++,s=n.end):s=t+1}else{var l=n+a.length,u=l<c?e.charCodeAt(l):62;if((u===H||u===R||u===z||u===B)&&(o--,o===0)){Cr=n;let t=n+a.length;for(;t<c&&e.charCodeAt(t)!==H;)t++;return t+1}s=n+1}}return-1}function Tr(e,t,n,r){if(r.ignoreHTMLBlocks||r.disableParsingRawHTML)return null;var i=Xn(e,t);if(tr(e,t,i),er>3&&!n.inHTML)return null;var a=t+Z;if(e.charCodeAt(a)!==Ne)return null;var o=e.indexOf(`>`,a+1);if(o!==-1&&o<i){var s=e.slice(a+1,o);if(/^[a-zA-Z][a-zA-Z0-9+.-]*:/.test(s)||/^[^\s@]+@[^\s@]+$/.test(s))return null}var c=Er(e,a);if(c>=1&&c<=5){var l=e.length;if(c===1){for(var u=e.length,d=0;d<yn.length;d++){var f=xr(e,`</${yn[d]}>`,a);f>=0&&f<u&&(u=f)}if(u<e.length){var p=e.indexOf(`>`,u);l=p>=0?X(e,p+1):e.length}}else{var m=c===2?`-->`:c===3?`?>`:c===4?`>`:`]]>`,h=e.indexOf(m,a);h>=0&&(l=X(e,h+m.length))}var g=e.slice(a,l);if(c>=2)return{node:{type:Y.htmlComment,text:g,s:!1,raw:!0},end:l};var _=`div`,v=g.match(/^<\/?([a-zA-Z][a-zA-Z0-9-]*)/);v&&(_=v[1]);var y=Ln(e,a),b={},x;y&&!y.f&&(b=br(y.attrs,_,r),x=y.g+y.b);var S=[],C=xr(g,`</${_.toLowerCase()}`,0),w=``,T,E,D;if(y?.f){D=g.slice(0,y.end-a);for(var O=g.slice(y.end-a);O.length>0&&O.charCodeAt(O.length-1)===B;)O=O.slice(0,-1);O&&(E=Rn(O))}else if(y&&!y.f){var ee=y.end-a;if(C===-1){for(var k=g;k.length>0&&k.charCodeAt(k.length-1)===B;)k=k.slice(0,-1);T=Rn(k)}else{var te=ee;g.charCodeAt(te)===B&&te++;for(var ne=C;ne>te;){var re=g.charCodeAt(ne-1);if(re!==R&&re!==z&&re!==B&&re!==Ce)break;ne--}var ie=g.slice(te,ne);ie&&(E=Rn(ie));for(var ae=g.slice(C);ae.length>0&&ae.charCodeAt(ae.length-1)===B;)ae=ae.slice(0,-1);D=Rn(ae),w=g.slice(ee,C).trim()}}var oe=y?y.f:!1;return{node:{type:Y.htmlBlock,tag:_,attrs:b,b:x,children:S,e:E,h:D,j:T,text:w,c:!0,a:oe},end:l}}if(c===6||c===7){var se=Qn(e,t),ce=se<e.length?se:e.length,le=e.slice(a,ce),A=se<e.length?X(e,se):e.length,j=Ln(e,a);if(j){var M=j.tag,ue=M.toLowerCase();if(j.f){var de=e.slice(j.end,ce);return{node:{type:Y.htmlBlock,tag:M,attrs:{},children:[],h:e.slice(a,j.end),e:de?Rn(de):void 0,text:de,c:!0,a:!0},end:A}}if(j.n||Mt(M))return{node:{type:Y.htmlBlock,tag:M,attrs:br(j.attrs,M,r),b:j.g+j.b,children:[],text:``,c:!1,a:!1},end:j.end<e.length&&e.charCodeAt(j.end)===B?j.end+1:j.end};var fe=n.d||0,N=e.slice(a,ce),P=-1,pe=-1,me=!1;if(fe<10){for(var he=`</${ue}`,ge=j.end-a,F=1,_e=ge;_e<N.length&&F>0;){var ve=xr(N,`<${ue}`,_e),ye=xr(N,he,_e);if(ye===-1)break;if(ve!==-1&&ve<ye){var be=ve+ue.length+1;if(be<N.length){var xe=N.charCodeAt(be);(xe===R||xe===z||xe===B||xe===H||xe===Qe)&&F++}_e=ve+1}else{var I=ye+he.length;if(I<N.length){var Se=N.charCodeAt(I);if((Se===H||Se===R||Se===z||Se===B)&&(F--,F===0)){P=ye;for(var L=I;L<N.length&&N.charCodeAt(L)!==H;)L++;pe=L+1;break}}else if(F--,F===0){P=ye,pe=N.length;break}_e=ye+1}}if(P===-1&&!j.f&&(c===6||j.u)){var V=wr(e,j.end,ue);if(V!==-1){for(var we=Cr,Te=j.end,Ee=!1,De=!1,Oe=!1,U=0,ke=!1,Ae=!1,je=Te;je<we;){var Me=e.charCodeAt(je);if(Me===B)Ae&&(Ee=!0),ke||U++,Ae=!0,je++;else if(Me===R||Me===z)je++;else{if(!ke&&(ke=!0,U>=2&&Me===Ne)){Oe=!0;break}if(Ae=!1,Me===Ne){var Pe=e.charCodeAt(je+1)|32;if((Pe===We||Pe===Ge||Pe===Ue)&&(Sn.lastIndex=je,Sn.test(e))){De=!0;break}}je++}}if(Ee&&!Oe&&!De){var Fe=Xn(e,V);ce=Fe,A=X(e,Fe),N=e.slice(a,ce),le=e.slice(a,ce),P=we-a,pe=V-a,me=!0}}}}var Ie=j.b.indexOf(`
`)!==-1||j.g.indexOf(`
`)!==-1,Le=!1;P!==-1&&(Le=N.slice(pe).trim().length===0);var Re=!1,ze=ce,Be=A;if(P!==-1){var Ve=a+pe,He=Xn(e,Ve-1);if(Ve<He){for(var Ke=Ve;Ke<He&&(e.charCodeAt(Ke)===R||e.charCodeAt(Ke)===z);)Ke++;if(Ke<He&&e.charCodeAt(Ke)===Ne){var qe=Ln(e,Ke);qe&&!qe.f&&(Re=!0,ze=Ve,Be=Ve,Le=!0)}}if(!Re){var Je=X(e,He);if(Je<ce){for(var Ye=Je;Ye<ce&&(e.charCodeAt(Ye)===R||e.charCodeAt(Ye)===z);)Ye++;Ye<ce&&e.charCodeAt(Ye)===Ne&&Ln(e,Ye)&&(Re=!0,ze=He,Be=Je,Le=!0)}}!Re&&n.inHTML&&(Re=!0,ze=He,Be=X(e,He),Le=e.slice(Ve,He).trim().length===0)}var Xe=[],Ze=``;if(P!==-1){Ze=N.slice(j.end-a,P);var $e=Ze.trim();if($e){var{inline:et,inHTML:tt,d:nt}=n;if(n.inHTML=!0,n.d=fe+1,ue===`p`)n.inline=!0,Xe=Mr($e,!1,n,r);else{var rt=Ze.indexOf(`

`)!==-1,it=Cn.test($e),at=wn.test($e),ot=rt||it||n.inHTML&&at;Ze.length>=2&&Ze.charCodeAt(0)===B&&Ze.charCodeAt(Ze.length-1)===B&&!rt&&!it&&!at?Xe=[{type:Y.text,text:$e}]:ot||at?(n.inline=!1,Xe=_i(Ze,n,r)):(n.inline=!0,Xe=Mr($e,!1,n,r))}n.inline=et,n.inHTML=tt,n.d=nt}}var st=!1;if(c===6&&P!==-1&&!n.inHTML&&!Ie){var ct=/<[a-zA-Z][^>]*>/.test(Ze),lt=Ze.indexOf(`

`)!==-1||Cn.test(Ze);ct&&!lt&&(st=!0)}if(!me&&(n.inHTML||c===7||Ie||!Le||st)){var ut,dt,ft=!1;if(P!==-1&&Re){var pt=!1;if(n.inHTML&&pe<N.length){for(var W=pe;W<N.length&&N.charCodeAt(W)!==B;)W++;var G=N.slice(pe,W).trim();pt=G.length>1&&G.charCodeAt(0)===Ne&&G.charCodeAt(1)!==Qe}dt=pt?N.slice(j.end-a):Ze,ft=!0}else(c===7||n.inHTML)&&P!==-1?(dt=N.slice(j.end-a),dt.charCodeAt(0)===B&&(dt=dt.slice(1))):Re?ut=e.slice(a,ze):Ie?ut=le:(dt=N.slice(j.end-a),dt.charCodeAt(0)===B&&(dt=dt.slice(1)));var J=ut!==void 0,mt=Rn(ut===void 0?dt||``:ut),ht={type:Y.htmlBlock,tag:M,attrs:br(j.attrs,M,r),b:j.g+j.b,children:Xe,e:J?void 0:mt,j:J?mt:void 0,text:mt,c:!0,a:!1};return ft&&(ht.x=!0),{node:ht,end:Be}}var gt=Rn(Ze);return{node:{type:Y.htmlBlock,tag:M,attrs:br(j.attrs,M,r),b:j.g+j.b,children:Xe,e:me?void 0:gt,text:gt,c:!1,a:!1},end:Be}}var _t=le.match(/^<(\/?)([a-zA-Z][a-zA-Z0-9-]*)/),vt=_t?_t[2]:`div`,yt=_t?_t[1]===`/`:!1,bt,xt,St,Ct=``;if(yt){var wt=le.indexOf(`>`);wt===-1?bt=le:(bt=le.slice(0,wt+1),Ct=le.slice(wt+1),Ct&&(xt=Rn(Ct)))}else St=Rn(le);return{node:{type:Y.htmlBlock,tag:vt,attrs:{},children:[],e:xt,h:bt,j:St,text:yt?Ct:le,c:!0,a:yt},end:A}}var Tt=Ln(e,a);if(!Tt)return null;var Et=Tt.tag,Dt=Et.toLowerCase(),Ot=Et.charCodeAt(0),kt=Ot>=K&&Ot<=q;if(!(kt||yr.has(Dt)||bn.has(Dt)||Dt.includes(`-`)))return null;if(Tt.f)return{node:{type:Y.htmlSelfClosing,tag:Et,attrs:{},h:e.slice(a,Tt.end),a:!0},end:Tt.end};var At=wr(e,Tt.end,Et),jt=[];if(At!==-1){var Nt=Cr,Pt=e.slice(Tt.end,Nt),Ft=Pt.trim();if(Ft){var It=Pt.indexOf(`

`)!==-1,Lt=Cn.test(Ft),Rt=wn.test(Ft),zt=n.inline,Bt=n.inHTML,Vt=n.d;n.inHTML=!0,n.d=(n.d||0)+1,It||Lt||Rt?(n.inline=!1,jt=_i(Pt,n,r)):(n.inline=!0,jt=Mr(Ft,!1,n,r)),n.inline=zt,n.inHTML=Bt,n.d=Vt}var Ht=Xn(e,At),Ut=e.slice(At,Ht).trim()?At:X(e,At),Wt=kt?e.slice(a,At):e.slice(a,Ut);return{node:{type:Y.htmlBlock,tag:Et,attrs:br(Tt.attrs,Et,r),b:Tt.g+Tt.b,children:jt,j:Rn(Wt),text:kt?Pt:Wt,c:!0,a:!1},end:Ut}}var Gt=Qn(e,Tt.end),Kt=Gt<e.length?X(e,Gt):Gt,qt=e.slice(Tt.end,Gt);if(qt.trim()){var{inline:Jt,inHTML:Yt,d:Xt}=n;n.inline=!1,n.inHTML=!0,n.d=(n.d||0)+1,jt=_i(qt,n,r),n.inline=Jt,n.inHTML=Yt,n.d=Xt}var Zt=e.slice(Tt.end,Gt);return{node:{type:Y.htmlBlock,tag:Et,attrs:br(Tt.attrs,Et,r),b:Tt.g+Tt.b,children:jt,e:Rn(Zt),text:qt,c:!0,a:!1},end:Kt}}function Er(e,t){if(e.charCodeAt(t)!==Ne)return 0;var n=t+1,r=e.length;if(e.charCodeAt(n)===Ie&&e.charCodeAt(n+1)===U&&e.charCodeAt(n+2)===U)return 2;if(e.charCodeAt(n)===Xe)return 3;if(e.charCodeAt(n)===Ie){var i=e.charCodeAt(n+1);if(i>=K&&i<=q)return 4;if(e.slice(n+1,n+8)===`[CDATA[`)return 5}for(var a=e.charCodeAt(n)===Qe,o=a?n+1:n,s=o;s<r;){var c=e.charCodeAt(s);if(c>=K&&c<=q||c>=J&&c<=mt||c>=W&&c<=G||c===U)s++;else break}if(s===o)return 0;var l=e.slice(o,s);if(bn.has(l.toLowerCase())){if(a)return 0;var u=e.charCodeAt(s);return+(u===R||u===z||u===H||u===B||s>=r)}if(yr.has(l.toLowerCase())){if(a){for(var d=s;d<r&&(e.charCodeAt(d)===R||e.charCodeAt(d)===z);)d++;return d<r&&e.charCodeAt(d)===H?6:0}var f=s<r?e.charCodeAt(s):-1;return f===R||f===z||f===H||f===B||f===Qe||f===-1?6:0}if(a){for(var p=s;p<r&&(e.charCodeAt(p)===R||e.charCodeAt(p)===z);)p++;if(p<r&&e.charCodeAt(p)===H){var m=Xn(e,t);if(e.slice(p+1,m).trim()===``)return 7}}else{var h=Xn(e,t),g=Ln(e,t);if(g&&g.end<=h&&e.slice(g.end,h).trim()===``)return 7}return 0}function Dr(e,t,n){for(var r=0,i=e.length;r<i&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;for(;i>r&&(e.charCodeAt(i-1)===R||e.charCodeAt(i-1)===z);)i--;r<i&&e.charCodeAt(r)===nt&&r++,i>r&&e.charCodeAt(i-1)===nt&&(i-2<r||e.charCodeAt(i-2)!==Ae)&&i--;for(var a=[],o=r,s=!1,c=[],l=r;l<i;){var u=e.charCodeAt(l);if(u===Ae&&l+1<i){e.charCodeAt(l+1)===nt?(s||(s=!0,c=[]),c.push(e.slice(o,l)),c.push(`|`),l+=2,o=l):l+=2;continue}if(u===V){for(var d=0;l<i&&e.charCodeAt(l)===V;)d++,l++;for(var f=!1;l<i&&!f;){for(var p=0;l<i&&e.charCodeAt(l)===V;)p++,l++;p===d?f=!0:p===0&&l++}continue}if(u===nt){var m=s?(c.push(e.slice(o,l)),c.join(``)):e.slice(o,l);a.push(m.trim()),l++,o=l,s=!1,c=[];continue}l++}var h=s?(c.push(e.slice(o,i)),c.join(``)):e.slice(o,i);return a.push(h.trim()),a.map(e=>{var r=e.indexOf(`\\|`)===-1?e:e.replace(/\\\|/g,`|`);return r?Mr(r,!1,t,n):[]})}function Or(e,t,n,r){let i=Xn(e,t);var a=e.indexOf(`|`,t);if(a<0||a>=i)return null;let o=X(e,i);if(o>=e.length)return null;let s=Xn(e,o);if(!kn(e,o,s))return null;let c=e.slice(t,i),l=e.slice(o,s);for(var u=[],d=0,f=l.length;d<f&&(l.charCodeAt(d)===R||l.charCodeAt(d)===z);)d++;for(d<f&&l.charCodeAt(d)===nt&&d++;d<f;){for(;d<f&&(l.charCodeAt(d)===R||l.charCodeAt(d)===z);)d++;if(d>=f||l.charCodeAt(d)===nt)break;var p=l.charCodeAt(d)===Re;for(p&&d++;d<f&&l.charCodeAt(d)===U;)d++;var m=d<f&&l.charCodeAt(d)===Re;for(m&&d++,u.push(p&&m?`center`:m?`right`:p?`left`:null);d<f&&(l.charCodeAt(d)===R||l.charCodeAt(d)===z);)d++;d<f&&l.charCodeAt(d)===nt&&d++}let h=Dr(c,n,r);if(u.length!==h.length)return null;let g=[],_=X(e,s);for(;_<e.length;){let t=Xn(e,_),i=e.slice(_,t);if(nr(e,_,t))break;if(tr(e,_,t),er<4){var v=e.charCodeAt(_+Z);if(v===H||v===De||(v===U||v===je||v===Me)&&or(e,_))break;if(v===V||v===we){for(var y=_+Z,b=0;y<t&&e.charCodeAt(y)===v;)b++,y++;if(b>=3)break}}g.push(Dr(i,n,r)),_=X(e,t)}if(r.optimizeForStreaming&&g.length===0)return null;for(var x=h.length,S=0;S<g.length;S++)if(g[S].length<x)for(;g[S].length<x;)g[S].push([]);else g[S].length>x&&(g[S].length=x);return{node:{type:Y.table,header:h,cells:g,align:u},end:_}}function kr(e,t,n){if(tr(e,t,Xn(e,t)),er>3)return null;var r=t+Z;if(e.charCodeAt(r)!==Te)return null;if(r+1<e.length&&e.charCodeAt(r+1)===Ee)return Ar(e,r,n)||null;n.refs||={};var i=Bn(e,r,n.refs);return i===null?null:{node:{type:Y.refCollection},end:i}}function Ar(e,t,n){var r=e.length;if(e.charCodeAt(t)!==Te||t+1>=r||e.charCodeAt(t+1)!==Ee)return null;for(var i=t+2,a=i;i<r&&e.charCodeAt(i)!==Fe;){if(e.charCodeAt(i)===B)return null;i++}if(i>=r)return null;var o=`^${e.slice(a,i)}`.toLowerCase();if(i++,i>=r||e.charCodeAt(i)!==Re)return null;for(i++;i<r&&(e.charCodeAt(i)===R||e.charCodeAt(i)===z);)i++;if(i<r&&e.charCodeAt(i)===B)for(i++;i<r&&(e.charCodeAt(i)===R||e.charCodeAt(i)===z);)i++;var s=e.indexOf(`
`,i);s<0&&(s=r);for(var c=e.slice(i,s).trim(),l=s<r?s+1:r;l<r;){var u=Xn(e,l);if(tr(e,l,u),er>=2&&!nr(e,l,u))c+=`
${e.slice(l,u)}`,l=X(e,u);else if(nr(e,l,u)){var d=X(e,u);if(d<r&&(tr(e,d,Xn(e,d)),er>=2)){c+=`
`,l=X(e,u);continue}break}else break}var f=n.refs;return f&&!f[o]&&(f[o]={target:c,title:void 0}),{node:{type:Y.footnote},end:l}}function jr(e,t,n,r){let i=t,a=0,o=0,s=-1;for(;i<e.length;){let t=s>=0?s:Xn(e,i);if(s=-1,nr(e,i,t))break;if(tr(e,i,t),er<4&&o>0&&!n.l){let n=e.charCodeAt(i+Z);if(n===ke||n===U){let r=i+Z;for(;r<t&&e.charCodeAt(r)===n;)r++;for(;r<t&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;if(r>=t){a=n===ke?1:2,i=X(e,t);break}}}o=t;let x=X(e,t);if(x<e.length){if(e.charCodeAt(x)===pt){var c=Xn(e,x);i=X(e,c),o=c;continue}let t=Xn(e,x);if(s=t,tr(e,x,t),er<4){let a=e.charCodeAt(x+Z);if(a===H){i=x;break}if(a===De){for(var l=x+Z,u=0;l<t&&e.charCodeAt(l)===De&&u<=6;)u++,l++;if(u>=1&&u<=6&&(l>=t||e.charCodeAt(l)===R||e.charCodeAt(l)===z)){i=x;break}}if(a===V||a===we){for(var d=x+Z,f=0;d<t&&e.charCodeAt(d)===a;)f++,d++;if(f>=3){i=x;break}}if(a===Ne){var p=x+Z+1,m=p<t?e.charCodeAt(p):0,h=m===Ie||m===Xe;if(!h&&m===Qe){for(var g=p+1,_=g;_<t&&(e.charCodeAt(_)>=K&&e.charCodeAt(_)<=q||e.charCodeAt(_)>=J&&e.charCodeAt(_)<=mt||e.charCodeAt(_)>=W&&e.charCodeAt(_)<=G||e.charCodeAt(_)===U);)_++;_>g&&(h=yr.has(e.slice(g,_).toLowerCase()))}else if(!h){for(var v=p;v<t&&(e.charCodeAt(v)>=K&&e.charCodeAt(v)<=q||e.charCodeAt(v)>=J&&e.charCodeAt(v)<=mt||e.charCodeAt(v)>=W&&e.charCodeAt(v)<=G||e.charCodeAt(v)===U);)v++;if(v>p){var y=e.slice(p,v).toLowerCase();h=yr.has(y)||bn.has(y)}}if(h&&Tr(e,x,n,r)){i=x;break}}if(a===U||a===je||a===tt){let n=x+Z+1;if(n<t&&(e.charCodeAt(n)===R||e.charCodeAt(n)===z)&&Zn(e,n,t)<t&&!or(e,x)){i=x;break}}if(a>=W&&a<=G){let n=x+Z;for(;n<t&&e.charCodeAt(n)>=W&&e.charCodeAt(n)<=G;)n++;if(n<t&&(e.charCodeAt(n)===Ze||e.charCodeAt(n)===ot)&&n-(x+Z)===1&&e.charCodeAt(x+Z)===49){var b=n+1;if(b<t&&(e.charCodeAt(b)===R||e.charCodeAt(b)===z)&&Zn(e,b,t)<t){i=x;break}}}if(a===nt){let n=X(e,t);if(n<e.length&&kn(e,n,Xn(e,n))){i=x;break}}if((a===U||a===je||a===Me)&&or(e,x)){if(a!==U){i=x;break}let n=0,r=x+Z;for(;r<t&&e.charCodeAt(r)===U;)n++,r++;for(;r<t&&(e.charCodeAt(r)===R||e.charCodeAt(r)===z);)r++;if(r<t){i=x;break}}}}i=X(e,t)}for(var x=a?o:i;x>t&&(e.charCodeAt(x-1)===B||e.charCodeAt(x-1)===Ce||e.charCodeAt(x-1)===R||e.charCodeAt(x-1)===z);)x--;for(var S=t;S<x&&(e.charCodeAt(S)===R||e.charCodeAt(S)===z);)S++;if(S>=x)return null;for(var C=!1,w=S;w<x;w++)if(e.charCodeAt(w)===pt){C=!0;break}var T=C?e.slice(S,x).replace(/\u001E/g,``):e.slice(S,x);if(!T)return null;let E=Mr(T,!0,n,r);return a?{node:{type:Y.heading,level:a,children:E,id:``},end:i}:{node:{type:Y.paragraph,children:E},end:i}}function Mr(e,t,n,r){var i=n.t;if(!i){var a=n.k;n.k=t;var o=hi(e,0,e.length,n,r);return n.k=a,o}var s=[];return i.push({dest:s,text:e,breaks:t,inline:n.inline,inAnchor:n.inAnchor,inHTML:n.inHTML,htmlDepth:n.d,inList:n.inList,inBlockQuote:n.inBlockQuote,noSetext:n.l,depth:n.o}),s}function Nr(e,t,n){if(e.charCodeAt(t)!==V)return null;let r=$n(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return null;let o=$n(e,a,n,96);if(o===r){let n=e.slice(t+r,a);return n.indexOf(`
`)!==-1&&(n=n.replace(/\n/g,` `)),n.length>0&&n[0]===` `&&n.at(-1)===` `&&n.trim().length>0&&(n=n.slice(1,-1)),{node:{type:Y.codeInline,text:n},end:a+o}}i=a+o}return null}function Pr(e,t,n){if(e.charCodeAt(t)!==V)return t;let r=$n(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return t;let o=$n(e,a,n,96);if(o===r)return a+o;i=a+o}return t}function Fr(e,t,n){if(e.charCodeAt(t)!==Ne)return t;if(t+1<n&&e.charCodeAt(t+1)===Qe){let r=t+2;for(;r<n&&e.charCodeAt(r)!==H;)r++;return r<n?r+1:t}if(t+3<n&&e.charCodeAt(t+1)===Ie&&e.charCodeAt(t+2)===U&&e.charCodeAt(t+3)===U){let n=e.indexOf(`-->`,t+4);return n>=0?n+3:t}let r=t+1,i=r;for(;r<n;){let t=e.charCodeAt(r);if(t>=K&&t<=q||t>=J&&t<=mt||t>=W&&t<=G||t===U)r++;else break}if(r===i)return t;let a=e.slice(i,r).toLowerCase(),o=!1;for(;r<n;){let i=e.charCodeAt(r);if(i===H){r++;break}if(i===Qe&&r+1<n&&e.charCodeAt(r+1)===H){r+=2,o=!0;break}if(i===et||i===$e){var s=i;for(r++;r<n&&e.charCodeAt(r)!==s;)r++;r<n&&r++;continue}if(i===B)return t;r++}if(o||Mt(a))return r;let c=1;for(;r<n&&c>0;)if(e.charCodeAt(r)===Ne){if(r+1<n&&e.charCodeAt(r+1)===Qe){let t=r+2,i=t;for(;i<n&&(e.charCodeAt(i)>=K&&e.charCodeAt(i)<=q||e.charCodeAt(i)>=J&&e.charCodeAt(i)<=mt);)i++;if(e.slice(t,i).toLowerCase()===a){for(;i<n&&e.charCodeAt(i)!==H;)i++;if(i<n&&i++,c--,c===0)return i}r=i}else{let t=r+1,i=t;for(;i<n&&(e.charCodeAt(i)>=K&&e.charCodeAt(i)<=q||e.charCodeAt(i)>=J&&e.charCodeAt(i)<=mt);)i++;e.slice(t,i).toLowerCase()===a&&c++,r++}}else r++;return r}function Ir(e,t,n,r,i){if(e.charCodeAt(t)!==we||t+1>=n||e.charCodeAt(t+1)!==we)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===V){let t=Pr(e,a,n);if(t>a){a=t;continue}}if(o===we&&e.charCodeAt(a+1)===we){let n=e.slice(t+2,a),o=hi(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`del`,children:o},end:a+2}}o===Ae&&a+1<n&&a++,a++}return null}function Lr(e,t,n,r,i){if(e.charCodeAt(t)!==ke||t+1>=n||e.charCodeAt(t+1)!==ke)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===V){let t=Pr(e,a,n);if(t>a){a=t;continue}}if(o===ke&&e.charCodeAt(a+1)===ke&&a>t+2){let n=e.slice(t+2,a),o=hi(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`mark`,children:o},end:a+2}}o===Ae&&a+1<n&&a++,a++}return null}function Rr(e,t,n){return e<ht?!!(Gn(e)&Ft):Vt.test(t[n])}function zr(e,t,n){return e<ht?!!(Gn(e)&Nt):Ht.test(t[n])}function Br(e,t,n){var r=e.charCodeAt(t);if(r!==je&&r!==Me)return null;var i=$n(e,t,n,r);if(i===0)return null;var a=t>0?e.charCodeAt(t-1):32,o=t+i<n?e.charCodeAt(t+i):32,s=zr(a,e,t-1),c=zr(o,e,t+i),l=t>0&&Rr(a,e,t-1),u=t+i<n&&Rr(o,e,t+i),d=!c&&(!u||s||l),f=!s&&(!l||c||u),p,m;return r===je?(p=d,m=f):(p=d&&(!f||l),m=f&&(!d||u)),{len:i,canOpen:p,canClose:m}}function Vr(e,t,n,r){if(t.length!==0){for(var i=e.length,a=Array(i),o=null,s=null,c=0;c<i;c++){var l={node:e[c],prev:s,next:null};s?s.next=l:o=l,a[c]=l,s=l}for(var u=Array(t.length),d=0;d<t.length;d++)u[d]=a[t[d].idx];for(var f=[],p=0;p<12;p++)f[p]=-1;for(var m=0;m<t.length;){var h=t[m];if(!(h.active&&h.canClose)){m++;continue}for(var g=(h.ch===je?0:1)*6+h.len%3*2+ +!!h.canOpen,_=f[g]===void 0?-1:f[g],v=-1,y=m-1;y>_;y--){var b=t[y];if(!(!b.active||b.ch!==h.ch||!b.canOpen)&&!((h.canOpen||b.canClose)&&(b.len+h.len)%3==0&&b.len%3!=0)){v=y;break}}if(v<0){f[g]=m-1,!h.canOpen&&(h.active=!1),m++;continue}var x=t[v],S=x.len>=2&&h.len>=2,C=S?2:1;x.len-=C,h.len-=C;var w=u[v],T=u[m],E=w.node,D=T.node;E.text=E.text.slice(0,E.text.length-C),D.text=D.text.slice(C);for(var O=[],ee=w.next;ee&&ee!==T;)O.push(ee.node),ee=ee.next;var k={node:{type:Y.textFormatted,tag:S?`strong`:`em`,children:O},prev:w,next:T};w.next=k,T.prev=k;for(var te=v+1;te<m;te++)t[te].active=!1;if(x.len===0&&(x.active=!1,E.text===``)){var ne=w.prev;k.prev=ne,ne?ne.next=k:o=k}if(h.len===0){if(h.active=!1,D.text===``){var re=T.next;k.next=re,re&&(re.prev=k)}}else continue;m++}for(var ie=0,ae=o;ae;){var oe=ae.node;if(oe.type===Y.text){var se=oe;if(se.text===``){ae=ae.next;continue}if(ie>0&&e[ie-1].type===Y.text){e[ie-1].text+=se.text,ae=ae.next;continue}}e[ie++]=oe,ae=ae.next}e.length=ie}}function Hr(e,t,n,r){return t(e,n,r)===null?null:e}var Ur=0,Wr=0,Gr=0,Kr=0,qr=0,Jr=0,Yr=0,Xr=0;function Zr(){return Yr===2147483647&&(Wr=0,Kr=0,Jr=0,$r=0,Yr=0),++Yr}var Qr=null,$r=0,ei=[],ti=256;function ni(e,t,n,r,i){let a=e.charCodeAt(t)===Ie,o=a?t+1:t;if(e.charCodeAt(o)!==Te||Kr===Xr&&o>=Gr)return null;var s=$r===Xr?Qr:null,c=s===null?0:s[o];if(c<0)return null;var l=c;if(c===0){var u=e.indexOf(`]`,o+1);if(u<0||u>=n)return Gr=o,Kr=Xr,null;l=o+1;var d=0;ei[d++]=o;for(var f=n-o>=ti;l<n&&d>0;){var p=e.charCodeAt(l);if(p===Ae&&l+1<n){l+=2;continue}if(p===V){var m=Pr(e,l,n);if(m>l){l=m;continue}}if(p===Ne){var h=ri(e,l,n);if(h){l=h.end;continue}var g=Fr(e,l,n);if(g>l){l=g;continue}}if(p===Te)ei[d++]=l;else if(p===Fe){var _=ei[--d];s===null&&f&&l-o>=ti&&(s=Qr=new Int32Array(n),$r=Xr),s!==null&&(s[_]=l+1)}l++}if(d>0){if(s===null&&f&&l-o>=ti&&(s=Qr=new Int32Array(n),$r=Xr),s!==null)for(;d>0;)s[ei[--d]]=-1;return null}}var v=l-1,y=e.slice(o+1,v),b=l<n?e.charCodeAt(l):0,x=!1;if(b===at){var S=!0;for(l++;l<n&&(e.charCodeAt(l)===R||e.charCodeAt(l)===B);)l++;var C=``,w=l;if(l<n&&e.charCodeAt(l)===Ne){for(l++,w=l;w<n&&e.charCodeAt(w)!==H;){if(e.charCodeAt(w)===Ae&&w+1<n){w+=2;continue}if(e.charCodeAt(w)===B){S=!1;break}w++}S&&(w>=n||e.charCodeAt(w)!==H)&&(S=!1),S&&(C=e.slice(l,w),w++)}else if(S){var T=Wr===Xr?Ur:-1;if(T>=0&&l>=T)S=!1;else{for(var E=0,D=!1;w<n;){var O=e.charCodeAt(w);if(O===Ae&&w+1<n){w+=2;continue}if(O===at)E++;else if(O===ot){if(D=!0,E===0)break;E--}else if(O===R||O===B)break;w++}w>=n&&!D&&(T<0||l<T)&&(Ur=l,Wr=Xr),C=e.slice(l,w)}}if(S){for(l=w;l<n&&(e.charCodeAt(l)===R||e.charCodeAt(l)===B);)l++;var ee;if(l<n){var k=e.charCodeAt(l);if(k===et||k===$e||k===at){var te=k===at?41:k;l++;for(var ne=l;l<n&&e.charCodeAt(l)!==te;)e.charCodeAt(l)===Ae&&l+1<n&&l++,l++;l>=n?S=!1:(ee=e.slice(ne,l),l++)}}if(S){for(;l<n&&(e.charCodeAt(l)===R||e.charCodeAt(l)===B);)l++;(l>=n||e.charCodeAt(l)!==ot)&&(S=!1)}}if(S){if(l++,C=Ct(Kn(C)),ee!==void 0&&(ee=Ct(Kn(ee))),a){var re=ci(hi(y,0,y.length,r,i));return{node:{type:Y.image,target:Hr(C,i?.sanitizer||Tt,`img`,`src`),alt:re,title:ee},end:l}}var ie=r.inAnchor;r.inAnchor=!0;var ae=ie?[{type:Y.text,text:y}]:hi(y,0,y.length,r,i);return r.inAnchor=ie,!r.inAnchor&&si(ae)?null:{node:{type:Y.link,target:Hr(C,i?.sanitizer||Tt,`a`,`href`),title:ee,children:ae},end:l}}l=v+1,x=!0}var oe=``,se=l;if(!x&&b===Te){var ce=l+1;se=ce;for(var le=!1;se<n&&e.charCodeAt(se)!==Fe;){if(e.charCodeAt(se)===Ae&&se+1<n){se+=2;continue}if(e.charCodeAt(se)===Te){le=!0;break}se++}if(le||se>=n)return null;var A=e.slice(ce,se);if(A.trim())oe=Wn(A);else{if(Un(y))return null;oe=Wn(y)}se+=1}else{if(Un(y))return null;oe=Wn(y)}var j=r.refs?.[oe];if(!j)return null;if(a)return{node:{type:Y.image,target:Hr(j.target,i?.sanitizer||Tt,`img`,`src`),alt:ci(hi(y,0,y.length,r,i)),title:j.title},end:se};var M=r.inAnchor;r.inAnchor=!0;var ae=M?[{type:Y.text,text:y}]:hi(y,0,y.length,r,i);return r.inAnchor=M,!r.inAnchor&&si(ae)?null:{node:{type:Y.link,target:Hr(j.target,i?.sanitizer||Tt,`a`,`href`),title:j.title,children:ae},end:se}}function ri(e,t,n){if(e.charCodeAt(t)!==Ne)return null;for(var r=t+1;r<n;){var i=e.charCodeAt(r);if(i===H)break;if(i===R||i===B||i===Ce||i===Ne)return null;r++}if(r>=n||e.charCodeAt(r)!==H)return null;var a=e.slice(t+1,r);return a.match(/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^\x00-\x20]*)$/)?{node:{type:Y.link,target:a,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:a.indexOf(`@`)!==-1&&/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(a)?{node:{type:Y.link,target:`mailto:${a}`,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:null}function ii(e,t,n,r){if(e.charCodeAt(t)!==Te||t+1>=n||e.charCodeAt(t+1)!==Ee||Jr===Xr&&t>=qr)return null;let i=t+2;for(;i<n&&e.charCodeAt(i)!==Fe&&e.charCodeAt(i)!==B;)i++;if(i>=n)return qr=t,Jr=Xr,null;if(e.charCodeAt(i)!==Fe)return null;let a=e.slice(t+2,i);return a?{node:{type:Y.footnoteReference,target:`#${kt(a)}`,text:a},end:i+1}:null}function ai(e,t,n,r){if(r.disableBareUrls)return null;var i=``,a=!1,o=e.charCodeAt(t);if(o===Ve||o===72?t+8<=n&&e.charCodeAt(t+1)===Ue&&e.charCodeAt(t+2)===Ue&&e.charCodeAt(t+3)===We&&(e.charCodeAt(t+4)===Ge&&e.charCodeAt(t+5)===Re&&e.charCodeAt(t+6)===Qe&&e.charCodeAt(t+7)===Qe?i=`https://`:e.charCodeAt(t+4)===Re&&e.charCodeAt(t+5)===Qe&&e.charCodeAt(t+6)===Qe&&(i=`http://`)):o===Be||o===70?t+6<=n&&e.charCodeAt(t+1)===Ue&&e.charCodeAt(t+2)===We&&e.charCodeAt(t+3)===Re&&e.charCodeAt(t+4)===Qe&&e.charCodeAt(t+5)===Qe&&(i=`ftp://`):(o===He||o===87)&&t+4<=n&&e.charCodeAt(t+1)===He&&e.charCodeAt(t+2)===He&&e.charCodeAt(t+3)===Ze&&(i=`www.`,a=!0),!i)return null;let s=t+i.length;for(;s<n;){let t=e.charCodeAt(s);if(t===R||t===B||t===z||t===Ce||t===Ne||t===H)break;s++}for(var c=0,l=0,u=t;u<s;u++){var d=e.charCodeAt(u);d===at?c++:d===ot&&l++}let f=s;for(;f>t+i.length;){let n=e.charCodeAt(f-1);if(n===Ze||n===Je||n===Re||n===Ie||n===Xe||n===ot||n===je||n===Me||n===we){if(n===ot){if(c>=l)break;l--}f--}else if(n===Ye){for(var p=f-2;p>t&&(e.charCodeAt(p)>=K&&e.charCodeAt(p)<=q||e.charCodeAt(p)>=J&&e.charCodeAt(p)<=mt||e.charCodeAt(p)>=W&&e.charCodeAt(p)<=G);)p--;p>=t&&e.charCodeAt(p)===Le?f=p:f--}else break}if(f<=t+i.length)return null;var m=t+(a?4:i.length),h=e.indexOf(`/`,m);if((h<0||h>f)&&(h=f),a&&e.indexOf(`.`,m)===-1)return null;for(var g=-1,_=-1,v=h-1;v>=m;v--)if(e.charCodeAt(v)===Ze){if(g<0)g=v;else{_=v;break}}for(var v=_>=0?_+1:m;v<h;v++)if(e.charCodeAt(v)===Me)return null;var y=e.slice(t,f),b=a?`http://${y}`:y;return{node:{type:Y.link,target:b,title:void 0,children:[{type:Y.text,text:y}]},end:f}}function oi(e,t,n,r){if(r.disableBareUrls)return null;for(var i=t,a=i;i<n;){var o=e.charCodeAt(i);if(o>=K&&o<=q||o>=J&&o<=mt||o>=W&&o<=G||o===Ze||o===Ie||o===De||o===36||o===Oe||o===Le||o===$e||o===je||o===tt||o===Qe||o===ke||o===Xe||o===Ee||o===Me||o===V||o===rt||o===nt||o===it||o===we||o===U)i++;else break}if(i===a||i>=n||e.charCodeAt(i)!==Pe)return null;i++;for(var s=i,c=-1,l=i;i<n;){var o=e.charCodeAt(i);if(o>=K&&o<=q||o>=J&&o<=mt||o>=W&&o<=G)i++;else if((o===U||o===Me)&&i>s)i++;else if(o===Ze){if(i===s)break;var u=e.charCodeAt(i-1);if(u===U||u===Me||i-l>63)break;if(i+1<n){var d=e.charCodeAt(i+1);if(d>=K&&d<=q||d>=J&&d<=mt||d>=W&&d<=G)c=i,l=i+1,i++;else break}else break}else break}if(i-l>63||c<0)return null;var f=e.charCodeAt(i-1);if(!(f>=K&&f<=q||f>=J&&f<=mt||f>=W&&f<=G)||i<=c+1)return null;for(var p=-1,m=c-1;m>=s;m--)if(e.charCodeAt(m)===Ze){p=m;break}for(var m=p>=0?p+1:s;m<i;m++)if(e.charCodeAt(m)===Me)return null;var h=e.slice(t,i);return{node:{type:Y.link,target:`mailto:${h}`,title:void 0,children:[{type:Y.text,text:h}]},end:i}}function si(e){for(var t=0;t<e.length;t++)if(e[t].type===Y.link||`children`in e[t]&&Array.isArray(e[t].children)&&si(e[t].children))return!0;return!1}function ci(e,t){for(var n=``,r=0;r<e.length;r++){var i=e[r];i.type===Y.text?n+=i.text:i.type===Y.breakLine?n+=` `:i.type===Y.codeInline||i.type===Y.footnoteReference?n+=i.text:`children`in i&&Array.isArray(i.children)?n+=ci(i.children,t):!t&&i.type===Y.image&&(n+=i.alt||``)}return n}function li(e,t,n){for(var r=0;r<e.length;r++){var i=e[r];if(i.type===Y.heading){var a=i;a.id=rr(n(ci(a.children,!0)),t)}if(`children`in i){var o=i.children;Array.isArray(o)&&li(o,t,n)}if((i.type===Y.orderedList||i.type===Y.unorderedList)&&Array.isArray(i.items))for(var s=i.items,c=0;c<s.length;c++)li(s[c],t,n)}}function ui(e){return{type:Y.text,text:e}}function di(e,t,n){var r=t+1;if(r>=n)return-1;if(e.charCodeAt(r)===De){r++;var i=r<n&&(e.charCodeAt(r)===dt||e.charCodeAt(r)===ft);i&&r++;for(var a=r,o=i?6:7;r<n&&r-a<=o;){var s=e.charCodeAt(r);if(!(s>=W&&s<=G||i&&(s>=K&&s<=ze||s>=J&&s<=Be)))break;r++}return r===a||r-a>o?-1:r<n&&e.charCodeAt(r)===Ye?r+1:-1}for(var c=r;r<n&&r-c<48;){var l=e.charCodeAt(r);if(l>=K&&l<=q||l>=J&&l<=mt||l>=W&&l<=G){r++;continue}break}return r===c?-1:r<n&&e.charCodeAt(r)===Ye?r+1:-1}function fi(e,t,n,r,i){if(e.charCodeAt(t)!==Ne)return null;var a=t+1;if(a>=n)return null;var o=e.charCodeAt(a);if(o===Ie&&a+1<n&&e.charCodeAt(a+1)===U&&a+2<n&&e.charCodeAt(a+2)===U){var s=a+3;if(s<n&&e.charCodeAt(s)===H)return{node:{type:Y.htmlComment,text:``,s:!0},end:s+1};if(s+1<n&&e.charCodeAt(s)===U&&e.charCodeAt(s+1)===H)return{node:{type:Y.htmlComment,text:`-`,s:!0},end:s+2};var c=e.indexOf(`-->`,s);return c!==-1&&c<=n-3?{node:{type:Y.htmlComment,text:e.slice(t+4,c),s:!1},end:c+3}:null}if(o===Xe){var l=e.indexOf(`?>`,a+1);return l!==-1&&l<n?{node:{type:Y.htmlSelfClosing,tag:`?`,attrs:{},m:e.slice(t,l+2),a:!1},end:l+2}:null}if(o===Ie&&a+1<n){var u=e.charCodeAt(a+1);if(u===Te&&e.slice(a+1,a+8)===`[CDATA[`){var d=e.indexOf(`]]>`,a+8);return d!==-1&&d<n?{node:{type:Y.htmlSelfClosing,tag:`![CDATA[`,attrs:{},m:e.slice(t,d+3),a:!1},end:d+3}:null}if(u>=K&&u<=q){var f=e.indexOf(`>`,a+2);return f!==-1&&f<n?{node:{type:Y.htmlSelfClosing,tag:`!${e.slice(a+1,f)}`,attrs:{},m:e.slice(t,f+1),a:!1},end:f+1}:null}}if(o===Qe){var p=a+1;if(p>=n)return null;var m=e.charCodeAt(p);if(!(m>=K&&m<=q||m>=J&&m<=mt))return null;for(p++;p<n;){var h=e.charCodeAt(p);if(h>=K&&h<=q||h>=J&&h<=mt||h>=W&&h<=G||h===U)p++;else break}for(;p<n&&(e.charCodeAt(p)===R||e.charCodeAt(p)===z||e.charCodeAt(p)===B);)p++;if(p<n&&e.charCodeAt(p)===H){var g=e.slice(a+1,p).trim();return{node:{type:Y.htmlSelfClosing,tag:g,attrs:{},h:e.slice(t,p+1),a:!0},end:p+1}}return null}if(!(o>=K&&o<=q||o>=J&&o<=mt))return null;var _=Ln(e,t);if(!_)return null;var v=_.tag,y=v.toLowerCase();if(_.n||Mt(v))return{node:{type:Y.htmlSelfClosing,tag:v,attrs:br(_.attrs,v,i),m:_.q?Fn(_):e.slice(t,_.end),a:!1},end:_.end};var b=bn.has(y),x=wr(e.slice(0,n),_.end,v);if(x===-1)return{node:{type:Y.htmlSelfClosing,tag:v,attrs:br(_.attrs,v,i),m:_.q?Fn(_):e.slice(t,_.end),a:!1},end:_.end};var S=Sr(e,`</${y}`,x),C=e.slice(_.end,S);if(b){var w=Rn(C);return{node:{type:Y.htmlBlock,tag:v,attrs:br(_.attrs,v,i),b:_.g+_.b,children:[],e:w||void 0,h:e.slice(S,x),text:w,c:!0,a:!1},end:x}}var T=[],E=C.trim();if(E){var{inAnchor:D,inline:O,k:ee}=r;y===`a`&&(r.inAnchor=!0),r.k=!1,E.indexOf(`

`)!==-1||/^#{1,6}\s/.test(E)?(r.inline=!1,T=_i(E,r,i)):T=hi(E,0,E.length,r,i),r.inAnchor=D,r.inline=O,r.k=ee}return{node:{type:Y.htmlBlock,tag:v,attrs:br(_.attrs,v,i),b:_.b,children:T,text:Rn(C),c:!1,a:!1},end:x}}var pi=200,mi=0;function hi(e,t,n,r,i){if(mi++,mi>pi)return mi--,[{type:Y.text,text:e.slice(t,n)}];var a=Xr;Xr=Zr();let o=r;if(i.optimizeForStreaming){let r=function(e,t){for(var n=1,r=t+1;r<e.length;r++){var i=e.charCodeAt(r);if(i===Te)n++;else if(i===Fe&&(n--,n===0))return r}return-1},i=e.slice(t,n),a=i;for(var s=0,c=0,l=0,u=0,d=0,f=-1,p=-1,m=-1,h=-1,g=-1,_=0;_<i.length;_++){var v=i.charCodeAt(_);v===je?_+1<i.length&&i.charCodeAt(_+1)===je?(s++,f=_,_++):(c++,p=_):v===Me?_+1<i.length&&i.charCodeAt(_+1)===Me?(l++,m=_,_++):(u++,h=_):v===we&&_+1<i.length&&i.charCodeAt(_+1)===we&&(d++,g=_,_++)}var y=[];d%2==1&&g>=0&&y.push([g,2]),l%2==1&&m>=0&&y.push([m,2]),u%2==1&&h>=0&&y.push([h,1]),s%2==1&&f>=0&&y.push([f,2]),c%2==1&&p>=0&&y.push([p,1]),y.sort((e,t)=>t[0]-e[0]);for(var b=0;b<y.length;b++){var x=y[b][0],S=y[b][1];i=i.slice(0,x)+i.slice(x+S)}let o=0,A=-1;for(let e=0;e<i.length;e++)i.charCodeAt(e)===V&&(o++,A=e);if(o%2==1&&A!==-1){let e=!1,t=-1,n=0;for(;n<i.length;)i.charCodeAt(n)===V&&(e?(e=!1,t=-1):(t=n,e=!0)),n++;e&&t!==-1&&(i=i.slice(0,t))}for(var C=!0;C;){C=!1;for(var w=-1,T=-1,E=-1,D=!1,O=0;O<i.length;O++)if(i.charCodeAt(O)===Te&&(O===0||i.charCodeAt(O-1)!==Ae)){var ee=O>0&&i.charCodeAt(O-1)===Ie,k=ee?O-1:O,te=r(i,O);if(te===-1)w=k,D=ee,T=O+1,E=i.length;else{var ne=te+1;if(ne>=i.length)w=k,D=ee,T=O+1,E=te;else if(i.charCodeAt(ne)===at){var re=i.indexOf(`)`,ne+1);re===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=re}else if(i.charCodeAt(ne)===Te){var ie=i.indexOf(`]`,ne+1);ie===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=ie}else O=te}}if(w>=0){var ae=D?``:i.slice(T,E);i=i.slice(0,w)+ae,C=!0}}let j=i.match(/<([A-Z][A-Za-z0-9]*)(?:\s[^>]*)?>([^<]*)$/);if(j&&j.index!==void 0){var oe=j[0].length-j[2].length;if(!(oe>=2&&j[0].charCodeAt(oe-2)===Qe)){for(var se=!1,ce=0,le=0;le<j.index;le++)i.charCodeAt(le)===V&&ce++;if(se=ce%2==1,!se){let e=j[1];xr(i,`</${e}`,0)===-1&&(i=i.slice(0,j.index)+j[2])}}}i!==a&&(e=e.slice(0,t)+i,n=t+i.length)}let A=[];var j=[];let M=t;var ue=``,de=i.disableAutoLink||i.disableBareUrls||o.inAnchor?-1:e.indexOf(`@`,t);for(de>=n&&(de=-1);t<n;){let r=e.charCodeAt(t),a=null;if(r===V){if(a=Nr(e,t,n),!a){var fe=$n(e,t,n,V);t+=fe-1}}else if(r===je||r===Me){var N=Br(e,t,n);if(N){if(N.canOpen||N.canClose){(ue||t>M)&&(A.push(ui(ue+e.slice(M,t))),ue=``);var P=ui(e.slice(t,t+N.len));j.push({idx:A.length,ch:r,len:N.len,canOpen:N.canOpen,canClose:N.canClose,active:!0}),A.push(P),t+=N.len,M=t;continue}t+=N.len-1}}else if(r===we)a=Ir(e,t,n,o,i);else if(r===ke)a=Lr(e,t,n,o,i);else if(r===Te)t+1<n&&e.charCodeAt(t+1)===Ee&&(a=ii(e,t,n,o)),a||=ni(e,t,n,o,i);else if(r===Ie&&t+1<n&&e.charCodeAt(t+1)===Te)a=ni(e,t,n,o,i);else if(r===Ne)a=ri(e,t,n),!(a||i.disableParsingRawHTML||i.ignoreHTMLBlocks)&&(a=fi(e,t,n,o,i));else if(r===Le){var pe=di(e,t,n);if(pe!==-1){var me=e.slice(t,pe),he=Ct(me);if(he!==me){ue=ue+e.slice(M,t)+he,t=pe,M=pe;continue}}}else if((r===Ve||r===He||r===Be)&&!o.inAnchor&&!i.disableAutoLink&&(t===0||e.charCodeAt(t-1)!==Ne)){var ge=t+1<n?e.charCodeAt(t+1):0;(r===Ve&&ge===Ue||r===Be&&ge===Ue||r===He&&ge===He)&&(a=ai(e,t,n,i))}if(!a&&de>=0&&de-t<=64&&!o.inAnchor&&!i.disableAutoLink&&!i.disableBareUrls&&(r>=K&&r<=q||r>=J&&r<=mt||r>=W&&r<=G)&&(a=oi(e,t,n,i),!a&&t>=de&&(de=e.indexOf(`@`,t+1),de>=n&&(de=-1))),r===B&&o.k){var F=!1,_e=0;if(t>M&&e.charCodeAt(t-1)===Ae)F=!0,_e=1;else{for(var ve=0,ye=t-1;ye>=M&&e.charCodeAt(ye)===R;)ve++,ye--;ve>=2&&(F=!0,_e=ve)}if(F){for((ue||t-_e>M)&&(A.push(ui(ue+e.slice(M,t-_e))),ue=``),A.push({type:Y.breakLine}),t++;t<n&&e.charCodeAt(t)===R;)t++;M=t;continue}var be=t>M&&e.charCodeAt(t-1)===R,xe=t+1<n&&e.charCodeAt(t+1)===R;if(be||xe){for(var I=t;I>M&&e.charCodeAt(I-1)===R;)I--;for(ue+=`${e.slice(M,I)}
`,t++;t<n&&e.charCodeAt(t)===R;)t++;M=t;continue}}if(a)(ue||t>M)&&(A.push(ui(ue+e.slice(M,t))),ue=``),A.push(a.node),t=a.end,M=t;else{if(r===Ae&&t+1<n&&Gn(e.charCodeAt(t+1))&Ft){(ue||t>M)&&(A.push(ui(ue+e.slice(M,t))),ue=``),A.push(ui(e[t+1])),t+=2,M=t;continue}if(t++,de<0||de-t>64)for(;t<n&&!(de>=0&&de-t<=64);){var Se=e.charCodeAt(t);if(Se<ht&&!Tn[Se])t++;else break}}}return(ue||n>M)&&(A.push(ui(ue+e.slice(M,n))),ue=``),j.length>0&&Vr(A,j,r,i),Xr=a,mi--,A}var gi=500;function _i(e,t,n){var r=t.o||0;if(r>gi)return[{type:Y.text,text:e}];if(t.o=r+1,n.optimizeForStreaming&&!(t.i||t.w)){for(var i=e.length;i>0&&e.charCodeAt(i-1)===B;)i--;for(var a=i;a>0&&e.charCodeAt(a-1)!==B;)a--;if(i>a&&e.charCodeAt(a)===nt){for(var o=!1,s=a+1;s<i;s++){var c=e.charCodeAt(s);if(c!==R&&c!==z&&c!==nt&&c!==Re&&c!==U){o=!0;break}}for(var l=!1,u=!1,d=0,f=a,p=a-1;p>0;){for(var m=p;m>0&&e.charCodeAt(m-1)!==B;)m--;if(e.charCodeAt(m)!==nt)break;f=m;for(var h=!0,g=!1,_=m;_<p;_++){var v=e.charCodeAt(_);if(v===U)g=!0;else if(v!==R&&v!==z&&v!==Re&&v!==nt){h=!1;break}}h&&g?(l=!0,u=!0):u||d++,p=m-1}o?l||(e=e.slice(0,a).trimEnd()):e=l&&d>0?e.slice(0,a).trimEnd():e.slice(0,f).trimEnd()}for(var y=-1,b=-1,x=-1,S=!1,C=e.length-1;C>=0;C--)if(e.charCodeAt(C)===Ne){for(var w=C+1<e.length?e.charCodeAt(C+1):0,T=w>=K&&w<=q||w>=J&&w<=mt,E=w===Qe&&C+2<e.length&&(e.charCodeAt(C+2)>=K&&e.charCodeAt(C+2)<=q||e.charCodeAt(C+2)>=J&&e.charCodeAt(C+2)<=mt),D=w===Ie||w===Xe,O=e.length;O>C+1&&e.charCodeAt(O-1)===B;)O--;var ee=C+1>=O;if(T||E||D||ee){var k=C+1;if((E||T)&&(k=C+2),T||E)for(;k<e.length;){var te=e.charCodeAt(k);if(te>=K&&te<=q||te>=J&&te<=mt||te>=W&&te<=G)k++;else break}for(var ne=T||E?k:C+2;ne<e.length&&e.charCodeAt(ne)!==H;)ne++;if(ne>=e.length)y=C,S=!0;else if((T||E)&&e.charCodeAt(ne-1)!==Qe){for(var re=!1,ie=ne+1;ie<e.length;ie++)if(e.charCodeAt(ie)===Ne){re=!0;break}re||(y=C,b=k,x=ne+1)}}break}if(y>=0){for(var ae=0,oe=0;oe<y;oe++)e.charCodeAt(oe)===V&&ae++;if(ae%2==0){if(S)e=e.slice(0,y);else{var se=e.slice(y+1,b);xr(e,`</${se}`,0)===-1&&(e=e.slice(0,y)+e.slice(x))}}}for(var ce=e.length;ce>0&&e.charCodeAt(ce-1)===B;)ce--;if(ce>0){for(var le=ce;le>0&&e.charCodeAt(le-1)!==B;)le--;for(var A=le,j=0;A<ce&&e.charCodeAt(A)===R&&j<3;)A++,j++;if(le>0&&A<ce&&ar(e,A,ce)){for(var M=le-1,ue=M;ue>0&&e.charCodeAt(ue-1)!==B;)ue--;nr(e,ue,M)||(e=e.slice(0,le).trimEnd())}}var de=e.length;if(de>0){for(var fe=e.lastIndexOf(`
`),N=fe===-1?0:fe+1,P=de,pe=N,me=0;pe<P&&e.charCodeAt(pe)===R&&me<3;)pe++,me++;if(pe<P){var he=e.charCodeAt(pe),ge=!1;if(he===je||he===U||he===tt){var F=pe+1;if(F>=P||e.charCodeAt(F)===R||e.charCodeAt(F)===z){for(var _e=F;_e<P&&(e.charCodeAt(_e)===R||e.charCodeAt(_e)===z);)_e++;_e>=P&&(ge=!0)}}else if(he>=W&&he<=G){for(var ve=pe;ve<P&&e.charCodeAt(ve)>=W&&e.charCodeAt(ve)<=G;)ve++;if(ve<P&&(e.charCodeAt(ve)===Ze||e.charCodeAt(ve)===ot)){var ye=ve+1;if(ye>=P||e.charCodeAt(ye)===R||e.charCodeAt(ye)===z){for(var be=ye;be<P&&(e.charCodeAt(be)===R||e.charCodeAt(be)===z);)be++;be>=P&&(ge=!0)}}}ge&&(e=e.slice(0,N).trimEnd())}}}if(t.inline)return hi(e,0,e.length,t,n);let xe=[],I=0,Se=e.length;if(I===0&&!n.disableFrontmatter&&e.startsWith(`---`)){let t=_t(e);if(t?.hasValidYaml){if(n.preserveFrontmatter!==!1){let n=e.slice(0,t.endPos).trimEnd();xe.push({type:Y.frontmatter,text:n})}I=t.endPos}}for(;I<Se;){for(var L=e.indexOf(`
`,I),Ce=L<0?Se:L;I<Se&&nr(e,I,Ce);)I=Ce<Se?Ce+1:Ce,I<Se&&(L=e.indexOf(`
`,I),Ce=L<0?Se:L);if(I>=Se)break;var Ee=e.charCodeAt(I)===pt;tr(e,I,Ce);let r=null;if(qn=e,Jn=I,Yn=Ce,!Ee&&er>=4&&!t.inHTML)r=fr(e,I);else if(!Ee){let i=I+Z,a=e.charCodeAt(i);a===De?r=ir(e,I,t,n):a===H?r=pr(e,I,t,n):a===V||a===we?r=ur(e,I,t):a===U||a===je||a===Me?(r=or(e,I),!r&&(r=vr(e,I,t,n))):a===tt||a>=W&&a<=G?r=vr(e,I,t,n):a===Ne?r=Tr(e,I,t,n):a===nt?r=Or(e,I,t,n):a===Te&&(r=kr(e,I,t))}if(!r){for(var Oe=!1,ke=I;ke<Ce;ke++)if(e.charCodeAt(ke)===nt){Oe=!0;break}Oe&&(r=Or(e,I,t,n))}if(r||=jr(e,I,t,n),r)r.node.type!==Y.refCollection&&xe.push(r.node),I=r.end;else{var Ae=e.indexOf(`
`,I);I=Ae<0?Se:Ae+1}}return t.o=r,xe}function vi(e,t,n,r){var i=Ln(e,t);return i?{tagName:i.tag,tagLower:i.tag.toLowerCase(),attrs:i.b,whitespaceBeforeAttrs:i.g,isSelfClosing:i.n,hasSpaceBeforeSlash:i.r,isClosing:i.f,hasNewline:i.g.includes(`
`)||i.b.includes(`
`),endPos:i.end}:null}function yi(e,t,n){mi=0,e=Wt(e),!t.refs&&(t.refs={}),(n.optimizeForStreaming||t.inline)&&(t.w=zn(e,t.refs,n));var r,i;t.t||(t.t=r=[],t.p=i=[]);let a=_i(e,t,n);if(r&&i){for(var o=r,s={inline:t.inline,inAnchor:t.inAnchor,inHTML:t.inHTML,htmlDepth:t.d,inList:t.inList,inBlockQuote:t.inBlockQuote,noSetext:t.l,depth:t.o},c=0;c<o.length;c++){var l=o[c];t.inline=l.inline,t.inAnchor=l.inAnchor,t.inHTML=l.inHTML,t.d=l.htmlDepth,t.inList=l.inList,t.inBlockQuote=l.inBlockQuote,t.l=l.noSetext,t.o=l.depth,t.k=l.breaks;var u=hi(l.text,0,l.text.length,t,n);t.k=!1;for(var d=0;d<u.length;d++)l.dest.push(u[d])}t.inline=s.inline,t.inAnchor=s.inAnchor,t.inHTML=s.inHTML,t.d=s.htmlDepth,t.inList=s.inList,t.inBlockQuote=s.inBlockQuote,t.l=s.noSetext,t.o=s.depth;for(var f=i,p=0;p<f.length;p++)for(var m=f[p],h=0;h<m.src.length;h++){var g=m.src[h];if(m.unwrap&&g.type===Y.paragraph)for(var _=g.children,v=0;v<_.length;v++)m.dest.push(_[v]);else m.dest.push(g)}t.t=void 0,t.p=void 0,li(a,t,n.slugify)}return qt(t.refs)?[{type:Y.refCollection,refs:t.refs},...a]:a}var bi;try{xi=d.createElement(`div`),bi=typeof xi==`object`&&xi&&`$$typeof`in xi&&typeof xi.$$typeof==`symbol`?xi.$$typeof:Symbol.for(`react.transitional.element`)}catch{bi=Symbol.for(`react.transitional.element`)}var xi;function Si(e,t,n){return{$$typeof:bi,type:e,key:n==null?null:String(n),ref:null,props:t,_owner:null,_store:{},_debugStack:null,_debugTask:null}}function Ci(e,t){var n={key:e};if(t){var r=xt(t);for(var i in r)n[i]=r[i]}return n}var wi=typeof d.createContext>`u`?void 0:d.createContext(void 0);function Ti(e,t,n,r,i,a,o,s,c){switch(e.type){case Y.blockQuote:{let i={key:n.key};return e.alert&&(i.className=`markdown-alert-${a(e.alert.toLowerCase(),kt)}`,e.children.unshift(Jt(e.alert))),r(`blockquote`,i,t(e.children,n))}case Y.breakLine:return r(`br`,{key:n.key});case Y.breakThematic:return r(`hr`,{key:n.key});case Y.frontmatter:return s.preserveFrontmatter?r(`pre`,{key:n.key},e.text):null;case Y.codeBlock:{let t=e.lang?Ct(e.lang):``;var l=e.attrs?xt(e.attrs):{};return l.className=t?`language-${t} lang-${t}`:``,r(`pre`,{key:n.key},r(`code`,l,e.text))}case Y.codeInline:return r(`code`,{key:n.key},e.text);case Y.footnoteReference:return r(`a`,{key:n.key,href:i(e.target,`a`,`href`)||void 0},r(`sup`,null,e.text));case Y.gfmTask:return r(`input`,{checked:e.completed,key:n.key,readOnly:!0,type:`checkbox`});case Y.heading:return r(`h${e.level}`,{id:e.id,key:n.key},t(e.children,n));case Y.htmlBlock:{let a=e;if(an(s)&&pn(a.tag)){var u=nn(a);return u.kind===`literal`?r(`span`,{key:n.key},u.literal):r(`span`,{key:n.key},...rn(u.open,a.children?t(a.children,n):null,u.close))}let l=a.j,_=l!==void 0,v=_?l:a.a?a.e||``:(a.e||``)+(a.h||``);if(v&&a.c){let r=Dn(a.tag.toLowerCase()),u=a.children,y=u!=null&&u.length>0;if(r){let t=_?l:a.e||``,r=an(s)?hn(t):t;if(/<[a-z][^>]{0,100}>/i.test(v)){var f=Ci(n.key,e.attrs);return f.dangerouslySetInnerHTML={__html:r},c(e.tag,f)}return c(e.tag,Ci(n.key,e.attrs),r)}let b=RegExp(`^<${a.tag}(\\s|>)`,`i`);if(y&&!b.test(v)&&an(s)&&mn(v))return c(e.tag,Ci(n.key,e.attrs),t(u,n));if(On(v)){let t=an(s)?hn(v):v;var p=Ci(n.key,e.attrs);return p.dangerouslySetInnerHTML={__html:t},c(e.tag,p)}let x=gn({slugify:s.slugify,sanitizer:i,tagfilter:!0}),S=Gt(v);if(RegExp(`^<${a.tag}(\\s[^>]*)?>(\\s*</${a.tag}>)?$`,`i`).test(S))return a.children&&a.children.length>0?c(e.tag,Ci(n.key,e.attrs),t(a.children,n)):c(e.tag,Ci(n.key,e.attrs));let C=yi(S,{inline:!1,refs:o,inHTML:!1},x);Qt(C);let w=a.tag.toLowerCase(),T=_;if(T&&y)return c(e.tag,Ci(n.key,e.attrs),t(u,n));if(T)return t(C.flatMap(Zt),n);var m=$t(C,w);if(m.found&&m.afterClose.length>0){var h=m.beforeClose.flatMap(Zt),g=m.afterClose.flatMap(Zt);return Si(d.Fragment,{children:[c(e.tag,Ci(n.key,e.attrs),t(h,n)),t(g,n)]},n.key)}return c(e.tag,Ci(n.key,e.attrs),t(C.flatMap(Zt),n))}return Mt(e.tag)?c(e.tag,Ci(n.key,e.attrs)):c(e.tag,Ci(n.key,e.attrs),e.children?t(e.children,n):``)}case Y.htmlSelfClosing:{let t=e;if(an(s)&&pn(t.tag)){var _=nn(t);return r(`span`,{key:n.key},_.kind===`literal`?_.literal:_.open+(_.close||``))}return c(e.tag,Ci(n.key,e.attrs))}case Y.image:{let t=e.target===null?null:i(e.target,`img`,`src`);return r(`img`,{key:n.key,alt:e.alt&&e.alt.length>0?e.alt:void 0,title:e.title||void 0,src:t||void 0})}case Y.link:{let a={key:n.key};if(e.target!=null){let t=on(e.target,i,`a`,`href`);t!=null&&(a.href=t)}return e.title&&(a.title=e.title),r(`a`,a,t(e.children,n))}case Y.table:{let i=e;return r(`table`,{key:n.key},r(`thead`,{key:`thead`},r(`tr`,null,i.header.map(function(e,a){return r(`th`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))),i.cells.length>0&&r(`tbody`,{key:`tbody`},i.cells.map(function(e,a){return r(`tr`,{key:a},e.map(function(e,a){return r(`td`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))})))}case Y.text:return e.text;case Y.textFormatted:return r(e.tag,{key:n.key},t(e.children,n));case Y.orderedList:case Y.unorderedList:return r(e.type===Y.orderedList?`ol`:`ul`,{key:n.key,start:e.type===Y.orderedList?e.start:void 0},e.items.map(function(e,i){return r(`li`,{key:i},t(e,n))}));case Y.paragraph:return r(`p`,{key:n.key},t(e.children,n));case Y.ref:return null;default:return null}}var Ei=(e,t,n,r,i,a,o)=>{var s=e=>e.map(e=>`text`in e?e.text:``),c=(l,u={})=>{var d=Array.isArray(l)?l:[l],f=(u.renderDepth||0)+1;if(f>2500)return s(d);u.renderDepth=f;for(var p=u.key,m=[],h=!1,g=0;g<d.length;g++){u.key=g;var _=e?e(Ti.bind(null,d[g],c,u,t,n,r,i,a,o),d[g],c,u):Ti(d[g],c,u,t,n,r,i,a,o),v=typeof _==`string`;if(h&&typeof _==`string`){var y=m.at(-1);m[m.length-1]=(typeof y==`string`?y:``)+_}else if(_!=null){if(Array.isArray(_))for(var b=0;b<_.length;b++)m.push(_[b]);else m.push(_)}h=v}return u.key=p,u.renderDepth=f-1,m};return c},Di=(e,t)=>{let n=cn(t,e,void 0);return n?typeof n==`function`||typeof n==`object`&&`render`in n?n:cn(t,`${e}.component`,e):e};function Oi(e,t){let n={...t||{}};n.overrides=n.overrides||{};let r=n.slugify||kt,i=n.sanitizer||Tt,a=n.createElement,o=qt(n.overrides),s=e=>ki(e,{...n,wrapper:null});function c(e){for(var t in e){var n=e[t];if(typeof n==`string`&&n.length>0&&n.charCodeAt(0)===Ne&&(_n.test(n)||vn.test(n)||vi(n,0))){var r=s(n.trim());e[t]=t===`innerHTML`&&Array.isArray(r)?r[0]:r}}}function l(e,t,...r){var i=t||{},s=e;if(o){var c=cn(n.overrides,`${e}.props`,{});s=Di(e,n.overrides),i={...i,...c,className:un(i.className,c.className)||void 0}}if(!a){var l=i.key;return l!=null&&delete i.key,r.length===1?i.children=r[0]:r.length>1&&(i.children=r),Si(s,i,l)}return a(s,i,...r)}function u(e,t,...n){return t&&c(t),l(e,t,...n)}let d=gn(n,n.forceInline),f=e[0]&&e[0].type===Y.refCollection?e[0].refs:{},p=Ei(n.renderRule,l,i,r,f,n,u),m=p(e,{inline:n.forceInline,refs:f}),h=sn(f);if(h.length>0&&m.push(l(`footer`,{key:`footer`},h.map(function(e){let t=e.identifier.charCodeAt(0)===Ee?e.identifier.slice(1):e.identifier,n=yi(e.footnote,{inline:!0,refs:f},d);return l(`div`,{id:r(t,kt),key:e.identifier},`${t}: `,p(n,{inline:!0,refs:f}))}))),n.wrapper===null)return m;let g=n.wrapper||(n.forceInline?`span`:`div`),_;if(m.length>1||n.forceWrapper)_=m;else return m.length===1?m[0]:null;var v=n.wrapperProps?{...n.wrapperProps}:{};return v.children=_,Si(g,v,`outer`)}function ki(e=``,t={}){let n={...t||{}};n.overrides=n.overrides||{},n.slugify,n.sanitizer;function r(e){let t=n.forceInline||!(n.forceBlock||St.test(e)),r=gn(n,t);return Oi(yi(t?e:Xt(e),{inline:t,refs:i},r),{...n,forceInline:t})}let i={};return r(e)}function Ai(e){let t=d.useRef(e),n=t.current;if(n!==e){var r=!0,i=0;for(var a in e)if(i++,!Object.is(n[a],e[a])){r=!1;break}if(r){var o=0;for(var s in n)o++;r=o===i}r||(t.current=e)}return t.current}var ji=({children:e,options:t,...n})=>{if(!(typeof d.useContext<`u`)){let r={...t,overrides:{...t?.overrides},wrapperProps:{...t?.wrapperProps,...n}};return ki(e??``,r)}let r=wi?d.useContext(wi):void 0,i=Ai(n),a=d.useMemo(()=>({...r,...t,overrides:{...r?.overrides,...t?.overrides},wrapperProps:{...r?.wrapperProps,...t?.wrapperProps,...i}}),[r,t,i]),o=e??``;return d.useMemo(()=>ki(o,a),[o,a])};function Mi({text:e}){return(0,p.jsx)(ji,{options:{disableParsingRawHTML:!0,forceBlock:!0},children:e})}let Ni=[`👍`,`❤️`,`😂`,`😮`,`😢`,`🎉`];async function Pi(e){if(navigator.clipboard?.writeText!==void 0)try{return await navigator.clipboard.writeText(e),!0}catch{return!1}if(typeof document.execCommand!=`function`)return!1;let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.left=`-9999px`,document.body.append(t),t.select();try{return document.execCommand(`copy`)}catch{return!1}finally{t.remove()}}function Fi({tools:e}){let[t,n]=(0,d.useState)(!1),[r,i]=(0,d.useState)(!1),a=e.copyText;if((0,d.useEffect)(()=>{if(!r)return;let e=()=>{i(!1)},t=t=>{t.key===`Escape`&&e()};return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,t)}},[r]),e.recalled)return null;let o=e.identity!==void 0,s=e.reactions.some(t=>t.messageId===e.message.messageId&&t.emoji===`👍`&&t.participantIds.includes(e.identity?.participantId??``));if(a===void 0&&!o)return null;let c=()=>{a===void 0||t||Pi(a).then(e=>{e&&(n(!0),globalThis.setTimeout(()=>{n(!1)},1e3))})};return(0,p.jsxs)(`div`,{className:`dsh-chatroom-message-actions`,children:[e.onReply!==void 0&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`回复`,onClick:e.onReply,children:[`↩ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`回复`})]}),o&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":s?`取消点赞`:`点赞`,"aria-pressed":s,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,`👍`)},children:[`👍 `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:s?`已赞`:`点赞`})]}),e.onBranch!==void 0&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`分支`,onClick:e.onBranch,children:[`⑂ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`分支`})]}),o&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`转发`,onClick:()=>{e.openForward(e.roomId,e.message)},children:[`↗ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`转发`})]}),(o||a!==void 0||e.onBranch!==void 0)&&(0,p.jsxs)(`span`,{className:`dsh-chatroom-inline-reaction-control`,children:[(0,p.jsx)(`button`,{type:`button`,"aria-label":`更多消息操作`,"aria-expanded":r,onClick:()=>{i(e=>!e)},children:`•••`}),r&&(0,p.jsxs)(`span`,{className:`dsh-chatroom-action-overflow`,role:`menu`,"aria-label":`更多消息操作`,onPointerDown:e=>{e.stopPropagation()},children:[o&&(0,p.jsx)(`span`,{className:`dsh-chatroom-inline-reactions`,"aria-label":`贴表情`,children:Ni.map(t=>(0,p.jsx)(`button`,{type:`button`,"aria-label":`贴表情 ${t}`,title:`贴表情 ${t}`,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t),i(!1)},children:t},t))}),a!==void 0&&(0,p.jsx)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{c(),i(!1)},children:t?`✓ 已复制`:`▣ 复制`}),o&&(0,p.jsx)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.toggleSelection(e.roomId,e.message),i(!1)},children:e.selected?`✓ 取消选择`:`☑ 多选`}),e.canRecall&&(0,p.jsx)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.recallMessage(e.roomId,e.message.messageId),i(!1)},children:`↶ 撤回`})]})]})]})}function Ii({tools:e}){return!e.selecting||e.recalled?null:(0,p.jsxs)(`label`,{className:`dsh-chatroom-selection-checkbox`,title:e.selected?`取消选择`:`选择消息`,children:[(0,p.jsx)(`input`,{type:`checkbox`,"aria-label":`${e.selected?`取消选择`:`选择`} ${e.message.displayName} 的消息`,checked:e.selected,onChange:()=>{e.toggleSelection(e.roomId,e.message)}}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:e.selected?`✓`:``})]})}function Li(){let[e,t]=(0,d.useState)();return(0,d.useEffect)(()=>{if(e===void 0)return;let n=()=>{t(void 0)},r=e=>{e.key===`Escape`&&n()};return document.addEventListener(`pointerdown`,n),document.addEventListener(`keydown`,r),()=>{document.removeEventListener(`pointerdown`,n),document.removeEventListener(`keydown`,r)}},[e]),{position:e,open:e=>{e.preventDefault(),e.stopPropagation(),t({x:Math.max(8,Math.min(e.clientX,globalThis.innerWidth-248)),y:Math.max(8,Math.min(e.clientY,globalThis.innerHeight-248))})},close:()=>{t(void 0)}}}function Ri(e){if(e.recalled)return null;let t=e.reactions.filter(t=>t.messageId===e.message.messageId&&t.participantIds.length>0);return t.length===0?null:(0,p.jsx)(`div`,{className:`dsh-chatroom-reaction-bar`,children:t.map(t=>(0,p.jsxs)(`button`,{type:`button`,"aria-label":`${t.emoji} ${t.participantIds.length}`,"aria-pressed":t.participantIds.includes(e.identity?.participantId??``),disabled:e.identity===void 0,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t.emoji)},children:[(0,p.jsx)(`span`,{children:t.emoji}),(0,p.jsx)(`small`,{children:t.participantIds.length})]},t.emoji))})}function zi({tools:e,position:t,close:n}){if(t===void 0||e.identity===void 0||e.recalled)return null;let r=e.copyText;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-context-menu`,style:{left:t.x,top:t.y},role:`menu`,onPointerDown:e=>{e.stopPropagation()},children:[(0,p.jsx)(`div`,{className:`dsh-chatroom-context-reactions`,"aria-label":`贴表情`,children:Ni.map(t=>(0,p.jsx)(`button`,{type:`button`,title:`贴表情 ${t}`,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t),n()},children:t},t))}),r!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{Pi(r),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`▣`}),` 复制`]}),e.onReply!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.onReply?.(),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↩`}),` 回复`]}),(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.openForward(e.roomId,e.message),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↗`}),` 转发`]}),(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.toggleSelection(e.roomId,e.message),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:e.selected?`✓`:`☑`}),` `,e.selected?`取消选择`:`多选`]}),e.onBranch!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.onBranch?.(),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⑂`}),` 分支`]}),e.canRecall&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.recallMessage(e.roomId,e.message.messageId),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↶`}),` 撤回`]})]})}let Bi=0,Vi=`dsh-chatroom:branch-frame-compatibility`;function Hi(e){let[t,n]=(0,d.useState)(),r=e.room.thread,i=r??t;return(0,d.useEffect)(()=>{r!==void 0&&n(r)},[r]),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(Gi,{toasts:e.room.toasts,dismiss:e.dismissToast}),(0,p.jsx)(N,{...e}),e.room.membersOpen&&(0,p.jsx)(Ki,{...e}),i!==void 0&&(0,p.jsx)(qi,{...e,thread:i,open:r?.id===i.id}),e.room.selectionRoomId!==void 0&&(0,p.jsx)(Ui,{...e}),e.room.forwardOpen&&(0,p.jsx)(Wi,{...e})]})}function Ui(e){let t=e.room.selectionRoomId;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-selection-bar`,role:`toolbar`,"aria-label":`消息多选`,children:[(0,p.jsxs)(`strong`,{children:[`已选择 `,e.room.selectedMessages.length,` 条消息`]}),(0,p.jsx)(`button`,{type:`button`,disabled:e.room.selectedMessages.length===0,onClick:()=>{t!==void 0&&e.openForward(t)},children:`合并转发`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.clearMessageSelection,children:`取消`})]})}function Wi(e){let t=e.room.rooms.filter(t=>t.id!==e.room.selectionRoomId);return(0,p.jsx)(`div`,{className:`dsh-chatroom-dialog-layer dsh-chatroom-forward-layer`,"data-testid":`chatroom-forward-dialog`,children:(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-forward-dialog`,"aria-label":`转发到群聊`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭转发`,type:`button`,onClick:e.closeForward,children:`×`}),(0,p.jsx)(`h2`,{children:`转发到群聊`}),(0,p.jsxs)(`p`,{children:[`将选中的 `,e.room.selectedMessages.length,` 条消息合并成一张聊天记录卡片。`]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-targets`,children:[t.map(t=>(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.forwardBusy,onClick:()=>{e.forwardSelected(t.id)},children:[(0,p.jsx)(`span`,{children:`＃`}),(0,p.jsx)(`strong`,{children:t.title}),(0,p.jsxs)(`small`,{children:[`@`,t.aiDisplayName]})]},t.id)),t.length===0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-empty`,children:`请先新建另一个群聊，再进行转发。`})]}),e.room.forwardError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.forwardError})]})})}function Gi({toasts:e,dismiss:t}){return e.length===0?null:(0,p.jsx)(`div`,{className:`dsh-chatroom-toast-stack`,role:`status`,"aria-live":`polite`,children:e.map(e=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-toast`,type:`button`,onClick:()=>{t(e.id)},children:[(0,p.jsxs)(`strong`,{children:[e.displayName,` `,(0,p.jsxs)(`small`,{children:[`· `,e.roomTitle,e.threadId===void 0?``:` · 分支`]})]}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})}function Ki(e){let[t,n]=(0,d.useState)(e.room.room?.title??``),[r,i]=(0,d.useState)(``),[a,o]=(0,d.useState)([]),s=e.room.members.find(t=>t.participantId===e.room.identity?.participantId)?.role??`member`,c=s===`owner`||s===`admin`,l=c||e.room.auth.account?.role===`super-admin`,u=r.trim().toLocaleLowerCase(`zh-CN`),f=e.room.memberCandidates.filter(e=>u===``||e.displayName.toLocaleLowerCase(`zh-CN`).includes(u)||e.username.toLocaleLowerCase(`zh-CN`).includes(u));return(0,d.useEffect)(()=>{let t=new Set(e.room.memberCandidates.map(e=>e.participantId));o(e=>e.filter(e=>t.has(e)))},[e.room.memberCandidates]),(0,p.jsxs)(`aside`,{className:`dsh-chatroom-member-card`,"data-testid":`chatroom-members`,"aria-label":`群管理`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭群管理`,type:`button`,onClick:e.closeMembers,children:`×`}),(0,p.jsx)(`h2`,{children:`群管理`}),(0,p.jsxs)(`p`,{children:[e.room.room?.title,` · `,e.room.members.length,` 位成员 · `,e.room.online,` 人在线`]}),l&&(0,p.jsxs)(`section`,{className:`dsh-chatroom-invite`,"aria-label":`添加群成员`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-heading`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`添加成员`}),(0,p.jsx)(`small`,{children:`从系统中尚未加入本群的启用账号里选择。`})]}),(0,p.jsxs)(`span`,{children:[a.length,` 位已选`]})]}),(0,p.jsx)(`input`,{type:`search`,value:r,placeholder:`搜索姓名或账号`,"aria-label":`搜索系统用户`,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-list`,children:[f.map(t=>{let n=a.includes(t.participantId);return(0,p.jsxs)(`label`,{children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:n,disabled:e.room.managementBusy,onChange:()=>{o(e=>n?e.filter(e=>e!==t.participantId):[...e,t.participantId])}}),(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:t.displayName}),(0,p.jsxs)(`small`,{children:[`@`,t.username]})]})]},t.participantId)}),f.length===0&&(0,p.jsx)(`p`,{children:e.room.managementBusy?`正在加载系统用户…`:u===``?`所有启用账号都已在群聊中。`:`没有匹配的系统用户。`})]}),(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.managementBusy||a.length===0,onClick:async()=>{await e.addRoomMembers?.(a)&&o([])},children:[`添加选中的 `,a.length,` 位`]})]}),c&&(0,p.jsxs)(`form`,{className:`dsh-chatroom-manage-title`,onSubmit:n=>{n.preventDefault(),e.renameRoom?.(t)},children:[(0,p.jsx)(`input`,{value:t,maxLength:160,"aria-label":`群聊名称`,onChange:e=>{n(e.target.value)}}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.managementBusy||t.trim()===``||t.trim()===e.room.room?.title,children:`保存名称`})]}),(0,p.jsxs)(`section`,{className:`dsh-chatroom-auto-trigger`,"aria-label":`AI 自动回复`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`无需 @AI 自动回复`}),(0,p.jsx)(`small`,{children:`开启后，由设置中选择的判断模型决定普通消息是否需要 AI 回复。群内所有成员都可以修改。`})]}),(0,p.jsxs)(`label`,{className:`dsh-chatroom-switch`,children:[(0,p.jsx)(`input`,{type:`checkbox`,"aria-label":`无需 @AI 自动回复`,checked:e.room.room?.autoTriggerEnabled??!1,disabled:e.room.managementBusy,onChange:t=>{e.setRoomAutoTrigger?.(t.target.checked)}}),(0,p.jsx)(`span`,{"aria-hidden":!0})]})]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-member-list`,children:e.room.members.map(t=>(0,p.jsxs)(`div`,{className:`dsh-chatroom-member`,children:[(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[t.displayName,` `,(0,p.jsx)(`em`,{children:t.role===`owner`?`群主`:t.role===`admin`?`管理员`:``})]}),(0,p.jsx)(`small`,{children:t.online?`在线`:`最近活跃 ${ra(t.lastSeenAt)}`})]}),s===`owner`&&t.role!==`owner`?(0,p.jsx)(`button`,{className:`dsh-chatroom-member-role`,type:`button`,disabled:e.room.managementBusy,onClick:()=>{e.setMemberRole?.(t.participantId,t.role===`admin`?`member`:`admin`)},children:t.role===`admin`?`取消管理员`:`设为管理员`}):(0,p.jsx)(`i`,{"data-online":t.online})]},t.participantId))}),e.room.managementError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.managementError}),(0,p.jsx)(`button`,{className:`dsh-chatroom-notification-button`,type:`button`,disabled:e.room.notificationsEnabled,onClick:()=>{e.enableSystemNotifications()},children:e.room.notificationsEnabled?`✓ 系统消息提醒已开启`:`开启系统消息提醒`})]})}function qi(e){let{thread:t}=e,n=e.room.room?.sessionId,r=(0,d.useRef)(null),[i]=(0,d.useState)(()=>++Bi),[a,o]=(0,d.useState)(0),[s,c]=(0,d.useState)(-1),[l,u]=(0,d.useState)(!1),[f,m]=(0,d.useState)($i);(0,d.useLayoutEffect)(()=>{if(n===void 0)return;if(f){ne(n);return}re(t.sessionId),c(a);let e=globalThis.setTimeout(()=>{ne(n)},3e4);return()=>{globalThis.clearTimeout(e),ne(n)}},[a,f,n,t.sessionId]),(0,d.useEffect)(()=>{e.open||n===void 0||ne(n)},[n,e.open]),(0,d.useEffect)(()=>{if(f)return;u(!1);let e=!1,i,a,o=()=>{if(e)return;let o=r.current?.contentWindow;o!=null&&n!==void 0&&ee(o,O(t,n));try{let e=r.current?.contentDocument;if(e==null||!ce(e,t.sessionId,t.root.text))return}catch{return}e=!0,globalThis.clearInterval(i),globalThis.clearTimeout(a),u(!0)},s=e=>{e.origin===globalThis.location.origin&&e.source===r.current?.contentWindow&&na(e.data,t.id)&&o()};return globalThis.addEventListener(`message`,s),i=globalThis.setInterval(o,150),a=globalThis.setTimeout(()=>{e||(globalThis.clearInterval(i),n!==void 0&&ne(n),ea(),m(!0))},8e3),o(),()=>{e=!0,globalThis.removeEventListener(`message`,s),globalThis.clearInterval(i),globalThis.clearTimeout(a)}},[a,f,n,t.id,t.root.text,t.sessionId]);let h=Qi(t.root.text),g=n===void 0?void 0:D(t,n,`${i}:${a}`);return(0,p.jsxs)(`aside`,{className:`dsh-chatroom-thread-panel`,"data-testid":`chatroom-thread-panel`,"data-open":e.open,"aria-hidden":!e.open,"aria-label":`分支回复`,children:[(0,p.jsxs)(`header`,{children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`分支回复`}),(0,p.jsxs)(`small`,{children:[`来自 `,e.room.room?.title??`群聊`,` · `,t.root.displayName,`：`,h]})]}),(0,p.jsx)(`button`,{"aria-label":`关闭分支`,type:`button`,onClick:e.closeThread,children:`×`})]}),n===void 0?(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-frame-error`,children:`无法确定父群聊会话。`}):f?(0,p.jsx)(Ji,{...e,thread:t,frameUrl:g,retry:()=>{ta(),m(!1),o(e=>e+1)}}):(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-shell`,children:[s===a&&(0,p.jsx)(`iframe`,{className:`dsh-chatroom-thread-frame`,ref:r,title:`分支回复：${h}`,src:g,onLoad:()=>{try{if(r.current?.contentDocument!==null)return}catch{}ne(n),ea(),m(!0)}},`${i}:${a}`),!l&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-status`,role:`status`,children:[(0,p.jsx)(`span`,{children:a===0?`正在加载分支…`:`正在重新加载分支…`}),(0,p.jsx)(`small`,{children:`正在打开分支。`})]})]}),e.room.threadError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.threadError})]})}function Ji(e){let[t,n]=(0,d.useState)(``),[r,i]=(0,d.useState)(),[a,o]=(0,d.useState)(0),s=(0,d.useRef)(null),c=(0,d.useRef)(null),l=(0,d.useMemo)(()=>[...[...new Set([`AI`,e.room.room?.aiDisplayName].filter(e=>e!==void 0))].map(e=>({name:e,description:`提及后在本分支触发 AI`,ai:!0})),...e.room.members.filter(t=>t.participantId!==e.room.identity?.participantId).map(e=>({name:e.displayName,description:e.online?`在线成员`:`群成员`,ai:!1}))].filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t),[e.room.identity?.participantId,e.room.members,e.room.room?.aiDisplayName]),u=r===void 0?[]:l.filter(e=>e.name.toLocaleLowerCase().includes(r.query.toLocaleLowerCase()));(0,d.useEffect)(()=>{typeof s.current?.scrollIntoView==`function`&&s.current.scrollIntoView({block:`end`})},[e.room.threadMessages.length]),(0,d.useEffect)(()=>{o(0)},[r?.query]);let f=(e,t)=>{i(Zi(e,t))},m=e=>{if(r===void 0)return;let a=c.current?.selectionStart??t.length,o=`${t.slice(0,r.start)}@${e} ${t.slice(a)}`,s=r.start+e.length+2;n(o),i(void 0),queueMicrotask(()=>{c.current?.focus(),c.current?.setSelectionRange(s,s)})};return(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility-notice`,role:`status`,children:[(0,p.jsx)(`span`,{children:`分支无法在当前页面完整显示，请在新标签中打开。`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`a`,{href:e.frameUrl,target:`_blank`,rel:`noreferrer`,children:`在新标签打开分支`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.retry,children:`重试`})]})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-root`,children:[(0,p.jsx)(`strong`,{children:e.thread.root.displayName}),(0,p.jsx)(`div`,{children:e.thread.root.role===`ai`?(0,p.jsx)(Mi,{text:e.thread.root.text}):e.thread.root.text})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-messages`,children:[e.room.threadMessages.length===0&&(0,p.jsxs)(`p`,{className:`dsh-chatroom-thread-empty`,children:[`从这里开始分支讨论。输入 `,(0,p.jsx)(`code`,{children:`@AI`}),` 只会在本分支触发 AI。`]}),e.room.threadMessages.map(t=>(0,p.jsx)(Yi,{message:t,roomId:e.thread.roomId,props:e},t.id)),(0,p.jsx)(`div`,{ref:s})]}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-thread-composer`,onSubmit:r=>{r.preventDefault();let i=t.trim();i!==``&&e.sendThreadMessage(i).then(e=>{e&&n(``)})},children:[e.room.threadReply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-composer-reply`,children:[(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.room.threadReply.displayName]}),e.room.threadReply.text]}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`取消引用`,onClick:e.clearThreadReply,children:`×`})]}),(0,p.jsx)(`textarea`,{ref:c,rows:3,placeholder:`回复分支；输入 @AI 让 AI 在本分支回答`,value:t,"aria-expanded":u.length>0,"aria-controls":`dsh-chatroom-thread-mentions`,onChange:e=>{n(e.target.value),f(e.target.value,e.target.selectionStart)},onClick:e=>{f(e.currentTarget.value,e.currentTarget.selectionStart)},onKeyDown:e=>{if(u.length>0){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=e.key===`ArrowDown`?1:-1;o(e=>(e+t+u.length)%u.length);return}if(e.key===`Escape`){e.preventDefault(),i(void 0);return}if(e.key===`Tab`){e.preventDefault(),m(u[a]?.name??u[0].name);return}}if(!(e.key!==`Enter`||e.shiftKey)){if(u.length>0&&r?.query===``){e.preventDefault(),m(u[a]?.name??u[0].name);return}e.preventDefault(),e.currentTarget.form?.requestSubmit()}}}),u.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-mentions`,id:`dsh-chatroom-thread-mentions`,role:`listbox`,"aria-label":`提及成员`,children:u.map((e,t)=>(0,p.jsxs)(`button`,{type:`button`,role:`option`,"aria-label":e.name,"aria-selected":t===a,"data-active":t===a,onMouseDown:e=>{e.preventDefault()},onClick:()=>{m(e.name)},children:[(0,p.jsx)(`i`,{children:e.ai?`✦`:`●`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:e.description})]})]},e.name))}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.threadBusy||t.trim()===``,children:`发送`})]})]})}function Yi({message:e,roomId:t,props:n}){let r=e.participantId===n.room.identity?.participantId,i=n.room.members.find(t=>t.participantId===e.participantId),a=i?.avatarId??e.avatarId??g(e.participantId),o=i?.avatarUrl??e.avatarUrl,s=e.role===`ai`?{id:`ai`,emoji:`✦`}:_(a,e.participantId),c=Xi(e),l=n.room.identity===void 0?void 0:()=>{n.setThreadReply(c)},u={roomId:t,message:{...c,role:e.role,createdAt:e.createdAt},reactions:n.room.reactions,identity:n.room.identity,selecting:n.room.selectionRoomId===t,selected:n.room.selectionRoomId===t&&n.room.selectedMessages.some(t=>t.messageId===e.id),recalled:n.room.recalls.some(t=>t.messageId===e.id),canRecall:r&&e.role===`human`,copyText:e.text,onReply:l,toggleReaction:n.toggleReaction,openForward:n.openForward,toggleSelection:n.toggleMessageSelection,recallMessage:n.recallMessage},d=Li();return(0,p.jsxs)(`article`,{className:`dsh-chatroom-thread-message`,"data-own":r,"data-role":e.role,"data-dsh-chatroom-selection-mode":u.selecting||void 0,"data-dsh-chatroom-selected":u.selected||void 0,onContextMenu:d.open,children:[(0,p.jsx)(Ii,{tools:u}),e.role===`ai`?(0,p.jsx)(`span`,{className:`dsh-chatroom-member-avatar`,"data-avatar":s.id,"aria-hidden":!0,children:s.emoji}):(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,participantId:e.participantId,avatarId:a,...o===void 0?{}:{avatarUrl:o}}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-message-column`,children:[(0,p.jsxs)(`strong`,{children:[e.displayName,(0,p.jsx)(`time`,{children:ia(e.createdAt)})]}),!u.recalled&&e.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-reply-quote`,children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.reply.displayName]}),(0,p.jsx)(`span`,{children:e.reply.text})]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-message-body`,children:u.recalled?(0,p.jsx)(`div`,{className:`dsh-chatroom-recalled-message`,children:`消息已撤回`}):e.role===`ai`?(0,p.jsx)(Mi,{text:e.text}):(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-literal-text`,children:e.text})}),(0,p.jsx)(Ri,{...u}),(0,p.jsx)(Fi,{tools:u})]}),(0,p.jsx)(zi,{tools:u,position:d.position,close:d.close})]})}function Xi(e){return{messageId:e.id,displayName:e.displayName,text:Qi(e.text,120)}}function Zi(e,t){let n=e.slice(0,t),r=/(?:^|\s)@([^\s@]*)$/u.exec(n);if(r!==null)return{start:n.length-r[1].length-1,query:r[1]}}function Qi(e,t=48){let n=e.replace(/```[\s\S]*?```/gu,` `).replace(/[`*_#>|\[\]]/gu,``).replace(/\s+/gu,` `).trim(),r=[...n];return r.length===0?`分支消息`:r.length<=t?n:`${r.slice(0,t).join(``)}…`}function $i(){try{return globalThis.sessionStorage?.getItem(Vi)===`1`}catch{return!1}}function ea(){try{globalThis.sessionStorage?.setItem(Vi,`1`)}catch{}}function ta(){try{globalThis.sessionStorage?.removeItem(Vi)}catch{}}function na(e,t){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let n=e;return n.type===`dsh-chatroom-branch-ready`&&n.threadId===t}function ra(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${t} 分钟前`:t<1440?`${Math.floor(t/60)} 小时前`:`${Math.floor(t/1440)} 天前`}function ia(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}function aa(e){let t=e.useChatroom(e=>e);if(t.branchFrame!==void 0)return null;let n=(0,p.jsx)(Hi,{room:t,...e});return t.open?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-dialog-layer`,"data-dsh-chatroom-entry":!0,"data-testid":`chatroom-dialog`,children:[t.phase===`auth-required`&&(0,p.jsx)(oa,{room:t,login:e.login,register:e.register}),t.phase===`identity-required`&&(0,p.jsx)(ca,{room:t,join:e.join,close:e.closeRoom}),t.phase===`loading`&&(0,p.jsx)(ua,{title:`正在载入共享会话`,detail:`正在恢复此浏览器的身份与会话目录…`,close:e.closeRoom}),t.phase===`ready`&&t.identity!==void 0&&(0,p.jsx)(la,{room:t,selectRoom:e.selectRoom,createRoom:e.createRoom,resetIdentity:e.resetIdentity,logout:e.logout,openAccount:e.openAccount,openAdmin:e.openAdmin,openDirect:e.openDirect,close:e.closeRoom}),t.phase===`error`&&(0,p.jsx)(ua,{title:`共享会话暂时不可用`,detail:t.error??`请稍后重试。`,action:`重试`,onAction:e.retry,close:e.closeRoom})]}),n]}):n}function oa({room:e,login:t,register:n}){let r=e.auth.bootstrapRequired||e.auth.allowSelfRegistration,[i,a]=(0,d.useState)(e.auth.bootstrapRequired?`register`:`login`),[o,s]=(0,d.useState)(``),[c,l]=(0,d.useState)(``),[u,f]=(0,d.useState)(``),[h,g]=(0,d.useState)(``),[_,v]=(0,d.useState)(m[0].id),y=typeof location>`u`?`/`:`${location.pathname}${location.search}`,b=e.auth.bootstrapRequired?void 0:e.auth.autoRedirectProvider,x=e.auth.authMode!==`dsh-auth-only`&&typeof location<`u`&&new URLSearchParams(location.search).get(`local`)===`1`;return(0,d.useEffect)(()=>{b===void 0||x||typeof location>`u`||location.assign(sa(b,y))},[b,x,y]),b!==void 0&&!x?(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,role:`status`,children:[(0,p.jsxs)(`h2`,{children:[`正在前往 `,b.label]}),(0,p.jsx)(`p`,{children:`正在打开企业统一登录…`})]}):(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,"aria-label":`系统登录`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-brand`,children:[(0,p.jsx)(`strong`,{children:`DeepSeek Harness`}),(0,p.jsx)(`span`,{children:`团队协作平台`})]}),(0,p.jsx)(`h2`,{children:i===`login`?`登录`:e.auth.bootstrapRequired?`创建超级管理员`:`注册账号`}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-tabs`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":i===`login`,onClick:()=>{a(`login`)},children:`登录`}),r&&(0,p.jsx)(`button`,{type:`button`,"data-active":i===`register`,onClick:()=>{a(`register`)},children:`注册`})]}),(0,p.jsxs)(`form`,{onSubmit:r=>{r.preventDefault(),i===`login`?t(o,c):n({username:o,password:c,displayName:u,avatarId:_,...e.auth.bootstrapRequired?{bootstrapToken:h}:{}})},children:[(0,p.jsxs)(`label`,{children:[`账号`,(0,p.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:o,onChange:e=>{s(e.target.value)}})]}),(0,p.jsxs)(`label`,{children:[`密码`,(0,p.jsx)(`input`,{type:`password`,autoComplete:i===`login`?`current-password`:`new-password`,value:c,onChange:e=>{l(e.target.value)}})]}),i===`register`&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`label`,{children:[`显示名称`,(0,p.jsx)(`input`,{value:u,onChange:e=>{f(e.target.value)}})]}),e.auth.bootstrapRequired&&(0,p.jsxs)(`label`,{children:[`初始化口令`,(0,p.jsx)(`input`,{type:`password`,value:h,onChange:e=>{g(e.target.value)}})]}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===_,type:`button`,role:`radio`,"aria-checked":e.id===_,onClick:()=>{v(e.id)},children:e.emoji},e.id))})]})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`submit`,disabled:o.trim()===``||c===``||i===`register`&&u.trim()===``,children:i===`login`?`登录`:`创建账号`})]}),e.auth.providers.length>0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-sso-list`,children:[(0,p.jsx)(`span`,{children:`或使用企业账号`}),e.auth.providers.map(e=>(0,p.jsxs)(`a`,{href:sa(e,y),children:[`使用 `,e.label,` 登录`]},e.id))]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function sa(e,t){return v(y,e,t)}function ca({room:e,join:t,close:n}){let[r,i]=(0,d.useState)(e.identity?.displayName??``),[a,o]=(0,d.useState)(e.identity?.avatarId??m[0].id);return(0,p.jsxs)(`form`,{className:`dsh-chatroom-card`,onSubmit:e=>{e.preventDefault(),t(r,a)},children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:n,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsx)(`p`,{children:`选择你在共享会话中显示的名字和头像。`}),(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-identity-input`,autoFocus:!0,maxLength:80,placeholder:`你的名字`,value:r,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===a,type:`button`,role:`radio`,"aria-checked":e.id===a,"aria-label":e.label,onClick:()=>{o(e.id)},children:e.emoji},e.id))})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,"data-testid":`chatroom-join`,type:`submit`,disabled:r.trim()===``,children:`继续`}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function la({room:e,selectRoom:t,createRoom:n,resetIdentity:r,logout:i,openAccount:a,openAdmin:o,openDirect:s,close:c}){let[l,u]=(0,d.useState)(``);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card dsh-chatroom-room-card`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:c,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsxs)(`p`,{children:[`普通消息只在人类之间聊天；输入 `,(0,p.jsx)(`code`,{children:`@AI`}),` 或 `,(0,p.jsxs)(`code`,{children:[`@`,e.rooms[0]?.aiDisplayName??`DeepSeek`]}),` 才会触发 AI 回复。`]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-room-list`,"data-testid":`chatroom-room-list`,children:e.rooms.map(n=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-room-item`,"data-active":n.id===e.room?.id,"data-testid":`chatroom-room-${n.id}`,type:`button`,onClick:()=>{t(n.id)},children:[(0,p.jsx)(`span`,{children:n.title}),(0,p.jsxs)(`small`,{children:[`@`,n.aiDisplayName]})]},n.id))}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-create`,onSubmit:e=>{e.preventDefault(),l.trim()!==``&&n(l)},children:[(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-title-input`,maxLength:160,placeholder:`新共享会话名称`,value:l,onChange:e=>{u(e.target.value)}}),(0,p.jsx)(`button`,{className:`dsh-chatroom-create-button`,"data-testid":`chatroom-create`,type:`submit`,disabled:l.trim()===``,children:`新建`})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-card-footer`,children:[(0,p.jsxs)(`span`,{children:[`当前身份：`,e.identity===void 0?``:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.identity.avatarId,avatarUrl:e.identity.avatarUrl,seed:e.identity.participantId}),` `,e.identity.displayName]})]}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`button`,{type:`button`,onClick:()=>{s()},children:`私聊`}),e.auth.enabled&&(0,p.jsx)(`button`,{type:`button`,onClick:a,children:`账号设置`}),e.auth.account?.role===`super-admin`&&(0,p.jsx)(`button`,{type:`button`,onClick:()=>{o()},children:`系统管理`}),e.auth.enabled?(0,p.jsx)(`button`,{type:`button`,onClick:()=>{i()},children:`退出登录`}):(0,p.jsx)(`button`,{type:`button`,onClick:()=>{r()},children:`更换身份`})]})]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function ua({title:e,detail:t,action:n,onAction:r,close:i}){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card`,role:`status`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:i,children:`×`}),(0,p.jsx)(`h2`,{children:e}),(0,p.jsx)(`p`,{children:t}),n!==void 0&&(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`button`,onClick:()=>{r?.()},children:n})]})}function da({preview:e,open:t}){return e===void 0?null:(0,p.jsxs)(`button`,{className:`dsh-chatroom-thread-activity`,type:`button`,"aria-label":`打开分支，${e.totalMessages} 条回复`,disabled:t===void 0,onClick:t,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-thread-activity-heading`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⑂`}),` 分支 · `,e.totalMessages,` 条回复`]}),(0,p.jsx)(`span`,{className:`dsh-chatroom-thread-activity-list`,children:e.recentMessages.map(e=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.avatarId,avatarUrl:e.avatarUrl,seed:e.participantId}),(0,p.jsx)(`strong`,{children:e.displayName}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})]})}function fa(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>t.sessionId===String(e.sessionId)),r=e.resolveTarget?.(String(e.sessionId))??(n===void 0?void 0:{kind:`room`,room:n}),i=r?.room,a=e.useSession(t=>t.nodes.find(t=>t.kind===`assistant`&&t.messageId===e.messageId)),o=(0,d.useRef)(null),s=Li(),c=t.selectionRoomId===i?.id&&t.selectedMessages.some(t=>t.messageId===String(e.messageId)),l=t.selectionRoomId===i?.id;if((0,d.useEffect)(()=>{let e=o.current?.closest(`[data-time-hover-root]`);if(e==null||i===void 0)return;let t=o.current?.parentElement;for(;t!=null&&t.parentElement!==null&&t.parentElement!==e;)t=t.parentElement;t?.setAttribute(`data-dsh-chatroom-native-actions`,``);let n=e=>{s.open(e)};return e.addEventListener(`contextmenu`,n),e.toggleAttribute(`data-dsh-chatroom-selected`,c),e.toggleAttribute(`data-dsh-chatroom-selection-mode`,l),()=>{e.removeEventListener(`contextmenu`,n),e.removeAttribute(`data-dsh-chatroom-selected`),e.removeAttribute(`data-dsh-chatroom-selection-mode`),t?.removeAttribute(`data-dsh-chatroom-native-actions`)}},[s.open,i,c,l]),i===void 0||a?.kind!==`assistant`)return null;let u=a.blocks.flatMap(e=>e.kind===`text`?[e.text]:[]).join(``).trim().replace(/\s+/gu,` `),f={messageId:String(e.messageId),displayName:i.aiDisplayName,text:[...u||`AI 回复`].slice(0,120).join(``)},m={...f,sourceSessionId:String(e.sessionId),sourceSeq:a.seq,role:`ai`,createdAt:a.time,content:a.blocks.reduce((e,t)=>(t.kind===`text`&&e.push({type:`text`,text:t.text,markdown:!0}),t.kind===`image`&&e.push({type:`image`,image:{...t.attachment,attachmentId:String(t.attachment.attachmentId)}}),e),[])},h={...f,role:`ai`,sourceSessionId:m.sourceSessionId,sourceSeq:m.sourceSeq},g={roomId:i.id,message:m,reactions:t.reactions,identity:t.identity,selecting:l,selected:c,recalled:!1,canRecall:!1,copyText:u||`AI 回复`,onReply:()=>{e.setReply(i.id,f)},onBranch:r?.kind===`thread`?void 0:()=>{e.openThread(i.id,h)},toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection,recallMessage:e.recallMessage},_=t.threadPreviews.find(e=>e.thread.root.messageId===m.messageId&&e.thread.root.role===`ai`);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-tools`,ref:o,children:[(0,p.jsx)(Ii,{tools:g}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-actions`,children:[(0,p.jsx)(Ri,{...g}),(0,p.jsx)(Fi,{tools:g})]}),r?.kind!==`thread`&&(0,p.jsx)(da,{preview:_,open:()=>{e.openThread(i.id,h)}}),(0,p.jsx)(zi,{tools:g,position:s.position,close:s.close})]})}function pa(e){if(!e.startsWith(`⁣dsh-chatroom:`))return;let t=e.indexOf(`⁣`,14);if(t<0)return;let n=e.slice(14,t),r=n.indexOf(`|`),i=r<0?n:n.slice(0,r);if(i===``)return;let a=r<0?void 0:n.slice(r+1);return{participantId:i,avatarId:h(a)?a:g(i),length:t+1}}function ma(e){if(!e.startsWith(`⁣dsh-chatroom-reply:`))return{text:e};let t=e.indexOf(`⁣`,20);if(t<0)return{text:e};let n=Ta(e.slice(20,t));if(!Ea(n))return{text:e};let r=e.slice(t+1),i=xa(n);return r.startsWith(i)&&(r=r.slice(i.length)),{text:r,reply:n}}function ha(e){let t=[],n=e;for(;;){let e=n.indexOf(`⁣dsh-chatroom-file:`);if(e<0)break;let r=n.indexOf(`⁣`,e+19);if(r<0)break;let i=Ta(n.slice(e+19,r));if(!Da(i))break;t.push(i);let a=n.slice(0,e).replace(/\n$/u,``),o=n.slice(r+1),s=Sa(i);o.startsWith(s)&&(o=o.slice(s.length)),n=`${a}${o}`}return{text:n,files:t}}function ga(e){if(!e.startsWith(`⁣dsh-chatroom-forward:`))return{text:e};let t=e.indexOf(`⁣`,22);if(t<0)return{text:e};let n=Ta(e.slice(22,t));if(!Oa(n))return{text:e};let r=e.slice(t+1),i=Ca(n);return r.startsWith(i)&&(r=r.slice(i.length)),{text:r,forward:n}}function _a(e){let t=[],n=e;for(;;){let e=n.indexOf(`⁣dsh-chatroom-card:`);if(e<0)break;let r=n.indexOf(`⁣`,e+19);if(r<0)break;let i=Ta(n.slice(e+19,r));if(!Aa(i))break;t.push(i);let a=n.slice(0,e).replace(/\n$/u,``),o=n.slice(r+1),s=wa(i);o.startsWith(s)&&(o=o.slice(s.length)),n=`${a}${o}`}return{text:n,cards:t}}function va(e,t){let n=e.filter(e=>e.type===`text`).map(e=>e.text).join(`
...
`)}`}function wa(e){if(e.kind===`meeting`){let t=[e.beginTime,e.endTime].filter(e=>e!==void 0).join(` - `);return`企微会议：${e.title}${t===``?``:`（${t}）`}`}return`企微${e.documentType??`文档`}：${e.title}`}function Ta(e){try{return JSON.parse(decodeURIComponent(e))}catch{return}}function Ea(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.messageId==`string`&&typeof t.displayName==`string`&&typeof t.text==`string`}function Da(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.id==`string`&&typeof t.name==`string`&&typeof t.mediaType==`string`&&typeof t.bytes==`number`}function Oa(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.sourceRoomId!=`string`||typeof t.sourceRoomTitle!=`string`||!Array.isArray(t.items)||t.items.length===0?!1:t.items.every(e=>{if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.messageId==`string`&&(t.role===`human`||t.role===`ai`)&&typeof t.displayName==`string`&&typeof t.text==`string`&&typeof t.createdAt==`number`&&(t.sourceSessionId===void 0||typeof t.sourceSessionId==`string`)&&(t.sourceSeq===void 0||typeof t.sourceSeq==`number`)&&(t.content===void 0||Array.isArray(t.content)&&t.content.every(ka))&&(t.reply===void 0||Ea(t.reply))&&(t.reactions===void 0||Array.isArray(t.reactions)&&t.reactions.every(e=>typeof e==`object`&&!!e&&typeof e.emoji==`string`&&typeof e.count==`number`))})}function ka(e){if(typeof e!=`object`||!e)return!1;let t=e;if(t.type===`text`)return typeof t.text==`string`&&typeof t.markdown==`boolean`;if(t.type===`file`)return Da(t.file);if(t.type!==`image`||t.image===null||typeof t.image!=`object`)return!1;let n=t.image;return typeof n.attachmentId==`string`&&typeof n.mediaType==`string`&&typeof n.bytes==`number`&&typeof n.width==`number`&&typeof n.height==`number`}function Aa(e){if(typeof e!=`object`||!e)return!1;let t=e;if(t.kind!==`meeting`&&t.kind!==`document`||typeof t.title!=`string`||t.title.trim()===``)return!1;if(t.kind===`meeting`){let t=e;return ja(t.beginTime,t.endTime,t.url,t.location,t.status)&&(t.attendees===void 0||Array.isArray(t.attendees)&&t.attendees.every(e=>typeof e==`string`))}let n=e;return ja(n.documentType,n.url,n.modifiedAt,n.owner)}function ja(...e){return e.every(e=>e===void 0||typeof e==`string`)}let Ma=new Set([`assistant-step`,`context`,`retry`,`tool-call`]);function Na(e){let t=e.nativeMessageView,n=(0,d.useRef)(null),[r,i]=(0,d.useState)(!1),a=e.node.data.finalNode,o=e.useTurnData(`turn-tail`),s=e.resolveTarget?.(String(e.sessionId))!==void 0&&a!==void 0&&o?.closing?.finalNode.seq===a.seq,c=e.useSession(t=>{if(!s)return``;let n=e.node.data.turn;return t.chat.order.flatMap(r=>{let i=t.chat.nodes.get(r);if(i===void 0||i.key===e.node.key)return[];let a=i.location;return(a.kind===`turn`||a.kind===`step`?a.turn.turn:void 0)===n&&Ma.has(i.kind)?[i.key]:[]}).join(`\0`)}),l=(0,d.useMemo)(()=>c===``?[]:c.split(`\0`),[c]),u=s?e.node.data.blocks.filter(e=>e.kind===`reasoning`&&e.text.trim()!==``).length:0,f=l.length+u,m=e.node.data.blocks.flatMap(e=>e.kind===`text`?_a(e.text).cards:[]),h=[];for(let t of e.node.data.blocks){if(t.kind!==`text`){h.push(t);continue}let e=_a(t.text);e.text.trim()!==``&&h.push({...t,text:e.text})}let g=m.length===0?e.node:{...e.node,data:{...e.node.data,blocks:h}};return(0,d.useEffect)(()=>{let e=n.current,t=e?.closest(`[data-chat-flow]`);if(e===null||!s)return;let i=new Set(l),a=t==null?[]:[...t.querySelectorAll(`[data-chat-flow-key]`)].filter(e=>i.has(e.dataset.chatFlowKey??``)),o=[...e.querySelectorAll(`[data-variant="think"]`)],c=[...a,...o].map(e=>({row:e,hidden:e.hidden}));for(let{row:e}of c)e.dataset.dshChatroomProcessRow=``,e.hidden=!r;return()=>{for(let{row:e,hidden:t}of c)e.hidden=t,delete e.dataset.dshChatroomProcessRow}},[s,r,l]),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-turn`,ref:n,children:[s&&f>0&&(0,p.jsxs)(`button`,{type:`button`,className:`dsh-chatroom-process-toggle`,"aria-expanded":r,onClick:()=>{i(e=>!e)},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,className:`dsh-chatroom-process-chevron`,children:`⌄`}),(0,p.jsxs)(`span`,{children:[r?`收起执行过程`:`执行过程`,` · `,f,` 项`]})]}),(0,p.jsx)(t,{...e,node:g}),m.map((e,t)=>(0,p.jsx)(ue,{card:e},`${e.kind}:${e.title}:${t}`))]})}let Pa=[`😀`,`😄`,`😂`,`🥰`,`😍`,`🤔`,`😮`,`😭`,`😡`,`👍`,`👏`,`🙏`,`🎉`,`❤️`,`🔥`,`✨`,`✅`,`👀`];function Fa(e){e.useChatroom(e=>e);let t=e.resolveTarget(String(e.sessionId))?.room,n=(0,d.useRef)(null),r=(0,d.useRef)(null),[i,a]=(0,d.useState)(!1);return(0,d.useEffect)(()=>{if(!i)return;let e=e=>{r.current?.contains(e.target)||a(!1)};return document.addEventListener(`pointerdown`,e),()=>{document.removeEventListener(`pointerdown`,e)}},[i]),t===void 0?null:(0,p.jsxs)(`div`,{className:`dsh-chatroom-composer-actions`,ref:r,children:[(0,p.jsxs)(`button`,{className:`dsh-chatroom-file-button`,type:`button`,title:`发送表情`,"aria-label":`发送表情`,"aria-expanded":i,onClick:()=>{a(e=>!e)},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`☺`}),(0,p.jsx)(`span`,{children:`表情`})]}),i&&(0,p.jsx)(`div`,{className:`dsh-chatroom-emoji-picker`,role:`dialog`,"aria-label":`选择表情`,children:Pa.map(t=>(0,p.jsx)(`button`,{type:`button`,"aria-label":`插入 ${t}`,onClick:()=>{e.inputActions.setDraft(`${e.input.draft}${t}`),a(!1)},children:t},t))}),(0,p.jsxs)(`button`,{className:`dsh-chatroom-file-button`,type:`button`,title:`发送图片或文件`,"aria-label":`发送图片或文件`,onClick:()=>{n.current?.click()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`📎`}),(0,p.jsx)(`span`,{children:`附件`})]}),(0,p.jsx)(`input`,{ref:n,className:`dsh-chatroom-file-input`,"data-testid":`chatroom-file-input`,type:`file`,multiple:!0,onChange:n=>{let r=n.currentTarget.files;r!==null&&e.addFiles(t.id,[...r]),n.currentTarget.value=``}})]})}function Ia(e){let t=e.useChatroom(e=>e),n=e.resolveTarget(String(e.sessionId));return n?.kind===`room`?(0,p.jsxs)(`div`,{className:`dsh-chatroom-session-controls`,children:[(0,p.jsx)(`button`,{type:`button`,disabled:!e.session.running||t.sessionControlBusy,onClick:()=>{e.stopRoomSession(n.room.id)},children:`■ 停止`}),(0,p.jsx)(`button`,{type:`button`,disabled:t.sessionControlBusy,onClick:()=>{e.newRoomSession(n.room.id)},children:`＋ 新会话`}),(0,p.jsx)(`button`,{type:`button`,className:`dsh-chatroom-quick-meeting`,disabled:t.wecomBusy,onClick:()=>{e.quickMeeting(n.room.id)},children:`⚡ 快速会议`}),t.sessionControlError!==void 0&&(0,p.jsx)(`span`,{className:`dsh-chatroom-control-error`,role:`alert`,title:t.sessionControlError,children:t.sessionControlError}),t.wecomError!==void 0&&(0,p.jsx)(`span`,{className:`dsh-chatroom-control-error`,role:`alert`,title:t.wecomError,children:t.wecomError})]}):null}function La(e){let t=e.useChatroom(e=>e),n=e.resolveTarget(String(e.sessionId)),r=n?.room;if(r===void 0)return null;let i=t.composerRoomId===r.id,a=i&&t.pendingFiles.length>0,o=n?.kind===`room`&&r.aiContextResetSeq!==void 0&&r.aiContextStartSeq===void 0;if(!a&&!o&&(!i||t.composerError===void 0))return null;let s=a&&e.input.draft.trim()===``&&e.input.imageIds.length===0;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-composer-dock`,"data-testid":`chatroom-composer-dock`,children:[o&&(0,p.jsx)(Ra,{}),a&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-pending-files`,children:[t.pendingFiles.map(t=>(0,p.jsxs)(`span`,{className:`dsh-chatroom-pending-file`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:t.file.type.startsWith(`image/`)?`🖼️`:`📎`}),(0,p.jsx)(`span`,{title:t.file.name,children:t.file.name}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`移除 ${t.file.name}`,onClick:()=>{e.removeFile(r.id,t.id)},children:`×`})]},t.id)),s?(0,p.jsx)(`button`,{className:`dsh-chatroom-send-files`,type:`button`,disabled:t.composerBusy,onClick:()=>{e.sendFiles(r.id)},children:t.composerBusy?`正在发送…`:`发送`}):(0,p.jsx)(`small`,{className:`dsh-chatroom-file-hint`,children:`文件将随当前消息发送`})]}),i&&t.composerError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-composer-error`,role:`alert`,children:t.composerError})]})}function Ra(){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-context-reset`,role:`status`,children:[(0,p.jsx)(`span`,{children:`新的 AI 会话`}),(0,p.jsx)(`small`,{children:`此前群聊消息继续保留`})]})}function za(e){let t=e.useChatroom(e=>e),n=e.resolveTarget(String(e.sessionId))?.room?.id,r=e.nativeAttachmentsView,i=n!==void 0&&t.composerRoomId===n?t.reply:void 0;return(0,p.jsxs)(p.Fragment,{children:[i!==void 0&&n!==void 0&&(0,p.jsx)(Ba,{reply:i,clear:()=>{e.clearReply(n)}}),(0,p.jsx)(r,{...e})]})}function Ba({reply:e,clear:t}){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-reply-preview`,children:[(0,p.jsx)(`button`,{type:`button`,"aria-label":`取消回复`,onClick:t,children:`×`}),(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.displayName,`：`]}),(0,p.jsx)(`small`,{children:e.text})]})]})}function Va(e,t,n=[]){let r=!1,i=!1,a,o,s,c,l,u,d=[],f=[],p=[],m=[];for(let h of e.data.content){if(h.type!==`text`){m.push(h);continue}let e=h.text;if(!i){i=!0;let d=pa(e);e=d===void 0?e:e.slice(d.length);let f=/^([^：]{1,80})：/.exec(e);a=f?.[1],r=t!==void 0&&(d===void 0?a===t.displayName:d.participantId===t.participantId),o=d?.avatarId??g(a??d?.participantId??`participant`),s=d?.participantId;let p=n.find(e=>e.participantId===s);o=p?.avatarId??o,c=p?.avatarUrl,f!==null&&(e=e.slice(f[0].length));let m=ma(e);e=m.text,l=m.reply;let h=ga(e);e=h.text,u=h.forward}let _=_a(e);e=_.text,f.push(..._.cards);let v=ha(e);e=v.text,d.push(...v.files),e.trim()!==``&&p.push(e.trim()),e.trim()!==``&&m.push(e===h.text?h:{...h,text:e})}if((d.length>0||m.some(e=>e.type===`image`))&&p.length===1&&Ha(p[0])){p.length=0;for(let e=m.length-1;e>=0;--e){let t=m[e];t?.type===`text`&&Ha(t.text.trim())&&m.splice(e,1)}}return{node:i?{...e,data:{...e.data,content:m}}:e,own:r,avatarId:o??g(t?.participantId??`participant`),...s===void 0?{}:{participantId:s},files:d,cards:f,text:p.join(`
`),...a===void 0?{}:{displayName:a},...c===void 0?t!==void 0&&r&&t.avatarUrl!==void 0?{avatarUrl:t.avatarUrl}:{}:{avatarUrl:c},...l===void 0?{}:{reply:l},...u===void 0?{}:{forward:u}}}function Ha(e){return e===`发送了文件。`||e===`发送了一张图片。`}let Ua=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=Va(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=(0,p.jsx)(n,{...e,node:o.node}),c=i.room,l=Ya(String(e.sessionId),e.node,o),u=Za(l),d=Xa(l),f=t.identity===void 0?void 0:()=>{e.setReply(c.id,u)},m=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(c.id,d)},h=Qa(e,t,c.id,l,l.text,o.own,f,m),g=$a(t.threadPreviews,l.messageId,`human`);return(0,p.jsxs)(p.Fragment,{children:[c.aiContextStartSeq===e.node.data.seq&&(0,p.jsx)(Ra,{}),(0,p.jsx)(Ga,{native:s,projection:o,tools:h,threadPreview:g,onReply:f,onThread:m})]})}),Wa=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=Va(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=(0,p.jsx)(n,{...e,node:o.node}),c=i.room,l=Ya(String(e.sessionId),e.node,o),u=Za(l),d=Xa(l),f=t.identity===void 0?void 0:()=>{e.setReply(c.id,u)},m=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(c.id,d)},h=Qa(e,t,c.id,l,l.text,o.own,f,m),g=$a(t.threadPreviews,l.messageId,`human`);return(0,p.jsxs)(p.Fragment,{children:[c.aiContextStartSeq===e.node.data.seq&&(0,p.jsx)(Ra,{}),(0,p.jsx)(Ga,{native:s,projection:o,tools:h,threadPreview:g,onReply:f,onThread:m})]})});function Ga({native:e,projection:t,tools:n,threadPreview:r,onReply:i,onThread:a}){let o=Li();return(0,p.jsxs)(`div`,{className:`dsh-chatroom-participant-message`,"data-dsh-chatroom-own":t.own,"data-dsh-chatroom-selection-mode":n.selecting||void 0,"data-dsh-chatroom-selected":n.selected||void 0,onContextMenu:o.open,children:[(0,p.jsx)(Ii,{tools:n}),(0,p.jsx)(A,{avatarId:t.avatarId,avatarUrl:t.avatarUrl,seed:t.participantId??t.displayName??``}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-message-column`,children:[t.displayName!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-display-name`,children:t.displayName}),!n.recalled&&t.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-reply-quote`,children:[(0,p.jsxs)(`strong`,{children:[`回复 `,t.reply.displayName]}),(0,p.jsx)(`span`,{children:t.reply.text})]}),n.recalled?(0,p.jsx)(`div`,{className:`dsh-chatroom-recalled-message`,children:`消息已撤回`}):(0,p.jsxs)(p.Fragment,{children:[t.node.data.content.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-native-message`,children:e}),t.files.map(e=>(0,p.jsx)(Ka,{file:e},e.id)),t.cards.map((e,t)=>(0,p.jsx)(ue,{card:e},`${e.kind}:${e.title}:${t}`)),t.forward!==void 0&&(0,p.jsx)(qa,{forward:t.forward})]}),(0,p.jsx)(Ri,{...n}),(0,p.jsx)(da,{preview:r,open:a}),(0,p.jsx)(Fi,{tools:n})]}),(0,p.jsx)(zi,{tools:n,position:o.position,close:o.close})]})}function Ka({file:e}){return(0,p.jsxs)(`a`,{className:`dsh-chatroom-file-card`,href:`${y}/files/${encodeURIComponent(e.id)}`,download:e.name,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-file-icon`,"aria-hidden":!0,children:`📎`}),(0,p.jsxs)(`span`,{className:`dsh-chatroom-file-copy`,children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:to(e.bytes)})]}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↓`})]})}function qa({forward:e,depth:t=0}){return(0,p.jsxs)(`details`,{className:`dsh-chatroom-forward-card`,children:[(0,p.jsxs)(`summary`,{children:[(0,p.jsxs)(`strong`,{children:[`合并转发 · `,e.items.length,` 条消息`]}),(0,p.jsxs)(`small`,{children:[`来自 `,e.sourceRoomTitle]})]}),(0,p.jsx)(`div`,{children:e.items.map(n=>(0,p.jsxs)(`article`,{children:[(0,p.jsxs)(`strong`,{children:[n.displayName,(0,p.jsx)(`time`,{children:eo(n.createdAt)})]}),n.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-reply`,children:[(0,p.jsxs)(`b`,{children:[`回复 `,n.reply.displayName]}),(0,p.jsx)(`span`,{children:n.reply.text})]}),(n.content??[{type:`text`,text:n.text,markdown:n.role===`ai`}]).map((t,r)=>{if(t.type===`text`)return t.markdown?(0,p.jsx)(Mi,{text:t.text},r):(0,p.jsx)(`p`,{className:`dsh-chatroom-forward-text`,children:t.text},r);if(t.type===`file`)return(0,p.jsx)(Ka,{file:t.file},`${t.file.id}:${r}`);let i=Ja(e.sourceRoomId,n,t.image);return i===void 0?(0,p.jsx)(`span`,{className:`dsh-chatroom-forward-image-error`,children:`图片来源不可用`},`${t.image.attachmentId}:${r}`):(0,p.jsx)(`img`,{className:`dsh-chatroom-forward-image`,src:i,alt:t.image.name??`转发图片`},`${t.image.attachmentId}:${r}`)}),n.forward!==void 0&&t<1&&(0,p.jsx)(qa,{forward:n.forward,depth:t+1}),n.reactions!==void 0&&n.reactions.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-reactions`,children:n.reactions.map(e=>(0,p.jsxs)(`span`,{children:[e.emoji,` `,e.count]},e.emoji))})]},n.messageId))})]})}function Ja(e,t,n){if(t.sourceSessionId!==void 0&&t.sourceSeq!==void 0)return`${y}/images/${encodeURIComponent(JSON.stringify({sourceRoomId:e,sourceSessionId:t.sourceSessionId,sourceSeq:t.sourceSeq,image:n}))}`}function Ya(e,t,n){let r=n.files.length===0?``:n.files.map(e=>e.name).join(`、`),i=n.forward===void 0?``:`合并转发 ${n.forward.items.length} 条消息`,a=(n.text.trim()||r||i||`图片消息`).replace(/\s+/gu,` `);return{messageId:`${t.kind}:${t.data.seq}`,sourceSessionId:e,sourceSeq:t.data.seq,role:`human`,displayName:n.displayName??`参与者`,text:[...a].slice(0,120).join(``),createdAt:t.data.time,content:[...n.text.trim()===``?[]:[{type:`text`,text:n.text,markdown:!1}],...n.node.data.content.flatMap(e=>e.type===`image`?[{type:`image`,image:{...e.attachment,attachmentId:String(e.attachment.attachmentId)}}]:[]),...n.files.map(e=>({type:`file`,file:e}))],...n.reply===void 0?{}:{reply:n.reply},...n.forward===void 0?{}:{forward:n.forward}}}function Xa(e){if(e.sourceSessionId===void 0||e.sourceSeq===void 0)throw Error(`chatroom branch target lost its source coordinates`);return{messageId:e.messageId,displayName:e.displayName,text:e.text,role:e.role,sourceSessionId:e.sourceSessionId,sourceSeq:e.sourceSeq}}function Za(e){return{messageId:e.messageId,displayName:e.displayName,text:e.text}}function Qa(e,t,n,r,i,a,o,s){return{roomId:n,message:r,reactions:t.reactions,identity:t.identity,selecting:t.selectionRoomId===n,selected:t.selectionRoomId===n&&t.selectedMessages.some(e=>e.messageId===r.messageId),recalled:t.recalls.some(e=>e.messageId===r.messageId),canRecall:a,copyText:i,onReply:o,onBranch:s,toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection,recallMessage:e.recallMessage}}function $a(e,t,n){return e.find(e=>e.thread.root.messageId===t&&e.thread.root.role===n)}function eo(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}function to(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function no(e,t){let n=e.displayName.trim(),r=n.localeCompare(`AI`,void 0,{sensitivity:`accent`})===0||n.localeCompare(`DeepSeek`,void 0,{sensitivity:`accent`})===0,i=t.some(t=>t.participantId!==e.participantId&&t.displayName.trim().localeCompare(n,void 0,{sensitivity:`accent`})===0);return n===``||r||i?e.username:n}var ro=class{openSession;snapshot={branchFrame:void 0,open:!1,phase:`loading`,connection:`offline`,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1},online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],membersOpen:!1,managementBusy:!1,managementError:void 0,error:void 0,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0,sessionControlBusy:!1,sessionControlError:void 0,wecomBusy:!1,wecomError:void 0,wecomAuthorization:void 0,wecomAuthorizationOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0,unreadCount:0,toasts:[],notificationsEnabled:lo()===`granted`,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0,accountOpen:!1,accountBusy:!1,accountError:void 0,adminOpen:!1,adminBusy:!1,adminOverview:void 0,adminError:void 0,automationBusy:!1,automationOverview:void 0,automationError:void 0,directOpen:!1,directBusy:!1,directPeers:[],directConversations:[],directConversation:void 0,directMessages:[],directError:void 0,newSessionModes:{}};listeners=new Set;eventSource;notificationSource;pendingOpenRoomId;identityPromptedRoomId;stopped=!1;compositionRevision=0;pendingFileSequence=0;originalTitle;activeNativeSession;roomEnsure;pendingAutoTriggerWrites=new Map;pendingQuickMeetingTarget;constructor(e=()=>!1,t){this.openSession=e,t!==void 0&&(this.snapshot={...this.snapshot,branchFrame:t})}getSnapshot=()=>this.snapshot;roomForSession(e){let t=this.snapshot.rooms.find(t=>t.sessionId===e);if(t!==void 0)return t;let n=this.snapshot.branchFrame;return n?.sessionId===e?this.snapshot.rooms.find(e=>e.id===n.roomId):void 0}agentTargetForSession(e){let t=this.roomForSession(e);if(t===void 0)return;let n=this.snapshot.branchFrame;return n?.sessionId===e?{kind:`thread`,room:t,threadId:n.threadId}:{kind:`room`,room:t}}registerNewSession=e=>{this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:`group`}})};newSessionMode=e=>this.snapshot.newSessionModes[e];chooseNewSessionMode=async(e,t)=>this.snapshot.newSessionModes[e]!==void 0&&(this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:t},error:void 0}),!0);ensurePromptTarget=async e=>{let t=this.agentTargetForSession(e);return t!==void 0||this.snapshot.newSessionModes[e]!==`group`||this.activeNativeSession?.id!==e?t:(await this.ensureActiveSessionRoom(),this.agentTargetForSession(e))};newGroupInvitees=e=>{let t=this.snapshot.directPeers.filter(e=>e.participantId!==this.snapshot.identity?.participantId);return t.filter(n=>{let r=no(n,t);return va(e,r)||r!==n.username&&va(e,n.username)}).map(e=>e.participantId)};switchBranchFrame(e){let t=this.snapshot.branchFrame;(t?.threadId!==e.threadId||t.sessionId!==e.sessionId||t.roomId!==e.roomId||t.parentSessionId!==e.parentSessionId)&&(this.compositionRevision+=1,this.set({branchFrame:e,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0}))}subscribe=e=>(this.listeners.add(e),()=>{this.listeners.delete(e)});async start(){this.stopped=!1,typeof document<`u`&&(this.originalTitle=document.title),await this.loadSession()}stop(){this.stopped=!0,this.closeEvents(),this.closeNotifications(),this.updateActiveDocumentRoom(!1),this.updateDocumentTitle(0),this.listeners.clear()}openRoom=()=>{this.set({open:!0,error:void 0})};login=async(e,t)=>{this.set({phase:`loading`,error:void 0});try{let n=await Q(`${y}/auth/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})});return this.acceptSession(n),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:$(e)}),!1}};register=async e=>{this.set({phase:`loading`,error:void 0});try{let t=await Q(`${y}/auth/register`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});return this.acceptSession(t),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:$(e)}),!1}};logout=async()=>{try{await _o(`${y}/auth/logout`,{method:`POST`})}finally{this.closeEvents(),this.closeNotifications();let e=this.snapshot.auth;this.set({phase:`auth-required`,open:!0,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:e.enabled,authenticated:!1,providers:e.providers,allowSelfRegistration:e.allowSelfRegistration,bootstrapRequired:e.bootstrapRequired},accountOpen:!1,accountError:void 0,adminOpen:!1,adminOverview:void 0,directOpen:!1,directConversation:void 0,directMessages:[]})}};openAccount=()=>{!this.snapshot.auth.enabled||!this.snapshot.auth.authenticated||this.set({accountOpen:!0,accountBusy:!1,accountError:void 0,adminOpen:!1,directOpen:!1})};closeAccount=()=>{this.set({accountOpen:!1,accountBusy:!1,accountError:void 0})};changePassword=async(e,t)=>{this.set({accountBusy:!0,accountError:void 0});try{let n=await Q(`${y}/account`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:`change-password`,currentPassword:e,newPassword:t})});return this.set({accountOpen:!1,accountBusy:!1,accountError:void 0,auth:{...this.snapshot.auth,account:n.account},identity:n.account}),!0}catch(e){return this.set({accountBusy:!1,accountError:$(e)}),!1}};openAdmin=async()=>{if(this.snapshot.auth.account?.role===`super-admin`){this.set({adminOpen:!0,adminBusy:!0,adminError:void 0,directOpen:!1,accountOpen:!1});try{let e=await Q(`${y}/admin`);this.set({adminBusy:!1,adminOverview:e})}catch(e){this.set({adminBusy:!1,adminError:$(e)})}}};closeAdmin=()=>{this.set({adminOpen:!1,adminError:void 0})};loadAutomation=async()=>{if(!this.snapshot.automationBusy){this.set({automationBusy:!0,automationError:void 0});try{let e=await Q(`${y}/automation`);this.set({automationBusy:!1,automationOverview:e})}catch(e){this.set({automationBusy:!1,automationError:$(e)})}}};saveAutomation=async(e,t,n,r)=>{if(this.snapshot.automationBusy)return!1;this.set({automationBusy:!0,automationError:void 0});try{let i=await Q(`${y}/automation`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,model:t,mainAgentPrompt:n,controllerPrompt:r})});return this.set({automationBusy:!1,automationOverview:i}),!0}catch(e){return this.set({automationBusy:!1,automationError:$(e)}),!1}};adminCreateUser=async e=>this.adminMutation({action:`create-user`,...e});adminUpdateUser=async(e,t)=>this.adminMutation({action:`update-user`,userId:e,...t});adminSetSelfRegistration=async e=>this.adminMutation({action:`settings`,allowSelfRegistration:e});adminSetAutoRedirectProvider=async e=>this.adminMutation({action:`settings`,autoRedirectProviderId:e??null});adminSaveProvider=async e=>this.adminMutation({action:`save-provider`,...e});adminDeleteProvider=async e=>this.adminMutation({action:`delete-provider`,providerId:e});openDirect=async e=>{this.set({directOpen:!0,directBusy:!0,directError:void 0,adminOpen:!1,accountOpen:!1});try{let t=e===void 0?await Q(`${y}/direct`):await Q(`${y}/direct`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({peerId:e})});this.set({directBusy:!1,directPeers:t.peers,directConversations:t.conversations,directConversation:t.conversation,directMessages:t.messages??[]})}catch(e){this.set({directBusy:!1,directError:$(e)})}};loadDirectDirectory=async()=>{if(this.snapshot.phase!==`ready`||this.snapshot.identity===void 0)return!1;try{let e=await Q(`${y}/direct`);return this.set({directPeers:e.peers,directConversations:e.conversations,directError:void 0}),!0}catch(e){return this.set({directError:$(e)}),!1}};closeDirect=()=>{this.set({directOpen:!1,directError:void 0})};sendDirect=async(e,t=[])=>{let n=this.snapshot.directConversation;if(n===void 0||e.trim()===``&&t.length===0||this.snapshot.directBusy)return!1;this.set({directBusy:!0,directError:void 0});try{let r=await ho(t),i=[...e.trim()===``?[]:[{type:`text`,text:e}],...r],a=await Q(`${y}/direct/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversationId:n.id,content:i})}),o=this.snapshot.directMessages.some(e=>e.id===a.message.id)?this.snapshot.directMessages:[...this.snapshot.directMessages,a.message];return this.set({directBusy:!1,directConversation:a.conversation,directMessages:o,directConversations:co(this.snapshot.directConversations,a.conversation)}),!0}catch(e){return this.set({directBusy:!1,directError:$(e)}),!1}};openMembers=()=>{if(this.snapshot.room===void 0)return;this.set({membersOpen:!0,memberCandidates:[],thread:void 0,threadMessages:[],threadReply:void 0,threadError:void 0});let e=this.snapshot.members.find(e=>e.participantId===this.snapshot.identity?.participantId)?.role;(e===`owner`||e===`admin`||this.snapshot.auth.account?.role===`super-admin`)&&this.loadRoomMemberCandidates()};loadRoomMemberCandidates=async()=>{let e=this.snapshot.room;if(!(e===void 0||this.snapshot.managementBusy)){this.set({managementBusy:!0,managementError:void 0});try{let t=await Q(`${y}/rooms/manage?roomId=${encodeURIComponent(e.id)}`);this.snapshot.room?.id===e.id&&this.applyRoomManagement(t)}catch(e){this.set({managementBusy:!1,managementError:$(e)})}}};completeGroupSetup=async(e,t)=>{let n=this.snapshot.room;return n===void 0||e.trim()===``||t.length===0||e.trim()!==n.title&&!await this.renameRoom(e)?!1:await this.addRoomMembers(t)};closeMembers=()=>{this.set({membersOpen:!1,memberCandidates:[],managementError:void 0})};addRoomMembers=async e=>{let t=this.snapshot.room;if(t===void 0||e.length===0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`add-members`,participantIds:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};setRoomPinned=async(e,t)=>{try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`set-pinned`,pinned:t})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementError:$(e)}),!1}};setRoomAutoTrigger=e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return Promise.resolve(!1);this.set({managementBusy:!0,managementError:void 0});let n=(async()=>{try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`set-auto-trigger`,enabled:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}})();return this.pendingAutoTriggerWrites.set(t.id,n),n.then(()=>{this.pendingAutoTriggerWrites.get(t.id)===n&&this.pendingAutoTriggerWrites.delete(t.id)}),n};async waitForRoomAutoTrigger(e){let t=this.pendingAutoTriggerWrites.get(e);if(t!==void 0&&!await t)throw Error(this.snapshot.managementError??`自动回复设置保存失败。`)}recallMessage=async(e,t)=>{try{let n=await Q(`${y}/messages/recall`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,messageId:t})});return this.replaceRecall(n),!0}catch(e){return this.set({composerError:$(e)}),!1}};renameRoom=async e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`rename`,title:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};setMemberRole=async(e,t)=>{let n=this.snapshot.room;if(n===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let r=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:n.id,action:`set-role`,participantId:e,role:t})});return this.applyRoomManagement(r),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};closeRoom=()=>{this.set(this.snapshot.phase===`identity-required`&&this.snapshot.identity!==void 0?{open:!1,phase:`ready`,error:void 0}:{open:!1})};resumeOpen=()=>{let e=this.pendingOpenRoomId;if(e===void 0)return;let t=this.snapshot.rooms.find(t=>t.id===e);t===void 0||!this.openSession(t.sessionId)||(this.pendingOpenRoomId=void 0,this.set({open:!1,error:void 0}))};activateSession=(e,t=`新会话`,n=!0)=>{this.activeNativeSession=e===void 0?void 0:{id:e,title:t,shareable:n};let r=e===void 0?void 0:this.roomForSession(e);if(r===void 0){this.closeEvents(),this.identityPromptedRoomId=void 0,this.updateActiveDocumentRoom(!1),this.set({room:void 0,roomEnsureSessionId:this.roomEnsure?.sessionId===e?e:void 0,connection:`offline`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0});return}this.updateActiveDocumentRoom(!0),this.snapshot.identity===void 0&&this.identityPromptedRoomId!==r.id&&(this.identityPromptedRoomId=r.id,this.set({open:!0})),(this.snapshot.room?.id!==r.id||this.eventSource===void 0)&&(this.set({room:r,roomEnsureSessionId:void 0,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0}),this.clearUnread(),this.openEvents(r))};join=async(e,t)=>{let n=this.snapshot.room,r=this.snapshot.connection,i=this.snapshot.online;this.set({phase:`loading`,error:void 0});try{let a=await Q(`${y}/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({displayName:e,avatarId:t})});if(a.identity===null)throw Error(`服务端没有返回聊天室身份。`);let o=n===void 0?void 0:a.rooms.find(e=>e.id===n.id);this.set({phase:`ready`,open:!1,rooms:a.rooms,room:o,identity:a.identity,connection:o===void 0?`offline`:r,online:o===void 0?0:i,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.set({phase:`identity-required`,error:$(e)})}};addFiles=(e,t)=>{if(t.length===0)return;let n=this.compositionFor(e),r=t.map(e=>({id:`file-${++this.pendingFileSequence}`,file:e}));this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:[...n.files,...r],reply:n.reply,composerError:void 0})};removeFile=(e,t)=>{if(this.snapshot.composerRoomId!==e)return;let n=this.snapshot.pendingFiles.filter(e=>e.id!==t);n.length!==this.snapshot.pendingFiles.length&&(this.compositionRevision+=1,this.set({pendingFiles:n,composerError:void 0}))};setReply=(e,t)=>{let n=this.compositionFor(e);this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:n.files,reply:t,composerError:void 0})};clearReply=e=>{this.snapshot.composerRoomId===e&&this.snapshot.reply!==void 0&&(this.compositionRevision+=1,this.set({reply:void 0,composerError:void 0}))};toggleReaction=async(e,t,n)=>{try{let r=await Q(`${y}/reactions/toggle`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,messageId:t,emoji:n})});this.replaceReaction(r)}catch(e){this.set({composerError:$(e)})}};toggleMessageSelection=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=n.some(e=>e.messageId===t.messageId)?n.filter(e=>e.messageId!==t.messageId):[...n,t];this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!1,forwardError:void 0})};openForward=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=t===void 0||n.some(e=>e.messageId===t.messageId)?n:[t];r.length!==0&&this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!0,forwardError:void 0})};clearMessageSelection=()=>{this.set({selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0})};closeForward=()=>{this.set({forwardOpen:!1,forwardError:void 0})};forwardSelected=async e=>{let t=this.snapshot.selectionRoomId;if(t===void 0||this.snapshot.selectedMessages.length===0||this.snapshot.forwardBusy)return!1;this.set({forwardBusy:!0,forwardError:void 0});try{return await Q(`${y}/forward`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sourceRoomId:t,targetRoomId:e,messages:this.snapshot.selectedMessages})}),this.clearMessageSelection(),!0}catch(e){return this.set({forwardBusy:!1,forwardError:$(e)}),!1}};composition=e=>{let t=this.compositionFor(e);return{roomId:e,revision:this.compositionRevision,files:t.files,reply:t.reply}};completeComposition=e=>{if(this.snapshot.composerRoomId!==e.roomId||this.compositionRevision!==e.revision){this.snapshot.composerBusy&&this.set({composerBusy:!1});return}this.compositionRevision+=1,this.set({composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0})};sendFiles=async e=>{let t=this.composition(e);if(!(t.files.length===0||this.snapshot.composerBusy)){this.set({composerBusy:!0,composerError:void 0});try{let n=await mo(t.files),r=this.snapshot.branchFrame;r?.roomId===e?await po({threadId:r.threadId,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}):await fo({roomId:e,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}),this.completeComposition(t)}catch(e){this.set({composerBusy:!1,composerError:$(e)})}}};selectRoom=async e=>{this.set({error:void 0});try{let t=await Q(`${y}/rooms/select`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:$(e)})}};createRoom=async e=>{this.set({error:void 0});try{let t=await Q(`${y}/rooms`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({title:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:$(e)})}};stopRoomSession=async e=>{if(this.snapshot.sessionControlBusy)return!1;this.set({sessionControlBusy:!0,sessionControlError:void 0});try{let t=await Q(`${y}/rooms/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`stop`})});return this.applyRoomManagement(t),this.set({sessionControlBusy:!1}),!0}catch(e){return this.set({sessionControlBusy:!1,sessionControlError:$(e)}),!1}};newRoomSession=async e=>{if(this.snapshot.sessionControlBusy)return!1;this.set({sessionControlBusy:!0,sessionControlError:void 0});try{let t=await Q(`${y}/rooms/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`new`})});return this.applyRoomManagement(t),this.set({sessionControlBusy:!1}),!0}catch(e){return this.set({sessionControlBusy:!1,sessionControlError:$(e)}),!1}};quickMeeting=async e=>this.createQuickMeeting({roomId:e});quickDirectMeeting=async e=>this.createQuickMeeting({directConversationId:e});loadWecomAuthorization=async()=>{try{let e=await Q(`${y}/wecom/auth`);this.set({wecomAuthorization:e,wecomError:e.error});let t=e.status===`authorized`?this.pendingQuickMeetingTarget:void 0;return t!==void 0&&(this.pendingQuickMeetingTarget=void 0,await this.publishQuickMeeting(t)),e}catch(e){this.set({wecomError:$(e)});return}};startWecomAuthorization=async()=>{if(this.snapshot.wecomBusy)return!1;this.set({wecomBusy:!0,wecomError:void 0});try{let e=await Q(`${y}/wecom/auth`,{method:`POST`});return this.set({wecomBusy:!1,wecomAuthorization:e,wecomAuthorizationOpen:!0}),!0}catch(e){return this.set({wecomBusy:!1,wecomError:$(e)}),!1}};closeWecomAuthorization=()=>{this.pendingQuickMeetingTarget=void 0,this.set({wecomAuthorizationOpen:!1,wecomError:void 0})};async createQuickMeeting(e){if(this.snapshot.wecomBusy)return!1;this.set({wecomBusy:!0,wecomError:void 0});let t=await this.loadWecomAuthorization();return t?.status===`authorized`?this.publishQuickMeeting(e):(this.pendingQuickMeetingTarget=e,this.set({wecomBusy:!1,wecomAuthorizationOpen:!0}),t?.enabled===!0&&t.status===`unauthorized`&&await this.startWecomAuthorization(),!1)}async publishQuickMeeting(e){this.set({wecomBusy:!0,wecomError:void 0});try{return await Q(`${y}/wecom/quick-meeting`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),this.set({wecomBusy:!1}),!0}catch(e){return this.set({wecomBusy:!1,wecomError:$(e)}),!1}}openThread=async(e,t)=>{this.set({membersOpen:!1,threadReply:void 0,threadBusy:!0,threadError:void 0});try{let n=await Q(`${y}/threads/open`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,root:t})});this.set({thread:n.thread,threadMessages:n.messages,...n.messages.length===0?{}:{threadPreviews:io(this.snapshot.threadPreviews,{thread:n.thread,totalMessages:n.messages.length,recentMessages:n.messages.slice(-3)})},threadBusy:!1,threadError:void 0}),this.clearUnread()}catch(e){this.set({threadBusy:!1,threadError:$(e)})}};closeThread=()=>{this.set({thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0})};setThreadReply=e=>{this.snapshot.thread!==void 0&&this.set({threadReply:e,threadError:void 0})};clearThreadReply=()=>{this.snapshot.threadReply!==void 0&&this.set({threadReply:void 0,threadError:void 0})};sendThreadMessage=async e=>{let t=this.snapshot.thread,n=this.snapshot.threadReply;if(t===void 0||this.snapshot.threadBusy||e.trim()===``)return!1;this.set({threadBusy:!0,threadError:void 0});try{return await Q(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({threadId:t.id,mode:`queue`,content:[{type:`text`,text:e}],...n===void 0?{}:{reply:n}})}),this.set({threadReply:void 0,threadBusy:!1,threadError:void 0}),!0}catch(e){return this.set({threadBusy:!1,threadError:$(e)}),!1}};enableSystemNotifications=async()=>{if(typeof Notification>`u`)return;let e=await Notification.requestPermission();this.set({notificationsEnabled:e===`granted`})};dismissToast=e=>{this.set({toasts:this.snapshot.toasts.filter(t=>t.id!==e)})};resetIdentity=async()=>{this.set({open:!0,phase:`identity-required`,error:void 0})};retry=async()=>{this.set({phase:`loading`,error:void 0}),await this.loadSession()};async adminMutation(e){if(this.snapshot.adminBusy)return!1;this.set({adminBusy:!0,adminError:void 0});try{let t=await Q(`${y}/admin`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=`overview`in t?t.overview:t;return this.set({adminBusy:!1,adminOverview:n}),!0}catch(e){return this.set({adminBusy:!1,adminError:$(e)}),!1}}acceptSession(e){if(e.identity===null)throw Error(`服务端没有返回登录账号。`);this.set({phase:`ready`,open:!1,connection:`offline`,rooms:e.rooms,identity:e.identity,auth:uo(e),error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}async ensureActiveSessionRoom(){let e=this.activeNativeSession;if(e===void 0||!e.shareable||this.snapshot.phase!==`ready`||this.snapshot.identity===void 0||this.snapshot.newSessionModes[e.id]!==`group`||this.roomForSession(e.id)!==void 0)return;if(this.roomEnsure?.sessionId===e.id)return await this.roomEnsure.promise;let t=(async()=>{this.set({roomEnsureSessionId:e.id,error:void 0});try{let t=await Q(`${y}/rooms/ensure`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sessionId:e.id,title:e.title})}),n=this.snapshot.rooms.some(e=>e.id===t.room.id)?this.snapshot.rooms.map(e=>e.id===t.room.id?t.room:e):[...this.snapshot.rooms,t.room];this.set({rooms:n,error:void 0}),this.activeNativeSession?.id===e.id&&this.activateSession(e.id,e.title,e.shareable)}catch(t){this.activeNativeSession?.id===e.id&&this.set({roomEnsureSessionId:void 0,error:$(t)})}})();this.roomEnsure={sessionId:e.id,promise:t};try{await t}finally{this.roomEnsure?.promise===t&&(this.roomEnsure=void 0)}}selectAndOpen(e){let t=this.snapshot.rooms.some(t=>t.id===e.id)?this.snapshot.rooms.map(t=>t.id===e.id?e:t):[...this.snapshot.rooms,e];this.pendingOpenRoomId=e.id,this.set({phase:`ready`,rooms:t,room:e,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,error:void 0}),this.openEvents(e),this.resumeOpen()}compositionFor(e){return this.snapshot.composerRoomId===e?{files:this.snapshot.pendingFiles,reply:this.snapshot.reply}:{files:[],reply:void 0}}async loadSession(){try{let e=await Q(`${y}/session`);if(this.stopped)return;let t=uo(e);if(t.enabled&&!t.authenticated){this.closeEvents(),this.closeNotifications(),this.set({phase:`auth-required`,open:!0,connection:`offline`,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}if(e.identity===null){this.closeEvents(),this.set({phase:`identity-required`,open:!0,connection:`offline`,rooms:e.rooms,room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}this.set({phase:`ready`,connection:`offline`,rooms:e.rooms,identity:e.identity,auth:t,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.stopped||this.set({phase:`error`,connection:`offline`,error:$(e)})}}openEvents(e){if(this.closeEvents(),this.stopped||this.snapshot.identity===void 0)return;this.set({connection:`connecting`});let t=new EventSource(`${y}/events?roomId=${encodeURIComponent(e.id)}`);this.eventSource=t,t.onopen=()=>{this.eventSource===t&&this.set({connection:`online`,error:void 0})},t.onmessage=e=>{if(this.eventSource===t)try{this.receive(JSON.parse(e.data))}catch{this.set({error:`收到无法识别的聊天室同步消息。`})}},t.onerror=()=>{this.eventSource===t&&this.set({connection:`connecting`})}}openNotifications(){if(this.stopped||this.snapshot.identity===void 0||this.notificationSource!==void 0)return;let e=new EventSource(`${y}/notifications`);this.notificationSource=e,e.onmessage=t=>{if(this.notificationSource===e)try{let e=JSON.parse(t.data);e.type===`notification`?this.receiveNotification(e.notification):e.type===`direct-message`&&this.receiveDirectMessage(e)}catch{this.set({error:`收到无法识别的消息提醒。`})}}}closeEvents(){this.eventSource?.close(),this.eventSource=void 0}closeNotifications(){this.notificationSource?.close(),this.notificationSource=void 0}receive(e){switch(e.type){case`snapshot`:{let t=so(e.room,e.members),n=ao(this.snapshot.rooms,t);this.set({phase:`ready`,connection:`online`,rooms:n,room:t,identity:e.identity,online:e.online,members:e.members,reactions:e.reactions,recalls:e.recalls??[],threadPreviews:e.threadPreviews,error:void 0});return}case`presence`:{let t=this.snapshot.room===void 0?void 0:so(this.snapshot.room,e.members);this.set({online:e.online,members:e.members,...t===void 0?{}:{room:t,rooms:ao(this.snapshot.rooms,t)}});return}case`thread-message`:this.set({threadPreviews:io(this.snapshot.threadPreviews,e.preview),...this.snapshot.thread?.id!==e.message.threadId||this.snapshot.threadMessages.some(t=>t.id===e.message.id)?{}:{threadMessages:[...this.snapshot.threadMessages,e.message]}});return;case`reaction`:this.replaceReaction(e.reaction);return;case`message-recalled`:this.replaceRecall(e.recall);return;case`room-updated`:this.applyRoomManagement({room:e.room,members:e.members});return}}replaceReaction(e){if(this.snapshot.room?.id!==e.roomId)return;let t=this.snapshot.reactions.filter(t=>t.messageId!==e.messageId||t.emoji!==e.emoji);this.set({reactions:e.participantIds.length===0?t:[...t,e]})}replaceRecall(e){if(this.snapshot.room?.id!==e.roomId)return;let t=this.snapshot.recalls.filter(t=>t.messageId!==e.messageId);this.set({recalls:[...t,e],reactions:this.snapshot.reactions.filter(t=>t.messageId!==e.messageId),selectedMessages:this.snapshot.selectedMessages.filter(t=>t.messageId!==e.messageId)})}applyRoomManagement(e){let t=this.snapshot.rooms.find(t=>t.id===e.room.id),n=t?.pinned!==void 0&&e.room.pinned===void 0?{...e.room,pinned:t.pinned}:e.room,r=oo(this.snapshot.rooms.map(e=>e.id===n.id?n:e)),i=new Set(e.members.map(e=>e.participantId));this.set({rooms:r,...this.snapshot.room?.id===n.id?{room:n,members:e.members}:{},memberCandidates:`candidates`in e?e.candidates:this.snapshot.memberCandidates.filter(e=>!i.has(e.participantId)),managementBusy:!1,managementError:void 0})}receiveNotification(e){if(e.participantId===this.snapshot.identity?.participantId)return;let t=[...this.snapshot.toasts.filter(t=>t.id!==e.id),e].slice(-4),n=typeof document<`u`&&document.visibilityState===`visible`,r=this.snapshot.room?.id===e.roomId&&(e.threadId===void 0||e.threadId===this.snapshot.thread?.id),i=n&&r?this.snapshot.unreadCount:this.snapshot.unreadCount+1,a=oo(this.snapshot.rooms.map(t=>t.id===e.roomId?{...t,updatedAt:Math.max(t.updatedAt??0,e.createdAt)}:t));if(this.set({toasts:t,unreadCount:i,rooms:a}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!n)try{new Notification(`${e.displayName} · ${e.roomTitle}`,{body:e.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${$(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(e.id)},6e3)}receiveDirectMessage(e){let t=co(this.snapshot.directConversations,e.conversation),n=this.snapshot.directConversation?.id===e.conversation.id,r=!n||this.snapshot.directMessages.some(t=>t.id===e.message.id)?this.snapshot.directMessages:[...this.snapshot.directMessages,e.message],i=e.message.senderId===this.snapshot.identity?.participantId,a=typeof document<`u`&&document.visibilityState===`visible`,o=this.snapshot.directOpen&&n;if(this.set({directConversations:t,...n?{directConversation:e.conversation,directMessages:r}:{},unreadCount:i||a&&o?this.snapshot.unreadCount:this.snapshot.unreadCount+1}),!i){let t={id:e.message.id,roomId:`direct:${e.conversation.id}`,roomTitle:`私聊`,participantId:e.message.senderId,displayName:e.conversation.peer.displayName,role:`human`,text:e.message.text,createdAt:e.message.createdAt},n=[...this.snapshot.toasts.filter(e=>e.id!==t.id),t].slice(-4);if(this.set({toasts:n}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!a)try{new Notification(`${e.conversation.peer.displayName} · 私聊`,{body:e.message.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${$(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(t.id)},6e3)}}clearUnread(){this.snapshot.unreadCount!==0&&this.set({unreadCount:0})}updateDocumentTitle(e){typeof document>`u`||this.originalTitle===void 0||(document.title=e===0?this.originalTitle:`(${e}) ${this.originalTitle}`)}updateActiveDocumentRoom(e){typeof document>`u`||document.documentElement.toggleAttribute(`data-dsh-chatroom-active`,e)}set(e){if(!this.stopped){this.snapshot={...this.snapshot,...e},e.unreadCount!==void 0&&this.updateDocumentTitle(this.snapshot.unreadCount);for(let e of this.listeners)e()}}};function io(e,t){return[...e.filter(e=>e.thread.id!==t.thread.id),t]}function ao(e,t){return oo(e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[...e,t])}function oo(e){return[...e].sort((e,t)=>Number(t.pinned===!0)-Number(e.pinned===!0)||(t.updatedAt??0)-(e.updatedAt??0)||e.id.localeCompare(t.id))}function so(e,t){if(e.memberAvatars!==void 0)return e;let n=t.slice(0,9);return{...e,memberAvatarIds:n.map(e=>e.avatarId),memberAvatars:n.map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}}))}}function co(e,t){return[t,...e.filter(e=>e.id!==t.id)].sort((e,t)=>t.updatedAt-e.updatedAt)}function lo(){return typeof Notification>`u`?`unsupported`:Notification.permission}function uo(e){return e.auth??{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1}}async function fo(e,t){return await Q(`${y}/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function po(e,t){return await Q(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function mo(e){return await ho(e.map(({file:e})=>e))}async function ho(e){return await Promise.all(e.map(async e=>{let t=yo(new Uint8Array(await e.arrayBuffer()));return e.type===`image/png`||e.type===`image/jpeg`||e.type===`image/webp`||e.type===`image/gif`?{type:`image`,name:e.name,mediaType:e.type,data:t}:{type:`file`,name:e.name,mediaType:e.type===``?`application/octet-stream`:e.type,data:t}}))}var go=class extends Error{status;constructor(e,t){super(t),this.status=e}};async function Q(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await vo(n);return await n.json()}async function _o(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await vo(n)}async function vo(e){let t=`聊天室请求失败（HTTP ${e.status}）。`;try{let n=await e.json();typeof n.error==`string`&&n.error!==``&&(t=n.error)}catch{}return new go(e.status,t)}function $(e){return e instanceof Error?e.message:String(e)}function yo(e){let t=``;for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}function bo(e,t){let n=e.sessions.prompt,r=async(e,r)=>{let i=String(e.sessionId);if(ya(e.content))return await n(e,r);let a=typeof t.agentTargetForSession==`function`?t.agentTargetForSession(String(e.sessionId)):(()=>{let n=t.roomForSession(String(e.sessionId));return n===void 0?void 0:{kind:`room`,room:n}})(),o=a===void 0&&typeof t.newSessionMode==`function`&&t.newSessionMode(i)===`group`;if(a===void 0&&typeof t.ensurePromptTarget==`function`&&(a=await t.ensurePromptTarget(i)),a===void 0)return await n(e,r);if(t.getSnapshot().identity===void 0)throw Error(`请先选择聊天室身份。`);if(o){let n=t.newGroupInvitees(e.content);if(n.length>0&&!await t.addRoomMembers(n))throw Error(t.getSnapshot().managementError??`无法把提及的成员加入新群聊。`)}typeof t.waitForRoomAutoTrigger==`function`&&await t.waitForRoomAutoTrigger(a.room.id);let s=t.composition(a.room.id),c=await mo(s.files),l=[...e.content,...c];return a.kind===`thread`?await po({threadId:a.threadId,mode:e.mode,content:l,...s.reply===void 0?{}:{reply:s.reply}},r):await fo({roomId:a.room.id,mode:e.mode,content:l,...s.reply===void 0?{}:{reply:s.reply}},r),t.completeComposition(s),{rpcId:`chatroom-human-first`,result:{ok:!0,value:{accepted:!0}}}};return e.sessions.prompt=r,()=>{e.sessions.prompt===r&&(e.sessions.prompt=n)}}let xo=`button[id^="dsh-slash-option-群聊成员-"]`,So=`dsh-chatroom-native-mention-avatar`;function Co(e){let t=()=>{let t=To(e.getSnapshot());for(let e of document.querySelectorAll(xo)){let n=e.firstElementChild,r=n?.nextElementSibling?.textContent?.trim();if(!(n instanceof HTMLElement)||r===void 0||r===``)continue;let i=t.get(r),a=n.querySelector(`:scope > img.${So}`);if(i===void 0){a?.remove(),n.classList.remove(So),delete n.dataset.dshChatroomAvatarFailed;continue}if(a?.src===i||(a?.remove(),n.dataset.dshChatroomAvatarFailed===i))continue;n.classList.add(So);let o=document.createElement(`img`);o.alt=``,o.referrerPolicy=`no-referrer`,o.src=i,o.addEventListener(`error`,()=>{n.dataset.dshChatroomAvatarFailed=i,o.remove(),n.classList.remove(So)},{once:!0}),n.prepend(o)}},n=new MutationObserver(e=>{e.some(wo)&&t()});n.observe(document.body,{childList:!0,subtree:!0});let r=e.subscribe(t);return t(),()=>{r(),n.disconnect();for(let e of document.querySelectorAll(`${xo} img.${So}`)){let t=e.parentElement;e.remove(),t?.classList.remove(So),t!=null&&delete t.dataset.dshChatroomAvatarFailed}}}function wo(e){return[...e.addedNodes].some(e=>e instanceof Element&&(e.matches(xo)||e.querySelector(xo)!==null))}function To(e){let t=new Map;for(let n of e.members){let e=Eo(n.avatarUrl);e!==void 0&&t.set(n.displayName,e)}for(let n of e.directPeers){let r=Eo(n.avatarUrl);r!==void 0&&t.set(no(n,e.directPeers),r)}return t}function Eo(e){if(e!==void 0)try{let t=new URL(e);return t.protocol===`https:`&&t.username===``&&t.password===``&&t.hash===``?t.href:void 0}catch{return}}function Do(e,t,n){let r=e.startSession,i=new Set,a=!1,o=r=>{let o=e.list.getSnapshot(),s=t.list.getSnapshot().current,c=s===void 0?void 0:o.items.find(e=>e.sessionIds.includes(s))?.workspaceId,l=r??c??o.recentWorkspaceId;if(l===void 0){t.clear();return}n(l).then(e=>{if(!a){let n=Oo(t,e,i);n!==void 0&&i.add(n)}},e=>{a||console.warn(`new shared session failed:`,e)})};return e.startSession=o,()=>{a=!0;for(let e of i)e();i.clear(),e.startSession===o&&(e.startSession=r)}}function Oo(e,t,n){let r=!1,i=()=>void 0,a,o=()=>{r||(r=!0,i(),a!==void 0&&clearTimeout(a),n.delete(o))},s=()=>{r||e.list.getSnapshot().byId[t]===void 0||(o(),e.open(t))};if(e.list.getSnapshot().byId[t]!==void 0){e.open(t);return}return i=e.list.subscribe(s),a=setTimeout(()=>{o(),console.warn(`new shared session was not listed within 5000ms`)},5e3),s(),r?void 0:o}function ko(e){let t=e.useChatroom(e=>e),n=e.newSessionMode(String(e.sessionId)),[r,i]=(0,d.useState)(),a=e.session.composerPhase===`blank`&&e.session.nodes.length===0;if((0,d.useEffect)(()=>{a&&n===void 0&&e.registerNewSession(String(e.sessionId))},[a,n,e.registerNewSession,e.sessionId]),(0,d.useEffect)(()=>{if(!a||t.branchFrame!==void 0)return;let e=[...document.querySelectorAll(`span`)].find(e=>e.textContent?.trim()===`探索未至之境`),n=e?.parentElement,r=n?.parentElement,o=n?.nextElementSibling;if(!(o instanceof HTMLElement)||e===void 0||r==null)return;let s=e.textContent;return e.textContent=`今天有什么工作要处理？`,r.setAttribute(`data-dsh-chatroom-new-session-hero`,``),o.setAttribute(`data-dsh-chatroom-new-session-switch-host`,``),i(o),()=>{e.textContent=s,r.removeAttribute(`data-dsh-chatroom-new-session-hero`),o.removeAttribute(`data-dsh-chatroom-new-session-switch-host`)}},[a,e.sessionId,t.branchFrame]),(0,d.useEffect)(()=>{if(!a||r===void 0||n===void 0)return;let e=null,t=r;for(;t!==null&&e===null;)e=t.querySelector(`button[aria-label="选择工作区"]`),t=t.parentElement;let i=e?.querySelector(`span`);if(e===null||i==null)return;let o=i.textContent??``,s=n===`solo`?`Solo`:`群聊`;return i.textContent=s,e.title=o===``?`当前会话类型：${s}`:`当前会话类型：${s}；工作区：${o}`,e.setAttribute(`data-dsh-chatroom-session-mode`,n),()=>{i.textContent=o,e.removeAttribute(`title`),e.removeAttribute(`data-dsh-chatroom-session-mode`)}},[a,n,r]),!a||t.branchFrame!==void 0||n===void 0)return null;let o=n===`solo`?`solo`:`group`,s=(0,p.jsxs)(`div`,{className:`dsh-chatroom-new-mode-switch`,"data-mode":o,role:`group`,"aria-label":`新会话模式`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":o===`group`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`group`)},children:`群聊`}),(0,p.jsx)(`button`,{type:`button`,"data-active":o===`solo`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`solo`)},children:`Solo`})]});return r===void 0?(0,p.jsx)(`section`,{className:`dsh-chatroom-new-mode`,"aria-label":`选择新会话模式`,children:s}):(0,f.createPortal)(s,r)}function Ao(e){if(e.isLoopback)return()=>void 0;let t=e.api,n=t.settings,r=t.credentials,i=t.llm,a={describe:(e,t)=>jo(`settings.describe`,e,t),openDocument:n.openDocument,update:(e,t)=>jo(`settings.update`,e,t),replace:(e,t)=>jo(`settings.replace`,e,t),mutate:(e,t)=>jo(`settings.mutate`,e,t)},o={describe:(e,t)=>jo(`credentials.describe`,e,t),set:(e,t)=>jo(`credentials.set`,e,t),unset:(e,t)=>jo(`credentials.unset`,e,t)},s={...i,discoverModels:(e,t)=>jo(`llm.discoverModels`,e,t)};return t.settings=a,t.credentials=o,t.llm=s,()=>{t.settings===a&&(t.settings=n),t.credentials===o&&(t.credentials=r),t.llm===s&&(t.llm=i)}}async function jo(e,t,n){let r=crypto.randomUUID(),i=await fetch(`${y}/configuration/${e}`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify({type:`client-request`,rpcId:r,method:e,payload:t}),credentials:`same-origin`,...n===void 0?{}:{signal:n}});if(!i.ok)throw Error(await No(i));let a=Mo(await i.json());if(a.rpcId!==r)throw Error(`远程模型设置响应编号不匹配：发送 ${r}，收到 ${String(a.rpcId)}`);return{rpcId:a.rpcId,result:a.result}}function Mo(e){if(typeof e!=`object`||!e||Array.isArray(e))throw Error(`远程模型设置响应格式无效。`);let t=e;if(t.type!==`server-response`||typeof t.rpcId!=`string`||t.result===null||typeof t.result!=`object`||Array.isArray(t.result))throw Error(`远程模型设置响应格式无效。`);let n=t.result;if(n.ok!==!0&&n.ok!==!1)throw Error(`远程模型设置响应格式无效。`);return{rpcId:t.rpcId,result:n}}async function No(e){try{let t=await e.json();if(typeof t==`object`&&t&&!Array.isArray(t)){let e=t.error;if(typeof e==`string`&&e!==``)return e}}catch{}return`远程模型设置请求失败：HTTP ${e.status}`}function Po(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>String(e.sessionId)===t.sessionId);if(n===void 0)return t.roomEnsureSessionId===String(e.sessionId)?(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,disabled:!0,children:`正在建立共享群…`}):null;let r=t.identity,i=t.room?.id===n.id,a=i&&t.connection===`online`?`${t.online} 人在线`:`共享会话`;return(0,p.jsxs)(`span`,{className:`dsh-chatroom-header-actions`,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-identity-action`,title:`当前群聊身份`,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-presence-dot`,"data-online":i&&t.connection===`online`}),r?.displayName??`选择身份`,` · `,a]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,onClick:e.openMembers,children:`群管理`})]})}let Fo=`div[role="treeitem"][aria-selected]`,Io=`data-dsh-chatroom-group-avatar`,Lo=`data-dsh-chatroom-solo-avatar`,Ro=`data-dsh-chatroom-sidebar-category`,zo=`data-dsh-chatroom-workspace-categories`,Bo=`data-dsh-chatroom-category-header`,Vo=`data-dsh-chatroom-direct-row`,Ho=`data-dsh-chatroom-category-wrapper`,Uo=`data-dsh-chatroom-branch-row`,Wo=`data-dsh-chatroom-branch-marker`,Go=`data-dsh-chatroom-branch-surface`,Ko=`data-dsh-chatroom-branch-replies`,qo=`data-dsh-chatroom-native-branch-title`,Jo=`data-dsh-chatroom-branch-count`,Yo=`chatroom-thread-v1-`,Xo=`分支：`,Zo=`data-dsh-chatroom-native-group-section`,Qo=`data-dsh-chatroom-native-folder-wrapper`,$o=`data-dsh-chatroom-native-folder-expand-attempted`,es=`data-dsh-chatroom-native-overflow-button`,ts=`data-dsh-chatroom-native-overflow-expand-attempted`,ns=`data-dsh-chatroom-category-overflow`,rs=`data-dsh-chatroom-overflow-row`,is=`[role="tree"], [role="treeitem"], [role="menu"]`,as=-1e4,os=-6e3,ss=new WeakMap,cs,ls;function us(e,t){if(typeof document>`u`||typeof MutationObserver>`u`)return()=>void 0;let n=!1,r,i,a=()=>{n=!1;let a=t.list.getSnapshot(),s=e.getSnapshot();fs(document,s,a.current,e.setRoomPinned,e.openDirect,e.closeDirect,a);let c=s.phase===`ready`?s.identity?.participantId:void 0;c===void 0?r=void 0:r!==c&&(r=c,e.loadDirectDirectory().then(e=>{e||r!==c||(r=void 0,i=setTimeout(o,2e3))}))},o=()=>{n||(n=!0,queueMicrotask(a))},s=new MutationObserver(e=>{e.some(ds)&&o()});s.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let c=e.subscribe(o),l=t.list.subscribe(o);return o(),()=>{c(),l(),s.disconnect();let e=document.querySelectorAll(`${Fo}, [${Uo}], [data-dsh-chatroom-session-id]`);for(let t of e)Ps(t);i!==void 0&&clearTimeout(i);for(let e of document.querySelectorAll(`[${Ro}]`))Fs(e);for(let e of document.querySelectorAll(`[${zo}]`))Qs(e)}}function ds(e){let t=e.target instanceof Element?e.target:e.target.parentElement;return t!==null&&t.closest(is)!==null||[...e.addedNodes,...e.removedNodes].some(e=>e instanceof Element&&(e.matches(is)||e.querySelector(is)!==null))}function fs(e,t,n,r,i,a,o){let s=[...e.querySelectorAll(Fo)].filter(e=>e.closest(`[${Vo}]`)===null),c=Rs(e,s),l=[...t.rooms],u=[],d=[],f=0,p=0;for(let e of s){hs(e,a);let r=e.getAttribute(`aria-selected`)===`true`,i=_s(e)??(r?n:void 0),s=ps(o,i)??ms(o,e),c=i===void 0?void 0:ys(l,e=>e.sessionId===i),d=ks(e)?.textContent?.trim(),f=s!==void 0&&Cs(s)||d?.startsWith(Xo)===!0||e.dataset.dshChatroomBranchSessionId!==void 0,p=c===void 0&&i===void 0&&!f&&r&&t.room!==void 0?ys(l,e=>e.id===t.room?.id):void 0,m=c??p??bs(l,e),h=Ss(e,i,s,o,t,m);u.push({row:e,sessionId:i,summary:s,branch:h,room:m})}let m=new Map,h=new Set;if(o!==void 0)for(let e of Object.values(o.byId)){if(!Cs(e)||e.parentId===void 0)continue;let t=String(e.id),n=String(e.parentId);h.add(t),m.set(n,(m.get(n)??0)+1)}for(let e of u){let t=e.branch;t!==void 0&&t.parentSessionId!==void 0&&(t.sessionId!==void 0&&h.has(t.sessionId)||t.sessionId===void 0&&o!==void 0&&Object.values(o.byId).some(e=>Cs(e)&&e.displayTitle.trim()===t.displayTitle&&String(e.parentId??``)===t.parentSessionId)||m.set(t.parentSessionId,(m.get(t.parentSessionId)??0)+1))}for(let e of u){let{row:n,sessionId:i,branch:a,room:o}=e;if(o!==void 0){Ms(n),Ts(n,o,xs(o,t),f++,r),Ds(n,o.title,i===void 0?0:m.get(i)??0),Is(n,`group`),d.push(n);continue}if(Ns(n),a!==void 0){n.dataset.dshChatroomBranchRow!==void 0&&n.dataset.dshChatroomBranchSessionId!==a.sessionId&&Ms(n),Es(n,a),n.style.order=String(as+f++),n.querySelector(`:scope > [${Lo}]`)?.remove(),Is(n,`group`),d.push(n);continue}if(Ms(n),!gs(n)){Fs(n);continue}n.removeAttribute(Uo),Ls(n,p++),Is(n,`solo`),d.push(n)}zs(e,c,d,t,i),ec(e,t,r)}function ps(e,t){if(e!==void 0&&t!==void 0)return e.byId[t]}function ms(e,t){if(e===void 0)return;let n=ks(t)?.textContent?.trim();if(n===void 0||!n.startsWith(Xo))return;let r=Object.values(e.byId).filter(e=>Cs(e)&&e.displayTitle.trim()===n);return r.length===1?r[0]:void 0}function hs(e,t){e.dataset.dshChatroomDirectCloseBound!==`true`&&(e.dataset.dshChatroomDirectCloseBound=`true`,e.addEventListener(`click`,e=>{e.target.closest(`button[aria-label]`)===null&&t?.()}))}function gs(e){return!e.hasAttribute(`aria-expanded`)&&(e.getAttribute(`aria-selected`)===`true`||e.querySelector(`button[aria-label]`)!==null||e.dataset.dshChatroomRoomRow!==void 0)}function _s(e){if(e.dataset.dshChatroomSessionId!==void 0)return e.dataset.dshChatroomSessionId;if(e.draggable!==!0)return;let t=e.ownerDocument.defaultView?.Event;if(t===void 0)return;let n=new Map,r={effectAllowed:`uninitialized`,dropEffect:`none`,setData:(e,t)=>n.set(e,t),getData:e=>n.get(e)??``,clearData:e=>e===void 0?n.clear():n.delete(e)},i;try{let a=new t(`dragstart`,{bubbles:!0,cancelable:!0});Object.defineProperty(a,"dataTransfer",{value:r}),e.dispatchEvent(a),i=n.get(`text/plain`)}catch{i=void 0}finally{try{let n=new t(`dragend`,{bubbles:!0});Object.defineProperty(n,"dataTransfer",{value:r}),e.dispatchEvent(n)}catch{}}if(i!==void 0&&i.length!==0)return e.dataset.dshChatroomSessionId=i,i}function vs(e,t){return[...e.querySelectorAll(`span`)].some(e=>!e.closest(`[${Go}]`)&&e.childElementCount===0&&e.textContent?.trim()===t)}function ys(e,t){let n=e.findIndex(t);if(!(n<0))return e.splice(n,1)[0]}function bs(e,t){let n=e.filter(e=>vs(t,e.title));return n.length===1?ys(e,e=>e.id===n[0]?.id):void 0}function xs(e,t){return e.memberAvatars===void 0?e.memberAvatarIds===void 0?t.room?.id===e.id&&t.members.length>0?t.members.slice(0,9).map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}})):[]:e.memberAvatarIds.slice(0,9).map((e,t)=>({participantId:String(t),avatarId:e})):e.memberAvatars.slice(0,9)}function Ss(e,t,n,r,i,a){if(a!==void 0||t!==void 0&&i.rooms.some(e=>e.sessionId===t))return;let o=ks(e)?.textContent?.trim(),s=n?.displayTitle.trim(),c=t?.startsWith(Yo)===!0,l=s?.startsWith(Xo)===!0||o?.startsWith(Xo)===!0;if(n!==void 0&&!Cs(n)&&!c)return;let u=n!==void 0&&Cs(n);if(c&&o!==void 0&&!o.startsWith(Xo)&&!u){e.dataset.dshChatroomSessionId===t&&delete e.dataset.dshChatroomSessionId;return}if(!c&&!l)return;let d=s??o??Xo,f=ws(d),p=t===void 0?void 0:(i.threadPreviews??[]).find(e=>e.thread.sessionId===t),m=p===void 0?void 0:i.rooms.find(e=>e.id===p.thread.roomId),h=n?.parentId===void 0?p?.thread.root.sourceSessionId??m?.sessionId:String(n.parentId),g=ps(r,h);return{sessionId:t,displayTitle:d,topic:f,parentSessionId:h,parentTitle:(h===void 0?void 0:i.rooms.find(e=>e.sessionId===h))?.title??g?.displayTitle??m?.title,replyCount:p!==void 0&&p.totalMessages>0?p.totalMessages:void 0}}function Cs(e){return String(e.id).startsWith(Yo)||e.parentId!==void 0&&e.displayTitle.trim().startsWith(Xo)}function ws(e){let t=e.trim(),n=t.startsWith(Xo)?t.slice(3).trim():t;return n===``?`未命名主题`:n}function Ts(e,t,n,r,i){e.dataset.dshChatroomRoomRow=``,e.dataset.dshChatroomRoomId=t.id,e.dataset.pinned=String(t.pinned===!0),e.style.order=String(as+r),e.parentElement?.setAttribute(`data-dsh-chatroom-room-list`,``),$s(e,t),e.querySelector(`:scope > [${Lo}]`)?.remove();let a=n.map(e=>`${e.participantId}:${e.avatarId}:${e.avatarUrl??``}`).join(`|`)||`empty`,o=e.querySelector(`:scope > [${Io}]`);if(o?.dataset.signature===a)return;o?.remove(),o=e.ownerDocument.createElement(`span`),o.setAttribute(Io,``),o.dataset.count=String(Math.max(1,n.length)),o.dataset.signature=a,o.setAttribute(`aria-hidden`,`true`);let s=n.length===0?[{emoji:`✦`}]:n.map(e=>({...e,emoji:_(e.avatarId,e.participantId).emoji}));for(let t of s){let n=e.ownerDocument.createElement(`span`);if(t.avatarUrl===void 0)n.textContent=t.emoji;else{let r=e.ownerDocument.createElement(`img`);r.src=t.avatarUrl,r.alt=``,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>{r.remove(),n.textContent=t.emoji},{once:!0}),n.append(r)}o.append(n)}e.prepend(o)}function Es(e,t){e.dataset.dshChatroomBranchRow=``,t.sessionId===void 0?delete e.dataset.dshChatroomBranchSessionId:e.dataset.dshChatroomBranchSessionId=t.sessionId,t.parentSessionId===void 0?delete e.dataset.dshChatroomBranchParentSessionId:e.dataset.dshChatroomBranchParentSessionId=t.parentSessionId,e.dataset.dshChatroomBranchTopic=t.topic,t.parentTitle===void 0?delete e.dataset.dshChatroomBranchParentTitle:e.dataset.dshChatroomBranchParentTitle=t.parentTitle,t.replyCount===void 0?e.removeAttribute(Ko):e.setAttribute(Ko,String(t.replyCount));let n=t.parentTitle===void 0?`来自群聊`:`来自 ${t.parentTitle}`,r=t.replyCount===void 0?``:` · ${t.replyCount} 条回复`,i=t.parentTitle===void 0&&t.replyCount===void 0?`分支会话：${t.topic}`:`分支会话：${t.topic}，${n}${r}`;js(e,i),e.setAttribute(`aria-label`,i),e.setAttribute(`title`,i);let a=ks(e,t.displayTitle);a?.setAttribute(qo,``);let o=e.querySelector(`:scope > [${Wo}]`);o===null&&(o=e.ownerDocument.createElement(`span`),o.setAttribute(Wo,``),o.setAttribute(`aria-hidden`,`true`),o.textContent=`↳`);let s=e.querySelector(`:scope > [${Go}]`);s===null&&(s=e.ownerDocument.createElement(`span`),s.setAttribute(Go,``),s.setAttribute(`aria-hidden`,`true`));let c=`${t.topic}|${t.parentTitle??``}|${t.replyCount??``}`;if(s.dataset.signature!==c){s.replaceChildren();let i=e.ownerDocument.createElement(`span`);i.setAttribute(`data-dsh-chatroom-branch-heading`,``);let a=e.ownerDocument.createElement(`span`);a.setAttribute(`data-dsh-chatroom-branch-badge`,``),a.textContent=`分支`;let o=e.ownerDocument.createElement(`span`);o.setAttribute(`data-dsh-chatroom-branch-topic`,``),o.textContent=t.topic,i.append(a,o);let l=e.ownerDocument.createElement(`span`);l.setAttribute(`data-dsh-chatroom-branch-parent`,``),l.textContent=`${n}${r}`,s.append(i,l),s.dataset.signature=c}a===void 0?(o.parentElement!==e||s.parentElement!==e)&&e.append(o,s):(a.previousElementSibling!==s||s.previousElementSibling!==o)&&a.before(o,s)}function Ds(e,t,n){if(n===0){Os(e);return}e.dataset.dshChatroomHasBranches=``,e.dataset.dshChatroomBranchCount=String(n);let r=e.querySelector(`:scope > [${Jo}]`);if(r===null){r=e.ownerDocument.createElement(`span`),r.setAttribute(Jo,``);let n=ks(e,t);n===void 0?e.append(r):n.after(r)}let i=`分支 ${n}`;r.textContent!==i&&(r.textContent=i),r.setAttribute(`title`,`${n} 个分支`),r.setAttribute(`aria-label`,`${n} 个分支`)}function Os(e){delete e.dataset.dshChatroomHasBranches,delete e.dataset.dshChatroomBranchCount,e.querySelector(`:scope > [${Jo}]`)?.remove()}function ks(e,t){let n=[...e.querySelectorAll(`span`)].filter(e=>!e.closest(`[${Go}]`)&&!e.hasAttribute(Wo)&&!e.hasAttribute(Jo)&&e.childElementCount===0);if(t!==void 0){let e=n.find(e=>e.textContent?.trim()===t);if(e!==void 0)return e}return n.find(e=>e.textContent?.trim().startsWith(Xo))??n.find(e=>e.dataset.dshChatroomNativeBranchTitle!==void 0)??n.filter(e=>{let t=e.textContent?.trim()??``;return t!==``&&!As(t)&&t!==`●`}).sort((e,t)=>(t.textContent?.trim().length??0)-(e.textContent?.trim().length??0))[0]}function As(e){return/^(?:刚刚|现在|now|\d+\s*(?:秒|分钟|小时|天|周|月|年|s|min|h|d|w))$/iu.test(e)}function js(e,t){let n=ss.get(e);if(n===void 0){ss.set(e,{ariaLabel:e.getAttribute(`aria-label`),title:e.getAttribute(`title`),appliedAriaLabel:t,appliedTitle:t});return}let r=e.getAttribute(`aria-label`)===n.appliedAriaLabel?n.ariaLabel:e.getAttribute(`aria-label`),i=e.getAttribute(`title`)===n.appliedTitle?n.title:e.getAttribute(`title`);ss.set(e,{ariaLabel:r,title:i,appliedAriaLabel:t,appliedTitle:t})}function Ms(e){delete e.dataset.dshChatroomBranchRow,delete e.dataset.dshChatroomBranchSessionId,delete e.dataset.dshChatroomBranchParentSessionId,delete e.dataset.dshChatroomBranchTopic,delete e.dataset.dshChatroomBranchParentTitle,e.removeAttribute(Ko),e.querySelector(`:scope > [${Wo}]`)?.remove(),e.querySelector(`:scope > [${Go}]`)?.remove();for(let t of e.querySelectorAll(`[${qo}]`))t.removeAttribute(qo);let t=ss.get(e);t!==void 0&&(e.getAttribute(`aria-label`)===t.appliedAriaLabel&&(t.ariaLabel===null?e.removeAttribute(`aria-label`):e.setAttribute(`aria-label`,t.ariaLabel)),e.getAttribute(`title`)===t.appliedTitle&&(t.title===null?e.removeAttribute(`title`):e.setAttribute(`title`,t.title)),ss.delete(e))}function Ns(e){delete e.dataset.dshChatroomRoomRow,delete e.dataset.dshChatroomRoomId,delete e.dataset.pinned,Os(e),e.querySelector(`:scope > [${Io}]`)?.remove()}function Ps(e){Ms(e),Ns(e),delete e.dataset.dshChatroomSessionId,delete e.dataset.dshChatroomBranchSessionId,e.style.removeProperty(`order`)}function Fs(e){Ps(e),e.removeAttribute(Ro),e.removeAttribute(Uo),e.removeAttribute(rs),e.querySelector(`:scope > [${Lo}]`)?.remove();let t=e.parentElement;t?.removeAttribute(Ho),t?.removeAttribute(rs),t?.style.removeProperty(`order`)}function Is(e,t){e.setAttribute(Ro,t);let n=e.closest(`[role="tree"]`),r=e.parentElement;n!==null&&r!==null&&r!==n&&(r.setAttribute(Ho,t),r.style.order=e.style.order)}function Ls(e,t){if(e.style.order=String(os+t),e.querySelector(`:scope > [${Lo}]`)!==null)return;let n=e.ownerDocument.createElement(`span`);n.setAttribute(Lo,``),n.setAttribute(`aria-hidden`,`true`),n.textContent=`✦`,e.prepend(n)}function Rs(e,t){return t.find(e=>e.closest(`[role="tree"]`)!==null)?.closest(`[role="tree"]`)??e.querySelector(`[role="tree"]`)??t[0]?.parentElement??void 0}function zs(e,t,n,r,i){for(let n of e.querySelectorAll(`[${zo}]`))n!==t&&Qs(n);if(t===void 0)return;t.setAttribute(zo,``),Bs(t),Vs(t);let a=n.filter(e=>e.getAttribute(Ro)===`group`),o=n.filter(e=>e.getAttribute(Ro)===`solo`);qs(t,`group`,`群聊`,a.length,-11e3),Ws(t,`group`,a,as),qs(t,`solo`,`Solo`,o.length,-7e3),Ws(t,`solo`,o,os);let s=Js(r.directPeers??[],r.directConversations??[]);qs(t,`direct`,`私聊`,s.length,-3e3),Ys(t,s,r,i)}function Bs(e){for(let t of e.querySelectorAll(`[${Zo}]`))t.removeAttribute(Zo);for(let t of e.querySelectorAll(`[${Qo}]`))t.removeAttribute(Qo),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`);for(let t of e.querySelectorAll(`div[role="treeitem"]`)){let n=Ks(e,t);if(n!==void 0&&n!==t&&n.setAttribute(Zo,``),!t.hasAttribute(`aria-expanded`))continue;let r=t.parentElement;if(r===null)continue;let i=r.querySelectorAll(`div[role="treeitem"]`).length>1?t:r;i.setAttribute(Qo,``),i.dataset.hidden=`true`,t.getAttribute(`aria-expanded`)===`true`?t.removeAttribute($o):t.getAttribute(`aria-expanded`)===`false`&&!t.hasAttribute($o)&&(t.setAttribute($o,``),t.click())}}function Vs(e){for(let t of e.querySelectorAll(`[${Zo}]`)){let e=t.querySelector(`:scope > button[aria-expanded]`);e!==null&&(e.setAttribute(es,``),e.style.removeProperty(`order`),e.getAttribute(`aria-expanded`)===`true`?e.removeAttribute(ts):e.hasAttribute(ts)||(e.setAttribute(ts,``),e.click()))}}function Hs(e){return`data-dsh-chatroom-${e}-overflow-expanded`}function Us(e){let t=e.parentElement;return t===null||!t.hasAttribute(Ho)||t.querySelectorAll(`div[role="treeitem"]`).length>1?e:t}function Ws(e,t,n,r){let i=n.length>8;n.forEach((e,n)=>{let r=Us(e);i&&n>=8?r.setAttribute(rs,t):r.removeAttribute(rs)});let a=e.querySelector(`:scope > [${ns}="${t}"]`);if(!i){a?.remove();return}if(a===null){a=e.ownerDocument.createElement(`div`),a.setAttribute(ns,t);let n=e.ownerDocument.createElement(`button`);n.type=`button`;let i=a;n.onclick=()=>{let n=Hs(t);e.setAttribute(n,String(e.getAttribute(n)!==`true`)),Gs(e,i,t,r)},a.append(n),e.append(a)}a.dataset.total=String(n.length),Gs(e,a,t,r)}function Gs(e,t,n,r){let i=Number(t.dataset.total??`0`),a=e.getAttribute(Hs(n))===`true`;t.style.order=String(r+(a?i:8));let o=t.querySelector(`button`);if(o===null)return;o.setAttribute(`aria-expanded`,String(a));let s=a?`收起`:`展开其余 ${String(i-8)} 个会话`;o.textContent!==s&&(o.textContent=s)}function Ks(e,t){let n=t;for(;n?.parentElement!==null&&n.parentElement!==e;)n=n.parentElement;return n?.parentElement===e?n:void 0}function qs(e,t,n,r,i){let a=e.querySelector(`:scope > [${Bo}="${t}"]`);if(a===null){a=e.ownerDocument.createElement(`div`),a.setAttribute(Bo,t);let n=e.ownerDocument.createElement(`button`);n.type=`button`,n.setAttribute(`aria-expanded`,`true`),n.innerHTML=`<span data-chevron aria-hidden>⌄</span><span data-folder-icon aria-hidden></span><strong></strong><small></small>`,n.onclick=()=>{let r=e.getAttribute(`data-dsh-chatroom-${t}-collapsed`)===`true`;e.setAttribute(`data-dsh-chatroom-${t}-collapsed`,String(!r)),n.setAttribute(`aria-expanded`,String(r));let i=n.querySelector(`[data-chevron]`);i!==null&&(i.textContent=r?`⌄`:`›`)},a.append(n),e.append(a)}a.style.order=String(i);let o=a.querySelector(`strong`),s=a.querySelector(`small`),c=a.querySelector(`[data-folder-icon]`);if(c!==null&&c.childElementCount===0){let t=e.querySelector(`div[role="treeitem"][aria-expanded] svg[width="16"]`);t!==null&&c.append(t.cloneNode(!0))}o?.textContent!==n&&(o.textContent=n);let l=String(r);s?.textContent!==l&&(s.textContent=l)}function Js(e,t){let n=new Map(t.map(e=>[e.peer.participantId,e])),r=new Map(e.map(e=>[e.participantId,e]));for(let e of t)r.set(e.peer.participantId,e.peer);return[...r.values()].sort((e,t)=>{let r=n.get(e.participantId)?.updatedAt??0;return(n.get(t.participantId)?.updatedAt??0)-r||e.displayName.localeCompare(t.displayName,`zh-CN`)})}function Ys(e,t,n,r){let i=new Map([...e.querySelectorAll(`:scope > [${Vo}]`)].map(e=>[e.dataset.peerId??``,e]));t.forEach((t,a)=>{let o=i.get(t.participantId);o===void 0&&(o=e.ownerDocument.createElement(`div`),o.setAttribute(Vo,``),o.dataset.peerId=t.participantId,o.innerHTML=`<button type="button"><span data-avatar></span><span><strong></strong><small></small></span></button>`,e.append(o)),i.delete(t.participantId),o.style.order=String(-2900+a),o.dataset.active=String(n.directConversation?.peer.participantId===t.participantId);let s=o.querySelector(`button`);s.setAttribute(`aria-label`,`与 ${t.displayName} 私聊`),s.onclick=()=>{r?.(t.participantId)};let c=o.querySelector(`strong`),l=o.querySelector(`small`);c.textContent!==t.displayName&&(c.textContent=t.displayName);let u=n.directConversations.find(e=>e.peer.participantId===t.participantId),d=u===void 0?`@${t.username}`:Zs(u.updatedAt);l.textContent!==d&&(l.textContent=d),Xs(o.querySelector(`[data-avatar]`),t)});for(let e of i.values())e.remove()}function Xs(e,t){let n=`${t.participantId}:${t.avatarId}:${t.avatarUrl??``}`;if(e.dataset.signature===n)return;e.dataset.signature=n,e.replaceChildren();let r=_(t.avatarId,t.participantId).emoji;if(t.avatarUrl===void 0){e.textContent=r;return}let i=e.ownerDocument.createElement(`img`);i.src=t.avatarUrl,i.alt=``,i.referrerPolicy=`no-referrer`,i.addEventListener(`error`,()=>{i.remove(),e.textContent=r},{once:!0}),e.append(i)}function Zs(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${String(t)}分钟`:t<1440?`${String(Math.floor(t/60))}小时`:`${String(Math.floor(t/1440))}天`}function Qs(e){e.removeAttribute(zo),e.removeAttribute(`data-dsh-chatroom-group-collapsed`),e.removeAttribute(`data-dsh-chatroom-solo-collapsed`),e.removeAttribute(`data-dsh-chatroom-direct-collapsed`),e.removeAttribute(Hs(`group`)),e.removeAttribute(Hs(`solo`));let t=`:scope > [${Bo}], :scope > [${Vo}], :scope > [${ns}]`;for(let n of e.querySelectorAll(t))n.remove();for(let t of e.querySelectorAll(`[${rs}]`))t.removeAttribute(rs);for(let t of e.querySelectorAll(`[${Zo}]`))t.removeAttribute(Zo);for(let t of e.querySelectorAll(`[${Qo}], [${Ho}]`))t.removeAttribute(Qo),t.removeAttribute(Ho),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`);for(let t of e.querySelectorAll(`[${$o}]`))t.removeAttribute($o);for(let t of e.querySelectorAll(`[${es}]`))t.removeAttribute(es),t.removeAttribute(ts),t.style.removeProperty(`order`)}function $s(e,t){let n=e.querySelector(`button[aria-label]`);n!==null&&(n.dataset.dshChatroomNativeMenuRoomId=t.id,n.dataset.dshChatroomNativeMenuBound!==`true`&&(n.dataset.dshChatroomNativeMenuBound=`true`,n.addEventListener(`click`,()=>{cs=n.dataset.dshChatroomNativeMenuRoomId,ls=void 0})))}function ec(e,t,n){if(ls!==void 0){ls.isConnected||(ls=void 0,cs=void 0);return}let r=t.rooms.find(e=>e.id===cs);if(r===void 0)return;let i=[...e.querySelectorAll(`[role="menu"]`)].at(-1)?.querySelector(`:scope > [role="presentation"]`),a=i?.querySelector(`:scope > *`),o=a?.querySelector(`:scope > button[role="menuitem"]`);if(i==null||a==null||o==null)return;let s=e.createElement(a.tagName.toLowerCase());s.className=a.className,s.dataset.dshChatroomPinMenuItem=``;let c=e.createElement(`button`);c.type=`button`,c.role=`menuitem`,c.className=o.className;let l=e.createElement(`span`);l.className=o.querySelector(`:scope > :first-child`)?.className??``;let u=e.createElementNS(`http://www.w3.org/2000/svg`,`svg`);u.setAttribute(`width`,`16`),u.setAttribute(`height`,`16`),u.setAttribute(`viewBox`,`0 0 16 16`);let d=e.createElementNS(`http://www.w3.org/2000/svg`,`path`);d.setAttribute(`d`,`M5 1.75h6l-1 4.1 2 2V9H8.65v5.25h-1.3V9H4V7.85l2-2-1-4.1Z`),d.setAttribute(`fill`,`currentColor`),u.append(d),l.append(u);let f=e.createElement(`span`);f.className=o.querySelector(`:scope > :last-child`)?.className??``,f.textContent=r.pinned===!0?`取消置顶`:`置顶群聊`,c.append(l,f),c.onclick=t=>{t.stopPropagation(),n?.(r.id,r.pinned!==!0),e.dispatchEvent(new KeyboardEvent(`keydown`,{key:`Escape`,bubbles:!0}))},s.append(c),i.append(s),ls=s}let tc=`data-dsh-chatroom-settings-nav`;function nc(e){if(typeof document>`u`||typeof MutationObserver>`u`)return()=>void 0;let t=!1,n=()=>{if(t)return;let n=e().trim(),r=document.querySelectorAll(`[role="dialog"] nav button`);for(let e of r)n.length>0&&e.textContent?.trim()===n?e.setAttribute(tc,``):e.removeAttribute(tc)};n();let r=new MutationObserver(n);return r.observe(document.body??document.documentElement,{childList:!0,subtree:!0,characterData:!0}),()=>{t=!0,r.disconnect(),document.querySelectorAll(`[${tc}]`).forEach(e=>{e.removeAttribute(tc)})}}let rc=[`connection`,`inputTriggers`,`sessions`,`settingsScope`,`slots`,`workspaces`];function ic(e){let t=e.get(`connection`);if(t===void 0)throw Error(`chatroom: client connection service unavailable`);let n=e.get(`sessions`);if(n===void 0)throw Error(`chatroom: client sessions service unavailable`);let r=e.get(`workspaces`);if(r===void 0)throw Error(`chatroom: client workspaces service unavailable`);let i=e.get(`inputTriggers`);if(i===void 0)throw Error(`chatroom: input trigger service unavailable`);let a=typeof location>`u`?void 0:T(location),o=new ro(e=>{let t=e,r=n.list.getSnapshot();return r.current===t||r.byId[t]!==void 0&&(n.open(t),!0)},a);e.effect(()=>Do(r,n,async e=>{let n=await t.api.sessions.create({workspaceId:e});if(!n.result.ok)throw Error(`new shared session failed: ${n.result.error.code}: ${n.result.error.message}`);let r=n.result.value.sessionId;return o.registerNewSession(String(r)),r}),`chatroom: distinct native New Session`),e.effect(()=>{document.documentElement.setAttribute(`data-dsh-chatroom-installed`,``),a!==void 0&&document.documentElement.setAttribute(`data-dsh-chatroom-branch-frame`,``);let r=()=>{a!==void 0&&document.querySelector(`[data-shell-overlay]`)?.parentElement?.setAttribute(`data-dsh-chatroom-branch-shell`,``)},i=a===void 0?void 0:new MutationObserver(r);i?.observe(document.body,{childList:!0,subtree:!0}),r();let s=document.createElement(`style`);s.dataset.dshChatroomStyles=``,s.textContent=`
...
`,document.head.append(s);let c=Ao(t),l=ac(e.get(`settingsScope`)),u=bo(t.api,o),d=us(o,n),f=Co(o),p=a,m=!1,h=()=>{let e=p;if(e===void 0||m)return;let t=n.list.getSnapshot();ae(e,{current:t.current===void 0?void 0:String(t.current),byId:t.byId},e=>{n.open(e)})&&(m=!0,ne(e.parentSessionId),oe(e))},g=e=>{if(a===void 0||e.origin!==globalThis.location.origin||e.source!==globalThis.parent)return;let t=k(e.data);if(t!==void 0){if(p!==void 0&&te(p,t)){h();return}p=t,m=!1,le(),o.switchBranchFrame(t),h()}};globalThis.addEventListener(`message`,g);let _=()=>{h(),o.resumeOpen();let e=n.list.getSnapshot(),t=e.current,r=t===void 0?void 0:e.byId[t];t!==void 0&&r?.blank===!0&&r.origin!==`subagent`&&o.roomForSession(String(t))===void 0&&o.newSessionMode(String(t))===void 0&&o.registerNewSession(String(t)),o.activateSession(t===void 0?void 0:String(t),r?.displayTitle??`新会话`,a===void 0&&r?.origin!==`subagent`)},v=n.list.subscribe(_);return o.start().then(async()=>{if(_(),typeof location>`u`)return;let e=E(location,a);e!==void 0&&await o.selectRoom(e)}),()=>{v(),globalThis.removeEventListener(`message`,g),u(),f(),d(),l(),c(),o.stop(),s.remove(),i?.disconnect(),document.documentElement.removeAttribute(`data-dsh-chatroom-installed`),a!==void 0&&(le(),document.documentElement.removeAttribute(`data-dsh-chatroom-branch-frame`))}},`chatroom: browser state and styles`);let s=uc(o),c=dc(o);e.effect(()=>i.registerSource(s),`chatroom: AI mention source`),e.effect(()=>i.registerSource(c),`chatroom: member mention source`),e.slots.inject(`shell.overlay`,()=>e.slots.register({name:`shell.overlay`,id:`chatroom`,order:0,inject:()=>({hooks:{chatroom:o},openRoom:o.openRoom,closeRoom:o.closeRoom,join:o.join,login:o.login,register:o.register,logout:o.logout,openAccount:o.openAccount,closeAccount:o.closeAccount,changePassword:o.changePassword,selectRoom:o.selectRoom,createRoom:o.createRoom,resetIdentity:o.resetIdentity,retry:o.retry,closeMembers:o.closeMembers,renameRoom:o.renameRoom,setMemberRole:o.setMemberRole,addRoomMembers:o.addRoomMembers,setRoomAutoTrigger:o.setRoomAutoTrigger,closeThread:o.closeThread,setThreadReply:o.setThreadReply,clearThreadReply:o.clearThreadReply,sendThreadMessage:o.sendThreadMessage,enableSystemNotifications:o.enableSystemNotifications,dismissToast:o.dismissToast,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,closeForward:o.closeForward,forwardSelected:o.forwardSelected,toggleMessageSelection:o.toggleMessageSelection,clearMessageSelection:o.clearMessageSelection,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect,quickDirectMeeting:o.quickDirectMeeting,loadWecomAuthorization:o.loadWecomAuthorization,startWecomAuthorization:o.startWecomAuthorization,closeWecomAuthorization:o.closeWecomAuthorization})},aa)),e.slots.inject(`settings.section`,()=>e.slots.register({name:`settings.section`,id:`chatroom`,order:30,label:()=>`群聊与账号`,inject:()=>({hooks:{chatroom:o},closeAccount:o.closeAccount,changePassword:o.changePassword,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect,quickDirectMeeting:o.quickDirectMeeting,loadWecomAuthorization:o.loadWecomAuthorization,startWecomAuthorization:o.startWecomAuthorization,closeWecomAuthorization:o.closeWecomAuthorization})},P)),e.effect(()=>nc(()=>`群聊与账号`),`chatroom: settings navigation icon`),e.slots.inject(`conversation.session.header.actions`,()=>e.slots.register({name:`conversation.session.header.actions`,id:`chatroom-identity`,order:-5,inject:()=>({hooks:{chatroom:o},openMembers:o.openMembers})},Po)),e.slots.inject(`conversation.input.left`,()=>e.slots.register({name:`conversation.input.left`,id:`chatroom-files`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},Fa)),e.slots.inject(`conversation.input.right`,()=>e.slots.register({name:`conversation.input.right`,id:`chatroom-session-controls`,order:-30,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),stopRoomSession:o.stopRoomSession,newRoomSession:o.newRoomSession,quickMeeting:o.quickMeeting})},Ia)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-group-setup`,order:-30,inject:()=>({hooks:{chatroom:o},registerNewSession:o.registerNewSession,newSessionMode:o.newSessionMode,chooseNewSessionMode:o.chooseNewSessionMode})},ko)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-composition`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},La)),e.slots.inject(`conversation.input.attachments`,()=>cc(()=>e.slots.entries(`conversation.input.attachments`).find(e=>(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.input.attachments`,t),t=>e.slots.register({name:`conversation.input.attachments`,priority:-10,locale:`conversation`,inject:()=>({hooks:{chatroom:o},nativeAttachmentsView:t,clearReply:o.clearReply,resolveTarget:o.agentTargetForSession.bind(o)})},za))),e.slots.inject(`conversation.chat.assistant-actions`,()=>e.slots.register({name:`conversation.chat.assistant-actions`,id:`chatroom-reply`,order:5,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),setReply:o.setReply,openThread:o.openThread,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,toggleMessageSelection:o.toggleMessageSelection})},fa)),e.slots.inject(`conversation.chat.node`,()=>cc(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`assistant-step`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`assistant-step`,priority:-10,locale:`conversation`,inject:()=>({nativeMessageView:t,resolveTarget:o.agentTargetForSession.bind(o)})},Na))),e.slots.inject(`conversation.chat.node`,()=>cc(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`user`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`user`,priority:-10,locale:`conversation`,inject:()=>lc(o,t)},Ua))),e.slots.inject(`conversation.chat.node`,()=>cc(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`steering`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`steering`,priority:-10,locale:`conversation`,inject:()=>lc(o,t)},Wa)))}function ac(e){if(!oc(e))return()=>void 0;let t=e.describe();return!sc(t)||t.persistence!==`memory`?()=>void 0:(t.persistence=`host`,t.load(),()=>{t.persistence===`host`&&(t.persistence=`memory`)})}function oc(e){return typeof e==`object`&&!!e&&typeof e.describe==`function`}function sc(e){return typeof e==`object`&&!!e&&(e.persistence===`host`||e.persistence===`memory`)&&typeof e.load==`function`}function cc(e,t,n){let r,i,a=()=>{let t=e();if(t===r)return;let a=i;i=void 0,r=void 0,a?.(),t!==void 0&&(r=t,i=n(t))},o=t(a);return a(),()=>{o(),i?.(),i=void 0,r=void 0}}function lc(e,t){return{hooks:{chatroom:e},resolveTarget:e.agentTargetForSession.bind(e),nativeMessageView:t,setReply:e.setReply,openThread:e.openThread,toggleReaction:e.toggleReaction,recallMessage:e.recallMessage,openForward:e.openForward,toggleMessageSelection:e.toggleMessageSelection}}function uc(e){return{trigger:`@`,name:`AI 助手`,order:-100,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];let a=[{name:pc(r?.aiDisplayName??`DeepSeek`),icon:`✦`,description:r===void 0?`创建群聊后立即回复`:`提及后回复`}],o=n.toLocaleLowerCase();return a.filter(e=>e.name.toLocaleLowerCase().includes(o))},lexicon(t){let n=e.roomForSession(String(t.sessionId));return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[`AI`,`DeepSeek`]:[]:[...new Set([`AI`,n.aiDisplayName])]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${mc(e.name)} `}}}}function dc(e){return{trigger:`@`,name:`群聊成员`,order:-90,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];i&&e.getSnapshot().directPeers.length===0&&await e.loadDirectDirectory();let a=e.getSnapshot(),o=r===void 0?a.directPeers.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:no(e,a.directPeers),icon:_(e.avatarId,e.participantId).emoji,description:`创建群聊时自动邀请 · @${e.username}`})):a.members.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:e.displayName,icon:_(e.avatarId,e.participantId).emoji,description:e.online?`在线成员`:`群成员`})),s=n.toLocaleLowerCase();return o.filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t).filter(e=>e.name.toLocaleLowerCase().includes(s))},lexicon(t){let n=e.roomForSession(String(t.sessionId)),r=e.getSnapshot();return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[...new Set(r.directPeers.filter(e=>e.participantId!==r.identity?.participantId).map(e=>no(e,r.directPeers)))]:[]:[...new Set(r.members.filter(e=>e.participantId!==r.identity?.participantId).map(e=>e.displayName))]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${e.name} `}}}}let fc=`（AI 助手）`;function pc(e){return`${e}${fc}`}function mc(e){return e.endsWith(fc)?e.slice(0,-7):e}var hc={inject:rc,apply:ic};return n.activateRemoteSettingsMirror=ac,n.apply=ic,n.createChatroomAiSource=uc,n.createChatroomMemberSource=dc,n.default=hc,n.inject=rc,n.mountAfterNativeMessageView=cc,t.exports}});
