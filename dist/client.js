...
`&&t++,Kn(e,`---`,r))return{endPos:t,hasValidYaml:n};if(!n){let t=cr(e,r,i);if(t<i){let r=e.charCodeAt(t);if(r>=kn&&r<=An||r>=q&&r<=J||r>=G&&r<=K||r===Kt){for(t++;t<i&&(r=e.charCodeAt(t),r>=kn&&r<=An||r>=q&&r<=J||r>=G&&r<=K||r===Kt||r===W||r===fn);)t++;t<i&&e.charCodeAt(t)===Qt&&(t++,t>=i?n=!0:(r=e.charCodeAt(t),(r===z||r===B)&&(n=!0)))}}}}return null}var Pn=/&([a-zA-Z0-9]+|#[0-9]{1,7}|#x[0-9a-fA-F]{1,6});/gi,Fn={class:`className`,for:`htmlFor`,allowfullscreen:`allowFullScreen`,allowtransparency:`allowTransparency`,autocomplete:`autoComplete`,autofocus:`autoFocus`,autoplay:`autoPlay`,cellpadding:`cellPadding`,cellspacing:`cellSpacing`,charset:`charSet`,classid:`classId`,colspan:`colSpan`,contenteditable:`contentEditable`,contextmenu:`contextMenu`,crossorigin:`crossOrigin`,enctype:`encType`,formaction:`formAction`,formenctype:`formEncType`,formmethod:`formMethod`,formnovalidate:`formNoValidate`,formtarget:`formTarget`,frameborder:`frameBorder`,hreflang:`hrefLang`,inputmode:`inputMode`,keyparams:`keyParams`,keytype:`keyType`,marginheight:`marginHeight`,marginwidth:`marginWidth`,maxlength:`maxLength`,mediagroup:`mediaGroup`,minlength:`minLength`,novalidate:`noValidate`,radiogroup:`radioGroup`,readonly:`readOnly`,rowspan:`rowSpan`,spellcheck:`spellCheck`,srcdoc:`srcDoc`,srclang:`srcLang`,srcset:`srcSet`,tabindex:`tabIndex`,usemap:`useMap`,viewbox:`viewBox`},In={};function Ln(e){if(!e)return In;var t={};for(var n in e){var r=Fn[n.toLowerCase()];if(r)t[r]=e[n];else{var i=n.indexOf(`:`);i===-1?t[n]=e[n]:t[n.slice(0,i)+n[i+1].toUpperCase()+n.slice(i+2)]=e[n]}}return t}var Rn=/(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s|^<(div|p|h[1-6]|ul|ol|li|blockquote|pre|table|thead|tbody|tr|td|th|dl|dt|dd|hr|address|article|aside|details|dialog|figure|figcaption|footer|form|header|main|menu|nav|section|summary|textarea|fieldset|legend|center|dir|hgroup|marquee|search|output|template)\b)/i;function zn(e){return e.indexOf(`&`)===-1?e:e.replace(Pn,(e,t)=>{var n=It(t);if(n)return n;if(t[0]===`#`){var r=t[1]===`x`||t[1]===`X`?Number.parseInt(t.slice(2),16):Number.parseInt(t.slice(1),10);return r===0||r>=55296&&r<=57343||r>1114111?`�`:r<=65535?String.fromCharCode(r):String.fromCharCode(55296+(r-65536>>10),56320+(r-65536&1023))}return e})}var Bn=/(javascript|vbscript|data(?!:image)):/i;function Vn(e){if(Bn.test(e))return null;if(e.indexOf(`%`)===-1)return e;try{let t=decodeURIComponent(e).replace(/[^A-Za-z0-9/:]/g,``);if(Bn.test(t))return null}catch{return null}return e}var Hn={},Un,Wn;for(Un=[192,193,194,195,196,197,224,225,226,227,228,229,230,198],Wn=0;Wn<Un.length;Wn++)Hn[Un[Wn]]=`a`;for(Hn[231]=Hn[199]=`c`,Hn[240]=Hn[208]=`d`,Un=[200,201,202,203,233,232,234,235],Wn=0;Wn<Un.length;Wn++)Hn[Un[Wn]]=`e`;for(Un=[207,239,206,238,205,237,204,236],Wn=0;Wn<Un.length;Wn++)Hn[Un[Wn]]=`i`;for(Hn[209]=Hn[241]=`n`,Un=[248,216,339,338,213,245,212,244,211,243,210,242],Wn=0;Wn<Un.length;Wn++)Hn[Un[Wn]]=`o`;for(Un=[220,252,219,251,218,250,217,249],Wn=0;Wn<Un.length;Wn++)Hn[Un[Wn]]=`u`;Hn[376]=Hn[255]=Hn[221]=Hn[253]=`y`;function Gn(e){for(var t=``,n=-1,r=e.length,i=0;i<r;i++){var a=e.charCodeAt(i);if(a>=kn&&a<=An||a>=G&&a<=K){n<0&&(n=i);continue}if(a>=q&&a<=J){n>=0&&(t+=e.slice(n,i),n=-1),t+=String.fromCharCode(a+Mn);continue}if(a===z||a===W){n>=0&&(t+=e.slice(n,i),n=-1),t+=`-`;continue}n>=0&&(t+=e.slice(n,i),n=-1);var o=Hn[a];o&&(t+=o)}return n>=0&&(t+=e.slice(n)),t}function Kn(e,t,n){return e.startsWith(t,n)}var qn=new Set([`area`,`base`,`br`,`col`,`embed`,`hr`,`img`,`input`,`link`,`meta`,`param`,`source`,`track`,`wbr`,`circle`,`ellipse`,`line`,`path`,`polygon`,`polyline`,`rect`,`use`,`stop`,`animate`,`set`]);function Jn(e){let t=e.toLowerCase();if(qn.has(t))return!0;let n=t.indexOf(`:`);return n!==-1&&(t=t.slice(n+1),qn.has(t))}var Yn=1,Xn=2,Zn=4,Qn=8,$n=16,er=32,tr=64,nr=(()=>{var e=new Uint8Array(128),t;for(e[B]=Yn,e[V]=Yn|Xn,e[cn]=Yn,e[Lt]=Yn|Xn,e[z]=Yn,t=Xt;t<=pn;t++)e[t]=Zn;for(t=Qt;t<=Jt;t++)e[t]=Zn;for(t=zt;t<=H;t++)e[t]=Zn;for(t=vn;t<=Rt;t++)e[t]=Zn;for(t=G;t<=K;t++)e[t]=$n;for(t=q;t<=J;t++)e[t]=Qn;for(t=kn;t<=An;t++)e[t]=Qn;return e})(),rr=/[\p{P}\p{S}]/u,ir=/\p{Zs}/u,ar=[];function or(e){var t=e.indexOf(`\r`),n=e.indexOf(`\0`);if(t===-1&&n===-1)return e;var r=e.length;ar.length=0;var i=0,a=0;for(a=t===-1?n:n===-1||t<n?t:n;a<r;a++){var o=e.charCodeAt(a);o===Lt?(i<a&&ar.push(e.slice(i,a)),a+1<r&&e.charCodeAt(a+1)===V&&a++,ar.push(`
`),i=a+1):o===0&&(i<a&&ar.push(e.slice(i,a)),ar.push(`�`),i=a+1)}return i<r&&ar.push(e.slice(i)),ar.join(``)}function sr(e){return e.replace(/>\s+</g,`><`).replace(/\n+/g,` `).trim()}function cr(e,t,n){let r=n??e.length;for(;t<r&&(e[t]===` `||e[t]===`	`);)t++;return t}function lr(e){if(!e)return!1;for(var t in e)return!0;return!1}function ur(e){return{attrs:{},children:[{type:Y.text,text:e}],c:!0,type:Y.htmlBlock,tag:`header`}}var dr=/^\n+/;function fr(e){for(var t=e.length;t>0&&(e[t-1]===`
`||e[t-1]===`\r`);)t--;return`${e.slice(0,t).replace(dr,``)}

`}function pr(e){if((e.type===Y.htmlSelfClosing||e.type===Y.htmlBlock)&&e.a)return[];if(e.type===Y.paragraph){var t=e.children;return t?t.flatMap(pr):[]}return e.type===Y.text?e.text?.trim()?[e]:[]:e.type===Y.htmlBlock&&e.children?[{...e,children:e.children?.flatMap(pr)}]:[e]}function mr(e){for(var t=0;t<e.length;t++){if(e[t].type===Y.htmlBlock){var n=e[t],r=!1;if(n.c&&t===e.length-1){var i=n.j===void 0?n.a?n.e||``:(n.e||``)+(n.h||``):n.j,a=`</${String(n.tag).toLowerCase()}>`,o=i.toLowerCase().indexOf(a);o!==-1&&i.slice(o+a.length).replace(/<\/[a-z][a-z0-9-]*\s*>/gi,``).trim()&&(r=!0)}r||(n.c=!1)}`children`in e[t]&&e[t].children&&mr(e[t].children)}}function hr(e,t){for(var n=0;n<e.length;n++){var r=e[n];if(r.type===Y.paragraph&&r.children)for(var i=r.children,a=0;a<i.length;a++){var o=i[a];if(o.type===Y.htmlSelfClosing&&o.a&&o.tag.toLowerCase()===t){var s=e.slice(0,n);a>0&&s.push({type:Y.paragraph,children:i.slice(0,a)});var c=[];if(a+1<i.length){var l=i.slice(a+1).filter(e=>!(e.type===Y.htmlSelfClosing&&e.a));l.length>0&&(c=l)}return c=c.concat(e.slice(n+1)),{found:!0,beforeClose:s,afterClose:c}}}if((r.type===Y.htmlSelfClosing||r.type===Y.htmlBlock)&&r.a&&r.tag.toLowerCase()===t)return{found:!0,beforeClose:e.slice(0,n),afterClose:e.slice(n+1)}}return{found:!1,beforeClose:e,afterClose:[]}}function gr(e){var t=``;for(var n in e){var r=e[n];r===!0?t+=` ${n}`:r!==void 0&&r!=null&&r!==!1&&(t+=` ${n}="${String(r)}"`)}return t}function _r(e,t,n,r){var i;return i=t===void 0?gr(n):t.length>0&&t.charCodeAt(0)>z?` ${t}`:t,`<${e}${i}${r}`}function vr(e){var t=e.tag,n=e.type===Y.htmlSelfClosing,r=e,i=r.b,a=`</${t}>`;if(!n&&r.a)return{kind:`literal`,literal:(r.h||a)+(r.e||``)};if(n){var o=e;return o.a?{kind:`literal`,literal:o.h||a}:o.m?{kind:`literal`,literal:o.m}:{kind:`literal`,literal:_r(t,i,e.attrs,` />`)}}var s=_r(t,i,e.attrs,`>`),c=r.children,l=c!=null&&c.length>0;if(r.c&&r.j!==void 0)return l?{kind:`sandwich`,open:s,close:a}:{kind:`literal`,literal:r.j};if(r.c&&!l)return{kind:`literal`,literal:s+(r.e||``)+(r.h||a)};if(c!=null&&c.length>0){for(var u=``,d=0;d<c.length;d++){var f=c[d];if(f.type!==Y.text)return{kind:`sandwich`,open:s,close:a};u+=f.text}return{kind:`literal`,literal:s+u+a}}var p=r.e||``;return p&&p.indexOf(a)!==-1?{kind:`literal`,literal:s+p}:{kind:`literal`,literal:s+p+a}}function yr(e,t,n){var r=[],i=e,a=n;if(i&&r.push(i),Array.isArray(t))for(var o=0;o<t.length;o++)r.push(t[o]);else t!=null&&r.push(t);a&&r.push(a);for(var s=[],c=0;c<r.length;c++){var l=r[c];typeof l==`string`&&s.length>0&&typeof s.at(-1)==`string`?s[s.length-1]=s.at(-1)+l:s.push(l)}return s}function br(e){return e==null||e.tagfilter!==!1}function xr(e,t,n,r){var i=t(e,n,r);return i===null?null:wr(i)}function Sr(e){var t=[];if(!e)return t;for(var n in e)n.charCodeAt(0)===94&&t.push({identifier:n,footnote:e[n].target});return t}function Cr(e,t,n){if(t.indexOf(`.`)===-1)return e?.[t]||n;for(var r=e,i=t.split(`.`),a=0;a<i.length&&(r=r?.[i[a]],r!==void 0);)a++;return r||n}function wr(e){for(var t=!1,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r<=z||r===hn||r===Ht||r===qt||r===U||r===zt||r===Wt||r===Yt||r===Bt||r===H||r>=123){t=!0;break}}if(!t)return e;for(var i=``,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r===Ht&&n+2<e.length){var a=e.charCodeAt(n+1),o=e.charCodeAt(n+2);if((a>=G&&a<=K||a>=q&&a<=$t||a>=kn&&a<=en)&&(o>=G&&o<=K||o>=q&&o<=$t||o>=kn&&o<=en)){i+=e[n]+e[n+1]+e[n+2],n+=2;continue}}if(r>=55296&&r<=57343){if(r<=56319&&n+1<e.length){var s=e.charCodeAt(n+1);if(s>=56320&&s<=57343){i+=encodeURI(e[n]+e[n+1]),n++;continue}}i+=e[n];continue}i+=encodeURI(e[n])}return i}function Tr(...e){return e.filter(Boolean).join(` `)}var Er=new Set([`title`,`textarea`,`style`,`xmp`,`iframe`,`noembed`,`noframes`,`script`,`plaintext`]),Dr=/<(\/?)(title|textarea|style|xmp|iframe|noembed|noframes|script|plaintext)(\s|>|\/)/gi;function Or(e){return Er.has(e.toLowerCase())}function kr(e){return Dr.lastIndex=0,Dr.test(e)}function Ar(e){return Dr.lastIndex=0,e.replace(Dr,(e,t,n,r)=>`&lt;${t}${n}${r}`)}function jr(e,t){var n=e||{},r=n.slugify,i;if(r){var a=r;i=e=>a(e,Gn)}else i=Gn;return{disableAutoLink:n.disableAutoLink,disableFrontmatter:n.disableFrontmatter,disableParsingRawHTML:n.disableParsingRawHTML,enforceAtxHeadings:n.enforceAtxHeadings,evalUnserializableExpressions:n.evalUnserializableExpressions,forceBlock:n.forceBlock,forceInline:t===void 0?n.forceInline:t,ignoreHTMLBlocks:n.ignoreHTMLBlocks,optimizeForStreaming:n.optimizeForStreaming,preserveFrontmatter:n.preserveFrontmatter,sanitizer:n.sanitizer||Vn,slugify:i,tagfilter:br(n)}}var Mr=/^<([a-zA-Z][a-zA-Z0-9-]*)\s[^>]*>/,Nr=/^<[A-Z]/,Pr=[`script`,`pre`,`style`,`textarea`],Fr=new Set(Pr),Ir=/<(?:pre|script|style|textarea)\b/i,Lr=/<(?:pre|script|style|textarea)\b/iy,Rr=/^(\s{0,3}#[#\s]|\s{0,3}[-*+]\s|\s{0,3}\d+\.\s|\s{0,3}>\s|\s{0,3}```)/m,zr=/^<([a-z][^ >/\n\r]*) ?([^>]*?)>/im,Br=new Uint8Array(128);(()=>{for(var e=[H,Gt,Kt,Rt,Ut,zt,Xt,qt,Wt,Zt,V,tn,nn,en],t=0;t<e.length;t++)Br[e[t]]=1})();var Vr=/([a-zA-Z_][a-zA-Z0-9_-]*)=(?:"([^"]*)"|'([^']*)')/g;function Hr(e){return Fr.has(e)}function Ur(e){return Ir.test(e)}function Wr(e,t,n){for(var r=t,i=n;r<i&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;if(r>=i)return!1;e.charCodeAt(r)===_n&&r++;for(var a=0;r<i;){for(;r<i&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;if(r>=i)break;if(e.charCodeAt(r)===_n&&a>0){for(var o=r+1;o<i&&(e.charCodeAt(o)===z||e.charCodeAt(o)===B);)o++;if(o>=i)return!0}if(e.charCodeAt(r)===Qt&&r++,r>=i||e.charCodeAt(r)!==W)return!1;for(;r<i&&e.charCodeAt(r)===W;)r++;for(r<i&&e.charCodeAt(r)===Qt&&r++,a++;r<i&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;if(r<i){if(e.charCodeAt(r)===_n)r++;else return!1}}return a>0}var Gr=/[\u0000-\u001F\u007F]/g,Kr={action:1,background:1,cite:1,data:1,formaction:1,href:1,longdesc:1,poster:1,src:1,"xlink:href":1},qr=/&#(x[0-9a-f]+|[0-9]+);?/gi;function Jr(e){return e.indexOf(`&#`)===-1?e:e.replace(qr,(e,t)=>{var n=t.charCodeAt(0)===En||t.charCodeAt(0)===Dn?Number.parseInt(t.slice(1),16):Number.parseInt(t,10);return n>0&&n<=1114111?String.fromCodePoint(n):e})}function Yr(e,t,n){if(n&&t.charCodeAt(0)===vn)return!1;var r=e.charCodeAt(0),i=e.charCodeAt(1);if((r===Tn||r===wn)&&(i===Cn||i===Sn))return!(n&&t===``);var a=e.toLowerCase();if(a===`srcdoc`)return!0;if(a===`style`)return/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(t);if(Kr[a]===1){var o=Jr(zn(t));if(Vn(o)===null)return!0;var s=o.replace(Gr,``);return s!==o&&Vn(s)===null}return!1}function Xr(e){return`<`+(e.f?`/`:``)+e.tag+e.g+e.b+(e.n?e.r?` />`:`/>`:`>`)}function Zr(e,t,n,r){for(var i=[],a=t,o=0;o<r.length;o+=2){var s=r[o];if(s>a){var c=e.slice(a,s).trim();c&&i.push(c)}a=r[o+1]}if(a<n){var l=e.slice(a,n).trim();l&&i.push(l)}return i.join(` `)}function Qr(e,t){if(e.charCodeAt(t)!==qt)return null;let n=t+1,r=e.length,i=!1;e.charCodeAt(n)===pn&&(n++,i=!0);let a=n,o=e.charCodeAt(n);if(!(o>=kn&&o<=An||o>=q&&o<=J))return null;for(;n<r&&(e.charCodeAt(n)>=kn&&e.charCodeAt(n)<=An||e.charCodeAt(n)>=q&&e.charCodeAt(n)<=J||e.charCodeAt(n)>=G&&e.charCodeAt(n)<=K||e.charCodeAt(n)===W);)n++;let s=e.slice(a,n);if(!s)return null;let c=s.charCodeAt(0),l=c>=q&&c<=J||s.indexOf(`-`)!==-1,u=n;for(;n<r&&(e.charCodeAt(n)===z||e.charCodeAt(n)===B||e.charCodeAt(n)===V);)n++;let d=e.slice(u,n);if(n===u&&n<r){var f=e.charCodeAt(n);if(f!==U&&f!==pn)return null}let p=n,m={},h=!1;for(var g=null;n<r;){let t=e.charCodeAt(n);if(t===U){let t=g?Zr(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!1,g:d,attrs:m,end:n+1,tag:s}}if(t===z||t===B||t===V){n++;continue}if(t===pn&&n+1<r&&e.charCodeAt(n+1)===U){h=n>p&&e.charCodeAt(n-1)===z;let t=g?Zr(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!0,g:d,attrs:m,end:n+2,tag:s}}var _=n,v=e.charCodeAt(n);if(!(v>=kn&&v<=An||v>=q&&v<=J||v===Kt||v===Qt))return null;for(n++;n<r;){var y=e.charCodeAt(n);if(y>=kn&&y<=An||y>=q&&y<=J||y>=G&&y<=K||y===Kt||y===fn||y===Qt||y===W)n++;else break}for(var b=e.slice(_,n),x=n;n<r&&(e.charCodeAt(n)===z||e.charCodeAt(n)===B);)n++;var S,C;if(e.charCodeAt(n)===Ut){for(n++;n<r&&(e.charCodeAt(n)===z||e.charCodeAt(n)===B);)n++;var w=e.charCodeAt(n);if(w===hn||w===mn){n++;for(var T=n;n<r&&e.charCodeAt(n)!==w;)n++;if(n>=r)return null;if(S=e.slice(T,n),n++,n<r){var E=e.charCodeAt(n);if(E!==z&&E!==B&&E!==V&&E!==U&&E!==pn)return null}C=n}else if(w===vn){var D=1,T=n;for(n++;n<r&&D>0;){var y=e.charCodeAt(n);y===vn?D++:y===yn&&D--,n++}S=e.slice(T,n),C=n}else{for(var T=n;n<r;){var O=e.charCodeAt(n);if(O===z||O===B||O===U||O===V||O===hn||O===mn||O===Ut||O===qt||O===H)break;n++}if(n===T)return null;S=e.slice(T,n),C=n}}else S=``,C=x;Yr(b,S,l)?(g===null&&(g=[]),g.push(_,C)):m[b]=S}return null}function $r(e){var t=e.indexOf(`<`);if(t===-1)return e;for(var n=``,r=0,i=!1;t!==-1;){var a=Qr(e,t);a?(a.q&&(n+=e.slice(r,t)+Xr(a),r=a.end,i=!0),t=e.indexOf(`<`,a.end)):t=e.indexOf(`<`,t+1)}return i?n+e.slice(r):e}function ei(e,t,n){if(!n.optimizeForStreaming&&e.indexOf(`[`)===-1)return!1;for(var r=0,i=e.length,a=!1,o=!1;r<i;){for(var s=e.indexOf(`
`,r),c=s<0?i:s,l=r,u=0;l<c&&u<4;)if(e.charCodeAt(l)===z)u++,l++;else if(e.charCodeAt(l)===B)u+=4,l++;else break;if(l>=c){a=!1,r=s<0?i:s+1;continue}if(u<4){var d=e.charCodeAt(l);if(d===H||d===Rt){for(var f=d,p=0,m=l;m<c&&e.charCodeAt(m)===f;)p++,m++;if(p>=3){var h=!0;if(f===H){for(var g=m;g<c;g++)if(e.charCodeAt(g)===H){h=!1;break}}if(h){a=!1;for(var _=s<0?i:s+1;_<i;){for(var v=_,y=0;v<i&&y<4;){var b=e.charCodeAt(v);if(b===z)y++,v++;else if(b===B)y+=4,v++;else break}if(y<4&&v<i&&e.charCodeAt(v)===f){for(var x=0;v<i&&e.charCodeAt(v)===f;)x++,v++;if(x>=p){for(;v<i&&(e.charCodeAt(v)===z||e.charCodeAt(v)===B);)v++;if(v>=i||e.charCodeAt(v)===V){r=v>=i?i:v+1;break}}}for(;_<i&&e.charCodeAt(_)!==V;)_++;_<i&&_++}_>=i&&(r=i,o=!0);continue}}}}for(var S=l;S<c&&e.charCodeAt(S)===U;){S++,S<c&&e.charCodeAt(S)===z&&S++;for(var C=0;S<c&&C<4;)if(e.charCodeAt(S)===z)C++,S++;else if(e.charCodeAt(S)===B)C+=4,S++;else break;if(C>=4)break;a=!1}if(!a&&u<4&&S<c&&e.charCodeAt(S)===zt&&!(S+1<i&&e.charCodeAt(S+1)===Bt)){var w=ti(e,S,t);if(w){r=w,a=!1;continue}}var T=e.charCodeAt(l);if(T===Vt&&u<4)a=!1;else if(u<4&&(T===W||T===Gt||T===Kt)){for(var E=l,D=0;E<c;){var O=e.charCodeAt(E);if(O===T)D++;else if(O!==z&&O!==B)break;E++}a=!(D>=3&&E>=c)}else a=!0;r=s<0?i:s+1}return o}function ti(e,t,n){let r=e.length;if(e.charCodeAt(t)!==zt)return null;let i=t+1<r&&e.charCodeAt(t+1)===Bt,a=t+1;for(;a<r;){var o=e.charCodeAt(a);if(o===Yt){a++;break}if(o===zt)return null;o===Wt&&a+1<r&&a++,a++}if(a>r||e.charCodeAt(a-1)!==Yt)return null;let s=e.slice(t+1,a-1);if(s.length>999)return null;let c=ai(s);if(!c||a>=r||e.charCodeAt(a)!==Qt)return null;a++;let l=!1;for(;a<r;){let t=e.charCodeAt(a);if(t===z||t===B)a++;else if(t===V&&!l)l=!0,a++;else break}if(i){let t=e.indexOf(`
`,a),i=t<0?r:t;return n[c]={target:e.slice(a,i).trim(),title:void 0},t<0?r:t+1}var u;if(a<r&&e.charCodeAt(a)===qt){a++;for(var d=a;a<r&&e.charCodeAt(a)!==U&&e.charCodeAt(a)!==V;)e.charCodeAt(a)===Wt&&a+1<r&&a++,a++;if(a>=r||e.charCodeAt(a)!==U)return null;u=e.slice(d,a),a++;for(var f=e.indexOf(`
`,a),p=f<0?r:f,m=a;m<p&&(e.charCodeAt(m)===z||e.charCodeAt(m)===B);)m++;if(m<p){if(m===a)return null;var h=e.charCodeAt(m);if(h!==hn&&h!==mn&&h!==bn)return null}}else{for(var d=a,g=0;a<r;){var o=e.charCodeAt(a);if(o===bn)g++;else if(o===xn){if(g===0)break;g--}else{if(o===z||o===B||o===V)break;o===Wt&&a+1<r&&a++}a++}if(u=e.slice(d,a),!u)return null}for(;a<r&&(e.charCodeAt(a)===z||e.charCodeAt(a)===B);)a++;var _=e.indexOf(`
`,a),v=_<0?r:_,y,b=!1,x=a,S=a;if(a===v&&a<r)for(S=a+1;S<r&&(e.charCodeAt(S)===z||e.charCodeAt(S)===B);)S++;if(S<r){var C=e.charCodeAt(S);if(C===hn||C===mn||C===bn){for(var w=C===bn?41:C,T=S+1,E=T;T<r;){var D=e.charCodeAt(T);if(D===w){for(var O=T+1;O<r&&(e.charCodeAt(O)===z||e.charCodeAt(O)===B);)O++;(O>=r||e.charCodeAt(O)===V)&&(y=e.slice(E,T),b=!0,x=O<r?O+1:r);break}if(D===Wt&&T+1<r){T+=2;continue}if(D===V&&T+1<r&&e.charCodeAt(T+1)===V)break;T++}if(!b&&S===a)return null}}if(b)return n[c]||(n[c]={target:zn(si(u)),title:y===void 0?y:zn(si(y))}),x;for(;a<v&&(e.charCodeAt(a)===z||e.charCodeAt(a)===B);)a++;return a<v?null:(n[c]||(n[c]={target:zn(si(u)),title:y}),_<0?r:_+1)}var ni=new Uint8Array(nr);for(ni[Vt]|=er,ni[U]|=er,ni[W]|=er|tr,ni[gn]|=er,ni[Gt]|=er|tr,ni[Kt]|=er|tr,ni[H]|=er|tr,ni[Rt]|=er|tr,ni[qt]|=er|tr,ni[zt]|=tr,ni[Xt]|=tr,ni[_n]|=er,ri=G;ri<=K;ri++)ni[ri]|=er;var ri;function ii(e){if(e.indexOf(`[`)<0&&e.indexOf(`]`)<0)return!1;for(var t=0;t<e.length;t++){if(e.charCodeAt(t)===Wt){t++;continue}if(e.charCodeAt(t)===zt||e.charCodeAt(t)===Yt)return!0}return!1}function ai(e){for(var t=e.length,n=!0,r=t>0,i=0;i<t;i++){var a=e.charCodeAt(i);if(a===z){if(n){r=!1;break}n=!0}else if(a<33||a>126||a>=q&&a<=J){r=!1;break}else n=!1}if(r&&!n)return e;var o=e.replace(/\s+/g,` `).trim();return o.indexOf(`ẞ`)===-1?o.toLowerCase():o.replace(/\u1E9E/g,`ss`).toLowerCase()}function oi(e){return e<jn?ni[e]:e===sn?Yn:0}function si(e){return e.indexOf(`\\`)===-1?e:e.replace(/\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,`$1`)}var ci=null,li=-1,ui=-1;function di(e,t){if(t>=li&&t<=ui&&e===ci)return ui;var n=e.indexOf(`
`,t),r=n<0?e.length:n;return ci=e,li=t,ui=r,r}function X(e,t){let n=di(e,t);return n<e.length?n+1:n}function fi(e,t,n){for(;t<n;){let n=e.charCodeAt(t);if(n!==z&&n!==B)break;t++}return t}function pi(e,t){let n=X(e,t);for(;n<e.length;){let t=di(e,n);if(_i(e,n,t))return n;n=X(e,n)}return e.length}function mi(e,t,n,r){let i=0;for(;t+i<n&&e.charCodeAt(t+i)===r;)i++;return i}var hi=0,Z=0;function gi(e,t,n){for(hi=0,Z=0;t+Z<n;){let n=e.charCodeAt(t+Z);if(n===B)hi+=4-hi%4;else if(n===z)hi++;else break;Z++}}function _i(e,t,n){return fi(e,t,n)>=n}function vi(e,t){if(!e)return e;var n=t.v||=Object.create(null),r=n[e];if(r===void 0)return n[e]=0,e;for(var i=r+1,a=`${e}-${i}`;n[a]!==void 0;)i++,a=`${e}-${i}`;return n[e]=i,n[a]=0,a}function yi(e,t,n,r){let i=di(e,t);if(gi(e,t,i),hi>3)return null;let a=t+Z;if(e.charCodeAt(a)!==Vt)return null;let o=mi(e,a,i,35);if(o<1||o>6||(a+=o,a<i&&e.charCodeAt(a)!==z&&e.charCodeAt(a)!==B))return null;a=fi(e,a,i);for(var s=i;s>a&&e.charCodeAt(s-1)===z;)s--;for(var c=s;s>a&&e.charCodeAt(s-1)===Vt;)s--;if(s<c){if(s===a||e.charCodeAt(s-1)===z)for(;s>a&&e.charCodeAt(s-1)===z;)s--;else s=c}let l=qi(e.slice(a,s),!1,n,r);return{node:{type:Y.heading,level:o,children:l,id:``},end:X(e,i)}}function bi(e,t,n){var r=e.charCodeAt(t);if(r!==Ut&&r!==W)return!1;for(var i=t;i<n&&e.charCodeAt(i)===r;)i++;for(;i<n&&(e.charCodeAt(i)===z||e.charCodeAt(i)===B);)i++;return i>=n}function xi(e,t){let n=di(e,t);if(gi(e,t,n),hi>3)return null;let r=t+Z,i=e.charCodeAt(r);if(i!==W&&i!==Gt&&i!==Kt)return null;let a=0;for(;r<n;){let t=e.charCodeAt(r);if(t===i)a++;else if(t!==z&&t!==B)return null;r++}return a<3?null:{node:{type:Y.breakThematic},end:X(e,n)}}var Si=0,Ci=0,wi=``;function Ti(e,t,n){let r=di(e,t);if(gi(e,t,r),hi>3)return null;let i=hi,a=t+Z,o=e.charCodeAt(a);if(o!==H&&o!==Rt)return null;let s=mi(e,a,r,o);if(s<3)return null;a+=s;let c=fi(e,a,r),l=r;if(o===H){for(let t=c;t<r;t++)if(e.charCodeAt(t)===H)return null}for(;l>c&&(e.charCodeAt(l-1)===z||e.charCodeAt(l-1)===B);)l--;let u=e.slice(c,l),d=``,f=``,p=u.indexOf(` `);p===-1?d=u:(d=u.slice(0,p),f=u.slice(p+1).trim()),d=si(d);var m;if(f){Vr.lastIndex=0;for(var h;(h=Vr.exec(f))!=null;)m||={},m[h[1]]=h[2]===void 0?h[3]:h[2]}let g=X(e,r),_=e.length,v=e.length;var y;o===Si&&s===Ci?y=wi:(y=String.fromCharCode(o).repeat(s),Si=o,Ci=s,wi=y);for(var b=g;b<e.length;){var x=e.indexOf(y,b);if(x===-1)break;for(var S=x,C=0;S>0&&C<4&&e.charCodeAt(S-1)===z;)S--,C++;if(C<=3&&(S===0||e.charCodeAt(S-1)===V)){for(var w=x+s;w<e.length&&e.charCodeAt(w)===o;)w++;var T=di(e,w);if(_i(e,w,T)){_=S,v=X(e,T);break}}b=x+1}var E;if(i===0)E=_>g&&e.charCodeAt(_-1)===V?e.slice(g,_-1):e.slice(g,_);else{E=``;for(var D=g;D<_;){var O=di(e,D);gi(e,D,O);var ee=Math.min(Z,i);E+=`${e.slice(D+ee,O)}
`,D=X(e,O)}E.length>0&&E.charCodeAt(E.length-1)===V&&(E=E.slice(0,-1))}return{node:{type:Y.codeBlock,lang:d||void 0,text:E,infoString:f||void 0,attrs:m},end:v}}function Ei(e,t,n){for(var r=0,i=t;i<n&&r<4;)e.charCodeAt(i)===B?r+=4-r%4:r++,i++;if(r<4)return``;for(var a=``,o=4;o<r;o++)a+=` `;return a+e.slice(i,n)}function Di(e,t){if(gi(e,t,di(e,t)),hi<4)return null;let n=``,r=t;for(;r<e.length;){let t=di(e,r);if(gi(e,r,t),_i(e,r,t)){for(var i=`${Ei(e,r,t)}
`,a=X(e,t);a<e.length;){var o=di(e,a);if(_i(e,a,o)){i+=`${Ei(e,a,o)}
`,a=X(e,o);continue}gi(e,a,o),hi>=4&&(n+=i,r=a);break}if(r!==a)break;continue}if(hi<4)break;let d=0,f=0;var s=0;for(let n=r;n<t&&f<4;n++){if(e.charCodeAt(n)===B){var c=4-f%4;f+c>4&&(s=f+c-4),f+=c}else f++;d++}var l=``;if(s>0)for(var u=0;u<s;u++)l+=` `;l+=e.slice(r+d,t),n+=`${l}
`,r=X(e,t)}for(;n.length>0&&n.charCodeAt(n.length-1)===V;)n=n.slice(0,-1);return n?{node:{type:Y.codeBlock,lang:void 0,text:n,infoString:void 0,attrs:void 0},end:r}:null}function Oi(e,t,n,r){if(gi(e,t,di(e,t)),hi>3)return null;let i=t+Z;if(e.charCodeAt(i)!==U)return null;let a=``,o=t,s,c=!1,l=!1,u=!1;for(;o<e.length;){let t=di(e,o);gi(e,o,t);let n=o+Z;if(e.charCodeAt(n)===U){let r=n+1;var d=hi+1,f=!1;if(r<t){var p=e.charCodeAt(r);p===z?(r++,d++,f=!0):p===B&&(f=!0)}for(var m=``,h=!1,g=r;g<t;g++)if(e.charCodeAt(g)===B){h=!0;break}if(h){var _=d;if(f&&r<t&&e.charCodeAt(r)===B){for(var v=4-_%4,y=0;y<v-1;y++)m+=` `;_+=v,r++}for(var b=r;b<t;b++)if(e.charCodeAt(b)===B){for(var x=4-_%4,S=0;S<x;S++)m+=` `;_+=x}else m+=e[b],_++}else m=e.slice(r,t);if(!(a||s)){let n=m.match(/^\[!([A-Za-z]+)\]\s*$/);if(n){s=n[1].toUpperCase(),o=X(e,t);continue}}a+=`${m}
`;var C=m.trimStart();C.startsWith("```")||C.startsWith(`~~~`)?u=!u:(m.startsWith(`    `)||m.startsWith(`	`))&&(u=!0),l=C.length>0,o=X(e,t)}else if(a&&!_i(e,o,t)&&l){if(hi<4){var w=o+Z,T=w<t?e.charCodeAt(w):0;if(T===Vt||T===U||T===H||T===Rt||T===qt||(T===W||T===Gt||T===Kt)&&xi(e,o)||(T===W||T===Gt||T===gn)&&w+1<t&&(e.charCodeAt(w+1)===z||e.charCodeAt(w+1)===B))break;if(T>=G&&T<=K){for(var E=w;E<t&&e.charCodeAt(E)>=G&&e.charCodeAt(E)<=K;)E++;if(E<t&&(e.charCodeAt(E)===fn||e.charCodeAt(E)===xn))break}}if(u)break;a+=`${e.slice(o,t)}
`,c=!0,o=X(e,t)}else break}if(!(a||s))return null;var{inBlockQuote:D,l:O}=n;n.inBlockQuote=!0,c&&(n.l=!0);var ee=n.i;n.i=ee||!_i(e,o,e.length);let k=Ma(a||``,n,r);return n.i=ee,n.inBlockQuote=D,n.l=O,{node:{type:Y.blockQuote,children:k,alert:s||void 0},end:o}}function ki(e,t,n){for(var r=0,i=t;i<n;i++)e.charCodeAt(i)===B?r+=4-r%4:r++;return r}function Ai(e,t,n){if(gi(e,t,n),hi>3)return null;var r=t+Z;if(r>=n)return null;var i=e.charCodeAt(r),a=hi,o=r,s=r;if(i===W||i===Gt||i===gn){if(o=r+1,o<n&&e.charCodeAt(o)!==z&&e.charCodeAt(o)!==B&&e.charCodeAt(o)!==V)return null}else if(i>=G&&i<=K){for(;s<n&&s-r<9;){var c=e.charCodeAt(s);if(c<G||c>K)break;s++}if(s>r&&s<n){var l=e.charCodeAt(s);if(l===fn||l===xn){if(o=s+1,o<n&&e.charCodeAt(o)!==z&&e.charCodeAt(o)!==B&&e.charCodeAt(o)!==V)return null}else return null}else return null}else return null;var u=o,d=ki(e,t,o),f=0,p=u,m=d;if(u>=n)return{ordered:i>=G&&i<=K,marker:i>=G&&i<=K?e[s]:e[r],start:i>=G&&i<=K?Number.parseInt(e.slice(r,s),10):void 0,contentStart:u,contentCol:d+1,markerCol:a,isEmpty:!0};for(;p<n&&(e.charCodeAt(p)===z||e.charCodeAt(p)===B);){if(e.charCodeAt(p)===B){var h=4-m%4;m+=h}else m++;p++,f++}var g=p>=n,_=m-d;return g||_>4?(m=d+1,p=u+1,f=1):f===0&&(m=d+1,p=u,f=1),{ordered:i>=G&&i<=K,marker:i>=G&&i<=K?e[s]:e[r],start:i>=G&&i<=K?Number.parseInt(e.slice(r,s),10):void 0,contentStart:p,contentCol:m,markerCol:a,isEmpty:g}}var ji=0;function Mi(e,t,n,r){var i=0,a=t;for(ji=0;a<n&&i<r;){var o=e.charCodeAt(a);if(o===B){var s=4-i%4;if(i+s>r){ji=i+s-r,a++,i=r;break}i+=s}else if(o===z)i++;else break;a++}return a}function Ni(e,t,n,r){var i=di(e,t),a=Ai(e,t,i);if(!a)return null;var o=[],s=t,c=a.contentCol,l=``,u=a.isEmpty,d=!1,f=!1;if(!a.isEmpty){for(var p=!1,m=a.contentStart;m<i;m++)if(e.charCodeAt(m)===B){p=!0;break}if(p){var h=``,g=ki(e,t,a.contentStart),_=g-a.contentCol;if(_>0)for(var v=0;v<_;v++)h+=` `;for(var y=a.contentStart;y<i;y++)if(e.charCodeAt(y)===B){for(var b=4-g%4,x=0;x<b;x++)h+=` `;g+=b}else h+=e[y],g++;l=`${h}
`}else l=`${e.slice(a.contentStart,i)}
`}for(s=X(e,i);s<e.length;){var S=di(e,s);gi(e,s,S);var C=e.charCodeAt(s+Z);if(hi<c&&(C===W||C===Gt||C===Kt)&&hi<=3&&xi(e,s))break;var w=Ai(e,s,S);if(w&&w.ordered===a.ordered&&w.marker===a.marker&&w.markerCol<c){o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),d&&(f=!0),c=w.contentCol,u=w.isEmpty,d=!1,l=w.isEmpty?``:`${e.slice(w.contentStart,S)}
`,s=X(e,S);continue}if(_i(e,s,S)){var T=Mi(e,s,S,c);if(ji>0||T<S){for(var E=``,D=0;D<ji;D++)E+=` `;l+=`${E+e.slice(T,S)}
`}else l+=`
`;s=X(e,S);for(var O=!1,ee=0;ee<l.length;ee++){var k=l.charCodeAt(ee);if(k!==V&&k!==Lt&&k!==z&&k!==B){O=!0;break}}if(u&&!O){if(s<e.length){var te=di(e,s),ne=Ai(e,s,te);if(!ne||ne.ordered!==a.ordered||ne.marker!==a.marker)break;d=!0}else break}if(s<e.length){var re=di(e,s);gi(e,s,re);var ie=e.charCodeAt(s+Z);if((ie===W||ie===Gt||ie===Kt)&&hi<=3&&xi(e,s))break;var ae=Ai(e,s,re);if(ae&&ae.ordered===a.ordered&&ae.marker===a.marker&&ae.markerCol<c){d=!0;continue}if(!_i(e,s,re)&&hi<c)break}continue}if(hi>=c){var oe=Mi(e,s,S,c);if(ji>0){for(var se=``,ce=c,le=0;le<ji;le++)se+=` `,ce++;for(var A=oe;A<S;A++)if(e.charCodeAt(A)===B){for(var j=4-ce%4,M=0;M<j;M++)se+=` `;ce+=j}else se+=e[A],ce++;l+=`${se}
`}else l+=`${e.slice(oe,S)}
`;s=X(e,S);continue}for(var N=!1,ue=0;ue<l.length;ue++){var de=l.charCodeAt(ue);if(de!==V&&de!==Lt&&de!==z&&de!==B){N=!0;break}}if(!d&&N&&!u){var P=s+Z,F=e.charCodeAt(P);if(!(F===Vt||F===U||F===qt||F===H||F===Rt||(F===W||F===Gt||F===Kt||F===gn)&&(xi(e,s)!=null||Ai(e,s,S)!=null)||F>=G&&F<=K&&Ai(e,s,S)!=null)){l+=`${e.slice(P,S)}
...
`,I);if(R<0&&(R=he),ye){gi(me,I,R);for(var Se=me.slice(I+Z,R),Ce=0;Ce<Se.length&&Se.charCodeAt(Ce)===be;)Ce++;Ce>=L&&Se.slice(Ce).trim()===``&&(ye=!1),I=R<he?R+1:he;continue}if(_i(me,I,R)){xe>=0?ve=!0:ge&&(_e=!0),I=R<he?R+1:he;continue}if(gi(me,I,R),xe>=0){if(hi>=xe){I=R<he?R+1:he;continue}var we=Ai(me,I,R);if(we&&we.markerCol<xe&&we.contentCol<=xe){I=R<he?R+1:he;continue}if(we){I=R<he?R+1:he;continue}xe=-1,ve&&=(_e=!0,!1)}var Te=me.slice(I+Z,R),Ee=Te.charCodeAt(0);if((Ee===H||Ee===Rt)&&hi<=3){for(var De=0;De<Te.length&&Te.charCodeAt(De)===Ee;)De++;if(De>=3){if(_e&&ge){fe=!0;break}ye=!0,be=Ee,L=De,ge=!0,I=R<he?R+1:he;continue}}var Oe=hi<=3?Ai(me,I,R):null;if(Oe&&ge){if(_e){fe=!0;break}xe=Oe.contentCol,ve=!1,I=R<he?R+1:he,ge=!0;continue}if(_e){fe=!0;break}ge=!0,I=R<he?R+1:he}if(fe)break}}for(var ke=[],Ae=0;Ae<o.length;Ae++){for(var je=o[Ae],Me=je.raw,Ne=Me.length;Ne>0&&Me.charCodeAt(Ne-1)===V;)Ne--;var Pe=Ne<Me.length?Me.slice(0,Ne):Me,Fe=null;if(Pe.length>=3&&Pe.charCodeAt(0)===zt){var Ie=Pe[1];(Ie===` `||Ie===`x`||Ie===`X`)&&Pe.charCodeAt(2)===Yt&&(Fe={type:Y.gfmTask,completed:Ie===`x`||Ie===`X`},Pe=Pe.slice(3))}var Le;if(je.isEmpty&&Pe.trim()===``)Le=[];else if(fe){var Re=n.inList;n.inList=!0;var ze=n.i;n.i=ze||Ae!==o.length-1,Le=Ma(Pe,n,r),n.i=ze,n.inList=Re}else{var Be=n.inList;n.inList=!0;var Ve=n.i;if(n.i=Ve||Ae!==o.length-1,Le=Ma(Pe,n,r),n.i=Ve,n.inList=Be,Le.length===1&&Le[0].type===Y.paragraph)Le=Le[0].children;else if(n.p){var He=[];n.p.push({src:Le,dest:He,unwrap:!0}),Le=He}else{for(var Ue=[],We=0;We<Le.length;We++)if(Le[We].type===Y.paragraph)for(var Ge=Le[We].children,Ke=0;Ke<Ge.length;Ke++)Ue.push(Ge[Ke]);else Ue.push(Le[We]);Le=Ue}}if(Fe){var qe=[Fe,{type:Y.text,text:` `}];if(n.p)n.p.push({src:Le,dest:qe,unwrap:!1});else for(var Je=0;Je<Le.length;Je++)qe.push(Le[Je]);ke.push(qe)}else ke.push(Le)}return{node:{type:a.ordered?Y.orderedList:Y.unorderedList,start:a.ordered?a.start:void 0,items:ke},end:s}}var Pi=new Set(`address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul`.split(`.`));function Fi(e,t,n){let r={};for(let[o,s]of Object.entries(e)){let e=o.toLowerCase();if(e===`style`&&typeof s==`string`){let e={},t=[],n=0,i=0;for(let e=0;e<s.length;e++){let r=s.charCodeAt(e);r===bn?n++:r===xn?n--:r===un&&n===0&&(t.push(s.slice(i,e)),i=e+1)}i<s.length&&t.push(s.slice(i));let a=!1;t.forEach(t=>{let n=t.indexOf(`:`);if(n===-1)return;let r=t.slice(0,n).trim(),i=t.slice(n+1).trim();if(r&&i){if(/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(i)){a=!0;return}let t=r.indexOf(`-`)===-1?r:r.replace(/-([a-z])/g,(e,t)=>t.toUpperCase());e[t]=i}}),!a&&Object.keys(e).length>0&&(r[o]=e)}else if((e===`href`||e===`src`)&&n?.sanitizer){let i=n.sanitizer(s,t,e);i!=null&&(r[o]=i)}else if(s===``)r[o]=!0;else if(s.length>=2&&s.charCodeAt(0)===vn&&s.charCodeAt(s.length-1)===yn){var i=s.slice(1,-1);if(i.length>0){var a=i.charCodeAt(0);if(a===zt||a===vn)try{r[o]=JSON.parse(i);continue}catch{}}if(i===`true`){r[o]=!0;continue}if(i===`false`){r[o]=!1;continue}if(n?.evalUnserializableExpressions)try{r[o]=(0,eval)(`(${i})`);continue}catch{}r[o]=i}else r[o]=s}return r}function Ii(e,t,n){let r=t.length;if(r===0)return n;var i=t.charCodeAt(0);if(!(i>=q&&i<=J||i>=kn&&i<=An)){for(var a=String.fromCharCode(i),o=e.length-r,s=n;s<=o;){var c=e.indexOf(a,s);if(c===-1||c>o)return-1;for(var l=!0,u=1;u<r;u++){var d=e.charCodeAt(c+u),f=t.charCodeAt(u);if(d>=q&&d<=J&&(d+=Mn),f>=q&&f<=J&&(f+=Mn),d!==f){l=!1;break}}if(l)return c;s=c+1}return-1}i>=q&&i<=J&&(i+=Mn);for(let a=n;a<=e.length-r;a++){var p=e.charCodeAt(a);if(p>=q&&p<=J&&(p+=Mn),p!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(a+i),o=t.charCodeAt(i);if(r>=q&&r<=J&&(r+=Mn),o>=q&&o<=J&&(o+=Mn),r!==o){n=!1;break}}if(n)return a}return-1}function Li(e,t,n){let r=t.length;var i=t.charCodeAt(0);i>=q&&i<=J&&(i+=Mn);for(let o=Math.min(n,e.length-r);o>=0;o--){var a=e.charCodeAt(o);if(a>=q&&a<=J&&(a+=Mn),a!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(o+i),a=t.charCodeAt(i);if(r>=q&&r<=J&&(r+=Mn),a>=q&&a<=J&&(a+=Mn),r!==a){n=!1;break}}if(n)return o}return-1}var Ri=-1;function zi(e,t,n){let r=n.toLowerCase(),i=`<${r}`,a=`</${r}`,o=1,s=t,c=e.length;for(Ri=-1;s<c&&o>0;){let t=Ii(e,i,s),n=Ii(e,a,s);if(n===-1)return-1;if(t!==-1&&t<n){let n=Qr(e,t);n?(n.tag.toLowerCase()===r&&!n.f&&!n.n&&!Jn(n.tag)&&o++,s=n.end):s=t+1}else{var l=n+a.length,u=l<c?e.charCodeAt(l):62;if((u===U||u===z||u===B||u===V)&&(o--,o===0)){Ri=n;let t=n+a.length;for(;t<c&&e.charCodeAt(t)!==U;)t++;return t+1}s=n+1}}return-1}function Bi(e,t,n,r){if(r.ignoreHTMLBlocks||r.disableParsingRawHTML)return null;var i=di(e,t);if(gi(e,t,i),hi>3&&!n.inHTML)return null;var a=t+Z;if(e.charCodeAt(a)!==qt)return null;var o=e.indexOf(`>`,a+1);if(o!==-1&&o<i){var s=e.slice(a+1,o);if(/^[a-zA-Z][a-zA-Z0-9+.-]*:/.test(s)||/^[^\s@]+@[^\s@]+$/.test(s))return null}var c=Vi(e,a);if(c>=1&&c<=5){var l=e.length;if(c===1){for(var u=e.length,d=0;d<Pr.length;d++){var f=Ii(e,`</${Pr[d]}>`,a);f>=0&&f<u&&(u=f)}if(u<e.length){var p=e.indexOf(`>`,u);l=p>=0?X(e,p+1):e.length}}else{var m=c===2?`-->`:c===3?`?>`:c===4?`>`:`]]>`,h=e.indexOf(m,a);h>=0&&(l=X(e,h+m.length))}var g=e.slice(a,l);if(c>=2)return{node:{type:Y.htmlComment,text:g,s:!1,raw:!0},end:l};var _=`div`,v=g.match(/^<\/?([a-zA-Z][a-zA-Z0-9-]*)/);v&&(_=v[1]);var y=Qr(e,a),b={},x;y&&!y.f&&(b=Fi(y.attrs,_,r),x=y.g+y.b);var S=[],C=Ii(g,`</${_.toLowerCase()}`,0),w=``,T,E,D;if(y?.f){D=g.slice(0,y.end-a);for(var O=g.slice(y.end-a);O.length>0&&O.charCodeAt(O.length-1)===V;)O=O.slice(0,-1);O&&(E=$r(O))}else if(y&&!y.f){var ee=y.end-a;if(C===-1){for(var k=g;k.length>0&&k.charCodeAt(k.length-1)===V;)k=k.slice(0,-1);T=$r(k)}else{var te=ee;g.charCodeAt(te)===V&&te++;for(var ne=C;ne>te;){var re=g.charCodeAt(ne-1);if(re!==z&&re!==B&&re!==V&&re!==Lt)break;ne--}var ie=g.slice(te,ne);ie&&(E=$r(ie));for(var ae=g.slice(C);ae.length>0&&ae.charCodeAt(ae.length-1)===V;)ae=ae.slice(0,-1);D=$r(ae),w=g.slice(ee,C).trim()}}var oe=y?y.f:!1;return{node:{type:Y.htmlBlock,tag:_,attrs:b,b:x,children:S,e:E,h:D,j:T,text:w,c:!0,a:oe},end:l}}if(c===6||c===7){var se=pi(e,t),ce=se<e.length?se:e.length,le=e.slice(a,ce),A=se<e.length?X(e,se):e.length,j=Qr(e,a);if(j){var M=j.tag,N=M.toLowerCase();if(j.f){var ue=e.slice(j.end,ce);return{node:{type:Y.htmlBlock,tag:M,attrs:{},children:[],h:e.slice(a,j.end),e:ue?$r(ue):void 0,text:ue,c:!0,a:!0},end:A}}if(j.n||Jn(M))return{node:{type:Y.htmlBlock,tag:M,attrs:Fi(j.attrs,M,r),b:j.g+j.b,children:[],text:``,c:!1,a:!1},end:j.end<e.length&&e.charCodeAt(j.end)===V?j.end+1:j.end};var de=n.d||0,P=e.slice(a,ce),F=-1,fe=-1,pe=!1;if(de<10){for(var me=`</${N}`,he=j.end-a,I=1,ge=he;ge<P.length&&I>0;){var _e=Ii(P,`<${N}`,ge),ve=Ii(P,me,ge);if(ve===-1)break;if(_e!==-1&&_e<ve){var ye=_e+N.length+1;if(ye<P.length){var be=P.charCodeAt(ye);(be===z||be===B||be===V||be===U||be===pn)&&I++}ge=_e+1}else{var L=ve+me.length;if(L<P.length){var xe=P.charCodeAt(L);if((xe===U||xe===z||xe===B||xe===V)&&(I--,I===0)){F=ve;for(var R=L;R<P.length&&P.charCodeAt(R)!==U;)R++;fe=R+1;break}}else if(I--,I===0){F=ve,fe=P.length;break}ge=ve+1}}if(F===-1&&!j.f&&(c===6||j.u)){var Se=zi(e,j.end,N);if(Se!==-1){for(var Ce=Ri,we=j.end,Te=!1,Ee=!1,De=!1,Oe=0,ke=!1,Ae=!1,je=we;je<Ce;){var Me=e.charCodeAt(je);if(Me===V)Ae&&(Te=!0),ke||Oe++,Ae=!0,je++;else if(Me===z||Me===B)je++;else{if(!ke&&(ke=!0,Oe>=2&&Me===qt)){De=!0;break}if(Ae=!1,Me===qt){var Ne=e.charCodeAt(je+1)|32;if((Ne===an||Ne===on||Ne===rn)&&(Lr.lastIndex=je,Lr.test(e))){Ee=!0;break}}je++}}if(Te&&!De&&!Ee){var Pe=di(e,Se);ce=Pe,A=X(e,Pe),P=e.slice(a,ce),le=e.slice(a,ce),F=Ce-a,fe=Se-a,pe=!0}}}}var Fe=j.b.indexOf(`
`)!==-1||j.g.indexOf(`
`)!==-1,Ie=!1;F!==-1&&(Ie=P.slice(fe).trim().length===0);var Le=!1,Re=ce,ze=A;if(F!==-1){var Be=a+fe,Ve=di(e,Be-1);if(Be<Ve){for(var He=Be;He<Ve&&(e.charCodeAt(He)===z||e.charCodeAt(He)===B);)He++;if(He<Ve&&e.charCodeAt(He)===qt){var Ue=Qr(e,He);Ue&&!Ue.f&&(Le=!0,Re=Be,ze=Be,Ie=!0)}}if(!Le){var We=X(e,Ve);if(We<ce){for(var Ge=We;Ge<ce&&(e.charCodeAt(Ge)===z||e.charCodeAt(Ge)===B);)Ge++;Ge<ce&&e.charCodeAt(Ge)===qt&&Qr(e,Ge)&&(Le=!0,Re=Ve,ze=We,Ie=!0)}}!Le&&n.inHTML&&(Le=!0,Re=Ve,ze=X(e,Ve),Ie=e.slice(Be,Ve).trim().length===0)}var Ke=[],qe=``;if(F!==-1){qe=P.slice(j.end-a,F);var Je=qe.trim();if(Je){var{inline:Ye,inHTML:Xe,d:Ze}=n;if(n.inHTML=!0,n.d=de+1,N===`p`)n.inline=!0,Ke=qi(Je,!1,n,r);else{var Qe=qe.indexOf(`

`)!==-1,$e=Rr.test(Je),et=zr.test(Je),tt=Qe||$e||n.inHTML&&et;qe.length>=2&&qe.charCodeAt(0)===V&&qe.charCodeAt(qe.length-1)===V&&!Qe&&!$e&&!et?Ke=[{type:Y.text,text:Je}]:tt||et?(n.inline=!1,Ke=Ma(qe,n,r)):(n.inline=!0,Ke=qi(Je,!1,n,r))}n.inline=Ye,n.inHTML=Xe,n.d=Ze}}var nt=!1;if(c===6&&F!==-1&&!n.inHTML&&!Fe){var rt=/<[a-zA-Z][^>]*>/.test(qe),it=qe.indexOf(`

`)!==-1||Rr.test(qe);rt&&!it&&(nt=!0)}if(!pe&&(n.inHTML||c===7||Fe||!Ie||nt)){var at,ot,st=!1;if(F!==-1&&Le){var ct=!1;if(n.inHTML&&fe<P.length){for(var lt=fe;lt<P.length&&P.charCodeAt(lt)!==V;)lt++;var ut=P.slice(fe,lt).trim();ct=ut.length>1&&ut.charCodeAt(0)===qt&&ut.charCodeAt(1)!==pn}ot=ct?P.slice(j.end-a):qe,st=!0}else(c===7||n.inHTML)&&F!==-1?(ot=P.slice(j.end-a),ot.charCodeAt(0)===V&&(ot=ot.slice(1))):Le?at=e.slice(a,Re):Fe?at=le:(ot=P.slice(j.end-a),ot.charCodeAt(0)===V&&(ot=ot.slice(1)));var dt=at!==void 0,ft=$r(at===void 0?ot||``:at),pt={type:Y.htmlBlock,tag:M,attrs:Fi(j.attrs,M,r),b:j.g+j.b,children:Ke,e:dt?void 0:ft,j:dt?ft:void 0,text:ft,c:!0,a:!1};return st&&(pt.x=!0),{node:pt,end:ze}}var mt=$r(qe);return{node:{type:Y.htmlBlock,tag:M,attrs:Fi(j.attrs,M,r),b:j.g+j.b,children:Ke,e:pe?void 0:mt,text:mt,c:!1,a:!1},end:ze}}var ht=le.match(/^<(\/?)([a-zA-Z][a-zA-Z0-9-]*)/),gt=ht?ht[2]:`div`,_t=ht?ht[1]===`/`:!1,vt,yt,bt,xt=``;if(_t){var St=le.indexOf(`>`);St===-1?vt=le:(vt=le.slice(0,St+1),xt=le.slice(St+1),xt&&(yt=$r(xt)))}else bt=$r(le);return{node:{type:Y.htmlBlock,tag:gt,attrs:{},children:[],e:yt,h:vt,j:bt,text:_t?xt:le,c:!0,a:_t},end:A}}var Ct=Qr(e,a);if(!Ct)return null;var wt=Ct.tag,Tt=wt.toLowerCase(),Et=wt.charCodeAt(0),Dt=Et>=q&&Et<=J;if(!(Dt||Pi.has(Tt)||Fr.has(Tt)||Tt.includes(`-`)))return null;if(Ct.f)return{node:{type:Y.htmlSelfClosing,tag:wt,attrs:{},h:e.slice(a,Ct.end),a:!0},end:Ct.end};var Ot=zi(e,Ct.end,wt),kt=[];if(Ot!==-1){var At=Ri,jt=e.slice(Ct.end,At),Mt=jt.trim();if(Mt){var Nt=jt.indexOf(`

`)!==-1,Pt=Rr.test(Mt),Ft=zr.test(Mt),It=n.inline,H=n.inHTML,Rt=n.d;n.inHTML=!0,n.d=(n.d||0)+1,Nt||Pt||Ft?(n.inline=!1,kt=Ma(jt,n,r)):(n.inline=!0,kt=qi(Mt,!1,n,r)),n.inline=It,n.inHTML=H,n.d=Rt}var zt=di(e,Ot),Bt=e.slice(Ot,zt).trim()?Ot:X(e,Ot),Vt=Dt?e.slice(a,Ot):e.slice(a,Bt);return{node:{type:Y.htmlBlock,tag:wt,attrs:Fi(Ct.attrs,wt,r),b:Ct.g+Ct.b,children:kt,j:$r(Vt),text:Dt?jt:Vt,c:!0,a:!1},end:Bt}}var Ht=pi(e,Ct.end),W=Ht<e.length?X(e,Ht):Ht,Ut=e.slice(Ct.end,Ht);if(Ut.trim()){var{inline:Wt,inHTML:Gt,d:Kt}=n;n.inline=!1,n.inHTML=!0,n.d=(n.d||0)+1,kt=Ma(Ut,n,r),n.inline=Wt,n.inHTML=Gt,n.d=Kt}var Jt=e.slice(Ct.end,Ht);return{node:{type:Y.htmlBlock,tag:wt,attrs:Fi(Ct.attrs,wt,r),b:Ct.g+Ct.b,children:kt,e:$r(Jt),text:Ut,c:!0,a:!1},end:W}}function Vi(e,t){if(e.charCodeAt(t)!==qt)return 0;var n=t+1,r=e.length;if(e.charCodeAt(n)===Xt&&e.charCodeAt(n+1)===W&&e.charCodeAt(n+2)===W)return 2;if(e.charCodeAt(n)===dn)return 3;if(e.charCodeAt(n)===Xt){var i=e.charCodeAt(n+1);if(i>=q&&i<=J)return 4;if(e.slice(n+1,n+8)===`[CDATA[`)return 5}for(var a=e.charCodeAt(n)===pn,o=a?n+1:n,s=o;s<r;){var c=e.charCodeAt(s);if(c>=q&&c<=J||c>=kn&&c<=An||c>=G&&c<=K||c===W)s++;else break}if(s===o)return 0;var l=e.slice(o,s);if(Fr.has(l.toLowerCase())){if(a)return 0;var u=e.charCodeAt(s);return+(u===z||u===B||u===U||u===V||s>=r)}if(Pi.has(l.toLowerCase())){if(a){for(var d=s;d<r&&(e.charCodeAt(d)===z||e.charCodeAt(d)===B);)d++;return d<r&&e.charCodeAt(d)===U?6:0}var f=s<r?e.charCodeAt(s):-1;return f===z||f===B||f===U||f===V||f===pn||f===-1?6:0}if(a){for(var p=s;p<r&&(e.charCodeAt(p)===z||e.charCodeAt(p)===B);)p++;if(p<r&&e.charCodeAt(p)===U){var m=di(e,t);if(e.slice(p+1,m).trim()===``)return 7}}else{var h=di(e,t),g=Qr(e,t);if(g&&g.end<=h&&e.slice(g.end,h).trim()===``)return 7}return 0}function Hi(e,t,n){for(var r=0,i=e.length;r<i&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;for(;i>r&&(e.charCodeAt(i-1)===z||e.charCodeAt(i-1)===B);)i--;r<i&&e.charCodeAt(r)===_n&&r++,i>r&&e.charCodeAt(i-1)===_n&&(i-2<r||e.charCodeAt(i-2)!==Wt)&&i--;for(var a=[],o=r,s=!1,c=[],l=r;l<i;){var u=e.charCodeAt(l);if(u===Wt&&l+1<i){e.charCodeAt(l+1)===_n?(s||(s=!0,c=[]),c.push(e.slice(o,l)),c.push(`|`),l+=2,o=l):l+=2;continue}if(u===H){for(var d=0;l<i&&e.charCodeAt(l)===H;)d++,l++;for(var f=!1;l<i&&!f;){for(var p=0;l<i&&e.charCodeAt(l)===H;)p++,l++;p===d?f=!0:p===0&&l++}continue}if(u===_n){var m=s?(c.push(e.slice(o,l)),c.join(``)):e.slice(o,l);a.push(m.trim()),l++,o=l,s=!1,c=[];continue}l++}var h=s?(c.push(e.slice(o,i)),c.join(``)):e.slice(o,i);return a.push(h.trim()),a.map(e=>{var r=e.indexOf(`\\|`)===-1?e:e.replace(/\\\|/g,`|`);return r?qi(r,!1,t,n):[]})}function Ui(e,t,n,r){let i=di(e,t);var a=e.indexOf(`|`,t);if(a<0||a>=i)return null;let o=X(e,i);if(o>=e.length)return null;let s=di(e,o);if(!Wr(e,o,s))return null;let c=e.slice(t,i),l=e.slice(o,s);for(var u=[],d=0,f=l.length;d<f&&(l.charCodeAt(d)===z||l.charCodeAt(d)===B);)d++;for(d<f&&l.charCodeAt(d)===_n&&d++;d<f;){for(;d<f&&(l.charCodeAt(d)===z||l.charCodeAt(d)===B);)d++;if(d>=f||l.charCodeAt(d)===_n)break;var p=l.charCodeAt(d)===Qt;for(p&&d++;d<f&&l.charCodeAt(d)===W;)d++;var m=d<f&&l.charCodeAt(d)===Qt;for(m&&d++,u.push(p&&m?`center`:m?`right`:p?`left`:null);d<f&&(l.charCodeAt(d)===z||l.charCodeAt(d)===B);)d++;d<f&&l.charCodeAt(d)===_n&&d++}let h=Hi(c,n,r);if(u.length!==h.length)return null;let g=[],_=X(e,s);for(;_<e.length;){let t=di(e,_),i=e.slice(_,t);if(_i(e,_,t))break;if(gi(e,_,t),hi<4){var v=e.charCodeAt(_+Z);if(v===U||v===Vt||(v===W||v===Gt||v===Kt)&&xi(e,_))break;if(v===H||v===Rt){for(var y=_+Z,b=0;y<t&&e.charCodeAt(y)===v;)b++,y++;if(b>=3)break}}g.push(Hi(i,n,r)),_=X(e,t)}if(r.optimizeForStreaming&&g.length===0)return null;for(var x=h.length,S=0;S<g.length;S++)if(g[S].length<x)for(;g[S].length<x;)g[S].push([]);else g[S].length>x&&(g[S].length=x);return{node:{type:Y.table,header:h,cells:g,align:u},end:_}}function Wi(e,t,n){if(gi(e,t,di(e,t)),hi>3)return null;var r=t+Z;if(e.charCodeAt(r)!==zt)return null;if(r+1<e.length&&e.charCodeAt(r+1)===Bt)return Gi(e,r,n)||null;n.refs||={};var i=ti(e,r,n.refs);return i===null?null:{node:{type:Y.refCollection},end:i}}function Gi(e,t,n){var r=e.length;if(e.charCodeAt(t)!==zt||t+1>=r||e.charCodeAt(t+1)!==Bt)return null;for(var i=t+2,a=i;i<r&&e.charCodeAt(i)!==Yt;){if(e.charCodeAt(i)===V)return null;i++}if(i>=r)return null;var o=`^${e.slice(a,i)}`.toLowerCase();if(i++,i>=r||e.charCodeAt(i)!==Qt)return null;for(i++;i<r&&(e.charCodeAt(i)===z||e.charCodeAt(i)===B);)i++;if(i<r&&e.charCodeAt(i)===V)for(i++;i<r&&(e.charCodeAt(i)===z||e.charCodeAt(i)===B);)i++;var s=e.indexOf(`
`,i);s<0&&(s=r);for(var c=e.slice(i,s).trim(),l=s<r?s+1:r;l<r;){var u=di(e,l);if(gi(e,l,u),hi>=2&&!_i(e,l,u))c+=`
${e.slice(l,u)}`,l=X(e,u);else if(_i(e,l,u)){var d=X(e,u);if(d<r&&(gi(e,d,di(e,d)),hi>=2)){c+=`
`,l=X(e,u);continue}break}else break}var f=n.refs;return f&&!f[o]&&(f[o]={target:c,title:void 0}),{node:{type:Y.footnote},end:l}}function Ki(e,t,n,r){let i=t,a=0,o=0,s=-1;for(;i<e.length;){let t=s>=0?s:di(e,i);if(s=-1,_i(e,i,t))break;if(gi(e,i,t),hi<4&&o>0&&!n.l){let n=e.charCodeAt(i+Z);if(n===Ut||n===W){let r=i+Z;for(;r<t&&e.charCodeAt(r)===n;)r++;for(;r<t&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;if(r>=t){a=n===Ut?1:2,i=X(e,t);break}}}o=t;let x=X(e,t);if(x<e.length){if(e.charCodeAt(x)===On){var c=di(e,x);i=X(e,c),o=c;continue}let t=di(e,x);if(s=t,gi(e,x,t),hi<4){let a=e.charCodeAt(x+Z);if(a===U){i=x;break}if(a===Vt){for(var l=x+Z,u=0;l<t&&e.charCodeAt(l)===Vt&&u<=6;)u++,l++;if(u>=1&&u<=6&&(l>=t||e.charCodeAt(l)===z||e.charCodeAt(l)===B)){i=x;break}}if(a===H||a===Rt){for(var d=x+Z,f=0;d<t&&e.charCodeAt(d)===a;)f++,d++;if(f>=3){i=x;break}}if(a===qt){var p=x+Z+1,m=p<t?e.charCodeAt(p):0,h=m===Xt||m===dn;if(!h&&m===pn){for(var g=p+1,_=g;_<t&&(e.charCodeAt(_)>=q&&e.charCodeAt(_)<=J||e.charCodeAt(_)>=kn&&e.charCodeAt(_)<=An||e.charCodeAt(_)>=G&&e.charCodeAt(_)<=K||e.charCodeAt(_)===W);)_++;_>g&&(h=Pi.has(e.slice(g,_).toLowerCase()))}else if(!h){for(var v=p;v<t&&(e.charCodeAt(v)>=q&&e.charCodeAt(v)<=J||e.charCodeAt(v)>=kn&&e.charCodeAt(v)<=An||e.charCodeAt(v)>=G&&e.charCodeAt(v)<=K||e.charCodeAt(v)===W);)v++;if(v>p){var y=e.slice(p,v).toLowerCase();h=Pi.has(y)||Fr.has(y)}}if(h&&Bi(e,x,n,r)){i=x;break}}if(a===W||a===Gt||a===gn){let n=x+Z+1;if(n<t&&(e.charCodeAt(n)===z||e.charCodeAt(n)===B)&&fi(e,n,t)<t&&!xi(e,x)){i=x;break}}if(a>=G&&a<=K){let n=x+Z;for(;n<t&&e.charCodeAt(n)>=G&&e.charCodeAt(n)<=K;)n++;if(n<t&&(e.charCodeAt(n)===fn||e.charCodeAt(n)===xn)&&n-(x+Z)===1&&e.charCodeAt(x+Z)===49){var b=n+1;if(b<t&&(e.charCodeAt(b)===z||e.charCodeAt(b)===B)&&fi(e,b,t)<t){i=x;break}}}if(a===_n){let n=X(e,t);if(n<e.length&&Wr(e,n,di(e,n))){i=x;break}}if((a===W||a===Gt||a===Kt)&&xi(e,x)){if(a!==W){i=x;break}let n=0,r=x+Z;for(;r<t&&e.charCodeAt(r)===W;)n++,r++;for(;r<t&&(e.charCodeAt(r)===z||e.charCodeAt(r)===B);)r++;if(r<t){i=x;break}}}}i=X(e,t)}for(var x=a?o:i;x>t&&(e.charCodeAt(x-1)===V||e.charCodeAt(x-1)===Lt||e.charCodeAt(x-1)===z||e.charCodeAt(x-1)===B);)x--;for(var S=t;S<x&&(e.charCodeAt(S)===z||e.charCodeAt(S)===B);)S++;if(S>=x)return null;for(var C=!1,w=S;w<x;w++)if(e.charCodeAt(w)===On){C=!0;break}var T=C?e.slice(S,x).replace(/\u001E/g,``):e.slice(S,x);if(!T)return null;let E=qi(T,!0,n,r);return a?{node:{type:Y.heading,level:a,children:E,id:``},end:i}:{node:{type:Y.paragraph,children:E},end:i}}function qi(e,t,n,r){var i=n.t;if(!i){var a=n.k;n.k=t;var o=Aa(e,0,e.length,n,r);return n.k=a,o}var s=[];return i.push({dest:s,text:e,breaks:t,inline:n.inline,inAnchor:n.inAnchor,inHTML:n.inHTML,htmlDepth:n.d,inList:n.inList,inBlockQuote:n.inBlockQuote,noSetext:n.l,depth:n.o}),s}function Ji(e,t,n){if(e.charCodeAt(t)!==H)return null;let r=mi(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return null;let o=mi(e,a,n,96);if(o===r){let n=e.slice(t+r,a);return n.indexOf(`
`)!==-1&&(n=n.replace(/\n/g,` `)),n.length>0&&n[0]===` `&&n.at(-1)===` `&&n.trim().length>0&&(n=n.slice(1,-1)),{node:{type:Y.codeInline,text:n},end:a+o}}i=a+o}return null}function Yi(e,t,n){if(e.charCodeAt(t)!==H)return t;let r=mi(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return t;let o=mi(e,a,n,96);if(o===r)return a+o;i=a+o}return t}function Xi(e,t,n){if(e.charCodeAt(t)!==qt)return t;if(t+1<n&&e.charCodeAt(t+1)===pn){let r=t+2;for(;r<n&&e.charCodeAt(r)!==U;)r++;return r<n?r+1:t}if(t+3<n&&e.charCodeAt(t+1)===Xt&&e.charCodeAt(t+2)===W&&e.charCodeAt(t+3)===W){let n=e.indexOf(`-->`,t+4);return n>=0?n+3:t}let r=t+1,i=r;for(;r<n;){let t=e.charCodeAt(r);if(t>=q&&t<=J||t>=kn&&t<=An||t>=G&&t<=K||t===W)r++;else break}if(r===i)return t;let a=e.slice(i,r).toLowerCase(),o=!1;for(;r<n;){let i=e.charCodeAt(r);if(i===U){r++;break}if(i===pn&&r+1<n&&e.charCodeAt(r+1)===U){r+=2,o=!0;break}if(i===hn||i===mn){var s=i;for(r++;r<n&&e.charCodeAt(r)!==s;)r++;r<n&&r++;continue}if(i===V)return t;r++}if(o||Jn(a))return r;let c=1;for(;r<n&&c>0;)if(e.charCodeAt(r)===qt){if(r+1<n&&e.charCodeAt(r+1)===pn){let t=r+2,i=t;for(;i<n&&(e.charCodeAt(i)>=q&&e.charCodeAt(i)<=J||e.charCodeAt(i)>=kn&&e.charCodeAt(i)<=An);)i++;if(e.slice(t,i).toLowerCase()===a){for(;i<n&&e.charCodeAt(i)!==U;)i++;if(i<n&&i++,c--,c===0)return i}r=i}else{let t=r+1,i=t;for(;i<n&&(e.charCodeAt(i)>=q&&e.charCodeAt(i)<=J||e.charCodeAt(i)>=kn&&e.charCodeAt(i)<=An);)i++;e.slice(t,i).toLowerCase()===a&&c++,r++}}else r++;return r}function Zi(e,t,n,r,i){if(e.charCodeAt(t)!==Rt||t+1>=n||e.charCodeAt(t+1)!==Rt)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===H){let t=Yi(e,a,n);if(t>a){a=t;continue}}if(o===Rt&&e.charCodeAt(a+1)===Rt){let n=e.slice(t+2,a),o=Aa(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`del`,children:o},end:a+2}}o===Wt&&a+1<n&&a++,a++}return null}function Qi(e,t,n,r,i){if(e.charCodeAt(t)!==Ut||t+1>=n||e.charCodeAt(t+1)!==Ut)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===H){let t=Yi(e,a,n);if(t>a){a=t;continue}}if(o===Ut&&e.charCodeAt(a+1)===Ut&&a>t+2){let n=e.slice(t+2,a),o=Aa(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`mark`,children:o},end:a+2}}o===Wt&&a+1<n&&a++,a++}return null}function $i(e,t,n){return e<jn?!!(oi(e)&Zn):rr.test(t[n])}function ea(e,t,n){return e<jn?!!(oi(e)&Yn):ir.test(t[n])}function ta(e,t,n){var r=e.charCodeAt(t);if(r!==Gt&&r!==Kt)return null;var i=mi(e,t,n,r);if(i===0)return null;var a=t>0?e.charCodeAt(t-1):32,o=t+i<n?e.charCodeAt(t+i):32,s=ea(a,e,t-1),c=ea(o,e,t+i),l=t>0&&$i(a,e,t-1),u=t+i<n&&$i(o,e,t+i),d=!c&&(!u||s||l),f=!s&&(!l||c||u),p,m;return r===Gt?(p=d,m=f):(p=d&&(!f||l),m=f&&(!d||u)),{len:i,canOpen:p,canClose:m}}function na(e,t,n,r){if(t.length!==0){for(var i=e.length,a=Array(i),o=null,s=null,c=0;c<i;c++){var l={node:e[c],prev:s,next:null};s?s.next=l:o=l,a[c]=l,s=l}for(var u=Array(t.length),d=0;d<t.length;d++)u[d]=a[t[d].idx];for(var f=[],p=0;p<12;p++)f[p]=-1;for(var m=0;m<t.length;){var h=t[m];if(!(h.active&&h.canClose)){m++;continue}for(var g=(h.ch===Gt?0:1)*6+h.len%3*2+ +!!h.canOpen,_=f[g]===void 0?-1:f[g],v=-1,y=m-1;y>_;y--){var b=t[y];if(!(!b.active||b.ch!==h.ch||!b.canOpen)&&!((h.canOpen||b.canClose)&&(b.len+h.len)%3==0&&b.len%3!=0)){v=y;break}}if(v<0){f[g]=m-1,!h.canOpen&&(h.active=!1),m++;continue}var x=t[v],S=x.len>=2&&h.len>=2,C=S?2:1;x.len-=C,h.len-=C;var w=u[v],T=u[m],E=w.node,D=T.node;E.text=E.text.slice(0,E.text.length-C),D.text=D.text.slice(C);for(var O=[],ee=w.next;ee&&ee!==T;)O.push(ee.node),ee=ee.next;var k={node:{type:Y.textFormatted,tag:S?`strong`:`em`,children:O},prev:w,next:T};w.next=k,T.prev=k;for(var te=v+1;te<m;te++)t[te].active=!1;if(x.len===0&&(x.active=!1,E.text===``)){var ne=w.prev;k.prev=ne,ne?ne.next=k:o=k}if(h.len===0){if(h.active=!1,D.text===``){var re=T.next;k.next=re,re&&(re.prev=k)}}else continue;m++}for(var ie=0,ae=o;ae;){var oe=ae.node;if(oe.type===Y.text){var se=oe;if(se.text===``){ae=ae.next;continue}if(ie>0&&e[ie-1].type===Y.text){e[ie-1].text+=se.text,ae=ae.next;continue}}e[ie++]=oe,ae=ae.next}e.length=ie}}function ra(e,t,n,r){return t(e,n,r)===null?null:e}var ia=0,aa=0,oa=0,sa=0,ca=0,la=0,ua=0,da=0;function fa(){return ua===2147483647&&(aa=0,sa=0,la=0,ma=0,ua=0),++ua}var pa=null,ma=0,ha=[],ga=256;function _a(e,t,n,r,i){let a=e.charCodeAt(t)===Xt,o=a?t+1:t;if(e.charCodeAt(o)!==zt||sa===da&&o>=oa)return null;var s=ma===da?pa:null,c=s===null?0:s[o];if(c<0)return null;var l=c;if(c===0){var u=e.indexOf(`]`,o+1);if(u<0||u>=n)return oa=o,sa=da,null;l=o+1;var d=0;ha[d++]=o;for(var f=n-o>=ga;l<n&&d>0;){var p=e.charCodeAt(l);if(p===Wt&&l+1<n){l+=2;continue}if(p===H){var m=Yi(e,l,n);if(m>l){l=m;continue}}if(p===qt){var h=va(e,l,n);if(h){l=h.end;continue}var g=Xi(e,l,n);if(g>l){l=g;continue}}if(p===zt)ha[d++]=l;else if(p===Yt){var _=ha[--d];s===null&&f&&l-o>=ga&&(s=pa=new Int32Array(n),ma=da),s!==null&&(s[_]=l+1)}l++}if(d>0){if(s===null&&f&&l-o>=ga&&(s=pa=new Int32Array(n),ma=da),s!==null)for(;d>0;)s[ha[--d]]=-1;return null}}var v=l-1,y=e.slice(o+1,v),b=l<n?e.charCodeAt(l):0,x=!1;if(b===bn){var S=!0;for(l++;l<n&&(e.charCodeAt(l)===z||e.charCodeAt(l)===V);)l++;var C=``,w=l;if(l<n&&e.charCodeAt(l)===qt){for(l++,w=l;w<n&&e.charCodeAt(w)!==U;){if(e.charCodeAt(w)===Wt&&w+1<n){w+=2;continue}if(e.charCodeAt(w)===V){S=!1;break}w++}S&&(w>=n||e.charCodeAt(w)!==U)&&(S=!1),S&&(C=e.slice(l,w),w++)}else if(S){var T=aa===da?ia:-1;if(T>=0&&l>=T)S=!1;else{for(var E=0,D=!1;w<n;){var O=e.charCodeAt(w);if(O===Wt&&w+1<n){w+=2;continue}if(O===bn)E++;else if(O===xn){if(D=!0,E===0)break;E--}else if(O===z||O===V)break;w++}w>=n&&!D&&(T<0||l<T)&&(ia=l,aa=da),C=e.slice(l,w)}}if(S){for(l=w;l<n&&(e.charCodeAt(l)===z||e.charCodeAt(l)===V);)l++;var ee;if(l<n){var k=e.charCodeAt(l);if(k===hn||k===mn||k===bn){var te=k===bn?41:k;l++;for(var ne=l;l<n&&e.charCodeAt(l)!==te;)e.charCodeAt(l)===Wt&&l+1<n&&l++,l++;l>=n?S=!1:(ee=e.slice(ne,l),l++)}}if(S){for(;l<n&&(e.charCodeAt(l)===z||e.charCodeAt(l)===V);)l++;(l>=n||e.charCodeAt(l)!==xn)&&(S=!1)}}if(S){if(l++,C=zn(si(C)),ee!==void 0&&(ee=zn(si(ee))),a){var re=Ca(Aa(y,0,y.length,r,i));return{node:{type:Y.image,target:ra(C,i?.sanitizer||Vn,`img`,`src`),alt:re,title:ee},end:l}}var ie=r.inAnchor;r.inAnchor=!0;var ae=ie?[{type:Y.text,text:y}]:Aa(y,0,y.length,r,i);return r.inAnchor=ie,!r.inAnchor&&Sa(ae)?null:{node:{type:Y.link,target:ra(C,i?.sanitizer||Vn,`a`,`href`),title:ee,children:ae},end:l}}l=v+1,x=!0}var oe=``,se=l;if(!x&&b===zt){var ce=l+1;se=ce;for(var le=!1;se<n&&e.charCodeAt(se)!==Yt;){if(e.charCodeAt(se)===Wt&&se+1<n){se+=2;continue}if(e.charCodeAt(se)===zt){le=!0;break}se++}if(le||se>=n)return null;var A=e.slice(ce,se);if(A.trim())oe=ai(A);else{if(ii(y))return null;oe=ai(y)}se+=1}else{if(ii(y))return null;oe=ai(y)}var j=r.refs?.[oe];if(!j)return null;if(a)return{node:{type:Y.image,target:ra(j.target,i?.sanitizer||Vn,`img`,`src`),alt:Ca(Aa(y,0,y.length,r,i)),title:j.title},end:se};var M=r.inAnchor;r.inAnchor=!0;var ae=M?[{type:Y.text,text:y}]:Aa(y,0,y.length,r,i);return r.inAnchor=M,!r.inAnchor&&Sa(ae)?null:{node:{type:Y.link,target:ra(j.target,i?.sanitizer||Vn,`a`,`href`),title:j.title,children:ae},end:se}}function va(e,t,n){if(e.charCodeAt(t)!==qt)return null;for(var r=t+1;r<n;){var i=e.charCodeAt(r);if(i===U)break;if(i===z||i===V||i===Lt||i===qt)return null;r++}if(r>=n||e.charCodeAt(r)!==U)return null;var a=e.slice(t+1,r);return a.match(/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^\x00-\x20]*)$/)?{node:{type:Y.link,target:a,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:a.indexOf(`@`)!==-1&&/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(a)?{node:{type:Y.link,target:`mailto:${a}`,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:null}function ya(e,t,n,r){if(e.charCodeAt(t)!==zt||t+1>=n||e.charCodeAt(t+1)!==Bt||la===da&&t>=ca)return null;let i=t+2;for(;i<n&&e.charCodeAt(i)!==Yt&&e.charCodeAt(i)!==V;)i++;if(i>=n)return ca=t,la=da,null;if(e.charCodeAt(i)!==Yt)return null;let a=e.slice(t+2,i);return a?{node:{type:Y.footnoteReference,target:`#${Gn(a)}`,text:a},end:i+1}:null}function ba(e,t,n,r){if(r.disableBareUrls)return null;var i=``,a=!1,o=e.charCodeAt(t);if(o===tn||o===72?t+8<=n&&e.charCodeAt(t+1)===rn&&e.charCodeAt(t+2)===rn&&e.charCodeAt(t+3)===an&&(e.charCodeAt(t+4)===on&&e.charCodeAt(t+5)===Qt&&e.charCodeAt(t+6)===pn&&e.charCodeAt(t+7)===pn?i=`https://`:e.charCodeAt(t+4)===Qt&&e.charCodeAt(t+5)===pn&&e.charCodeAt(t+6)===pn&&(i=`http://`)):o===en||o===70?t+6<=n&&e.charCodeAt(t+1)===rn&&e.charCodeAt(t+2)===an&&e.charCodeAt(t+3)===Qt&&e.charCodeAt(t+4)===pn&&e.charCodeAt(t+5)===pn&&(i=`ftp://`):(o===nn||o===87)&&t+4<=n&&e.charCodeAt(t+1)===nn&&e.charCodeAt(t+2)===nn&&e.charCodeAt(t+3)===fn&&(i=`www.`,a=!0),!i)return null;let s=t+i.length;for(;s<n;){let t=e.charCodeAt(s);if(t===z||t===V||t===B||t===Lt||t===qt||t===U)break;s++}for(var c=0,l=0,u=t;u<s;u++){var d=e.charCodeAt(u);d===bn?c++:d===xn&&l++}let f=s;for(;f>t+i.length;){let n=e.charCodeAt(f-1);if(n===fn||n===ln||n===Qt||n===Xt||n===dn||n===xn||n===Gt||n===Kt||n===Rt){if(n===xn){if(c>=l)break;l--}f--}else if(n===un){for(var p=f-2;p>t&&(e.charCodeAt(p)>=q&&e.charCodeAt(p)<=J||e.charCodeAt(p)>=kn&&e.charCodeAt(p)<=An||e.charCodeAt(p)>=G&&e.charCodeAt(p)<=K);)p--;p>=t&&e.charCodeAt(p)===Zt?f=p:f--}else break}if(f<=t+i.length)return null;var m=t+(a?4:i.length),h=e.indexOf(`/`,m);if((h<0||h>f)&&(h=f),a&&e.indexOf(`.`,m)===-1)return null;for(var g=-1,_=-1,v=h-1;v>=m;v--)if(e.charCodeAt(v)===fn){if(g<0)g=v;else{_=v;break}}for(var v=_>=0?_+1:m;v<h;v++)if(e.charCodeAt(v)===Kt)return null;var y=e.slice(t,f),b=a?`http://${y}`:y;return{node:{type:Y.link,target:b,title:void 0,children:[{type:Y.text,text:y}]},end:f}}function xa(e,t,n,r){if(r.disableBareUrls)return null;for(var i=t,a=i;i<n;){var o=e.charCodeAt(i);if(o>=q&&o<=J||o>=kn&&o<=An||o>=G&&o<=K||o===fn||o===Xt||o===Vt||o===36||o===Ht||o===Zt||o===mn||o===Gt||o===gn||o===pn||o===Ut||o===dn||o===Bt||o===Kt||o===H||o===vn||o===_n||o===yn||o===Rt||o===W)i++;else break}if(i===a||i>=n||e.charCodeAt(i)!==Jt)return null;i++;for(var s=i,c=-1,l=i;i<n;){var o=e.charCodeAt(i);if(o>=q&&o<=J||o>=kn&&o<=An||o>=G&&o<=K)i++;else if((o===W||o===Kt)&&i>s)i++;else if(o===fn){if(i===s)break;var u=e.charCodeAt(i-1);if(u===W||u===Kt||i-l>63)break;if(i+1<n){var d=e.charCodeAt(i+1);if(d>=q&&d<=J||d>=kn&&d<=An||d>=G&&d<=K)c=i,l=i+1,i++;else break}else break}else break}if(i-l>63||c<0)return null;var f=e.charCodeAt(i-1);if(!(f>=q&&f<=J||f>=kn&&f<=An||f>=G&&f<=K)||i<=c+1)return null;for(var p=-1,m=c-1;m>=s;m--)if(e.charCodeAt(m)===fn){p=m;break}for(var m=p>=0?p+1:s;m<i;m++)if(e.charCodeAt(m)===Kt)return null;var h=e.slice(t,i);return{node:{type:Y.link,target:`mailto:${h}`,title:void 0,children:[{type:Y.text,text:h}]},end:i}}function Sa(e){for(var t=0;t<e.length;t++)if(e[t].type===Y.link||`children`in e[t]&&Array.isArray(e[t].children)&&Sa(e[t].children))return!0;return!1}function Ca(e,t){for(var n=``,r=0;r<e.length;r++){var i=e[r];i.type===Y.text?n+=i.text:i.type===Y.breakLine?n+=` `:i.type===Y.codeInline||i.type===Y.footnoteReference?n+=i.text:`children`in i&&Array.isArray(i.children)?n+=Ca(i.children,t):!t&&i.type===Y.image&&(n+=i.alt||``)}return n}function wa(e,t,n){for(var r=0;r<e.length;r++){var i=e[r];if(i.type===Y.heading){var a=i;a.id=vi(n(Ca(a.children,!0)),t)}if(`children`in i){var o=i.children;Array.isArray(o)&&wa(o,t,n)}if((i.type===Y.orderedList||i.type===Y.unorderedList)&&Array.isArray(i.items))for(var s=i.items,c=0;c<s.length;c++)wa(s[c],t,n)}}function Ta(e){return{type:Y.text,text:e}}function Ea(e,t,n){var r=t+1;if(r>=n)return-1;if(e.charCodeAt(r)===Vt){r++;var i=r<n&&(e.charCodeAt(r)===En||e.charCodeAt(r)===Dn);i&&r++;for(var a=r,o=i?6:7;r<n&&r-a<=o;){var s=e.charCodeAt(r);if(!(s>=G&&s<=K||i&&(s>=q&&s<=$t||s>=kn&&s<=en)))break;r++}return r===a||r-a>o?-1:r<n&&e.charCodeAt(r)===un?r+1:-1}for(var c=r;r<n&&r-c<48;){var l=e.charCodeAt(r);if(l>=q&&l<=J||l>=kn&&l<=An||l>=G&&l<=K){r++;continue}break}return r===c?-1:r<n&&e.charCodeAt(r)===un?r+1:-1}function Da(e,t,n,r,i){if(e.charCodeAt(t)!==qt)return null;var a=t+1;if(a>=n)return null;var o=e.charCodeAt(a);if(o===Xt&&a+1<n&&e.charCodeAt(a+1)===W&&a+2<n&&e.charCodeAt(a+2)===W){var s=a+3;if(s<n&&e.charCodeAt(s)===U)return{node:{type:Y.htmlComment,text:``,s:!0},end:s+1};if(s+1<n&&e.charCodeAt(s)===W&&e.charCodeAt(s+1)===U)return{node:{type:Y.htmlComment,text:`-`,s:!0},end:s+2};var c=e.indexOf(`-->`,s);return c!==-1&&c<=n-3?{node:{type:Y.htmlComment,text:e.slice(t+4,c),s:!1},end:c+3}:null}if(o===dn){var l=e.indexOf(`?>`,a+1);return l!==-1&&l<n?{node:{type:Y.htmlSelfClosing,tag:`?`,attrs:{},m:e.slice(t,l+2),a:!1},end:l+2}:null}if(o===Xt&&a+1<n){var u=e.charCodeAt(a+1);if(u===zt&&e.slice(a+1,a+8)===`[CDATA[`){var d=e.indexOf(`]]>`,a+8);return d!==-1&&d<n?{node:{type:Y.htmlSelfClosing,tag:`![CDATA[`,attrs:{},m:e.slice(t,d+3),a:!1},end:d+3}:null}if(u>=q&&u<=J){var f=e.indexOf(`>`,a+2);return f!==-1&&f<n?{node:{type:Y.htmlSelfClosing,tag:`!${e.slice(a+1,f)}`,attrs:{},m:e.slice(t,f+1),a:!1},end:f+1}:null}}if(o===pn){var p=a+1;if(p>=n)return null;var m=e.charCodeAt(p);if(!(m>=q&&m<=J||m>=kn&&m<=An))return null;for(p++;p<n;){var h=e.charCodeAt(p);if(h>=q&&h<=J||h>=kn&&h<=An||h>=G&&h<=K||h===W)p++;else break}for(;p<n&&(e.charCodeAt(p)===z||e.charCodeAt(p)===B||e.charCodeAt(p)===V);)p++;if(p<n&&e.charCodeAt(p)===U){var g=e.slice(a+1,p).trim();return{node:{type:Y.htmlSelfClosing,tag:g,attrs:{},h:e.slice(t,p+1),a:!0},end:p+1}}return null}if(!(o>=q&&o<=J||o>=kn&&o<=An))return null;var _=Qr(e,t);if(!_)return null;var v=_.tag,y=v.toLowerCase();if(_.n||Jn(v))return{node:{type:Y.htmlSelfClosing,tag:v,attrs:Fi(_.attrs,v,i),m:_.q?Xr(_):e.slice(t,_.end),a:!1},end:_.end};var b=Fr.has(y),x=zi(e.slice(0,n),_.end,v);if(x===-1)return{node:{type:Y.htmlSelfClosing,tag:v,attrs:Fi(_.attrs,v,i),m:_.q?Xr(_):e.slice(t,_.end),a:!1},end:_.end};var S=Li(e,`</${y}`,x),C=e.slice(_.end,S);if(b){var w=$r(C);return{node:{type:Y.htmlBlock,tag:v,attrs:Fi(_.attrs,v,i),b:_.g+_.b,children:[],e:w||void 0,h:e.slice(S,x),text:w,c:!0,a:!1},end:x}}var T=[],E=C.trim();if(E){var{inAnchor:D,inline:O,k:ee}=r;y===`a`&&(r.inAnchor=!0),r.k=!1,E.indexOf(`

`)!==-1||/^#{1,6}\s/.test(E)?(r.inline=!1,T=Ma(E,r,i)):T=Aa(E,0,E.length,r,i),r.inAnchor=D,r.inline=O,r.k=ee}return{node:{type:Y.htmlBlock,tag:v,attrs:Fi(_.attrs,v,i),b:_.b,children:T,text:$r(C),c:!1,a:!1},end:x}}var Oa=200,ka=0;function Aa(e,t,n,r,i){if(ka++,ka>Oa)return ka--,[{type:Y.text,text:e.slice(t,n)}];var a=da;da=fa();let o=r;if(i.optimizeForStreaming){let r=function(e,t){for(var n=1,r=t+1;r<e.length;r++){var i=e.charCodeAt(r);if(i===zt)n++;else if(i===Yt&&(n--,n===0))return r}return-1},i=e.slice(t,n),a=i;for(var s=0,c=0,l=0,u=0,d=0,f=-1,p=-1,m=-1,h=-1,g=-1,_=0;_<i.length;_++){var v=i.charCodeAt(_);v===Gt?_+1<i.length&&i.charCodeAt(_+1)===Gt?(s++,f=_,_++):(c++,p=_):v===Kt?_+1<i.length&&i.charCodeAt(_+1)===Kt?(l++,m=_,_++):(u++,h=_):v===Rt&&_+1<i.length&&i.charCodeAt(_+1)===Rt&&(d++,g=_,_++)}var y=[];d%2==1&&g>=0&&y.push([g,2]),l%2==1&&m>=0&&y.push([m,2]),u%2==1&&h>=0&&y.push([h,1]),s%2==1&&f>=0&&y.push([f,2]),c%2==1&&p>=0&&y.push([p,1]),y.sort((e,t)=>t[0]-e[0]);for(var b=0;b<y.length;b++){var x=y[b][0],S=y[b][1];i=i.slice(0,x)+i.slice(x+S)}let o=0,A=-1;for(let e=0;e<i.length;e++)i.charCodeAt(e)===H&&(o++,A=e);if(o%2==1&&A!==-1){let e=!1,t=-1,n=0;for(;n<i.length;)i.charCodeAt(n)===H&&(e?(e=!1,t=-1):(t=n,e=!0)),n++;e&&t!==-1&&(i=i.slice(0,t))}for(var C=!0;C;){C=!1;for(var w=-1,T=-1,E=-1,D=!1,O=0;O<i.length;O++)if(i.charCodeAt(O)===zt&&(O===0||i.charCodeAt(O-1)!==Wt)){var ee=O>0&&i.charCodeAt(O-1)===Xt,k=ee?O-1:O,te=r(i,O);if(te===-1)w=k,D=ee,T=O+1,E=i.length;else{var ne=te+1;if(ne>=i.length)w=k,D=ee,T=O+1,E=te;else if(i.charCodeAt(ne)===bn){var re=i.indexOf(`)`,ne+1);re===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=re}else if(i.charCodeAt(ne)===zt){var ie=i.indexOf(`]`,ne+1);ie===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=ie}else O=te}}if(w>=0){var ae=D?``:i.slice(T,E);i=i.slice(0,w)+ae,C=!0}}let j=i.match(/<([A-Z][A-Za-z0-9]*)(?:\s[^>]*)?>([^<]*)$/);if(j&&j.index!==void 0){var oe=j[0].length-j[2].length;if(!(oe>=2&&j[0].charCodeAt(oe-2)===pn)){for(var se=!1,ce=0,le=0;le<j.index;le++)i.charCodeAt(le)===H&&ce++;if(se=ce%2==1,!se){let e=j[1];Ii(i,`</${e}`,0)===-1&&(i=i.slice(0,j.index)+j[2])}}}i!==a&&(e=e.slice(0,t)+i,n=t+i.length)}let A=[];var j=[];let M=t;var N=``,ue=i.disableAutoLink||i.disableBareUrls||o.inAnchor?-1:e.indexOf(`@`,t);for(ue>=n&&(ue=-1);t<n;){let r=e.charCodeAt(t),a=null;if(r===H){if(a=Ji(e,t,n),!a){var de=mi(e,t,n,H);t+=de-1}}else if(r===Gt||r===Kt){var P=ta(e,t,n);if(P){if(P.canOpen||P.canClose){(N||t>M)&&(A.push(Ta(N+e.slice(M,t))),N=``);var F=Ta(e.slice(t,t+P.len));j.push({idx:A.length,ch:r,len:P.len,canOpen:P.canOpen,canClose:P.canClose,active:!0}),A.push(F),t+=P.len,M=t;continue}t+=P.len-1}}else if(r===Rt)a=Zi(e,t,n,o,i);else if(r===Ut)a=Qi(e,t,n,o,i);else if(r===zt)t+1<n&&e.charCodeAt(t+1)===Bt&&(a=ya(e,t,n,o)),a||=_a(e,t,n,o,i);else if(r===Xt&&t+1<n&&e.charCodeAt(t+1)===zt)a=_a(e,t,n,o,i);else if(r===qt)a=va(e,t,n),!(a||i.disableParsingRawHTML||i.ignoreHTMLBlocks)&&(a=Da(e,t,n,o,i));else if(r===Zt){var fe=Ea(e,t,n);if(fe!==-1){var pe=e.slice(t,fe),me=zn(pe);if(me!==pe){N=N+e.slice(M,t)+me,t=fe,M=fe;continue}}}else if((r===tn||r===nn||r===en)&&!o.inAnchor&&!i.disableAutoLink&&(t===0||e.charCodeAt(t-1)!==qt)){var he=t+1<n?e.charCodeAt(t+1):0;(r===tn&&he===rn||r===en&&he===rn||r===nn&&he===nn)&&(a=ba(e,t,n,i))}if(!a&&ue>=0&&ue-t<=64&&!o.inAnchor&&!i.disableAutoLink&&!i.disableBareUrls&&(r>=q&&r<=J||r>=kn&&r<=An||r>=G&&r<=K)&&(a=xa(e,t,n,i),!a&&t>=ue&&(ue=e.indexOf(`@`,t+1),ue>=n&&(ue=-1))),r===V&&o.k){var I=!1,ge=0;if(t>M&&e.charCodeAt(t-1)===Wt)I=!0,ge=1;else{for(var _e=0,ve=t-1;ve>=M&&e.charCodeAt(ve)===z;)_e++,ve--;_e>=2&&(I=!0,ge=_e)}if(I){for((N||t-ge>M)&&(A.push(Ta(N+e.slice(M,t-ge))),N=``),A.push({type:Y.breakLine}),t++;t<n&&e.charCodeAt(t)===z;)t++;M=t;continue}var ye=t>M&&e.charCodeAt(t-1)===z,be=t+1<n&&e.charCodeAt(t+1)===z;if(ye||be){for(var L=t;L>M&&e.charCodeAt(L-1)===z;)L--;for(N+=`${e.slice(M,L)}
`,t++;t<n&&e.charCodeAt(t)===z;)t++;M=t;continue}}if(a)(N||t>M)&&(A.push(Ta(N+e.slice(M,t))),N=``),A.push(a.node),t=a.end,M=t;else{if(r===Wt&&t+1<n&&oi(e.charCodeAt(t+1))&Zn){(N||t>M)&&(A.push(Ta(N+e.slice(M,t))),N=``),A.push(Ta(e[t+1])),t+=2,M=t;continue}if(t++,ue<0||ue-t>64)for(;t<n&&!(ue>=0&&ue-t<=64);){var xe=e.charCodeAt(t);if(xe<jn&&!Br[xe])t++;else break}}}return(N||n>M)&&(A.push(Ta(N+e.slice(M,n))),N=``),j.length>0&&na(A,j,r,i),da=a,ka--,A}var ja=500;function Ma(e,t,n){var r=t.o||0;if(r>ja)return[{type:Y.text,text:e}];if(t.o=r+1,n.optimizeForStreaming&&!(t.i||t.w)){for(var i=e.length;i>0&&e.charCodeAt(i-1)===V;)i--;for(var a=i;a>0&&e.charCodeAt(a-1)!==V;)a--;if(i>a&&e.charCodeAt(a)===_n){for(var o=!1,s=a+1;s<i;s++){var c=e.charCodeAt(s);if(c!==z&&c!==B&&c!==_n&&c!==Qt&&c!==W){o=!0;break}}for(var l=!1,u=!1,d=0,f=a,p=a-1;p>0;){for(var m=p;m>0&&e.charCodeAt(m-1)!==V;)m--;if(e.charCodeAt(m)!==_n)break;f=m;for(var h=!0,g=!1,_=m;_<p;_++){var v=e.charCodeAt(_);if(v===W)g=!0;else if(v!==z&&v!==B&&v!==Qt&&v!==_n){h=!1;break}}h&&g?(l=!0,u=!0):u||d++,p=m-1}o?l||(e=e.slice(0,a).trimEnd()):e=l&&d>0?e.slice(0,a).trimEnd():e.slice(0,f).trimEnd()}for(var y=-1,b=-1,x=-1,S=!1,C=e.length-1;C>=0;C--)if(e.charCodeAt(C)===qt){for(var w=C+1<e.length?e.charCodeAt(C+1):0,T=w>=q&&w<=J||w>=kn&&w<=An,E=w===pn&&C+2<e.length&&(e.charCodeAt(C+2)>=q&&e.charCodeAt(C+2)<=J||e.charCodeAt(C+2)>=kn&&e.charCodeAt(C+2)<=An),D=w===Xt||w===dn,O=e.length;O>C+1&&e.charCodeAt(O-1)===V;)O--;var ee=C+1>=O;if(T||E||D||ee){var k=C+1;if((E||T)&&(k=C+2),T||E)for(;k<e.length;){var te=e.charCodeAt(k);if(te>=q&&te<=J||te>=kn&&te<=An||te>=G&&te<=K)k++;else break}for(var ne=T||E?k:C+2;ne<e.length&&e.charCodeAt(ne)!==U;)ne++;if(ne>=e.length)y=C,S=!0;else if((T||E)&&e.charCodeAt(ne-1)!==pn){for(var re=!1,ie=ne+1;ie<e.length;ie++)if(e.charCodeAt(ie)===qt){re=!0;break}re||(y=C,b=k,x=ne+1)}}break}if(y>=0){for(var ae=0,oe=0;oe<y;oe++)e.charCodeAt(oe)===H&&ae++;if(ae%2==0){if(S)e=e.slice(0,y);else{var se=e.slice(y+1,b);Ii(e,`</${se}`,0)===-1&&(e=e.slice(0,y)+e.slice(x))}}}for(var ce=e.length;ce>0&&e.charCodeAt(ce-1)===V;)ce--;if(ce>0){for(var le=ce;le>0&&e.charCodeAt(le-1)!==V;)le--;for(var A=le,j=0;A<ce&&e.charCodeAt(A)===z&&j<3;)A++,j++;if(le>0&&A<ce&&bi(e,A,ce)){for(var M=le-1,N=M;N>0&&e.charCodeAt(N-1)!==V;)N--;_i(e,N,M)||(e=e.slice(0,le).trimEnd())}}var ue=e.length;if(ue>0){for(var de=e.lastIndexOf(`
`),P=de===-1?0:de+1,F=ue,fe=P,pe=0;fe<F&&e.charCodeAt(fe)===z&&pe<3;)fe++,pe++;if(fe<F){var me=e.charCodeAt(fe),he=!1;if(me===Gt||me===W||me===gn){var I=fe+1;if(I>=F||e.charCodeAt(I)===z||e.charCodeAt(I)===B){for(var ge=I;ge<F&&(e.charCodeAt(ge)===z||e.charCodeAt(ge)===B);)ge++;ge>=F&&(he=!0)}}else if(me>=G&&me<=K){for(var _e=fe;_e<F&&e.charCodeAt(_e)>=G&&e.charCodeAt(_e)<=K;)_e++;if(_e<F&&(e.charCodeAt(_e)===fn||e.charCodeAt(_e)===xn)){var ve=_e+1;if(ve>=F||e.charCodeAt(ve)===z||e.charCodeAt(ve)===B){for(var ye=ve;ye<F&&(e.charCodeAt(ye)===z||e.charCodeAt(ye)===B);)ye++;ye>=F&&(he=!0)}}}he&&(e=e.slice(0,P).trimEnd())}}}if(t.inline)return Aa(e,0,e.length,t,n);let be=[],L=0,xe=e.length;if(L===0&&!n.disableFrontmatter&&e.startsWith(`---`)){let t=Nn(e);if(t?.hasValidYaml){if(n.preserveFrontmatter!==!1){let n=e.slice(0,t.endPos).trimEnd();be.push({type:Y.frontmatter,text:n})}L=t.endPos}}for(;L<xe;){for(var R=e.indexOf(`
`,L),Se=R<0?xe:R;L<xe&&_i(e,L,Se);)L=Se<xe?Se+1:Se,L<xe&&(R=e.indexOf(`
`,L),Se=R<0?xe:R);if(L>=xe)break;var Ce=e.charCodeAt(L)===On;gi(e,L,Se);let r=null;if(ci=e,li=L,ui=Se,!Ce&&hi>=4&&!t.inHTML)r=Di(e,L);else if(!Ce){let i=L+Z,a=e.charCodeAt(i);a===Vt?r=yi(e,L,t,n):a===U?r=Oi(e,L,t,n):a===H||a===Rt?r=Ti(e,L,t):a===W||a===Gt||a===Kt?(r=xi(e,L),!r&&(r=Ni(e,L,t,n))):a===gn||a>=G&&a<=K?r=Ni(e,L,t,n):a===qt?r=Bi(e,L,t,n):a===_n?r=Ui(e,L,t,n):a===zt&&(r=Wi(e,L,t))}if(!r){for(var we=!1,Te=L;Te<Se;Te++)if(e.charCodeAt(Te)===_n){we=!0;break}we&&(r=Ui(e,L,t,n))}if(r||=Ki(e,L,t,n),r)r.node.type!==Y.refCollection&&be.push(r.node),L=r.end;else{var Ee=e.indexOf(`
`,L);L=Ee<0?xe:Ee+1}}return t.o=r,be}function Na(e,t,n,r){var i=Qr(e,t);return i?{tagName:i.tag,tagLower:i.tag.toLowerCase(),attrs:i.b,whitespaceBeforeAttrs:i.g,isSelfClosing:i.n,hasSpaceBeforeSlash:i.r,isClosing:i.f,hasNewline:i.g.includes(`
`)||i.b.includes(`
`),endPos:i.end}:null}function Pa(e,t,n){ka=0,e=or(e),!t.refs&&(t.refs={}),(n.optimizeForStreaming||t.inline)&&(t.w=ei(e,t.refs,n));var r,i;t.t||(t.t=r=[],t.p=i=[]);let a=Ma(e,t,n);if(r&&i){for(var o=r,s={inline:t.inline,inAnchor:t.inAnchor,inHTML:t.inHTML,htmlDepth:t.d,inList:t.inList,inBlockQuote:t.inBlockQuote,noSetext:t.l,depth:t.o},c=0;c<o.length;c++){var l=o[c];t.inline=l.inline,t.inAnchor=l.inAnchor,t.inHTML=l.inHTML,t.d=l.htmlDepth,t.inList=l.inList,t.inBlockQuote=l.inBlockQuote,t.l=l.noSetext,t.o=l.depth,t.k=l.breaks;var u=Aa(l.text,0,l.text.length,t,n);t.k=!1;for(var d=0;d<u.length;d++)l.dest.push(u[d])}t.inline=s.inline,t.inAnchor=s.inAnchor,t.inHTML=s.inHTML,t.d=s.htmlDepth,t.inList=s.inList,t.inBlockQuote=s.inBlockQuote,t.l=s.noSetext,t.o=s.depth;for(var f=i,p=0;p<f.length;p++)for(var m=f[p],h=0;h<m.src.length;h++){var g=m.src[h];if(m.unwrap&&g.type===Y.paragraph)for(var _=g.children,v=0;v<_.length;v++)m.dest.push(_[v]);else m.dest.push(g)}t.t=void 0,t.p=void 0,wa(a,t,n.slugify)}return lr(t.refs)?[{type:Y.refCollection,refs:t.refs},...a]:a}var Fa;try{Ia=d.createElement(`div`),Fa=typeof Ia==`object`&&Ia&&`$$typeof`in Ia&&typeof Ia.$$typeof==`symbol`?Ia.$$typeof:Symbol.for(`react.transitional.element`)}catch{Fa=Symbol.for(`react.transitional.element`)}var Ia;function La(e,t,n){return{$$typeof:Fa,type:e,key:n==null?null:String(n),ref:null,props:t,_owner:null,_store:{},_debugStack:null,_debugTask:null}}function Ra(e,t){var n={key:e};if(t){var r=Ln(t);for(var i in r)n[i]=r[i]}return n}var za=typeof d.createContext>`u`?void 0:d.createContext(void 0);function Ba(e,t,n,r,i,a,o,s,c){switch(e.type){case Y.blockQuote:{let i={key:n.key};return e.alert&&(i.className=`markdown-alert-${a(e.alert.toLowerCase(),Gn)}`,e.children.unshift(ur(e.alert))),r(`blockquote`,i,t(e.children,n))}case Y.breakLine:return r(`br`,{key:n.key});case Y.breakThematic:return r(`hr`,{key:n.key});case Y.frontmatter:return s.preserveFrontmatter?r(`pre`,{key:n.key},e.text):null;case Y.codeBlock:{let t=e.lang?zn(e.lang):``;var l=e.attrs?Ln(e.attrs):{};return l.className=t?`language-${t} lang-${t}`:``,r(`pre`,{key:n.key},r(`code`,l,e.text))}case Y.codeInline:return r(`code`,{key:n.key},e.text);case Y.footnoteReference:return r(`a`,{key:n.key,href:i(e.target,`a`,`href`)||void 0},r(`sup`,null,e.text));case Y.gfmTask:return r(`input`,{checked:e.completed,key:n.key,readOnly:!0,type:`checkbox`});case Y.heading:return r(`h${e.level}`,{id:e.id,key:n.key},t(e.children,n));case Y.htmlBlock:{let a=e;if(br(s)&&Or(a.tag)){var u=vr(a);return u.kind===`literal`?r(`span`,{key:n.key},u.literal):r(`span`,{key:n.key},...yr(u.open,a.children?t(a.children,n):null,u.close))}let l=a.j,_=l!==void 0,v=_?l:a.a?a.e||``:(a.e||``)+(a.h||``);if(v&&a.c){let r=Hr(a.tag.toLowerCase()),u=a.children,y=u!=null&&u.length>0;if(r){let t=_?l:a.e||``,r=br(s)?Ar(t):t;if(/<[a-z][^>]{0,100}>/i.test(v)){var f=Ra(n.key,e.attrs);return f.dangerouslySetInnerHTML={__html:r},c(e.tag,f)}return c(e.tag,Ra(n.key,e.attrs),r)}let b=RegExp(`^<${a.tag}(\\s|>)`,`i`);if(y&&!b.test(v)&&br(s)&&kr(v))return c(e.tag,Ra(n.key,e.attrs),t(u,n));if(Ur(v)){let t=br(s)?Ar(v):v;var p=Ra(n.key,e.attrs);return p.dangerouslySetInnerHTML={__html:t},c(e.tag,p)}let x=jr({slugify:s.slugify,sanitizer:i,tagfilter:!0}),S=sr(v);if(RegExp(`^<${a.tag}(\\s[^>]*)?>(\\s*</${a.tag}>)?$`,`i`).test(S))return a.children&&a.children.length>0?c(e.tag,Ra(n.key,e.attrs),t(a.children,n)):c(e.tag,Ra(n.key,e.attrs));let C=Pa(S,{inline:!1,refs:o,inHTML:!1},x);mr(C);let w=a.tag.toLowerCase(),T=_;if(T&&y)return c(e.tag,Ra(n.key,e.attrs),t(u,n));if(T)return t(C.flatMap(pr),n);var m=hr(C,w);if(m.found&&m.afterClose.length>0){var h=m.beforeClose.flatMap(pr),g=m.afterClose.flatMap(pr);return La(d.Fragment,{children:[c(e.tag,Ra(n.key,e.attrs),t(h,n)),t(g,n)]},n.key)}return c(e.tag,Ra(n.key,e.attrs),t(C.flatMap(pr),n))}return Jn(e.tag)?c(e.tag,Ra(n.key,e.attrs)):c(e.tag,Ra(n.key,e.attrs),e.children?t(e.children,n):``)}case Y.htmlSelfClosing:{let t=e;if(br(s)&&Or(t.tag)){var _=vr(t);return r(`span`,{key:n.key},_.kind===`literal`?_.literal:_.open+(_.close||``))}return c(e.tag,Ra(n.key,e.attrs))}case Y.image:{let t=e.target===null?null:i(e.target,`img`,`src`);return r(`img`,{key:n.key,alt:e.alt&&e.alt.length>0?e.alt:void 0,title:e.title||void 0,src:t||void 0})}case Y.link:{let a={key:n.key};if(e.target!=null){let t=xr(e.target,i,`a`,`href`);t!=null&&(a.href=t)}return e.title&&(a.title=e.title),r(`a`,a,t(e.children,n))}case Y.table:{let i=e;return r(`table`,{key:n.key},r(`thead`,{key:`thead`},r(`tr`,null,i.header.map(function(e,a){return r(`th`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))),i.cells.length>0&&r(`tbody`,{key:`tbody`},i.cells.map(function(e,a){return r(`tr`,{key:a},e.map(function(e,a){return r(`td`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))})))}case Y.text:return e.text;case Y.textFormatted:return r(e.tag,{key:n.key},t(e.children,n));case Y.orderedList:case Y.unorderedList:return r(e.type===Y.orderedList?`ol`:`ul`,{key:n.key,start:e.type===Y.orderedList?e.start:void 0},e.items.map(function(e,i){return r(`li`,{key:i},t(e,n))}));case Y.paragraph:return r(`p`,{key:n.key},t(e.children,n));case Y.ref:return null;default:return null}}var Va=(e,t,n,r,i,a,o)=>{var s=e=>e.map(e=>`text`in e?e.text:``),c=(l,u={})=>{var d=Array.isArray(l)?l:[l],f=(u.renderDepth||0)+1;if(f>2500)return s(d);u.renderDepth=f;for(var p=u.key,m=[],h=!1,g=0;g<d.length;g++){u.key=g;var _=e?e(Ba.bind(null,d[g],c,u,t,n,r,i,a,o),d[g],c,u):Ba(d[g],c,u,t,n,r,i,a,o),v=typeof _==`string`;if(h&&typeof _==`string`){var y=m.at(-1);m[m.length-1]=(typeof y==`string`?y:``)+_}else if(_!=null){if(Array.isArray(_))for(var b=0;b<_.length;b++)m.push(_[b]);else m.push(_)}h=v}return u.key=p,u.renderDepth=f-1,m};return c},Ha=(e,t)=>{let n=Cr(t,e,void 0);return n?typeof n==`function`||typeof n==`object`&&`render`in n?n:Cr(t,`${e}.component`,e):e};function Ua(e,t){let n={...t||{}};n.overrides=n.overrides||{};let r=n.slugify||Gn,i=n.sanitizer||Vn,a=n.createElement,o=lr(n.overrides),s=e=>Wa(e,{...n,wrapper:null});function c(e){for(var t in e){var n=e[t];if(typeof n==`string`&&n.length>0&&n.charCodeAt(0)===qt&&(Mr.test(n)||Nr.test(n)||Na(n,0))){var r=s(n.trim());e[t]=t===`innerHTML`&&Array.isArray(r)?r[0]:r}}}function l(e,t,...r){var i=t||{},s=e;if(o){var c=Cr(n.overrides,`${e}.props`,{});s=Ha(e,n.overrides),i={...i,...c,className:Tr(i.className,c.className)||void 0}}if(!a){var l=i.key;return l!=null&&delete i.key,r.length===1?i.children=r[0]:r.length>1&&(i.children=r),La(s,i,l)}return a(s,i,...r)}function u(e,t,...n){return t&&c(t),l(e,t,...n)}let d=jr(n,n.forceInline),f=e[0]&&e[0].type===Y.refCollection?e[0].refs:{},p=Va(n.renderRule,l,i,r,f,n,u),m=p(e,{inline:n.forceInline,refs:f}),h=Sr(f);if(h.length>0&&m.push(l(`footer`,{key:`footer`},h.map(function(e){let t=e.identifier.charCodeAt(0)===Bt?e.identifier.slice(1):e.identifier,n=Pa(e.footnote,{inline:!0,refs:f},d);return l(`div`,{id:r(t,Gn),key:e.identifier},`${t}: `,p(n,{inline:!0,refs:f}))}))),n.wrapper===null)return m;let g=n.wrapper||(n.forceInline?`span`:`div`),_;if(m.length>1||n.forceWrapper)_=m;else return m.length===1?m[0]:null;var v=n.wrapperProps?{...n.wrapperProps}:{};return v.children=_,La(g,v,`outer`)}function Wa(e=``,t={}){let n={...t||{}};n.overrides=n.overrides||{},n.slugify,n.sanitizer;function r(e){let t=n.forceInline||!(n.forceBlock||Rn.test(e)),r=jr(n,t);return Ua(Pa(t?e:fr(e),{inline:t,refs:i},r),{...n,forceInline:t})}let i={};return r(e)}function Ga(e){let t=d.useRef(e),n=t.current;if(n!==e){var r=!0,i=0;for(var a in e)if(i++,!Object.is(n[a],e[a])){r=!1;break}if(r){var o=0;for(var s in n)o++;r=o===i}r||(t.current=e)}return t.current}var Ka=({children:e,options:t,...n})=>{if(!(typeof d.useContext<`u`)){let r={...t,overrides:{...t?.overrides},wrapperProps:{...t?.wrapperProps,...n}};return Wa(e??``,r)}let r=za?d.useContext(za):void 0,i=Ga(n),a=d.useMemo(()=>({...r,...t,overrides:{...r?.overrides,...t?.overrides},wrapperProps:{...r?.wrapperProps,...t?.wrapperProps,...i}}),[r,t,i]),o=e??``;return d.useMemo(()=>Wa(o,a),[o,a])};function qa({text:e}){return(0,p.jsx)(Ka,{options:{disableParsingRawHTML:!0,forceBlock:!0},children:e})}let Ja=0,Ya=`dsh-chatroom:branch-frame-compatibility`;function Xa(e){return(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(no,{toasts:e.room.toasts,dismiss:e.dismissToast}),(0,p.jsx)(gt,{...e}),e.room.membersOpen&&(0,p.jsx)(ro,{...e}),e.room.thread!==void 0&&(0,p.jsx)(io,{...e,thread:e.room.thread,open:!0}),e.room.selectionRoomId!==void 0&&(0,p.jsx)(eo,{...e}),e.room.forwardOpen&&(0,p.jsx)(to,{...e}),e.room.searchOpen&&(0,p.jsx)(Za,{...e})]})}function Za(e){let[t,n]=(0,d.useState)(e.room.searchQuery);return(0,d.useEffect)(()=>{let t=t=>{t.key===`Escape`&&e.closeSearch()};return document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`keydown`,t)}},[e.closeSearch]),(0,d.useEffect)(()=>{let n=globalThis.setTimeout(()=>{e.searchAll(t)},180);return()=>{globalThis.clearTimeout(n)}},[e.searchAll,t]),(0,p.jsx)(`div`,{className:`dsh-chatroom-search-layer`,"data-testid":`chatroom-search-dialog`,onPointerDown:t=>{t.target===t.currentTarget&&e.closeSearch()},children:(0,p.jsxs)(`section`,{className:`dsh-chatroom-search-dialog`,role:`dialog`,"aria-modal":`true`,"aria-label":`搜索全部会话`,children:[(0,p.jsxs)(`header`,{children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`搜索`}),(0,p.jsx)(`small`,{children:`用户、群聊、私聊、分支与全部聊天内容`})]}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`关闭搜索`,onClick:e.closeSearch,children:`×`})]}),(0,p.jsxs)(`label`,{className:`dsh-chatroom-search-input`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⌕`}),(0,p.jsx)(`input`,{autoFocus:!0,type:`search`,value:t,placeholder:`输入用户名、群聊名或消息内容`,"aria-label":`搜索用户名、群聊名或消息内容`,onChange:e=>{n(e.target.value)}}),t!==``&&(0,p.jsx)(`button`,{type:`button`,"aria-label":`清空搜索`,onClick:()=>{n(``)},children:`×`})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-search-results`,role:`listbox`,"aria-label":`搜索结果`,children:[e.room.searchResults.map(t=>(0,p.jsxs)(`button`,{type:`button`,role:`option`,"aria-label":`${t.title}，${t.subtitle}`,onClick:()=>{e.openSearchResult(t)},children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-search-result-icon`,"aria-hidden":!0,children:Qa(t.kind)}),(0,p.jsxs)(`span`,{className:`dsh-chatroom-search-result-copy`,children:[(0,p.jsx)(`strong`,{children:t.title}),(0,p.jsx)(`small`,{children:t.subtitle}),t.preview!==void 0&&(0,p.jsx)(`span`,{children:t.preview})]}),t.createdAt!==void 0&&(0,p.jsx)(`time`,{children:$a(t.createdAt)})]},t.id)),e.room.searchBusy&&(0,p.jsx)(`p`,{role:`status`,children:`正在搜索…`}),!e.room.searchBusy&&e.room.searchError!==void 0&&(0,p.jsx)(`p`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.searchError}),!e.room.searchBusy&&e.room.searchError===void 0&&t.trim()===``&&(0,p.jsx)(`p`,{children:`输入关键词，搜索当前账号可见的全部内容。`}),!e.room.searchBusy&&e.room.searchError===void 0&&t.trim()!==``&&e.room.searchResults.length===0&&(0,p.jsx)(`p`,{children:`没有找到匹配的用户、会话或消息。`})]})]})})}function Qa(e){switch(e){case`account`:return`人`;case`direct`:return`私`;case`room`:return`群`;case`thread`:return`↳`;case`message`:return`文`}}function $a(e){let t=new Date(e),n=new Date;return t.toDateString()===n.toDateString()?t.toLocaleTimeString(`zh-CN`,{hour:`2-digit`,minute:`2-digit`,hour12:!1}):t.toLocaleDateString(`zh-CN`,{month:`numeric`,day:`numeric`})}function eo(e){let t=e.room.selectionRoomId;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-selection-bar`,role:`toolbar`,"aria-label":`消息多选`,children:[(0,p.jsxs)(`strong`,{children:[`已选择 `,e.room.selectedMessages.length,` 条消息`]}),(0,p.jsx)(`button`,{type:`button`,disabled:e.room.selectedMessages.length===0,onClick:()=>{t!==void 0&&e.openForward(t)},children:`合并转发`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.clearMessageSelection,children:`取消`})]})}function to(e){let t=e.room.rooms.filter(t=>t.id!==e.room.selectionRoomId);return(0,p.jsx)(`div`,{className:`dsh-chatroom-dialog-layer dsh-chatroom-forward-layer`,"data-testid":`chatroom-forward-dialog`,children:(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-forward-dialog`,"aria-label":`转发到群聊`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭转发`,type:`button`,onClick:e.closeForward,children:`×`}),(0,p.jsx)(`h2`,{children:`转发到群聊`}),(0,p.jsxs)(`p`,{children:[`将选中的 `,e.room.selectedMessages.length,` 条消息合并成一张聊天记录卡片。`]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-targets`,children:[t.map(t=>(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.forwardBusy,onClick:()=>{e.forwardSelected(t.id)},children:[(0,p.jsx)(`span`,{children:`＃`}),(0,p.jsx)(`strong`,{children:t.title}),(0,p.jsxs)(`small`,{children:[`@`,t.aiDisplayName]})]},t.id)),t.length===0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-empty`,children:`请先新建另一个群聊，再进行转发。`})]}),e.room.forwardError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.forwardError})]})})}function no({toasts:e,dismiss:t}){return e.length===0?null:(0,p.jsx)(`div`,{className:`dsh-chatroom-toast-stack`,role:`status`,"aria-live":`polite`,children:e.map(e=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-toast`,type:`button`,onClick:()=>{t(e.id)},children:[(0,p.jsxs)(`strong`,{children:[e.displayName,` `,(0,p.jsxs)(`small`,{children:[`· `,e.roomTitle,e.threadId===void 0?``:` · 分支`]})]}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})}function ro(e){let[t,n]=(0,d.useState)(e.room.room?.title??``),[r,i]=(0,d.useState)(``),[a,o]=(0,d.useState)([]),s=e.room.members.find(t=>t.participantId===e.room.identity?.participantId)?.role??`member`,c=s===`owner`||s===`admin`,l=c||e.room.auth.account?.role===`super-admin`,u=r.trim().toLocaleLowerCase(`zh-CN`),f=e.room.memberCandidates.filter(e=>u===``||e.displayName.toLocaleLowerCase(`zh-CN`).includes(u)||e.username.toLocaleLowerCase(`zh-CN`).includes(u));return(0,d.useEffect)(()=>{let t=new Set(e.room.memberCandidates.map(e=>e.participantId));o(e=>e.filter(e=>t.has(e)))},[e.room.memberCandidates]),(0,p.jsxs)(`aside`,{className:`dsh-chatroom-member-card`,"data-testid":`chatroom-members`,"aria-label":`群管理`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭群管理`,type:`button`,onClick:e.closeMembers,children:`×`}),(0,p.jsx)(`h2`,{children:`群管理`}),(0,p.jsxs)(`p`,{children:[e.room.room?.title,` · `,e.room.members.length,` 位成员 · `,e.room.online,` 人在线`]}),l&&(0,p.jsxs)(`section`,{className:`dsh-chatroom-invite`,"aria-label":`添加群成员`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-heading`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`添加成员`}),(0,p.jsx)(`small`,{children:`从系统中尚未加入本群的启用账号里选择。`})]}),(0,p.jsxs)(`span`,{children:[a.length,` 位已选`]})]}),(0,p.jsx)(`input`,{type:`search`,value:r,placeholder:`搜索姓名或账号`,"aria-label":`搜索系统用户`,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-list`,children:[f.map(t=>{let n=a.includes(t.participantId);return(0,p.jsxs)(`label`,{children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:n,disabled:e.room.managementBusy,onChange:()=>{o(e=>n?e.filter(e=>e!==t.participantId):[...e,t.participantId])}}),(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:t.displayName}),(0,p.jsxs)(`small`,{children:[`@`,t.username]})]})]},t.participantId)}),f.length===0&&(0,p.jsx)(`p`,{children:e.room.managementBusy?`正在加载系统用户…`:u===``?`所有启用账号都已在群聊中。`:`没有匹配的系统用户。`})]}),(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.managementBusy||a.length===0,onClick:async()=>{await e.addRoomMembers?.(a)&&o([])},children:[`添加选中的 `,a.length,` 位`]})]}),c&&(0,p.jsxs)(`form`,{className:`dsh-chatroom-manage-title`,onSubmit:n=>{n.preventDefault(),e.renameRoom?.(t)},children:[(0,p.jsx)(`input`,{value:t,maxLength:160,"aria-label":`群聊名称`,onChange:e=>{n(e.target.value)}}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.managementBusy||t.trim()===``||t.trim()===e.room.room?.title,children:`保存名称`})]}),(0,p.jsxs)(`section`,{className:`dsh-chatroom-auto-trigger`,"aria-label":`AI 自动回复`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`无需 @AI 自动回复`}),(0,p.jsx)(`small`,{children:`开启后，由设置中选择的判断模型决定普通消息是否需要 AI 回复。群内所有成员都可以修改。`})]}),(0,p.jsxs)(`label`,{className:`dsh-chatroom-switch`,children:[(0,p.jsx)(`input`,{type:`checkbox`,"aria-label":`无需 @AI 自动回复`,checked:e.room.room?.autoTriggerEnabled??!1,disabled:e.room.managementBusy,onChange:t=>{e.setRoomAutoTrigger?.(t.target.checked)}}),(0,p.jsx)(`span`,{"aria-hidden":!0})]})]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-member-list`,children:e.room.members.map(t=>(0,p.jsxs)(`div`,{className:`dsh-chatroom-member`,children:[(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[t.displayName,` `,(0,p.jsx)(`em`,{children:t.role===`owner`?`群主`:t.role===`admin`?`管理员`:``})]}),(0,p.jsx)(`small`,{children:t.online?`在线`:`最近活跃 ${ho(t.lastSeenAt)}`})]}),s===`owner`&&t.role!==`owner`?(0,p.jsx)(`button`,{className:`dsh-chatroom-member-role`,type:`button`,disabled:e.room.managementBusy,onClick:()=>{e.setMemberRole?.(t.participantId,t.role===`admin`?`member`:`admin`)},children:t.role===`admin`?`取消管理员`:`设为管理员`}):(0,p.jsx)(`i`,{"data-online":t.online})]},t.participantId))}),e.room.managementError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.managementError}),(0,p.jsx)(`button`,{className:`dsh-chatroom-notification-button`,type:`button`,disabled:e.room.notificationsEnabled,onClick:()=>{e.enableSystemNotifications()},children:e.room.notificationsEnabled?`✓ 系统消息提醒已开启`:`开启系统消息提醒`})]})}function io(e){let{thread:t}=e,n=e.room.room?.sessionId,r=(0,d.useRef)(null),[i]=(0,d.useState)(()=>++Ja),[a,o]=(0,d.useState)(0),[s,c]=(0,d.useState)(-1),[l,u]=(0,d.useState)(!1),[f,m]=(0,d.useState)(uo);(0,d.useLayoutEffect)(()=>{if(n===void 0)return;if(f){ne(n);return}re(t.sessionId),c(a);let e=globalThis.setTimeout(()=>{ne(n)},3e4);return()=>{globalThis.clearTimeout(e),ne(n)}},[a,f,n,t.sessionId]),(0,d.useEffect)(()=>{e.open||n===void 0||ne(n)},[n,e.open]),(0,d.useEffect)(()=>{if(!e.open)return;let t=t=>{t.key===`Escape`&&e.closeThread()};return document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`keydown`,t)}},[e.closeThread,e.open]),(0,d.useEffect)(()=>{if(f)return;u(!1);let e=!1,i,a,o=()=>{if(e)return;let o=r.current?.contentWindow;o!=null&&n!==void 0&&ee(o,O(t,n));try{let e=r.current?.contentDocument;if(e==null||!ce(e,t.sessionId,t.root.text))return}catch{return}e=!0,globalThis.clearInterval(i),globalThis.clearTimeout(a),u(!0)},s=e=>{e.origin===globalThis.location.origin&&e.source===r.current?.contentWindow&&mo(e.data,t.id)&&o()};return globalThis.addEventListener(`message`,s),i=globalThis.setInterval(o,150),a=globalThis.setTimeout(()=>{e||(globalThis.clearInterval(i),n!==void 0&&ne(n),fo(),m(!0))},8e3),o(),()=>{e=!0,globalThis.removeEventListener(`message`,s),globalThis.clearInterval(i),globalThis.clearTimeout(a)}},[a,f,n,t.id,t.root.text,t.sessionId]);let h=lo(t.root.text),g=n===void 0?void 0:D(t,n,`${i}:${a}`);return(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-layer`,"data-testid":`chatroom-thread-layer`,onPointerDown:t=>{t.target===t.currentTarget&&e.closeThread()},children:(0,p.jsxs)(`aside`,{className:`dsh-chatroom-thread-panel`,"data-testid":`chatroom-thread-panel`,"data-open":e.open,"aria-hidden":!e.open,"aria-label":`分支回复`,onPointerDown:e=>{e.stopPropagation()},children:[(0,p.jsxs)(`header`,{children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`分支回复`}),(0,p.jsxs)(`small`,{children:[`来自 `,e.room.room?.title??`群聊`,` · `,t.root.displayName,`：`,h]})]}),(0,p.jsx)(`button`,{"aria-label":`关闭分支`,type:`button`,onClick:e.closeThread,children:`×`})]}),n===void 0?(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-frame-error`,children:`无法确定父群聊会话。`}):f?(0,p.jsx)(ao,{...e,thread:t,frameUrl:g,retry:()=>{po(),m(!1),o(e=>e+1)}}):(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-shell`,children:[s===a&&(0,p.jsx)(`iframe`,{className:`dsh-chatroom-thread-frame`,ref:r,title:`分支回复：${h}`,src:g,onLoad:()=>{try{if(r.current?.contentDocument!==null)return}catch{}ne(n),fo(),m(!0)}},`${i}:${a}`),!l&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-status`,role:`status`,children:[(0,p.jsx)(`span`,{children:a===0?`正在加载分支…`:`正在重新加载分支…`}),(0,p.jsx)(`small`,{children:`正在打开分支。`})]})]}),e.room.threadError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.threadError})]})})}function ao(e){let[t,n]=(0,d.useState)(``),[r,i]=(0,d.useState)(),[a,o]=(0,d.useState)(0),s=(0,d.useRef)(null),c=(0,d.useRef)(null),l=(0,d.useMemo)(()=>[...[...new Set([`AI`,e.room.room?.aiDisplayName].filter(e=>e!==void 0))].map(e=>({name:e,description:`当前分支的 AI 助手`,ai:!0})),...e.room.members.filter(t=>t.participantId!==e.room.identity?.participantId).map(e=>({name:e.displayName,description:e.online?`在线成员`:`群成员`,ai:!1}))].filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t),[e.room.identity?.participantId,e.room.members,e.room.room?.aiDisplayName]),u=r===void 0?[]:l.filter(e=>e.name.toLocaleLowerCase().includes(r.query.toLocaleLowerCase()));(0,d.useEffect)(()=>{typeof s.current?.scrollIntoView==`function`&&s.current.scrollIntoView({block:`end`})},[e.room.threadMessages.length]),(0,d.useEffect)(()=>{o(0)},[r?.query]);let f=(e,t)=>{i(co(e,t))},m=e=>{if(r===void 0)return;let a=c.current?.selectionStart??t.length,o=`${t.slice(0,r.start)}@${e} ${t.slice(a)}`,s=r.start+e.length+2;n(o),i(void 0),queueMicrotask(()=>{c.current?.focus(),c.current?.setSelectionRange(s,s)})};return(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility-notice`,role:`status`,children:[(0,p.jsx)(`span`,{children:`分支无法在当前页面完整显示，请在新标签中打开。`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`a`,{href:e.frameUrl,target:`_blank`,rel:`noreferrer`,children:`在新标签打开分支`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.retry,children:`重试`})]})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-root`,children:[(0,p.jsx)(`strong`,{children:e.thread.root.displayName}),(0,p.jsx)(`div`,{children:e.thread.root.role===`ai`?(0,p.jsx)(qa,{text:e.thread.root.text}):e.thread.root.text})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-messages`,children:[e.room.threadMessages.length===0&&(0,p.jsx)(`p`,{className:`dsh-chatroom-thread-empty`,children:`从这里开始与分支 AI 对话；回复只会进入当前分支。`}),e.room.threadMessages.map((t,n,r)=>(0,p.jsx)(oo,{message:t,roomId:e.thread.roomId,props:e,groupPosition:be(r,n,e=>`${e.role}:${e.participantId}`,e=>e.createdAt),actionGroup:L(r,n,e=>`${e.role}:${e.participantId}`,e=>e.createdAt)},t.id)),(0,p.jsx)(`div`,{ref:s})]}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-thread-composer`,onSubmit:r=>{r.preventDefault();let i=t.trim();i!==``&&e.sendThreadMessage(i).then(e=>{e&&n(``)})},children:[e.room.threadReply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-composer-reply`,children:[(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.room.threadReply.displayName]}),e.room.threadReply.text]}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`取消引用`,onClick:e.clearThreadReply,children:`×`})]}),(0,p.jsx)(`textarea`,{ref:c,rows:3,placeholder:`给分支 AI 发消息`,value:t,"aria-expanded":u.length>0,"aria-controls":`dsh-chatroom-thread-mentions`,onChange:e=>{n(e.target.value),f(e.target.value,e.target.selectionStart)},onClick:e=>{f(e.currentTarget.value,e.currentTarget.selectionStart)},onKeyDown:e=>{if(u.length>0){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=e.key===`ArrowDown`?1:-1;o(e=>(e+t+u.length)%u.length);return}if(e.key===`Escape`){e.preventDefault(),i(void 0);return}if(e.key===`Tab`){e.preventDefault(),m(u[a]?.name??u[0].name);return}}if(!(e.key!==`Enter`||e.shiftKey)){if(u.length>0&&r?.query===``){e.preventDefault(),m(u[a]?.name??u[0].name);return}e.preventDefault(),e.currentTarget.form?.requestSubmit()}}}),u.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-mentions`,id:`dsh-chatroom-thread-mentions`,role:`listbox`,"aria-label":`提及成员`,children:u.map((e,t)=>(0,p.jsxs)(`button`,{type:`button`,role:`option`,"aria-label":e.name,"aria-selected":t===a,"data-active":t===a,onMouseDown:e=>{e.preventDefault()},onClick:()=>{m(e.name)},children:[(0,p.jsx)(`i`,{children:e.ai?`✦`:`●`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:e.description})]})]},e.name))}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.threadBusy||t.trim()===``,children:`发送`})]})]})}function oo({message:e,roomId:t,props:n,groupPosition:r,actionGroup:i}){let a=e.participantId===n.room.identity?.participantId,o=n.room.members.find(t=>t.participantId===e.participantId),s=o?.avatarId??e.avatarId??g(e.participantId),c=o?.avatarUrl??e.avatarUrl,l=e.role===`ai`?{id:`ai`,emoji:`✦`}:_(s,e.participantId),u=so(e),d=n.room.identity===void 0?void 0:()=>{n.setThreadReply(u)},f={roomId:t,message:{...u,role:e.role,createdAt:e.createdAt},reactions:n.room.reactions,identity:n.room.identity,selecting:n.room.selectionRoomId===t,selected:n.room.selectionRoomId===t&&n.room.selectedMessages.some(t=>t.messageId===e.id),recalled:n.room.recalls.some(t=>t.messageId===e.id),canRecall:a&&e.role===`human`,copyText:e.text,onReply:d,toggleReaction:n.toggleReaction,openForward:n.openForward,toggleSelection:n.toggleMessageSelection,recallMessage:n.recallMessage};return(0,p.jsx)(Ie,{className:`dsh-chatroom-thread-message`,own:a,role:e.role,groupPosition:r,actionGroup:i,avatar:e.role===`ai`?(0,p.jsx)(`span`,{className:`dsh-chatroom-member-avatar`,"data-avatar":l.id,"aria-hidden":!0,children:l.emoji}):(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,participantId:e.participantId,avatarId:s,...c===void 0?{}:{avatarUrl:c}}),displayName:e.displayName,reply:e.reply,tools:f,body:(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-message-body`,children:[f.recalled?(0,p.jsx)(`div`,{className:`dsh-chatroom-recalled-message`,children:`消息已撤回`}):e.role===`ai`?(0,p.jsx)(qa,{text:e.text}):(0,p.jsx)(I,{className:`dsh-chatroom-thread-literal-text`,text:e.text}),!f.recalled&&e.card!==void 0&&(0,p.jsx)(N,{card:e.card}),!f.recalled&&(0,p.jsx)(ge,{text:e.text,existingUrls:e.card?.url===void 0?[]:[e.card.url]})]})})}function so(e){return{messageId:e.id,displayName:e.displayName,text:lo(e.text,120)}}function co(e,t){let n=e.slice(0,t),r=/(?:^|\s)@([^\s@]*)$/u.exec(n);if(r!==null)return{start:n.length-r[1].length-1,query:r[1]}}function lo(e,t=48){let n=e.replace(/```[\s\S]*?```/gu,` `).replace(/[`*_#>|\[\]]/gu,``).replace(/\s+/gu,` `).trim(),r=[...n];return r.length===0?`分支消息`:r.length<=t?n:`${r.slice(0,t).join(``)}…`}function uo(){try{return globalThis.sessionStorage?.getItem(Ya)===`1`}catch{return!1}}function fo(){try{globalThis.sessionStorage?.setItem(Ya,`1`)}catch{}}function po(){try{globalThis.sessionStorage?.removeItem(Ya)}catch{}}function mo(e,t){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let n=e;return n.type===`dsh-chatroom-branch-ready`&&n.threadId===t}function ho(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${t} 分钟前`:t<1440?`${Math.floor(t/60)} 小时前`:`${Math.floor(t/1440)} 天前`}function go(e){let t=e.useChatroom(e=>e);if(t.branchFrame!==void 0)return null;let n=(0,p.jsx)(Xa,{room:t,...e});return t.open?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-dialog-layer`,"data-dsh-chatroom-entry":!0,"data-testid":`chatroom-dialog`,children:[t.phase===`auth-required`&&(0,p.jsx)(_o,{room:t,login:e.login,register:e.register}),t.phase===`identity-required`&&(0,p.jsx)(yo,{room:t,join:e.join,close:e.closeRoom}),t.phase===`loading`&&(0,p.jsx)(xo,{title:`正在载入共享会话`,detail:`正在恢复此浏览器的身份与会话目录…`,close:e.closeRoom}),t.phase===`ready`&&t.identity!==void 0&&(0,p.jsx)(bo,{room:t,selectRoom:e.selectRoom,createRoom:e.createRoom,resetIdentity:e.resetIdentity,logout:e.logout,openAccount:e.openAccount,openAdmin:e.openAdmin,openDirect:e.openDirect,close:e.closeRoom}),t.phase===`error`&&(0,p.jsx)(xo,{title:`共享会话暂时不可用`,detail:t.error??`请稍后重试。`,action:`重试`,onAction:e.retry,close:e.closeRoom})]}),n]}):n}function _o({room:e,login:t,register:n}){let r=e.auth.bootstrapRequired||e.auth.allowSelfRegistration,[i,a]=(0,d.useState)(e.auth.bootstrapRequired?`register`:`login`),[o,s]=(0,d.useState)(``),[c,l]=(0,d.useState)(``),[u,f]=(0,d.useState)(``),[h,g]=(0,d.useState)(``),[_,v]=(0,d.useState)(m[0].id),y=typeof location>`u`?`/`:`${location.pathname}${location.search}`,b=e.auth.bootstrapRequired?void 0:e.auth.autoRedirectProvider,x=e.auth.authMode!==`dsh-auth-only`&&typeof location<`u`&&new URLSearchParams(location.search).get(`local`)===`1`;return(0,d.useEffect)(()=>{b===void 0||x||typeof location>`u`||location.assign(vo(b,y))},[b,x,y]),b!==void 0&&!x?(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,role:`status`,children:[(0,p.jsxs)(`h2`,{children:[`正在前往 `,b.label]}),(0,p.jsx)(`p`,{children:`正在打开企业统一登录…`})]}):(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,"aria-label":`系统登录`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-brand`,children:[(0,p.jsx)(`strong`,{children:`DeepSeek Harness`}),(0,p.jsx)(`span`,{children:`团队协作平台`})]}),(0,p.jsx)(`h2`,{children:i===`login`?`登录`:e.auth.bootstrapRequired?`创建超级管理员`:`注册账号`}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-tabs`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":i===`login`,onClick:()=>{a(`login`)},children:`登录`}),r&&(0,p.jsx)(`button`,{type:`button`,"data-active":i===`register`,onClick:()=>{a(`register`)},children:`注册`})]}),(0,p.jsxs)(`form`,{onSubmit:r=>{r.preventDefault(),i===`login`?t(o,c):n({username:o,password:c,displayName:u,avatarId:_,...e.auth.bootstrapRequired?{bootstrapToken:h}:{}})},children:[(0,p.jsxs)(`label`,{children:[`账号`,(0,p.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:o,onChange:e=>{s(e.target.value)}})]}),(0,p.jsxs)(`label`,{children:[`密码`,(0,p.jsx)(`input`,{type:`password`,autoComplete:i===`login`?`current-password`:`new-password`,value:c,onChange:e=>{l(e.target.value)}})]}),i===`register`&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`label`,{children:[`显示名称`,(0,p.jsx)(`input`,{value:u,onChange:e=>{f(e.target.value)}})]}),e.auth.bootstrapRequired&&(0,p.jsxs)(`label`,{children:[`初始化口令`,(0,p.jsx)(`input`,{type:`password`,value:h,onChange:e=>{g(e.target.value)}})]}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===_,type:`button`,role:`radio`,"aria-checked":e.id===_,onClick:()=>{v(e.id)},children:e.emoji},e.id))})]})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`submit`,disabled:o.trim()===``||c===``||i===`register`&&u.trim()===``,children:i===`login`?`登录`:`创建账号`})]}),e.auth.providers.length>0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-sso-list`,children:[(0,p.jsx)(`span`,{children:`或使用企业账号`}),e.auth.providers.map(e=>(0,p.jsxs)(`a`,{href:vo(e,y),children:[`使用 `,e.label,` 登录`]},e.id))]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function vo(e,t){return v(y,e,t)}function yo({room:e,join:t,close:n}){let[r,i]=(0,d.useState)(e.identity?.displayName??``),[a,o]=(0,d.useState)(e.identity?.avatarId??m[0].id);return(0,p.jsxs)(`form`,{className:`dsh-chatroom-card`,onSubmit:e=>{e.preventDefault(),t(r,a)},children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:n,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsx)(`p`,{children:`选择你在共享会话中显示的名字和头像。`}),(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-identity-input`,autoFocus:!0,maxLength:80,placeholder:`你的名字`,value:r,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===a,type:`button`,role:`radio`,"aria-checked":e.id===a,"aria-label":e.label,onClick:()=>{o(e.id)},children:e.emoji},e.id))})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,"data-testid":`chatroom-join`,type:`submit`,disabled:r.trim()===``,children:`继续`}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function bo({room:e,selectRoom:t,createRoom:n,resetIdentity:r,logout:i,openAccount:a,openAdmin:o,openDirect:s,close:c}){let[l,u]=(0,d.useState)(``);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card dsh-chatroom-room-card`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:c,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsxs)(`p`,{children:[`普通消息只在人类之间聊天；输入 `,(0,p.jsx)(`code`,{children:`@AI`}),` 或 `,(0,p.jsxs)(`code`,{children:[`@`,e.rooms[0]?.aiDisplayName??`DeepSeek`]}),` 才会触发 AI 回复。`]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-room-list`,"data-testid":`chatroom-room-list`,children:e.rooms.map(n=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-room-item`,"data-active":n.id===e.room?.id,"data-testid":`chatroom-room-${n.id}`,type:`button`,onClick:()=>{t(n.id)},children:[(0,p.jsx)(`span`,{children:n.title}),(0,p.jsxs)(`small`,{children:[`@`,n.aiDisplayName]})]},n.id))}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-create`,onSubmit:e=>{e.preventDefault(),l.trim()!==``&&n(l)},children:[(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-title-input`,maxLength:160,placeholder:`新共享会话名称`,value:l,onChange:e=>{u(e.target.value)}}),(0,p.jsx)(`button`,{className:`dsh-chatroom-create-button`,"data-testid":`chatroom-create`,type:`submit`,disabled:l.trim()===``,children:`新建`})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-card-footer`,children:[(0,p.jsxs)(`span`,{children:[`当前身份：`,e.identity===void 0?``:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.identity.avatarId,avatarUrl:e.identity.avatarUrl,seed:e.identity.participantId}),` `,e.identity.displayName]})]}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`button`,{type:`button`,onClick:()=>{s()},children:`私聊`}),e.auth.enabled&&(0,p.jsx)(`button`,{type:`button`,onClick:a,children:`账号设置`}),e.auth.account?.role===`super-admin`&&(0,p.jsx)(`button`,{type:`button`,onClick:()=>{o()},children:`系统管理`}),e.auth.enabled?(0,p.jsx)(`button`,{type:`button`,onClick:()=>{i()},children:`退出登录`}):(0,p.jsx)(`button`,{type:`button`,onClick:()=>{r()},children:`更换身份`})]})]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function xo({title:e,detail:t,action:n,onAction:r,close:i}){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card`,role:`status`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:i,children:`×`}),(0,p.jsx)(`h2`,{children:e}),(0,p.jsx)(`p`,{children:t}),n!==void 0&&(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`button`,onClick:()=>{r?.()},children:n})]})}function So({preview:e,open:t}){return e===void 0?null:(0,p.jsxs)(`button`,{className:`dsh-chatroom-thread-activity`,type:`button`,"aria-label":`打开分支，${e.totalMessages} 条回复`,disabled:t===void 0,onClick:t,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-thread-activity-heading`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⑂`}),` 分支 · `,e.totalMessages,` 条回复`]}),(0,p.jsx)(`span`,{className:`dsh-chatroom-thread-activity-list`,children:e.recentMessages.map(e=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.avatarId,avatarUrl:e.avatarUrl,seed:e.participantId}),(0,p.jsx)(`strong`,{children:e.displayName}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})]})}function Co(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>t.sessionId===String(e.sessionId)),r=e.resolveTarget?.(String(e.sessionId))??(n===void 0?void 0:{kind:`room`,room:n}),i=r?.room,a=e.useSession(t=>t.nodes.find(t=>t.kind===`assistant`&&t.messageId===e.messageId)),o=(0,d.useRef)(null),s=Ne(),c=t.selectionRoomId===i?.id&&t.selectedMessages.some(t=>t.messageId===String(e.messageId)),l=t.selectionRoomId===i?.id;if((0,d.useEffect)(()=>{let t=o.current?.closest(`[data-time-hover-root]`);if(t==null||i===void 0)return;let n=o.current?.parentElement;for(;n!=null&&n.parentElement!==null&&n.parentElement!==t;)n=n.parentElement;n?.setAttribute(`data-dsh-chatroom-native-actions`,``);let r=e=>{s.open(e)};return t.addEventListener(`contextmenu`,r),t.dataset.dshChatroomMessageId=String(e.messageId),t.toggleAttribute(`data-dsh-chatroom-selected`,c),t.toggleAttribute(`data-dsh-chatroom-selection-mode`,l),()=>{t.removeEventListener(`contextmenu`,r),t.removeAttribute(`data-dsh-chatroom-selected`),t.removeAttribute(`data-dsh-chatroom-selection-mode`),delete t.dataset.dshChatroomMessageId,n?.removeAttribute(`data-dsh-chatroom-native-actions`)}},[s.open,e.messageId,i,c,l]),i===void 0||a?.kind!==`assistant`)return null;let u=a.blocks.flatMap(e=>e.kind===`text`?[e.text]:[]).join(``).trim().replace(/\s+/gu,` `),f={messageId:String(e.messageId),displayName:i.aiDisplayName,text:[...u||`AI 回复`].slice(0,120).join(``)},m={...f,sourceSessionId:String(e.sessionId),sourceSeq:a.seq,role:`ai`,createdAt:a.time,content:a.blocks.reduce((e,t)=>(t.kind===`text`&&e.push({type:`text`,text:t.text,markdown:!0}),t.kind===`image`&&e.push({type:`image`,image:{...t.attachment,attachmentId:String(t.attachment.attachmentId)}}),e),[])},h={...f,role:`ai`,sourceSessionId:m.sourceSessionId,sourceSeq:m.sourceSeq},g={roomId:i.id,message:m,reactions:t.reactions,identity:t.identity,selecting:l,selected:c,recalled:!1,canRecall:!1,copyText:u||`AI 回复`,onReply:()=>{e.setReply(i.id,f)},onBranch:r?.kind===`thread`?void 0:()=>{e.openThread(i.id,h)},toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection,recallMessage:e.recallMessage},_=t.threadPreviews.find(e=>e.thread.root.messageId===m.messageId&&e.thread.root.role===`ai`);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-tools`,ref:o,children:[(0,p.jsx)(Me,{tools:g}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-actions`,children:[(0,p.jsx)(Pe,{...g}),(0,p.jsx)(Ae,{tools:g})]}),r?.kind!==`thread`&&(0,p.jsx)(So,{preview:_,open:()=>{e.openThread(i.id,h)}}),(0,p.jsx)(Fe,{tools:g,position:s.position,close:s.close})]})}function wo(e){let{message:t}=e,[n,r]=(0,d.useState)(!1),i={roomId:t.roomId},a={messageId:t.messageId,role:`human`,displayName:t.displayName,text:t.text,createdAt:t.createdAt,content:t.content,...t.reply===void 0?{}:{reply:t.reply},...t.forward===void 0?{}:{forward:t.forward}},o=async n=>{r(!0);try{let r=await e.update(i,t.messageId,n);n===`edit`&&r!==void 0&&it(e.sessionId,r)}finally{r(!1)}};return(0,p.jsx)(Ie,{className:`dsh-chatroom-pending-message`,own:e.own,avatar:(0,p.jsx)(A,{avatarId:t.avatarId,avatarUrl:t.avatarUrl,seed:t.participantId}),displayName:t.displayName,reply:t.reply,tools:{roomId:t.roomId,message:a,reactions:[],identity:void 0,selecting:!1,selected:!1,recalled:!1,canRecall:!1,copyText:t.text,toggleReaction:async()=>void 0,openForward:()=>void 0,toggleSelection:()=>void 0,recallMessage:async()=>!1},body:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(I,{className:`dsh-chatroom-human-bubble`,text:t.text}),t.content.flatMap((e,t)=>e.type===`text`?[]:e.type===`file`?[(0,p.jsxs)(`a`,{className:`dsh-chatroom-file-card`,href:`${y}/files/${encodeURIComponent(e.file.id)}`,download:e.file.name,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`📎`}),(0,p.jsx)(`strong`,{children:e.file.name}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↓`})]},`${e.file.id}:${t}`)]:[(0,p.jsx)(`span`,{className:`dsh-chatroom-pending-image`,children:`🖼️ 图片已发送`},`${e.image.attachmentId}:${t}`)])]}),footer:t.status===`passive`?void 0:(0,p.jsxs)(`div`,{className:`dsh-chatroom-pending-control`,role:`status`,children:[(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`i`,{"aria-hidden":!0}),To(t.status)]}),e.own&&t.status!==`guiding`&&(0,p.jsxs)(`span`,{className:`dsh-chatroom-pending-actions`,children:[(0,p.jsx)(`button`,{type:`button`,disabled:n,onClick:()=>{o(`guide`)},children:`引导`}),(0,p.jsx)(`button`,{type:`button`,disabled:n,onClick:()=>{o(`edit`)},children:`编辑`}),(0,p.jsx)(`button`,{type:`button`,disabled:n,onClick:()=>{o(`delete`)},children:`撤回`})]})]})})}function To(e){switch(e){case`deciding`:return`正在判断是否需要 AI 回复`;case`queued`:return`正在排队 · 等待当前回复完成`;case`guiding`:return`正在引导当前回复`;case`passive`:return``}}let Eo=new Set([`assistant-step`,`context`,`retry`,`tool-call`]);function Do(e){let t=e.nativeMessageView,n=(0,d.useRef)(null),[r,i]=(0,d.useState)(!1),a=e.node.data.finalNode,o=e.useTurnData(`turn-tail`),s=e.resolveTarget?.(String(e.sessionId)),c=s!==void 0,l=c&&a!==void 0&&o?.closing?.finalNode.seq===a.seq,u=c&&a!==void 0&&!l&&e.node.data.blocks.some(e=>e.kind===`text`&&e.text.trimStart().startsWith(`## 会议总结 ·`))?a.messageId:void 0,f=u!==void 0,m=e.useSession(t=>{let n=t.chat.order.indexOf(e.node.key);return n<0?!1:t.chat.order.slice(n+1).every(e=>t.chat.nodes.get(e)?.kind!==`assistant-step`)}),h=e.useChatroom(e=>s?.kind===`room`&&m?e.pendingMessages.filter(e=>e.roomId===s.room.id):[]),g=e.useChatroom(e=>e.identity),_=e.useSession(t=>{if(!l)return``;let n=e.node.data.turn;return t.chat.order.flatMap(r=>{let i=t.chat.nodes.get(r);if(i===void 0||i.key===e.node.key)return[];let a=i.location;return(a.kind===`turn`||a.kind===`step`?a.turn.turn:void 0)===n&&Eo.has(i.kind)?[i.key]:[]}).join(`\0`)}),v=(0,d.useMemo)(()=>_===``?[]:_.split(`\0`),[_]),y=l?e.node.data.blocks.filter(e=>e.kind===`reasoning`&&e.text.trim()!==``).length:0,b=v.length+y,x=e.node.data.blocks.flatMap(e=>e.kind===`text`?Ve(e.text).cards:[]),S=[];for(let t of e.node.data.blocks){if(t.kind!==`text`){S.push(t);continue}let e=Ve(t.text);e.text.trim()!==``&&S.push({...t,text:e.text})}let C=x.length===0?e.node:{...e.node,data:{...e.node.data,blocks:S}};return(0,d.useEffect)(()=>{let e=n.current,t=e?.closest(`[data-chat-flow]`);if(e===null||!l)return;let i=new Set(v),a=t==null?[]:[...t.querySelectorAll(`[data-chat-flow-key]`)].filter(e=>i.has(e.dataset.chatFlowKey??``)),o=[...e.querySelectorAll(`[data-variant="think"]`)],s=[...a,...o].map(e=>({row:e,hidden:e.hidden}));for(let{row:e}of s)e.dataset.dshChatroomProcessRow=``,e.hidden=!r;return()=>{for(let{row:e,hidden:t}of s)e.hidden=t,delete e.dataset.dshChatroomProcessRow}},[l,r,v]),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-turn`,ref:n,"data-time-hover-root":f||void 0,"data-dsh-chatroom-standalone-assistant":f||void 0,children:[l&&b>0&&(0,p.jsxs)(`button`,{type:`button`,className:`dsh-chatroom-process-toggle`,"aria-expanded":r,onClick:()=>{i(e=>!e)},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,className:`dsh-chatroom-process-chevron`,children:`⌄`}),(0,p.jsxs)(`span`,{children:[r?`收起执行过程`:`执行过程`,` · `,b,` 项`]})]}),(0,p.jsx)(t,{...e,node:C}),x.map((e,t)=>(0,p.jsx)(N,{card:e},`${e.kind}:${e.title}:${t}`)),f&&(0,p.jsx)(Co,{...e,messageId:u}),h.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-pending-stream`,"aria-label":`已发送的排队消息`,children:h.map(t=>(0,p.jsx)(wo,{message:t,own:t.participantId===g?.participantId,sessionId:String(e.sessionId),update:e.updateQueuedPrompt},t.messageId))})]})}function Oo(e,t,n=[]){let r=!1,i=!1,a,o,s,c,l,u,d=[],f=[],p=[],m=[];for(let h of e.data.content){if(h.type!==`text`){m.push(h);continue}let e=h.text;if(!i){i=!0;let d=Le(e);e=d===void 0?e:e.slice(d.length);let f=/^([^：]{1,80})：/.exec(e);a=f?.[1],r=t!==void 0&&(d===void 0?a===t.displayName:d.participantId===t.participantId),o=d?.avatarId??g(a??d?.participantId??`participant`),s=d?.participantId;let p=n.find(e=>e.participantId===s);o=p?.avatarId??o,c=p?.avatarUrl,f!==null&&(e=e.slice(f[0].length));let m=Re(e);e=m.text,l=m.reply;let h=Be(e);e=h.text,u=h.forward}let _=Ve(e);e=_.text,f.push(..._.cards);let v=ze(e);e=v.text,d.push(...v.files),e.trim()!==``&&p.push(e.trim()),e.trim()!==``&&m.push(e===h.text?h:{...h,text:e})}if((d.length>0||m.some(e=>e.type===`image`))&&p.length===1&&ko(p[0])){p.length=0;for(let e=m.length-1;e>=0;--e){let t=m[e];t?.type===`text`&&ko(t.text.trim())&&m.splice(e,1)}}return{node:i?{...e,data:{...e.data,content:m}}:e,own:r,avatarId:o??g(t?.participantId??`participant`),...s===void 0?{}:{participantId:s},files:d,cards:f,text:p.join(`
`),...a===void 0?{}:{displayName:a},...c===void 0?t!==void 0&&r&&t.avatarUrl!==void 0?{avatarUrl:t.avatarUrl}:{}:{avatarUrl:c},...l===void 0?{}:{reply:l},...u===void 0?{}:{forward:u}}}function ko(e){return e===`发送了文件。`||e===`发送了一张图片。`}let Ao=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=Oo(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=he(o.text).length>0,c=s?No(o.node):o.node,l=c.data.content.length===0?void 0:(0,p.jsx)(n,{...e,node:c}),u=i.room,d=Lo(String(e.sessionId),e.node,o),f=zo(d),m=Ro(d),h=t.identity===void 0?void 0:()=>{e.setReply(u.id,f)},g=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(u.id,m)},_=Bo(e,t,u.id,d,d.text,o.own,h,g),v=Vo(t.threadPreviews,d.messageId,`human`);return(0,p.jsxs)(p.Fragment,{children:[u.aiContextStartSeq===e.node.data.seq&&(0,p.jsx)(mt,{}),(0,p.jsx)(Mo,{native:l,projection:o,tools:_,threadPreview:v,onReply:h,onThread:g,linkedText:s})]})}),jo=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=Oo(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=he(o.text).length>0,c=s?No(o.node):o.node,l=c.data.content.length===0?void 0:(0,p.jsx)(n,{...e,node:c}),u=i.room,d=Lo(String(e.sessionId),e.node,o),f=zo(d),m=Ro(d),h=t.identity===void 0?void 0:()=>{e.setReply(u.id,f)},g=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(u.id,m)},_=Bo(e,t,u.id,d,d.text,o.own,h,g),v=Vo(t.threadPreviews,d.messageId,`human`);return(0,p.jsxs)(p.Fragment,{children:[u.aiContextStartSeq===e.node.data.seq&&(0,p.jsx)(mt,{}),(0,p.jsx)(Mo,{native:l,projection:o,tools:_,threadPreview:v,onReply:h,onThread:g,linkedText:s})]})});function Mo({native:e,projection:t,tools:n,threadPreview:r,onReply:i,onThread:a,linkedText:o}){let s=(0,d.useRef)(null);return(0,d.useLayoutEffect)(()=>{let e=s.current;if(e!==null)return Se(e,t.participantId??t.displayName??t.avatarId,n.message.createdAt)},[t.avatarId,t.displayName,t.participantId,n.message.createdAt]),(0,p.jsx)(Ie,{rootRef:s,own:t.own,avatar:(0,p.jsx)(A,{avatarId:t.avatarId,avatarUrl:t.avatarUrl,seed:t.participantId??t.displayName??``}),displayName:t.displayName,reply:t.reply,tools:n,body:n.recalled?(0,p.jsx)(`div`,{className:`dsh-chatroom-recalled-message`,children:`消息已撤回`}):(0,p.jsxs)(p.Fragment,{children:[o&&(0,p.jsx)(I,{className:`dsh-chatroom-human-bubble`,text:t.text}),e!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-native-message`,children:e}),t.files.map(e=>(0,p.jsx)(Po,{file:e},e.id)),t.cards.map((e,t)=>(0,p.jsx)(N,{card:e},`${e.kind}:${e.title}:${t}`)),(0,p.jsx)(ge,{text:t.text,existingUrls:t.cards.flatMap(e=>e.url===void 0?[]:[e.url])}),t.forward!==void 0&&(0,p.jsx)(Fo,{forward:t.forward})]}),footer:(0,p.jsx)(So,{preview:r,open:a})})}function No(e){return{...e,data:{...e.data,content:e.data.content.filter(e=>e.type!==`text`)}}}function Po({file:e}){return(0,p.jsxs)(`a`,{className:`dsh-chatroom-file-card`,href:`${y}/files/${encodeURIComponent(e.id)}`,download:e.name,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-file-icon`,"aria-hidden":!0,children:`📎`}),(0,p.jsxs)(`span`,{className:`dsh-chatroom-file-copy`,children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:Uo(e.bytes)})]}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↓`})]})}function Fo({forward:e,depth:t=0}){return(0,p.jsxs)(`details`,{className:`dsh-chatroom-forward-card`,children:[(0,p.jsxs)(`summary`,{children:[(0,p.jsxs)(`strong`,{children:[`合并转发 · `,e.items.length,` 条消息`]}),(0,p.jsxs)(`small`,{children:[`来自 `,e.sourceRoomTitle]})]}),(0,p.jsx)(`div`,{children:e.items.map(n=>(0,p.jsxs)(`article`,{children:[(0,p.jsxs)(`strong`,{children:[n.displayName,(0,p.jsx)(`time`,{children:Ho(n.createdAt)})]}),n.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-reply`,children:[(0,p.jsxs)(`b`,{children:[`回复 `,n.reply.displayName]}),(0,p.jsx)(`span`,{children:n.reply.text})]}),(n.content??[{type:`text`,text:n.text,markdown:n.role===`ai`}]).map((t,r)=>{if(t.type===`text`)return t.markdown?(0,p.jsx)(qa,{text:t.text},r):(0,p.jsx)(`p`,{className:`dsh-chatroom-forward-text`,children:t.text},r);if(t.type===`file`)return(0,p.jsx)(Po,{file:t.file},`${t.file.id}:${r}`);let i=Io(e.sourceRoomId,n,t.image);return i===void 0?(0,p.jsx)(`span`,{className:`dsh-chatroom-forward-image-error`,children:`图片来源不可用`},`${t.image.attachmentId}:${r}`):(0,p.jsx)(`img`,{className:`dsh-chatroom-forward-image`,src:i,alt:t.image.name??`转发图片`},`${t.image.attachmentId}:${r}`)}),n.forward!==void 0&&t<1&&(0,p.jsx)(Fo,{forward:n.forward,depth:t+1}),n.reactions!==void 0&&n.reactions.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-reactions`,children:n.reactions.map(e=>(0,p.jsxs)(`span`,{children:[e.emoji,` `,e.count]},e.emoji))})]},n.messageId))})]})}function Io(e,t,n){if(t.sourceSessionId!==void 0&&t.sourceSeq!==void 0)return`${y}/images/${encodeURIComponent(JSON.stringify({sourceRoomId:e,sourceSessionId:t.sourceSessionId,sourceSeq:t.sourceSeq,image:n}))}`}function Lo(e,t,n){let r=n.files.length===0?``:n.files.map(e=>e.name).join(`、`),i=n.forward===void 0?``:`合并转发 ${n.forward.items.length} 条消息`,a=(n.text.trim()||r||i||`图片消息`).replace(/\s+/gu,` `);return{messageId:`${t.kind}:${t.data.seq}`,sourceSessionId:e,sourceSeq:t.data.seq,role:`human`,displayName:n.displayName??`参与者`,text:[...a].slice(0,120).join(``),createdAt:t.data.time,content:[...n.text.trim()===``?[]:[{type:`text`,text:n.text,markdown:!1}],...n.node.data.content.flatMap(e=>e.type===`image`?[{type:`image`,image:{...e.attachment,attachmentId:String(e.attachment.attachmentId)}}]:[]),...n.files.map(e=>({type:`file`,file:e}))],...n.reply===void 0?{}:{reply:n.reply},...n.forward===void 0?{}:{forward:n.forward}}}function Ro(e){if(e.sourceSessionId===void 0||e.sourceSeq===void 0)throw Error(`chatroom branch target lost its source coordinates`);return{messageId:e.messageId,displayName:e.displayName,text:e.text,role:e.role,sourceSessionId:e.sourceSessionId,sourceSeq:e.sourceSeq}}function zo(e){return{messageId:e.messageId,displayName:e.displayName,text:e.text}}function Bo(e,t,n,r,i,a,o,s){return{roomId:n,message:r,reactions:t.reactions,identity:t.identity,selecting:t.selectionRoomId===n,selected:t.selectionRoomId===n&&t.selectedMessages.some(e=>e.messageId===r.messageId),recalled:t.recalls.some(e=>e.messageId===r.messageId),canRecall:a,copyText:i,onReply:o,onBranch:s,toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection,recallMessage:e.recallMessage}}function Vo(e,t,n){return e.find(e=>e.thread.root.messageId===t&&e.thread.root.role===n)}function Ho(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}function Uo(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function Wo(e,t){let n=e.displayName.trim(),r=n.localeCompare(`AI`,void 0,{sensitivity:`accent`})===0||n.localeCompare(`DeepSeek`,void 0,{sensitivity:`accent`})===0,i=t.some(t=>t.participantId!==e.participantId&&t.displayName.trim().localeCompare(n,void 0,{sensitivity:`accent`})===0);return n===``||r||i?e.username:n}var Go=class{openSession;snapshot={branchFrame:void 0,open:!1,phase:`loading`,connection:`offline`,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1},online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],pendingMessages:[],membersOpen:!1,managementBusy:!1,managementError:void 0,error:void 0,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0,sessionControlBusy:!1,sessionControlError:void 0,wecomBusy:!1,wecomError:void 0,wecomAuthorization:void 0,wecomAuthorizationOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0,unreadCount:0,toasts:[],notificationsEnabled:Zo()===`granted`,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0,accountOpen:!1,accountBusy:!1,accountError:void 0,adminOpen:!1,adminBusy:!1,adminOverview:void 0,adminError:void 0,automationBusy:!1,automationOverview:void 0,automationError:void 0,directOpen:!1,directBusy:!1,directPeers:[],directConversations:[],directConversation:void 0,directMessages:[],directError:void 0,soloSessionIds:[],newSessionModes:{},searchOpen:!1,searchQuery:``,searchBusy:!1,searchResults:[],searchError:void 0};listeners=new Set;eventSource;notificationSource;pendingOpenRoomId;identityPromptedRoomId;stopped=!1;compositionRevision=0;pendingFileSequence=0;searchRevision=0;originalTitle;activeNativeSession;roomEnsure;pendingAutoTriggerWrites=new Map;constructor(e=()=>!1,t){this.openSession=e,t!==void 0&&(this.snapshot={...this.snapshot,branchFrame:t})}getSnapshot=()=>this.snapshot;roomForSession(e){let t=this.snapshot.rooms.find(t=>t.sessionId===e);if(t!==void 0)return t;let n=this.snapshot.branchFrame,r=this.snapshot.threadPreviews.find(t=>t.thread.sessionId===e)?.thread.roomId;if(n?.sessionId===e)return this.snapshot.rooms.find(e=>e.id===n.roomId);if(r!==void 0)return this.snapshot.rooms.find(e=>e.id===r);let i=this.activeNativeSession;if(!(i?.id!==e||i.parentSessionId===void 0||!e.startsWith(`chatroom-thread-v1-`)))return this.snapshot.rooms.find(e=>e.sessionId===i.parentSessionId)}agentTargetForSession(e){let t=this.roomForSession(e);if(t===void 0)return;let n=this.snapshot.branchFrame;if(n?.sessionId===e)return{kind:`thread`,room:t,threadId:n.threadId};let r=this.snapshot.threadPreviews.find(t=>t.thread.sessionId===e)?.thread;return r===void 0?this.activeNativeSession?.id===e&&this.activeNativeSession.parentSessionId!==void 0&&e.startsWith(`chatroom-thread-v1-`)?{kind:`thread`,room:t,threadId:e.slice(19)}:{kind:`room`,room:t}:{kind:`thread`,room:t,threadId:r.id}}registerNewSession=e=>{this.snapshot.auth.enabled&&!this.snapshot.soloSessionIds.includes(e)||this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:`group`}})};reserveSoloSession=async()=>{let e=await Q(`${y}/solo-sessions`,{method:`POST`,headers:{"Content-Type":`application/json`}});return this.set({soloSessionIds:this.snapshot.soloSessionIds.includes(e.sessionId)?this.snapshot.soloSessionIds:[...this.snapshot.soloSessionIds,e.sessionId]}),e.sessionId};releaseSoloSession=async e=>{try{await is(`${y}/solo-sessions`,{method:`DELETE`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sessionId:e})})}finally{this.set({soloSessionIds:this.snapshot.soloSessionIds.filter(t=>t!==e)})}};canPromptNativeSession(e){return this.snapshot.phase===`ready`?!this.snapshot.auth.enabled||this.snapshot.soloSessionIds.includes(e):!1}newSessionMode=e=>this.snapshot.newSessionModes[e];chooseNewSessionMode=async(e,t)=>this.snapshot.newSessionModes[e]!==void 0&&(this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:t},error:void 0}),!0);ensurePromptTarget=async e=>{let t=this.agentTargetForSession(e);return t!==void 0||this.snapshot.newSessionModes[e]!==`group`||this.activeNativeSession?.id!==e?t:(await this.ensureActiveSessionRoom(),this.agentTargetForSession(e))};newGroupInvitees=e=>{let t=this.snapshot.directPeers.filter(e=>e.participantId!==this.snapshot.identity?.participantId);return t.filter(n=>{let r=Wo(n,t);return He(e,r)||r!==n.username&&He(e,n.username)}).map(e=>e.participantId)};switchBranchFrame(e){let t=this.snapshot.branchFrame;(t?.threadId!==e.threadId||t.sessionId!==e.sessionId||t.roomId!==e.roomId||t.parentSessionId!==e.parentSessionId)&&(this.compositionRevision+=1,this.set({branchFrame:e,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0}))}subscribe=e=>(this.listeners.add(e),()=>{this.listeners.delete(e)});async start(){this.stopped=!1,typeof document<`u`&&(this.originalTitle=document.title),await this.loadSession()}stop(){this.stopped=!0,this.closeEvents(),this.closeNotifications(),this.updateActiveDocumentRoom(!1),this.updateDocumentTitle(0),this.listeners.clear()}openRoom=()=>{this.set({open:!0,error:void 0})};login=async(e,t)=>{this.set({phase:`loading`,error:void 0});try{let n=await Q(`${y}/auth/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})});return this.acceptSession(n),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:$(e)}),!1}};register=async e=>{this.set({phase:`loading`,error:void 0});try{let t=await Q(`${y}/auth/register`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});return this.acceptSession(t),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:$(e)}),!1}};logout=async()=>{try{await is(`${y}/auth/logout`,{method:`POST`})}finally{this.closeEvents(),this.closeNotifications();let e=this.snapshot.auth;this.set({phase:`auth-required`,open:!0,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:e.enabled,authenticated:!1,providers:e.providers,allowSelfRegistration:e.allowSelfRegistration,bootstrapRequired:e.bootstrapRequired},accountOpen:!1,accountError:void 0,adminOpen:!1,adminOverview:void 0,directOpen:!1,directConversation:void 0,directMessages:[],soloSessionIds:[],newSessionModes:{},searchOpen:!1,searchBusy:!1,searchResults:[],searchError:void 0})}};openAccount=()=>{!this.snapshot.auth.enabled||!this.snapshot.auth.authenticated||this.set({accountOpen:!0,accountBusy:!1,accountError:void 0,adminOpen:!1,directOpen:!1})};closeAccount=()=>{this.set({accountOpen:!1,accountBusy:!1,accountError:void 0})};changePassword=async(e,t)=>{this.set({accountBusy:!0,accountError:void 0});try{let n=await Q(`${y}/account`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:`change-password`,currentPassword:e,newPassword:t})});return this.set({accountOpen:!1,accountBusy:!1,accountError:void 0,auth:{...this.snapshot.auth,account:n.account},identity:n.account}),!0}catch(e){return this.set({accountBusy:!1,accountError:$(e)}),!1}};openAdmin=async()=>{if(this.snapshot.auth.account?.role===`super-admin`){this.set({adminOpen:!0,adminBusy:!0,adminError:void 0,directOpen:!1,accountOpen:!1});try{let e=await Q(`${y}/admin`);this.set({adminBusy:!1,adminOverview:e})}catch(e){this.set({adminBusy:!1,adminError:$(e)})}}};closeAdmin=()=>{this.set({adminOpen:!1,adminError:void 0})};loadAutomation=async()=>{if(!this.snapshot.automationBusy){this.set({automationBusy:!0,automationError:void 0});try{let e=await Q(`${y}/automation`);this.set({automationBusy:!1,automationOverview:e})}catch(e){this.set({automationBusy:!1,automationError:$(e)})}}};saveAutomation=async(e,t,n,r,i,a)=>{if(this.snapshot.automationBusy)return!1;this.set({automationBusy:!0,automationError:void 0});try{let o=await Q(`${y}/automation`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,model:t,meetingSummaryProvider:n,meetingSummaryModel:r,mainAgentPrompt:i,controllerPrompt:a})});return this.set({automationBusy:!1,automationOverview:o}),!0}catch(e){return this.set({automationBusy:!1,automationError:$(e)}),!1}};adminCreateUser=async e=>this.adminMutation({action:`create-user`,...e});adminUpdateUser=async(e,t)=>this.adminMutation({action:`update-user`,userId:e,...t});adminSetSelfRegistration=async e=>this.adminMutation({action:`settings`,allowSelfRegistration:e});adminSetAutoRedirectProvider=async e=>this.adminMutation({action:`settings`,autoRedirectProviderId:e??null});adminSaveProvider=async e=>this.adminMutation({action:`save-provider`,...e});adminDeleteProvider=async e=>this.adminMutation({action:`delete-provider`,providerId:e});openDirect=async e=>{this.set({directOpen:!0,directBusy:!0,directError:void 0,adminOpen:!1,accountOpen:!1});try{let t=e===void 0?await Q(`${y}/direct`):await Q(`${y}/direct`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({peerId:e})});this.set({directBusy:!1,directPeers:t.peers,directConversations:t.conversations,directConversation:t.conversation,directMessages:t.messages??[]})}catch(e){this.set({directBusy:!1,directError:$(e)})}};loadDirectDirectory=async()=>{if(this.snapshot.phase!==`ready`||this.snapshot.identity===void 0)return!1;try{let e=await Q(`${y}/direct`);return this.set({directPeers:e.peers,directConversations:e.conversations,directError:void 0}),!0}catch(e){return this.set({directError:$(e)}),!1}};closeDirect=()=>{this.set({directOpen:!1,directError:void 0})};openSearch=()=>{this.snapshot.phase===`ready`&&this.set({searchOpen:!0,searchError:void 0,membersOpen:!1,accountOpen:!1,adminOpen:!1})};closeSearch=()=>{this.searchRevision+=1,this.set({searchOpen:!1,searchBusy:!1,searchError:void 0})};searchAll=async e=>{let t=e.normalize(`NFC`).trim(),n=++this.searchRevision;if(t===``){this.set({searchQuery:e,searchBusy:!1,searchResults:[],searchError:void 0});return}this.set({searchQuery:e,searchBusy:!0,searchError:void 0});try{let e=await Q(`${y}/search?q=${encodeURIComponent(t)}`);if(n!==this.searchRevision||!this.snapshot.searchOpen)return;this.set({searchBusy:!1,searchResults:e.results,searchError:void 0})}catch(e){if(n!==this.searchRevision||!this.snapshot.searchOpen)return;this.set({searchBusy:!1,searchResults:[],searchError:$(e)})}};openSearchResult=async e=>{if(this.closeSearch(),e.participantId!==void 0&&(e.conversationKind===`direct`||e.kind===`account`||e.kind===`direct`)){await this.openDirect(e.participantId),this.revealSearchMessage(e.messageId);return}if(e.conversationKind===`room`&&e.conversationId!==void 0){await this.selectRoom(e.conversationId),this.revealSearchMessage(e.messageId);return}if(e.sessionId!==void 0){if(this.closeDirect(),this.closeThread(),!this.openSession(e.sessionId)){this.set({error:`暂时无法打开搜索结果对应的会话。`});return}this.revealSearchMessage(e.messageId)}};sendDirect=async(e,t=[],n)=>{let r=this.snapshot.directConversation;if(r===void 0||e.trim()===``&&t.length===0||this.snapshot.directBusy)return!1;this.set({directBusy:!0,directError:void 0});try{let i=await ns(t),a=[...e.trim()===``?[]:[{type:`text`,text:e}],...i],o=await Q(`${y}/direct/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversationId:r.id,content:a,...n===void 0?{}:{reply:n}})}),s=this.snapshot.directMessages.some(e=>e.id===o.message.id)?this.snapshot.directMessages:[...this.snapshot.directMessages,o.message];return this.set({directBusy:!1,directConversation:o.conversation,directMessages:s,directConversations:Xo(this.snapshot.directConversations,o.conversation)}),!0}catch(e){return this.set({directBusy:!1,directError:$(e)}),!1}};toggleDirectReaction=async(e,t,n)=>{try{let r=await Q(`${y}/direct/reactions/toggle`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversationId:e,messageId:t,emoji:n})});this.set({directMessages:this.snapshot.directMessages.map(e=>e.id===r.id?r:e),directError:void 0})}catch(e){this.set({directError:$(e)})}};openMembers=()=>{if(this.snapshot.room===void 0)return;this.set({membersOpen:!0,memberCandidates:[],thread:void 0,threadMessages:[],threadReply:void 0,threadError:void 0});let e=this.snapshot.members.find(e=>e.participantId===this.snapshot.identity?.participantId)?.role;(e===`owner`||e===`admin`||this.snapshot.auth.account?.role===`super-admin`)&&this.loadRoomMemberCandidates()};loadRoomMemberCandidates=async()=>{let e=this.snapshot.room;if(!(e===void 0||this.snapshot.managementBusy)){this.set({managementBusy:!0,managementError:void 0});try{let t=await Q(`${y}/rooms/manage?roomId=${encodeURIComponent(e.id)}`);this.snapshot.room?.id===e.id&&this.applyRoomManagement(t)}catch(e){this.set({managementBusy:!1,managementError:$(e)})}}};completeGroupSetup=async(e,t)=>{let n=this.snapshot.room;return n===void 0||e.trim()===``||t.length===0||e.trim()!==n.title&&!await this.renameRoom(e)?!1:await this.addRoomMembers(t)};closeMembers=()=>{this.set({membersOpen:!1,memberCandidates:[],managementError:void 0})};addRoomMembers=async e=>{let t=this.snapshot.room;if(t===void 0||e.length===0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`add-members`,participantIds:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};setRoomPinned=async(e,t)=>{try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`set-pinned`,pinned:t})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementError:$(e)}),!1}};setRoomAutoTrigger=e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return Promise.resolve(!1);this.set({managementBusy:!0,managementError:void 0});let n=(async()=>{try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`set-auto-trigger`,enabled:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}})();return this.pendingAutoTriggerWrites.set(t.id,n),n.then(()=>{this.pendingAutoTriggerWrites.get(t.id)===n&&this.pendingAutoTriggerWrites.delete(t.id)}),n};async waitForRoomAutoTrigger(e){let t=this.pendingAutoTriggerWrites.get(e);if(t!==void 0&&!await t)throw Error(this.snapshot.managementError??`自动回复设置保存失败。`)}recallMessage=async(e,t)=>{try{let n=await Q(`${y}/messages/recall`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,messageId:t})});return this.replaceRecall(n),!0}catch(e){return this.set({composerError:$(e)}),!1}};renameRoom=async e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`rename`,title:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};setMemberRole=async(e,t)=>{let n=this.snapshot.room;if(n===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let r=await Q(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:n.id,action:`set-role`,participantId:e,role:t})});return this.applyRoomManagement(r),!0}catch(e){return this.set({managementBusy:!1,managementError:$(e)}),!1}};closeRoom=()=>{this.set(this.snapshot.phase===`identity-required`&&this.snapshot.identity!==void 0?{open:!1,phase:`ready`,error:void 0}:{open:!1})};resumeOpen=()=>{let e=this.pendingOpenRoomId;if(e===void 0)return;let t=this.snapshot.rooms.find(t=>t.id===e);t===void 0||!this.openSession(t.sessionId)||(this.pendingOpenRoomId=void 0,this.set({open:!1,error:void 0}))};activateSession=(e,t=`新会话`,n=!0,r)=>{this.activeNativeSession=e===void 0?void 0:{id:e,title:t,shareable:n,...r===void 0?{}:{parentSessionId:r}};let i=(e===void 0?void 0:this.agentTargetForSession(e))?.room;if(i===void 0){this.closeEvents(),this.identityPromptedRoomId=void 0,this.updateActiveDocumentRoom(!1),this.set({room:void 0,roomEnsureSessionId:this.roomEnsure?.sessionId===e?e:void 0,connection:`offline`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],pendingMessages:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0});return}if(this.updateActiveDocumentRoom(!0),this.snapshot.identity===void 0&&this.identityPromptedRoomId!==i.id&&(this.identityPromptedRoomId=i.id,this.set({open:!0})),this.snapshot.room?.id===i.id&&(this.eventSource!==void 0||this.snapshot.branchFrame!==void 0)){this.snapshot.directOpen&&this.set({directOpen:!1,directError:void 0});return}this.set({room:i,roomEnsureSessionId:void 0,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],pendingMessages:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0}),this.clearUnread(),this.openEvents(i)};join=async(e,t)=>{let n=this.snapshot.room,r=this.snapshot.connection,i=this.snapshot.online;this.set({phase:`loading`,error:void 0});try{let a=await Q(`${y}/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({displayName:e,avatarId:t})});if(a.identity===null)throw Error(`服务端没有返回聊天室身份。`);let o=n===void 0?void 0:a.rooms.find(e=>e.id===n.id);this.set({phase:`ready`,open:!1,rooms:a.rooms,room:o,identity:a.identity,connection:o===void 0?`offline`:r,online:o===void 0?0:i,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.set({phase:`identity-required`,error:$(e)})}};addFiles=(e,t)=>{if(t.length===0)return;let n=this.compositionFor(e),r=t.map(e=>({id:`file-${++this.pendingFileSequence}`,file:e}));this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:[...n.files,...r],reply:n.reply,composerError:void 0})};removeFile=(e,t)=>{if(this.snapshot.composerRoomId!==e)return;let n=this.snapshot.pendingFiles.filter(e=>e.id!==t);n.length!==this.snapshot.pendingFiles.length&&(this.compositionRevision+=1,this.set({pendingFiles:n,composerError:void 0}))};setReply=(e,t)=>{let n=this.compositionFor(e);this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:n.files,reply:t,composerError:void 0})};clearReply=e=>{this.snapshot.composerRoomId===e&&this.snapshot.reply!==void 0&&(this.compositionRevision+=1,this.set({reply:void 0,composerError:void 0}))};toggleReaction=async(e,t,n)=>{try{let r=await Q(`${y}/reactions/toggle`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,messageId:t,emoji:n})});this.replaceReaction(r)}catch(e){this.set({composerError:$(e)})}};toggleMessageSelection=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=n.some(e=>e.messageId===t.messageId)?n.filter(e=>e.messageId!==t.messageId):[...n,t];this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!1,forwardError:void 0})};openForward=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=t===void 0||n.some(e=>e.messageId===t.messageId)?n:[t];r.length!==0&&this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!0,forwardError:void 0})};clearMessageSelection=()=>{this.set({selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0})};closeForward=()=>{this.set({forwardOpen:!1,forwardError:void 0})};forwardSelected=async e=>{let t=this.snapshot.selectionRoomId;if(t===void 0||this.snapshot.selectedMessages.length===0||this.snapshot.forwardBusy)return!1;this.set({forwardBusy:!0,forwardError:void 0});try{return await Q(`${y}/forward`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sourceRoomId:t,targetRoomId:e,messages:this.snapshot.selectedMessages})}),this.clearMessageSelection(),!0}catch(e){return this.set({forwardBusy:!1,forwardError:$(e)}),!1}};composition=e=>{let t=this.compositionFor(e);return{roomId:e,revision:this.compositionRevision,files:t.files,reply:t.reply}};completeComposition=e=>{if(this.snapshot.composerRoomId!==e.roomId||this.compositionRevision!==e.revision){this.snapshot.composerBusy&&this.set({composerBusy:!1});return}this.compositionRevision+=1,this.set({composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0})};sendFiles=async e=>{let t=this.composition(e);if(!(t.files.length===0||this.snapshot.composerBusy)){this.set({composerBusy:!0,composerError:void 0});try{let n=await ts(t.files),r=this.snapshot.branchFrame;r?.roomId===e?await es({threadId:r.threadId,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}):await $o({roomId:e,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}),this.completeComposition(t)}catch(e){this.set({composerBusy:!1,composerError:$(e)})}}};updateQueuedPrompt=async(e,t,n)=>{try{let r=await Q(`${y}/queue`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({...e,messageId:t,action:n})});return this.set({composerError:void 0}),r.text}catch(e){this.set({composerError:$(e)});return}};selectRoom=async e=>{this.set({directOpen:!1,directError:void 0,error:void 0});try{let t=await Q(`${y}/rooms/select`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:$(e)})}};createRoom=async e=>{this.set({error:void 0});try{let t=await Q(`${y}/rooms`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({title:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:$(e)})}};stopRoomSession=async e=>{if(this.snapshot.sessionControlBusy)return!1;this.set({sessionControlBusy:!0,sessionControlError:void 0});try{let t=await Q(`${y}/rooms/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`stop`})});return this.applyRoomManagement(t),this.set({sessionControlBusy:!1}),!0}catch(e){return this.set({sessionControlBusy:!1,sessionControlError:$(e)}),!1}};newRoomSession=async e=>{if(this.snapshot.sessionControlBusy)return!1;this.set({sessionControlBusy:!0,sessionControlError:void 0});try{let t=await Q(`${y}/rooms/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`new`})});return this.applyRoomManagement(t),this.set({sessionControlBusy:!1}),!0}catch(e){return this.set({sessionControlBusy:!1,sessionControlError:$(e)}),!1}};quickMeeting=async e=>this.createQuickMeeting({roomId:e});quickThreadMeeting=async e=>this.createQuickMeeting({threadId:e});quickDirectMeeting=async e=>this.createQuickMeeting({directConversationId:e});loadWecomAuthorization=async()=>{try{let e=await Q(`${y}/wecom/auth`);return this.set({wecomAuthorization:e,wecomError:e.error}),e}catch(e){this.set({wecomError:$(e)});return}};startWecomAuthorization=async()=>{if(this.snapshot.wecomBusy)return!1;this.set({wecomBusy:!0,wecomError:void 0});try{let e=await Q(`${y}/wecom/auth`,{method:`POST`});return this.set({wecomBusy:!1,wecomAuthorization:e,wecomAuthorizationOpen:!1}),!0}catch(e){return this.set({wecomBusy:!1,wecomError:$(e)}),!1}};disconnectWecomAuthorization=async()=>{if(this.snapshot.wecomBusy)return!1;this.set({wecomBusy:!0,wecomError:void 0});try{let e=await Q(`${y}/wecom/auth`,{method:`DELETE`});return this.set({wecomBusy:!1,wecomAuthorization:e,wecomAuthorizationOpen:!1}),!0}catch(e){return this.set({wecomBusy:!1,wecomError:$(e)}),!1}};rebindWecomAuthorization=async()=>await this.disconnectWecomAuthorization()?await this.startWecomAuthorization():!1;async createQuickMeeting(e){if(this.snapshot.wecomBusy)return!1;this.set({wecomBusy:!0,wecomError:void 0});let t=await this.loadWecomAuthorization();return t?.status===`authorized`?this.publishQuickMeeting(e):(this.set({wecomBusy:!1,wecomAuthorizationOpen:!1,wecomError:t?.enabled===!0?`共享企业微信账号尚未连接，请由管理员前往“设置 → 群聊与账号”完成绑定。`:t?.error??`当前服务未启用企业微信 CLI。`}),!1)}async publishQuickMeeting(e){this.set({wecomBusy:!0,wecomError:void 0});try{return await Q(`${y}/wecom/quick-meeting`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),this.set({wecomBusy:!1}),!0}catch(e){return this.set({wecomBusy:!1,wecomError:$(e)}),!1}}openThread=async(e,t)=>{this.set({membersOpen:!1,threadReply:void 0,threadBusy:!0,threadError:void 0});try{let n=await Q(`${y}/threads/open`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,root:t})});this.set({thread:n.thread,threadMessages:n.messages,...n.messages.length===0?{}:{threadPreviews:Ko(this.snapshot.threadPreviews,{thread:n.thread,totalMessages:n.messages.length,recentMessages:n.messages.slice(-3)})},threadBusy:!1,threadError:void 0}),this.clearUnread()}catch(e){this.set({threadBusy:!1,threadError:$(e)})}};closeThread=()=>{this.set({thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0})};setThreadReply=e=>{this.snapshot.thread!==void 0&&this.set({threadReply:e,threadError:void 0})};clearThreadReply=()=>{this.snapshot.threadReply!==void 0&&this.set({threadReply:void 0,threadError:void 0})};sendThreadMessage=async e=>{let t=this.snapshot.thread,n=this.snapshot.threadReply;if(t===void 0||this.snapshot.threadBusy||e.trim()===``)return!1;this.set({threadBusy:!0,threadError:void 0});try{return await Q(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({threadId:t.id,mode:`queue`,content:[{type:`text`,text:e}],...n===void 0?{}:{reply:n}})}),this.set({threadReply:void 0,threadBusy:!1,threadError:void 0}),!0}catch(e){return this.set({threadBusy:!1,threadError:$(e)}),!1}};enableSystemNotifications=async()=>{if(typeof Notification>`u`)return;let e=await Notification.requestPermission();this.set({notificationsEnabled:e===`granted`})};dismissToast=e=>{this.set({toasts:this.snapshot.toasts.filter(t=>t.id!==e)})};resetIdentity=async()=>{this.set({open:!0,phase:`identity-required`,error:void 0})};retry=async()=>{this.set({phase:`loading`,error:void 0}),await this.loadSession()};async adminMutation(e){if(this.snapshot.adminBusy)return!1;this.set({adminBusy:!0,adminError:void 0});try{let t=await Q(`${y}/admin`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=`overview`in t?t.overview:t;return this.set({adminBusy:!1,adminOverview:n}),!0}catch(e){return this.set({adminBusy:!1,adminError:$(e)}),!1}}acceptSession(e){if(e.identity===null)throw Error(`服务端没有返回登录账号。`);this.set({phase:`ready`,open:!1,connection:`offline`,rooms:e.rooms,soloSessionIds:e.soloSessionIds,identity:e.identity,auth:Qo(e),error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}async ensureActiveSessionRoom(){let e=this.activeNativeSession;if(e===void 0||!e.shareable||this.snapshot.phase!==`ready`||this.snapshot.identity===void 0||this.snapshot.newSessionModes[e.id]!==`group`||this.roomForSession(e.id)!==void 0)return;if(this.roomEnsure?.sessionId===e.id)return await this.roomEnsure.promise;let t=(async()=>{this.set({roomEnsureSessionId:e.id,error:void 0});try{let t=await Q(`${y}/rooms/ensure`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sessionId:e.id,title:e.title})}),n=this.snapshot.rooms.some(e=>e.id===t.room.id)?this.snapshot.rooms.map(e=>e.id===t.room.id?t.room:e):[...this.snapshot.rooms,t.room],{[e.id]:r,...i}=this.snapshot.newSessionModes;this.set({rooms:n,soloSessionIds:this.snapshot.soloSessionIds.filter(t=>t!==e.id),newSessionModes:i,error:void 0}),this.activeNativeSession?.id===e.id&&this.activateSession(e.id,e.title,e.shareable)}catch(t){this.activeNativeSession?.id===e.id&&this.set({roomEnsureSessionId:void 0,error:$(t)})}})();this.roomEnsure={sessionId:e.id,promise:t};try{await t}finally{this.roomEnsure?.promise===t&&(this.roomEnsure=void 0)}}selectAndOpen(e){let t=this.snapshot.rooms.some(t=>t.id===e.id)?this.snapshot.rooms.map(t=>t.id===e.id?e:t):[...this.snapshot.rooms,e];this.pendingOpenRoomId=e.id,this.set({phase:`ready`,rooms:t,room:e,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],recalls:[],threadPreviews:[],pendingMessages:[],thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0,error:void 0}),this.openEvents(e),this.resumeOpen()}compositionFor(e){return this.snapshot.composerRoomId===e?{files:this.snapshot.pendingFiles,reply:this.snapshot.reply}:{files:[],reply:void 0}}async loadSession(){try{let e=await Q(`${y}/session`);if(this.stopped)return;let t=Qo(e);if(t.enabled&&!t.authenticated){this.closeEvents(),this.closeNotifications(),this.set({phase:`auth-required`,open:!0,connection:`offline`,rooms:[],soloSessionIds:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}if(e.identity===null){this.closeEvents(),this.set({phase:`identity-required`,open:!0,connection:`offline`,rooms:e.rooms,soloSessionIds:e.soloSessionIds,room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}this.set({phase:`ready`,connection:`offline`,rooms:e.rooms,soloSessionIds:e.soloSessionIds,identity:e.identity,auth:t,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.stopped||this.set({phase:`error`,connection:`offline`,error:$(e)})}}openEvents(e){if(this.closeEvents(),this.stopped||this.snapshot.identity===void 0)return;if(this.snapshot.branchFrame!==void 0){this.set({connection:`online`});return}this.set({connection:`connecting`});let t=new EventSource(`${y}/events?roomId=${encodeURIComponent(e.id)}`);this.eventSource=t,t.onopen=()=>{this.eventSource===t&&this.set({connection:`online`,error:void 0})},t.onmessage=e=>{if(this.eventSource===t)try{this.receive(JSON.parse(e.data))}catch{this.set({error:`收到无法识别的聊天室同步消息。`})}},t.onerror=()=>{this.eventSource===t&&this.set({connection:`connecting`})}}openNotifications(){if(this.stopped||this.snapshot.identity===void 0||this.notificationSource!==void 0||this.snapshot.branchFrame!==void 0)return;let e=new EventSource(`${y}/notifications`);this.notificationSource=e,e.onmessage=t=>{if(this.notificationSource===e)try{let e=JSON.parse(t.data);e.type===`notification`?this.receiveNotification(e.notification):e.type===`direct-message`&&this.receiveDirectMessage(e)}catch{this.set({error:`收到无法识别的消息提醒。`})}}}closeEvents(){this.eventSource?.close(),this.eventSource=void 0}closeNotifications(){this.notificationSource?.close(),this.notificationSource=void 0}receive(e){switch(e.type){case`snapshot`:{let t=Yo(e.room,e.members),n=qo(this.snapshot.rooms,t);this.set({phase:`ready`,connection:`online`,rooms:n,room:t,identity:e.identity,online:e.online,members:e.members,reactions:e.reactions,recalls:e.recalls??[],threadPreviews:e.threadPreviews,pendingMessages:e.pendingMessages??[],error:void 0});return}case`presence`:{let t=this.snapshot.room===void 0?void 0:Yo(this.snapshot.room,e.members);this.set({online:e.online,members:e.members,...t===void 0?{}:{room:t,rooms:qo(this.snapshot.rooms,t)}});return}case`pending-messages`:this.set({pendingMessages:e.messages});return;case`thread-message`:this.set({threadPreviews:Ko(this.snapshot.threadPreviews,e.preview),...this.snapshot.thread?.id!==e.message.threadId||this.snapshot.threadMessages.some(t=>t.id===e.message.id)?{}:{threadMessages:[...this.snapshot.threadMessages,e.message]}});return;case`reaction`:this.replaceReaction(e.reaction);return;case`message-recalled`:this.replaceRecall(e.recall);return;case`room-updated`:this.applyRoomManagement({room:e.room,members:e.members});return}}replaceReaction(e){if(this.snapshot.room?.id!==e.roomId)return;let t=this.snapshot.reactions.filter(t=>t.messageId!==e.messageId||t.emoji!==e.emoji);this.set({reactions:e.participantIds.length===0?t:[...t,e]})}replaceRecall(e){if(this.snapshot.room?.id!==e.roomId)return;let t=this.snapshot.recalls.filter(t=>t.messageId!==e.messageId);this.set({recalls:[...t,e],reactions:this.snapshot.reactions.filter(t=>t.messageId!==e.messageId),selectedMessages:this.snapshot.selectedMessages.filter(t=>t.messageId!==e.messageId)})}applyRoomManagement(e){let t=this.snapshot.rooms.find(t=>t.id===e.room.id),n=t?.pinned!==void 0&&e.room.pinned===void 0?{...e.room,pinned:t.pinned}:e.room,r=Jo(this.snapshot.rooms.map(e=>e.id===n.id?n:e)),i=new Set(e.members.map(e=>e.participantId));this.set({rooms:r,...this.snapshot.room?.id===n.id?{room:n,members:e.members}:{},memberCandidates:`candidates`in e?e.candidates:this.snapshot.memberCandidates.filter(e=>!i.has(e.participantId)),managementBusy:!1,managementError:void 0})}receiveNotification(e){if(e.participantId===this.snapshot.identity?.participantId)return;let t=[...this.snapshot.toasts.filter(t=>t.id!==e.id),e].slice(-4),n=typeof document<`u`&&document.visibilityState===`visible`,r=this.snapshot.room?.id===e.roomId&&(e.threadId===void 0||e.threadId===this.snapshot.thread?.id),i=n&&r?this.snapshot.unreadCount:this.snapshot.unreadCount+1,a=Jo(this.snapshot.rooms.map(t=>t.id===e.roomId?{...t,updatedAt:Math.max(t.updatedAt??0,e.createdAt)}:t));if(this.set({toasts:t,unreadCount:i,rooms:a}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!n)try{new Notification(`${e.displayName} · ${e.roomTitle}`,{body:e.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${$(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(e.id)},6e3)}receiveDirectMessage(e){let t=Xo(this.snapshot.directConversations,e.conversation),n=this.snapshot.directConversation?.id===e.conversation.id,r=this.snapshot.directMessages.some(t=>t.id===e.message.id),i=n?r?this.snapshot.directMessages.map(t=>t.id===e.message.id?e.message:t):[...this.snapshot.directMessages,e.message]:this.snapshot.directMessages,a=e.message.senderId===this.snapshot.identity?.participantId,o=typeof document<`u`&&document.visibilityState===`visible`,s=this.snapshot.directOpen&&n;if(this.set({directConversations:t,...n?{directConversation:e.conversation,directMessages:i}:{},unreadCount:r||a||o&&s?this.snapshot.unreadCount:this.snapshot.unreadCount+1}),!a&&!r){let t={id:e.message.id,roomId:`direct:${e.conversation.id}`,roomTitle:`私聊`,participantId:e.message.senderId,displayName:e.conversation.peer.displayName,role:`human`,text:e.message.text,createdAt:e.message.createdAt},n=[...this.snapshot.toasts.filter(e=>e.id!==t.id),t].slice(-4);if(this.set({toasts:n}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!o)try{new Notification(`${e.conversation.peer.displayName} · 私聊`,{body:e.message.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${$(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(t.id)},6e3)}}clearUnread(){this.snapshot.unreadCount!==0&&this.set({unreadCount:0})}updateDocumentTitle(e){typeof document>`u`||this.originalTitle===void 0||(document.title=e===0?this.originalTitle:`(${e}) ${this.originalTitle}`)}updateActiveDocumentRoom(e){typeof document>`u`||document.documentElement.toggleAttribute(`data-dsh-chatroom-active`,e)}revealSearchMessage(e){if(e===void 0||typeof document>`u`)return;let t=0,n=()=>{let r=[...document.querySelectorAll(`[data-dsh-chatroom-message-id]`)].find(t=>t.dataset.dshChatroomMessageId===e);if(r===void 0){t+=1,t<30&&globalThis.setTimeout(n,100);return}r.scrollIntoView({block:`center`,behavior:`smooth`}),r.setAttribute(`data-dsh-chatroom-search-highlight`,``),globalThis.setTimeout(()=>{r.removeAttribute(`data-dsh-chatroom-search-highlight`)},2400)};globalThis.setTimeout(n,0)}set(e){if(!this.stopped){this.snapshot={...this.snapshot,...e},e.unreadCount!==void 0&&this.updateDocumentTitle(this.snapshot.unreadCount);for(let e of this.listeners)e()}}};function Ko(e,t){return[...e.filter(e=>e.thread.id!==t.thread.id),t]}function qo(e,t){return Jo(e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[...e,t])}function Jo(e){return[...e].sort((e,t)=>Number(t.pinned===!0)-Number(e.pinned===!0)||(t.updatedAt??0)-(e.updatedAt??0)||e.id.localeCompare(t.id))}function Yo(e,t){if(e.memberAvatars!==void 0)return e;let n=t.slice(0,9);return{...e,memberAvatarIds:n.map(e=>e.avatarId),memberAvatars:n.map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}}))}}function Xo(e,t){return[t,...e.filter(e=>e.id!==t.id)].sort((e,t)=>t.updatedAt-e.updatedAt)}function Zo(){return typeof Notification>`u`?`unsupported`:Notification.permission}function Qo(e){return e.auth??{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1}}async function $o(e,t){return await Q(`${y}/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function es(e,t){return await Q(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function ts(e){return await ns(e.map(({file:e})=>e))}async function ns(e){return await Promise.all(e.map(async e=>{let t=os(new Uint8Array(await e.arrayBuffer()));return e.type===`image/png`||e.type===`image/jpeg`||e.type===`image/webp`||e.type===`image/gif`?{type:`image`,name:e.name,mediaType:e.type,data:t}:{type:`file`,name:e.name,mediaType:e.type===``?`application/octet-stream`:e.type,data:t}}))}var rs=class extends Error{status;constructor(e,t){super(t),this.status=e}};async function Q(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await as(n);return await n.json()}async function is(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await as(n)}async function as(e){let t=`聊天室请求失败（HTTP ${e.status}）。`;try{let n=await e.json();typeof n.error==`string`&&n.error!==``&&(t=n.error)}catch{}return new rs(e.status,t)}function $(e){return e instanceof Error?e.message:String(e)}function os(e){let t=``;for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}function ss(e,t){let n=e.sessions.prompt,r=async(e,r)=>{let i=String(e.sessionId),a=Ue(e.content),o=typeof t.agentTargetForSession==`function`?t.agentTargetForSession(String(e.sessionId)):(()=>{let n=t.roomForSession(String(e.sessionId));return n===void 0?void 0:{kind:`room`,room:n}})();if(o===void 0&&a){if(!t.canPromptNativeSession(i))throw Error(`会话不存在或你无权访问。`);return await n(e,r)}let s=o===void 0&&typeof t.newSessionMode==`function`&&t.newSessionMode(i)===`group`;if(o===void 0&&typeof t.ensurePromptTarget==`function`&&(o=await t.ensurePromptTarget(i)),o===void 0){if(!t.canPromptNativeSession(i))throw Error(`会话不存在或你无权访问。`);return await n(e,r)}if(a)return await n(e,r);if(t.getSnapshot().identity===void 0)throw Error(`请先选择聊天室身份。`);if(s){let n=t.newGroupInvitees(e.content);if(n.length>0&&!await t.addRoomMembers(n))throw Error(t.getSnapshot().managementError??`无法把提及的成员加入新群聊。`)}typeof t.waitForRoomAutoTrigger==`function`&&await t.waitForRoomAutoTrigger(o.room.id);let c=t.composition(o.room.id),l=await ts(c.files),u=[...e.content,...l];return o.kind===`thread`?await es({threadId:o.threadId,mode:e.mode,content:u,...c.reply===void 0?{}:{reply:c.reply}},r):await $o({roomId:o.room.id,mode:e.mode,content:u,...c.reply===void 0?{}:{reply:c.reply}},r),t.completeComposition(c),{rpcId:`chatroom-human-first`,result:{ok:!0,value:{accepted:!0}}}};return e.sessions.prompt=r,()=>{e.sessions.prompt===r&&(e.sessions.prompt=n)}}let cs=`button[id^="dsh-slash-option-群聊成员-"]`,ls=`dsh-chatroom-native-mention-avatar`;function us(e){let t=()=>{let t=fs(e.getSnapshot());for(let e of document.querySelectorAll(cs)){let n=e.firstElementChild,r=n?.nextElementSibling?.textContent?.trim();if(!(n instanceof HTMLElement)||r===void 0||r===``)continue;let i=t.get(r),a=n.querySelector(`:scope > img.${ls}`);if(i===void 0){a?.remove(),n.classList.remove(ls),delete n.dataset.dshChatroomAvatarFailed;continue}if(a?.src===i||(a?.remove(),n.dataset.dshChatroomAvatarFailed===i))continue;n.classList.add(ls);let o=document.createElement(`img`);o.alt=``,o.referrerPolicy=`no-referrer`,o.src=i,o.addEventListener(`error`,()=>{n.dataset.dshChatroomAvatarFailed=i,o.remove(),n.classList.remove(ls)},{once:!0}),n.prepend(o)}},n=new MutationObserver(e=>{e.some(ds)&&t()});n.observe(document.body,{childList:!0,subtree:!0});let r=e.subscribe(t);return t(),()=>{r(),n.disconnect();for(let e of document.querySelectorAll(`${cs} img.${ls}`)){let t=e.parentElement;e.remove(),t?.classList.remove(ls),t!=null&&delete t.dataset.dshChatroomAvatarFailed}}}function ds(e){return[...e.addedNodes].some(e=>e instanceof Element&&(e.matches(cs)||e.querySelector(cs)!==null))}function fs(e){let t=new Map;for(let n of e.members){let e=ps(n.avatarUrl);e!==void 0&&t.set(n.displayName,e)}for(let n of e.directPeers){let r=ps(n.avatarUrl);r!==void 0&&t.set(Wo(n,e.directPeers),r)}return t}function ps(e){if(e!==void 0)try{let t=new URL(e);return t.protocol===`https:`&&t.username===``&&t.password===``&&t.hash===``?t.href:void 0}catch{return}}function ms(e,t,n){let r=e.startSession,i=new Set,a=!1,o=r=>{let o=e.list.getSnapshot(),s=t.list.getSnapshot().current,c=s===void 0?void 0:o.items.find(e=>e.sessionIds.includes(s))?.workspaceId,l=r??c??o.recentWorkspaceId;if(l===void 0){t.clear();return}n(l).then(e=>{if(!a){let n=hs(t,e,i);n!==void 0&&i.add(n)}},e=>{a||console.warn(`new shared session failed:`,e)})};return e.startSession=o,()=>{a=!0;for(let e of i)e();i.clear(),e.startSession===o&&(e.startSession=r)}}function hs(e,t,n){let r=!1,i=()=>void 0,a,o=()=>{r||(r=!0,i(),a!==void 0&&clearTimeout(a),n.delete(o))},s=()=>{r||e.list.getSnapshot().byId[t]===void 0||(o(),e.open(t))};if(e.list.getSnapshot().byId[t]!==void 0){e.open(t);return}return i=e.list.subscribe(s),a=setTimeout(()=>{o(),console.warn(`new shared session was not listed within 5000ms`)},5e3),s(),r?void 0:o}function gs(e){let t=e.useChatroom(e=>e),n=e.newSessionMode(String(e.sessionId)),[r,i]=(0,d.useState)(),a=e.session.composerPhase===`blank`&&e.session.nodes.length===0;if((0,d.useEffect)(()=>{a&&n===void 0&&e.registerNewSession(String(e.sessionId))},[a,n,e.registerNewSession,e.sessionId]),(0,d.useEffect)(()=>{if(!a||t.branchFrame!==void 0)return;let e=[...document.querySelectorAll(`span`)].find(e=>e.textContent?.trim()===`探索未至之境`),n=e?.parentElement,r=n?.parentElement,o=n?.nextElementSibling;if(!(o instanceof HTMLElement)||e===void 0||r==null)return;let s=e.textContent;return e.textContent=`今天有什么工作要处理？`,r.setAttribute(`data-dsh-chatroom-new-session-hero`,``),o.setAttribute(`data-dsh-chatroom-new-session-switch-host`,``),i(o),()=>{e.textContent=s,r.removeAttribute(`data-dsh-chatroom-new-session-hero`),o.removeAttribute(`data-dsh-chatroom-new-session-switch-host`)}},[a,e.sessionId,t.branchFrame]),(0,d.useEffect)(()=>{if(!a||r===void 0||n===void 0)return;let e=null,t=r;for(;t!==null&&e===null;)e=t.querySelector(`button[aria-label="选择工作区"]`),t=t.parentElement;let i=e?.querySelector(`span`);if(e===null||i==null)return;let o=i.textContent??``,s=n===`solo`?`Solo`:`群聊`;return i.textContent=s,e.title=o===``?`当前会话类型：${s}`:`当前会话类型：${s}；工作区：${o}`,e.setAttribute(`data-dsh-chatroom-session-mode`,n),()=>{i.textContent=o,e.removeAttribute(`title`),e.removeAttribute(`data-dsh-chatroom-session-mode`)}},[a,n,r]),!a||t.branchFrame!==void 0||n===void 0)return null;let o=n===`solo`?`solo`:`group`,s=(0,p.jsxs)(`div`,{className:`dsh-chatroom-new-mode-switch`,"data-mode":o,role:`group`,"aria-label":`新会话模式`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":o===`group`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`group`)},children:`群聊`}),(0,p.jsx)(`button`,{type:`button`,"data-active":o===`solo`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`solo`)},children:`Solo`})]});return r===void 0?(0,p.jsx)(`section`,{className:`dsh-chatroom-new-mode`,"aria-label":`选择新会话模式`,children:s}):(0,f.createPortal)(s,r)}function _s(e){if(e.isLoopback)return()=>void 0;let t=e.api,n=t.settings,r=t.credentials,i=t.llm,a={describe:(e,t)=>vs(`settings.describe`,e,t),openDocument:n.openDocument,update:(e,t)=>vs(`settings.update`,e,t),replace:(e,t)=>vs(`settings.replace`,e,t),mutate:(e,t)=>vs(`settings.mutate`,e,t)},o={describe:(e,t)=>vs(`credentials.describe`,e,t),set:(e,t)=>vs(`credentials.set`,e,t),unset:(e,t)=>vs(`credentials.unset`,e,t)},s={...i,discoverModels:(e,t)=>vs(`llm.discoverModels`,e,t)};return t.settings=a,t.credentials=o,t.llm=s,()=>{t.settings===a&&(t.settings=n),t.credentials===o&&(t.credentials=r),t.llm===s&&(t.llm=i)}}async function vs(e,t,n){let r=crypto.randomUUID(),i=await fetch(`${y}/configuration/${e}`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify({type:`client-request`,rpcId:r,method:e,payload:t}),credentials:`same-origin`,...n===void 0?{}:{signal:n}});if(!i.ok)throw Error(await bs(i));let a=ys(await i.json());if(a.rpcId!==r)throw Error(`远程模型设置响应编号不匹配：发送 ${r}，收到 ${String(a.rpcId)}`);return{rpcId:a.rpcId,result:a.result}}function ys(e){if(typeof e!=`object`||!e||Array.isArray(e))throw Error(`远程模型设置响应格式无效。`);let t=e;if(t.type!==`server-response`||typeof t.rpcId!=`string`||t.result===null||typeof t.result!=`object`||Array.isArray(t.result))throw Error(`远程模型设置响应格式无效。`);let n=t.result;if(n.ok!==!0&&n.ok!==!1)throw Error(`远程模型设置响应格式无效。`);return{rpcId:t.rpcId,result:n}}async function bs(e){try{let t=await e.json();if(typeof t==`object`&&t&&!Array.isArray(t)){let e=t.error;if(typeof e==`string`&&e!==``)return e}}catch{}return`远程模型设置请求失败：HTTP ${e.status}`}function xs(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>String(e.sessionId)===t.sessionId);if(n===void 0)return t.roomEnsureSessionId===String(e.sessionId)?(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,disabled:!0,children:`正在建立共享群…`}):null;let r=t.identity,i=t.room?.id===n.id,a=i&&t.connection===`online`?`${t.online} 人在线`:`共享会话`;return(0,p.jsxs)(`span`,{className:`dsh-chatroom-header-actions`,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-identity-action`,title:`当前群聊身份`,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-presence-dot`,"data-online":i&&t.connection===`online`}),r?.displayName??`选择身份`,` · `,a]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,onClick:e.openMembers,children:`群管理`})]})}let Ss=`div[role="treeitem"][aria-selected]`,Cs=`data-dsh-chatroom-group-avatar`,ws=`data-dsh-chatroom-solo-avatar`,Ts=`data-dsh-chatroom-sidebar-category`,Es=`data-dsh-chatroom-workspace-categories`,Ds=`data-dsh-chatroom-category-header`,Os=`data-dsh-chatroom-direct-row`,ks=`data-dsh-chatroom-category-wrapper`,As=`data-dsh-chatroom-branch-row`,js=`data-dsh-chatroom-branch-marker`,Ms=`data-dsh-chatroom-branch-surface`,Ns=`data-dsh-chatroom-branch-replies`,Ps=`data-dsh-chatroom-native-branch-title`,Fs=`data-dsh-chatroom-branch-count`,Is=`data-dsh-chatroom-branch-overflow`,Ls=`data-dsh-chatroom-branch-overflow-row`,Rs=`data-dsh-chatroom-branch-updated-at`,zs=`data-dsh-chatroom-session-id`,Bs=`data-dsh-chatroom-hidden-session`,Vs=`chatroom-thread-v1-`,Hs=`分支：`,Us=`data-dsh-chatroom-native-group-section`,Ws=`data-dsh-chatroom-native-folder-wrapper`,Gs=`data-dsh-chatroom-native-folder-expand-attempted`,Ks=`data-dsh-chatroom-native-overflow-button`,qs=`data-dsh-chatroom-native-overflow-expand-attempted`,Js=`data-dsh-chatroom-category-overflow`,Ys=`data-dsh-chatroom-overflow-row`,Xs=`[role="tree"], [role="treeitem"], [role="menu"]`,Zs=-1e4,Qs=-6e3,$s=new WeakMap,ec=new WeakMap,tc,nc;function rc(e,t){if(typeof document>`u`||typeof MutationObserver>`u`)return()=>void 0;let n=!1,r,i,a=()=>{n=!1;let a=t.list.getSnapshot(),s=e.getSnapshot();ac(document,s,a.current,e.setRoomPinned,e.openDirect,e.closeDirect,a);let c=s.phase===`ready`?s.identity?.participantId:void 0;c===void 0?r=void 0:r!==c&&(r=c,e.loadDirectDirectory().then(e=>{e||r!==c||(r=void 0,i=setTimeout(o,2e3))}))},o=()=>{n||(n=!0,queueMicrotask(a))},s=new MutationObserver(e=>{e.some(ic)&&o()}),c=t=>{(t.target instanceof Element?t.target.closest(`button[aria-label="搜索会话"]`):null)!==null&&(t.preventDefault(),t.stopPropagation(),t.stopImmediatePropagation(),e.openSearch())};document.addEventListener(`click`,c,!0),s.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let l=e.subscribe(o),u=t.list.subscribe(o);return o(),()=>{l(),u(),s.disconnect(),document.removeEventListener(`click`,c,!0);let e=document.querySelectorAll(`${Ss}, [${As}], [${zs}]`);for(let t of e)jc(t);for(let e of document.querySelectorAll(`[${Bs}]`))e.removeAttribute(Bs);i!==void 0&&clearTimeout(i);for(let e of document.querySelectorAll(`[${Ts}]`))Mc(e);for(let e of document.querySelectorAll(`[${Es}]`))rl(e)}}function ic(e){let t=e.target instanceof Element?e.target:e.target.parentElement;return t!==null&&t.closest(Xs)!==null||[...e.addedNodes,...e.removedNodes].some(e=>e instanceof Element&&(e.matches(Xs)||e.querySelector(Xs)!==null))}function ac(e,t,n,r,i,a,o){let s=[...e.querySelectorAll(Ss)].filter(e=>e.closest(`[${Os}]`)===null),c=Fc(e,s),l=[...t.rooms],u=[],d=[],f=0,p=0;for(let e of s){fc(e,a);let r=e.getAttribute(`aria-selected`)===`true`,i=dc(o,e),s=i===void 0?mc(e)??(r?n:void 0):String(i.id),c=uc(o,s)??i,d=s===void 0?void 0:gc(l,e=>e.sessionId===s),f=Ec(e)?.textContent?.trim(),p=c!==void 0&&bc(c)||f?.startsWith(Hs)===!0||e.dataset.dshChatroomBranchSessionId!==void 0,m=d===void 0&&s===void 0&&!p&&r&&t.room!==void 0?gc(l,e=>e.id===t.room?.id):void 0,h=d??m??_c(l,e),g=yc(e,s,c,o,t,h),_=g!==void 0&&oc(g,t)?g:void 0;u.push({row:e,sessionId:s,summary:c,branch:_,room:h})}let m=new Map,h=new Set;for(let e of u){let t=e.branch;if(t===void 0||t.parentSessionId===void 0)continue;let n=t.sessionId??`${t.parentSessionId}\u0000${t.displayTitle}`;h.has(n)||(h.add(n),m.set(t.parentSessionId,(m.get(t.parentSessionId)??0)+1))}for(let e of u){let{row:n,sessionId:i,branch:a,room:o}=e;if(o!==void 0){lc(n),kc(n),n.setAttribute(zs,o.sessionId),Sc(n,o,vc(o,t),f++,r);let e=i??o.sessionId;wc(n,o.title,m.get(e)??0),Nc(n,`group`),d.push(n);continue}if(Ac(n),a!==void 0){lc(n),n.dataset.dshChatroomBranchRow!==void 0&&n.dataset.dshChatroomBranchSessionId!==a.sessionId&&kc(n),Cc(n,a),n.style.order=String(Zs+f++),n.querySelector(`:scope > [${ws}]`)?.remove(),Nc(n,`group`),d.push(n);continue}if(kc(n),!pc(n)){lc(n),Mc(n);continue}if(!sc(i,t)){cc(n);continue}lc(n),n.removeAttribute(As),Pc(n,p++),Nc(n,`solo`),d.push(n)}Ic(e,c,d,t,i),al(e,t,r)}function oc(e,t){return t.auth?.enabled!==!0||e.parentSessionId!==void 0&&t.rooms.some(t=>t.sessionId===e.parentSessionId)}function sc(e,t){return t.phase!==void 0&&t.phase!==`ready`?!1:t.auth?.enabled!==!0||e!==void 0&&t.soloSessionIds?.includes(e)===!0}function cc(e){let t=Jc(e);Mc(e),e.setAttribute(Bs,``),t.setAttribute(Bs,``)}function lc(e){e.removeAttribute(Bs),e.parentElement?.removeAttribute(Bs)}function uc(e,t){if(e!==void 0&&t!==void 0)return e.byId[t]}function dc(e,t){if(e===void 0)return;let n=Ec(t)?.textContent?.trim();if(n===void 0||!n.startsWith(Hs))return;let r=Object.values(e.byId).filter(e=>bc(e)&&e.displayTitle.trim()===n);return r.length===1?r[0]:void 0}function fc(e,t){e.dataset.dshChatroomDirectCloseBound!==`true`&&(e.dataset.dshChatroomDirectCloseBound=`true`,e.addEventListener(`click`,e=>{e.target.closest(`button[aria-label]`)===null&&t?.()}))}function pc(e){return!e.hasAttribute(`aria-expanded`)&&(e.getAttribute(`aria-selected`)===`true`||e.querySelector(`button[aria-label]`)!==null||e.dataset.dshChatroomRoomRow!==void 0)}function mc(e){if(e.dataset.dshChatroomSessionId!==void 0)return e.dataset.dshChatroomSessionId;if(e.draggable!==!0)return;let t=e.ownerDocument.defaultView?.Event;if(t===void 0)return;let n=new Map,r={effectAllowed:`uninitialized`,dropEffect:`none`,setData:(e,t)=>n.set(e,t),getData:e=>n.get(e)??``,clearData:e=>e===void 0?n.clear():n.delete(e)},i;try{let a=new t(`dragstart`,{bubbles:!0,cancelable:!0});Object.defineProperty(a,"dataTransfer",{value:r}),e.dispatchEvent(a),i=n.get(`text/plain`)}catch{i=void 0}finally{try{let n=new t(`dragend`,{bubbles:!0});Object.defineProperty(n,"dataTransfer",{value:r}),e.dispatchEvent(n)}catch{}}if(i!==void 0&&i.length!==0)return e.dataset.dshChatroomSessionId=i,i}function hc(e,t){return[...e.querySelectorAll(`span`)].some(e=>!e.closest(`[${Ms}]`)&&e.childElementCount===0&&e.textContent?.trim()===t)}function gc(e,t){let n=e.findIndex(t);if(!(n<0))return e.splice(n,1)[0]}function _c(e,t){let n=e.filter(e=>hc(t,e.title));return n.length===1?gc(e,e=>e.id===n[0]?.id):void 0}function vc(e,t){return e.memberAvatars===void 0?e.memberAvatarIds===void 0?t.room?.id===e.id&&t.members.length>0?t.members.slice(0,9).map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}})):[]:e.memberAvatarIds.slice(0,9).map((e,t)=>({participantId:String(t),avatarId:e})):e.memberAvatars.slice(0,9)}function yc(e,t,n,r,i,a){if(a!==void 0||t!==void 0&&i.rooms.some(e=>e.sessionId===t))return;let o=Ec(e)?.textContent?.trim(),s=n?.displayTitle.trim(),c=t?.startsWith(Vs)===!0,l=s?.startsWith(Hs)===!0||o?.startsWith(Hs)===!0;if(n!==void 0&&!bc(n)&&!c)return;let u=n!==void 0&&bc(n);if(c&&o!==void 0&&!o.startsWith(Hs)&&!u){e.dataset.dshChatroomSessionId===t&&delete e.dataset.dshChatroomSessionId;return}if(!c&&!l)return;let d=s??o??Hs,f=xc(d),p=t===void 0?void 0:(i.threadPreviews??[]).find(e=>e.thread.sessionId===t),m=p===void 0?void 0:i.rooms.find(e=>e.id===p.thread.roomId),h=n?.parentId===void 0?p?.thread.root.sourceSessionId??m?.sessionId:String(n.parentId),g=uc(r,h);return{sessionId:t,displayTitle:d,topic:f,parentSessionId:h,parentTitle:(h===void 0?void 0:i.rooms.find(e=>e.sessionId===h))?.title??g?.displayTitle??m?.title,replyCount:p!==void 0&&p.totalMessages>0?p.totalMessages:void 0,updatedAt:n?.updatedAt??p?.thread.createdAt??0}}function bc(e){return String(e.id).startsWith(Vs)||e.parentId!==void 0&&e.displayTitle.trim().startsWith(Hs)}function xc(e){let t=e.trim(),n=t.startsWith(Hs)?t.slice(3).trim():t;return n===``?`未命名主题`:n}function Sc(e,t,n,r,i){e.dataset.dshChatroomRoomRow=``,e.dataset.dshChatroomRoomId=t.id,e.dataset.pinned=String(t.pinned===!0),e.style.order=String(Zs+r),e.parentElement?.setAttribute(`data-dsh-chatroom-room-list`,``),il(e,t),e.querySelector(`:scope > [${ws}]`)?.remove();let a=n.map(e=>`${e.participantId}:${e.avatarId}:${e.avatarUrl??``}`).join(`|`)||`empty`,o=e.querySelector(`:scope > [${Cs}]`);if(o?.dataset.signature===a)return;o?.remove(),o=e.ownerDocument.createElement(`span`),o.setAttribute(Cs,``),o.dataset.count=String(Math.max(1,n.length)),o.dataset.signature=a,o.setAttribute(`aria-hidden`,`true`);let s=n.length===0?[{emoji:`✦`}]:n.map(e=>({...e,emoji:_(e.avatarId,e.participantId).emoji}));for(let t of s){let n=e.ownerDocument.createElement(`span`);if(t.avatarUrl===void 0)n.textContent=t.emoji;else{let r=e.ownerDocument.createElement(`img`);r.src=t.avatarUrl,r.alt=``,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>{r.remove(),n.textContent=t.emoji},{once:!0}),n.append(r)}o.append(n)}e.prepend(o)}function Cc(e,t){e.dataset.dshChatroomBranchRow=``,t.sessionId===void 0?delete e.dataset.dshChatroomBranchSessionId:(e.dataset.dshChatroomBranchSessionId=t.sessionId,e.setAttribute(zs,t.sessionId)),t.parentSessionId===void 0?delete e.dataset.dshChatroomBranchParentSessionId:e.dataset.dshChatroomBranchParentSessionId=t.parentSessionId,e.setAttribute(Rs,String(t.updatedAt)),e.dataset.dshChatroomBranchTopic=t.topic,t.parentTitle===void 0?delete e.dataset.dshChatroomBranchParentTitle:e.dataset.dshChatroomBranchParentTitle=t.parentTitle,t.replyCount===void 0?e.removeAttribute(Ns):e.setAttribute(Ns,String(t.replyCount));let n=t.parentTitle===void 0?`来自群聊`:`来自 ${t.parentTitle}`,r=t.replyCount===void 0?``:` · ${t.replyCount} 条回复`,i=t.parentTitle===void 0&&t.replyCount===void 0?`分支会话：${t.topic}`:`分支会话：${t.topic}，${n}${r}`;Oc(e,i),e.setAttribute(`aria-label`,i),e.setAttribute(`title`,i);let a=Ec(e,t.displayTitle);a?.setAttribute(Ps,``);let o=e.querySelector(`:scope > [${js}]`);o===null&&(o=e.ownerDocument.createElement(`span`),o.setAttribute(js,``),o.setAttribute(`aria-hidden`,`true`),o.textContent=`↳`);let s=e.querySelector(`:scope > [${Ms}]`);s===null&&(s=e.ownerDocument.createElement(`span`),s.setAttribute(Ms,``),s.setAttribute(`aria-hidden`,`true`));let c=`${t.topic}|${t.parentTitle??``}|${t.replyCount??``}`;if(s.dataset.signature!==c){s.replaceChildren();let i=e.ownerDocument.createElement(`span`);i.setAttribute(`data-dsh-chatroom-branch-heading`,``);let a=e.ownerDocument.createElement(`span`);a.setAttribute(`data-dsh-chatroom-branch-badge`,``),a.textContent=`分支`;let o=e.ownerDocument.createElement(`span`);o.setAttribute(`data-dsh-chatroom-branch-topic`,``),o.textContent=t.topic,i.append(a,o);let l=e.ownerDocument.createElement(`span`);l.setAttribute(`data-dsh-chatroom-branch-parent`,``),l.textContent=`${n}${r}`,s.append(i,l),s.dataset.signature=c}a===void 0?(o.parentElement!==e||s.parentElement!==e)&&e.append(o,s):(a.previousElementSibling!==s||s.previousElementSibling!==o)&&a.before(o,s)}function wc(e,t,n){if(n===0){Tc(e);return}e.dataset.dshChatroomHasBranches=``,e.dataset.dshChatroomBranchCount=String(n);let r=e.querySelector(`:scope > [${Fs}]`);if(r===null){r=e.ownerDocument.createElement(`span`),r.setAttribute(Fs,``);let n=Ec(e,t);n===void 0?e.append(r):n.after(r)}let i=`分支 ${n}`;r.textContent!==i&&(r.textContent=i),r.setAttribute(`title`,`${n} 个分支`),r.setAttribute(`aria-label`,`${n} 个分支`)}function Tc(e){delete e.dataset.dshChatroomHasBranches,delete e.dataset.dshChatroomBranchCount,e.querySelector(`:scope > [${Fs}]`)?.remove()}function Ec(e,t){let n=[...e.querySelectorAll(`span`)].filter(e=>!e.closest(`[${Ms}]`)&&!e.hasAttribute(js)&&!e.hasAttribute(Fs)&&e.childElementCount===0);if(t!==void 0){let e=n.find(e=>e.textContent?.trim()===t);if(e!==void 0)return e}return n.find(e=>e.textContent?.trim().startsWith(Hs))??n.find(e=>e.dataset.dshChatroomNativeBranchTitle!==void 0)??n.filter(e=>{let t=e.textContent?.trim()??``;return t!==``&&!Dc(t)&&t!==`●`}).sort((e,t)=>(t.textContent?.trim().length??0)-(e.textContent?.trim().length??0))[0]}function Dc(e){return/^(?:刚刚|现在|now|\d+\s*(?:秒|分钟|小时|天|周|月|年|s|min|h|d|w))$/iu.test(e)}function Oc(e,t){let n=$s.get(e);if(n===void 0){$s.set(e,{ariaLabel:e.getAttribute(`aria-label`),title:e.getAttribute(`title`),appliedAriaLabel:t,appliedTitle:t});return}let r=e.getAttribute(`aria-label`)===n.appliedAriaLabel?n.ariaLabel:e.getAttribute(`aria-label`),i=e.getAttribute(`title`)===n.appliedTitle?n.title:e.getAttribute(`title`);$s.set(e,{ariaLabel:r,title:i,appliedAriaLabel:t,appliedTitle:t})}function kc(e){delete e.dataset.dshChatroomBranchRow,delete e.dataset.dshChatroomBranchSessionId,delete e.dataset.dshChatroomBranchParentSessionId,e.removeAttribute(Rs),e.removeAttribute(Ls),delete e.dataset.dshChatroomBranchTopic,delete e.dataset.dshChatroomBranchParentTitle,e.removeAttribute(Ns),e.querySelector(`:scope > [${js}]`)?.remove(),e.querySelector(`:scope > [${Ms}]`)?.remove();for(let t of e.querySelectorAll(`[${Ps}]`))t.removeAttribute(Ps);let t=$s.get(e);t!==void 0&&(e.getAttribute(`aria-label`)===t.appliedAriaLabel&&(t.ariaLabel===null?e.removeAttribute(`aria-label`):e.setAttribute(`aria-label`,t.ariaLabel)),e.getAttribute(`title`)===t.appliedTitle&&(t.title===null?e.removeAttribute(`title`):e.setAttribute(`title`,t.title)),$s.delete(e)),Jc(e).removeAttribute(Ls)}function Ac(e){delete e.dataset.dshChatroomRoomRow,delete e.dataset.dshChatroomRoomId,delete e.dataset.pinned,Tc(e),e.querySelector(`:scope > [${Cs}]`)?.remove()}function jc(e){kc(e),Ac(e),delete e.dataset.dshChatroomSessionId,delete e.dataset.dshChatroomBranchSessionId,e.style.removeProperty(`order`)}function Mc(e){jc(e),e.removeAttribute(Ts),e.removeAttribute(As),e.removeAttribute(Ys),e.querySelector(`:scope > [${ws}]`)?.remove();let t=e.parentElement;t?.removeAttribute(ks),t?.removeAttribute(Ys),t?.style.removeProperty(`order`)}function Nc(e,t){e.setAttribute(Ts,t);let n=e.closest(`[role="tree"]`),r=e.parentElement;n!==null&&r!==null&&r!==n&&(r.setAttribute(ks,t),r.style.order=e.style.order)}function Pc(e,t){if(e.style.order=String(Qs+t),e.querySelector(`:scope > [${ws}]`)!==null)return;let n=e.ownerDocument.createElement(`span`);n.setAttribute(ws,``),n.setAttribute(`aria-hidden`,`true`),n.textContent=`✧`,e.prepend(n)}function Fc(e,t){return t.find(e=>e.closest(`[role="tree"]`)!==null)?.closest(`[role="tree"]`)??e.querySelector(`[role="tree"]`)??t[0]?.parentElement??void 0}function Ic(e,t,n,r,i){for(let n of e.querySelectorAll(`[${Es}]`))n!==t&&rl(n);if(t===void 0)return;t.setAttribute(Es,``),Lc(t),Rc(t);let a=n.filter(e=>e.getAttribute(Ts)===`group`),o=n.filter(e=>e.getAttribute(Ts)===`solo`);Bc(t,a),Hc(t,a),Qc(t,`group`,`群聊`,a.filter(e=>e.dataset.dshChatroomRoomRow!==void 0).length,-11e3),Yc(t,`group`,a.filter(e=>e.dataset.dshChatroomRoomRow!==void 0),Zs),qc(t,a),Qc(t,`solo`,`Solo`,o.length,-7e3),Yc(t,`solo`,o,Qs);let s=$c(r.directPeers??[],r.directConversations??[]);Qc(t,`direct`,`私聊`,s.length,-3e3),el(t,s,r,i)}function Lc(e){for(let t of e.querySelectorAll(`[${Us}]`))t.removeAttribute(Us);for(let t of e.querySelectorAll(`[${Ws}]`))t.removeAttribute(Ws),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`);for(let t of e.querySelectorAll(`div[role="treeitem"]`)){let n=Zc(e,t);if(n!==void 0&&n!==t&&n.setAttribute(Us,``),!t.hasAttribute(`aria-expanded`))continue;let r=t.parentElement;if(r===null)continue;let i=r.querySelectorAll(`div[role="treeitem"]`).length>1?t:r;i.setAttribute(Ws,``),i.dataset.hidden=`true`,t.getAttribute(`aria-expanded`)===`true`?t.removeAttribute(Gs):t.getAttribute(`aria-expanded`)===`false`&&!t.hasAttribute(Gs)&&(t.setAttribute(Gs,``),t.click())}}function Rc(e){for(let t of e.querySelectorAll(`[${Us}]`)){let e=t.querySelector(`:scope > button[aria-expanded]`);e!==null&&(e.setAttribute(Ks,``),e.style.removeProperty(`order`),e.getAttribute(`aria-expanded`)===`true`?e.removeAttribute(qs):e.hasAttribute(qs)||(e.setAttribute(qs,``),e.click()))}}function zc(e){return`data-dsh-chatroom-${e}-overflow-expanded`}function Bc(e,t){let n=Vc(e),r=t.filter(e=>e.dataset.dshChatroomBranchParentSessionId!==void 0),i=new Map;for(let e of r){e.removeAttribute(Ls),Jc(e).removeAttribute(Ls);let t=e.dataset.dshChatroomBranchParentSessionId,n=i.get(t)??[];n.push(e),i.set(t,n)}let a=new Map([...e.querySelectorAll(`:scope > [${Is}]`)].map(e=>[e.dataset.parentSessionId??``,e]));for(let[t,r]of i){let i=Gc(r),o=a.get(t);if(a.delete(t),i.length<=2){n.delete(t),o?.remove();continue}if(o===void 0){o=e.ownerDocument.createElement(`div`),o.setAttribute(Is,``),o.dataset.parentSessionId=t;let r=e.ownerDocument.createElement(`button`);r.type=`button`;let i=o;r.onclick=()=>{n.has(t)?n.delete(t):n.add(t),i.dataset.expanded=String(n.has(t)),Kc(i,Gc(Wc(e,t)))},o.append(r),e.append(o)}o.dataset.expanded=String(n.has(t)),o.dataset.total=String(i.length),Kc(o,i)}for(let[e,t]of a)n.delete(e),t.remove()}function Vc(e){let t=ec.get(e);if(t!==void 0)return t;let n=new Set([...e.querySelectorAll(`:scope > [${Is}][data-expanded="true"]`)].map(e=>e.dataset.parentSessionId).filter(e=>e!==void 0));return ec.set(e,n),n}function Hc(e,t){let n=new Map([...e.querySelectorAll(`:scope > [${Is}]`)].map(e=>[e.dataset.parentSessionId??``,e])),r=new Map;for(let e of t.filter(e=>e.dataset.dshChatroomBranchRow!==void 0)){let t=e.dataset.dshChatroomBranchParentSessionId;if(t===void 0)continue;let n=r.get(t)??[];n.push(e),r.set(t,n)}let i=new Set,a=Zs;for(let e of t.filter(e=>e.dataset.dshChatroomRoomRow!==void 0)){Uc(e,a++),i.add(e);let t=e.dataset.dshChatroomSessionId;if(t===void 0)continue;for(let e of Gc(r.get(t)??[]))Uc(e,a++),i.add(e);let o=n.get(t);o!==void 0&&(o.style.order=String(a++)),n.delete(t)}for(let e of t)i.has(e)||Uc(e,a++);for(let e of n.values())e.style.order=String(a++)}function Uc(e,t){e.style.order=String(t);let n=Jc(e);n!==e&&(n.style.order=e.style.order)}function Wc(e,t){return[...e.querySelectorAll(`[${As}]`)].filter(e=>e.dataset.dshChatroomBranchParentSessionId===t)}function Gc(e){return[...e].sort((e,t)=>Number(t.getAttribute(Rs)??`0`)-Number(e.getAttribute(Rs)??`0`)||Number(e.style.order)-Number(t.style.order))}function Kc(e,t){let n=e.dataset.expanded===`true`;t.forEach((e,t)=>{let r=Jc(e);!n&&t>=2?(e.setAttribute(Ls,``),r.setAttribute(Ls,``)):(e.removeAttribute(Ls),r.removeAttribute(Ls))});let r=e.querySelector(`button`);if(r===null)return;r.setAttribute(`aria-expanded`,String(n));let i=t.length-2,a=n?`收起`:`展开其余 ${String(i)} 个分支`;r.textContent!==a&&(r.textContent=a)}function qc(e,t){for(let e of t.filter(e=>e.dataset.dshChatroomBranchRow!==void 0)){let t=Jc(e);t.getAttribute(Ys)===`group`&&t.removeAttribute(Ys)}for(let t of e.querySelectorAll(`:scope > [${Is}]`))t.getAttribute(Ys)===`group`&&t.removeAttribute(Ys);let n=t.filter(e=>e.dataset.dshChatroomRoomRow!==void 0&&Jc(e).getAttribute(Ys)===`group`).map(e=>e.dataset.dshChatroomSessionId).filter(e=>e!==void 0);for(let t of n){for(let n of Wc(e,t))Jc(n).setAttribute(Ys,`group`);[...e.querySelectorAll(`:scope > [${Is}]`)].find(e=>e.dataset.parentSessionId===t)?.setAttribute(Ys,`group`)}}function Jc(e){let t=e.parentElement;return t===null||!t.hasAttribute(ks)||t.querySelectorAll(`div[role="treeitem"]`).length>1?e:t}function Yc(e,t,n,r){let i=n.length>8;n.forEach((e,n)=>{let r=Jc(e);i&&n>=8?r.setAttribute(Ys,t):r.removeAttribute(Ys)});let a=e.querySelector(`:scope > [${Js}="${t}"]`);if(!i){a?.remove();return}if(a===null){a=e.ownerDocument.createElement(`div`),a.setAttribute(Js,t);let n=e.ownerDocument.createElement(`button`);n.type=`button`;let r=a;n.onclick=()=>{let n=zc(t);e.setAttribute(n,String(e.getAttribute(n)!==`true`)),Xc(e,r,t)},a.append(n),e.append(a)}a.dataset.total=String(n.length),a.dataset.collapsedOrder=n[8]?.style.order??String(r+8);let o=[...e.querySelectorAll(`[${Ts}="${t}"]`)].map(e=>Number(e.style.order));t===`group`&&o.push(...[...e.querySelectorAll(`:scope > [${Is}]`)].map(e=>Number(e.style.order))),a.dataset.expandedOrder=String(Math.max(...o)+1),Xc(e,a,t)}function Xc(e,t,n){let r=Number(t.dataset.total??`0`),i=e.getAttribute(zc(n))===`true`;t.style.order=i?t.dataset.expandedOrder??String(r):t.dataset.collapsedOrder??`8`;let a=t.querySelector(`button`);if(a===null)return;a.setAttribute(`aria-expanded`,String(i));let o=i?`收起`:`展开其余 ${String(r-8)} 个会话`;a.textContent!==o&&(a.textContent=o)}function Zc(e,t){let n=t;for(;n?.parentElement!==null&&n.parentElement!==e;)n=n.parentElement;return n?.parentElement===e?n:void 0}function Qc(e,t,n,r,i){let a=e.querySelector(`:scope > [${Ds}="${t}"]`);if(a===null){a=e.ownerDocument.createElement(`div`),a.setAttribute(Ds,t);let n=e.ownerDocument.createElement(`button`);n.type=`button`,n.setAttribute(`aria-expanded`,`true`),n.innerHTML=`<span data-chevron aria-hidden>⌄</span><span data-folder-icon aria-hidden></span><strong></strong><small></small>`,n.onclick=()=>{let r=e.getAttribute(`data-dsh-chatroom-${t}-collapsed`)===`true`;e.setAttribute(`data-dsh-chatroom-${t}-collapsed`,String(!r)),n.setAttribute(`aria-expanded`,String(r));let i=n.querySelector(`[data-chevron]`);i!==null&&(i.textContent=r?`⌄`:`›`)},a.append(n),e.append(a)}a.style.order=String(i);let o=a.querySelector(`strong`),s=a.querySelector(`small`),c=a.querySelector(`[data-folder-icon]`);if(c!==null&&c.childElementCount===0){let t=e.querySelector(`div[role="treeitem"][aria-expanded] svg[width="16"]`);t!==null&&c.append(t.cloneNode(!0))}o?.textContent!==n&&(o.textContent=n);let l=String(r);s?.textContent!==l&&(s.textContent=l)}function $c(e,t){let n=new Map(t.map(e=>[e.peer.participantId,e])),r=new Map(e.map(e=>[e.participantId,e]));for(let e of t)r.set(e.peer.participantId,e.peer);return[...r.values()].sort((e,t)=>{let r=n.get(e.participantId)?.updatedAt??0;return(n.get(t.participantId)?.updatedAt??0)-r||e.displayName.localeCompare(t.displayName,`zh-CN`)})}function el(e,t,n,r){let i=new Map([...e.querySelectorAll(`:scope > [${Os}]`)].map(e=>[e.dataset.peerId??``,e]));t.forEach((t,a)=>{let o=i.get(t.participantId);o===void 0&&(o=e.ownerDocument.createElement(`div`),o.setAttribute(Os,``),o.dataset.peerId=t.participantId,o.innerHTML=`<button type="button"><span data-avatar></span><span><strong></strong><small></small></span></button>`,e.append(o)),i.delete(t.participantId),o.style.order=String(-2900+a),o.dataset.active=String(n.directConversation?.peer.participantId===t.participantId);let s=o.querySelector(`button`);s.setAttribute(`aria-label`,`与 ${t.displayName} 私聊`),s.onclick=()=>{r?.(t.participantId)};let c=o.querySelector(`strong`),l=o.querySelector(`small`);c.textContent!==t.displayName&&(c.textContent=t.displayName);let u=n.directConversations.find(e=>e.peer.participantId===t.participantId),d=u===void 0?`@${t.username}`:nl(u.updatedAt);l.textContent!==d&&(l.textContent=d),tl(o.querySelector(`[data-avatar]`),t)});for(let e of i.values())e.remove()}function tl(e,t){let n=`${t.participantId}:${t.avatarId}:${t.avatarUrl??``}`;if(e.dataset.signature===n)return;e.dataset.signature=n,e.replaceChildren();let r=_(t.avatarId,t.participantId).emoji;if(t.avatarUrl===void 0){e.textContent=r;return}let i=e.ownerDocument.createElement(`img`);i.src=t.avatarUrl,i.alt=``,i.referrerPolicy=`no-referrer`,i.addEventListener(`error`,()=>{i.remove(),e.textContent=r},{once:!0}),e.append(i)}function nl(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${String(t)}分钟`:t<1440?`${String(Math.floor(t/60))}小时`:`${String(Math.floor(t/1440))}天`}function rl(e){e.removeAttribute(Es),e.removeAttribute(`data-dsh-chatroom-group-collapsed`),e.removeAttribute(`data-dsh-chatroom-solo-collapsed`),e.removeAttribute(`data-dsh-chatroom-direct-collapsed`),e.removeAttribute(zc(`group`)),e.removeAttribute(zc(`solo`));let t=`:scope > [${Ds}], :scope > [${Os}], :scope > [${Js}], :scope > [${Is}]`;for(let n of e.querySelectorAll(t))n.remove();for(let t of e.querySelectorAll(`[${Ys}]`))t.removeAttribute(Ys);for(let t of e.querySelectorAll(`[${Ls}]`))t.removeAttribute(Ls);for(let t of e.querySelectorAll(`[${Us}]`))t.removeAttribute(Us);for(let t of e.querySelectorAll(`[${Ws}], [${ks}]`))t.removeAttribute(Ws),t.removeAttribute(ks),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`);for(let t of e.querySelectorAll(`[${Gs}]`))t.removeAttribute(Gs);for(let t of e.querySelectorAll(`[${Ks}]`))t.removeAttribute(Ks),t.removeAttribute(qs),t.style.removeProperty(`order`)}function il(e,t){let n=e.querySelector(`button[aria-label]`);n!==null&&(n.dataset.dshChatroomNativeMenuRoomId=t.id,n.dataset.dshChatroomNativeMenuBound!==`true`&&(n.dataset.dshChatroomNativeMenuBound=`true`,n.addEventListener(`click`,()=>{tc=n.dataset.dshChatroomNativeMenuRoomId,nc=void 0})))}function al(e,t,n){if(nc!==void 0){nc.isConnected||(nc=void 0,tc=void 0);return}let r=t.rooms.find(e=>e.id===tc);if(r===void 0)return;let i=[...e.querySelectorAll(`[role="menu"]`)].at(-1)?.querySelector(`:scope > [role="presentation"]`),a=i?.querySelector(`:scope > *`),o=a?.querySelector(`:scope > button[role="menuitem"]`);if(i==null||a==null||o==null)return;let s=e.createElement(a.tagName.toLowerCase());s.className=a.className,s.dataset.dshChatroomPinMenuItem=``;let c=e.createElement(`button`);c.type=`button`,c.role=`menuitem`,c.className=o.className;let l=e.createElement(`span`);l.className=o.querySelector(`:scope > :first-child`)?.className??``;let u=e.createElementNS(`http://www.w3.org/2000/svg`,`svg`);u.setAttribute(`width`,`16`),u.setAttribute(`height`,`16`),u.setAttribute(`viewBox`,`0 0 16 16`);let d=e.createElementNS(`http://www.w3.org/2000/svg`,`path`);d.setAttribute(`d`,`M5 1.75h6l-1 4.1 2 2V9H8.65v5.25h-1.3V9H4V7.85l2-2-1-4.1Z`),d.setAttribute(`fill`,`currentColor`),u.append(d),l.append(u);let f=e.createElement(`span`);f.className=o.querySelector(`:scope > :last-child`)?.className??``,f.textContent=r.pinned===!0?`取消置顶`:`置顶群聊`,c.append(l,f),c.onclick=t=>{t.stopPropagation(),n?.(r.id,r.pinned!==!0),e.dispatchEvent(new KeyboardEvent(`keydown`,{key:`Escape`,bubbles:!0}))},s.append(c),i.append(s),nc=s}let ol=`data-dsh-chatroom-settings-nav`;function sl(e){if(typeof document>`u`||typeof MutationObserver>`u`)return()=>void 0;let t=!1,n=()=>{if(t)return;let n=e().trim(),r=document.querySelectorAll(`[role="dialog"] nav button`);for(let e of r)n.length>0&&e.textContent?.trim()===n?e.setAttribute(ol,``):e.removeAttribute(ol)};n();let r=new MutationObserver(n);return r.observe(document.body??document.documentElement,{childList:!0,subtree:!0,characterData:!0}),()=>{t=!0,r.disconnect(),document.querySelectorAll(`[${ol}]`).forEach(e=>{e.removeAttribute(ol)})}}let cl=[`connection`,`inputTriggers`,`sessions`,`settingsScope`,`slots`,`workspaces`];function ll(e){let t=e.get(`connection`);if(t===void 0)throw Error(`chatroom: client connection service unavailable`);let n=e.get(`sessions`);if(n===void 0)throw Error(`chatroom: client sessions service unavailable`);let r=e.get(`workspaces`);if(r===void 0)throw Error(`chatroom: client workspaces service unavailable`);let i=e.get(`inputTriggers`);if(i===void 0)throw Error(`chatroom: input trigger service unavailable`);let a=typeof location>`u`?void 0:T(location),o=new Go(e=>{let t=e,r=n.list.getSnapshot();return r.current===t||r.byId[t]!==void 0&&(n.open(t),!0)},a);e.effect(()=>ms(r,n,async e=>{let n=o.getSnapshot();if(n.phase===`loading`)throw Error(`chatroom identity is still loading`);let r=n.auth.enabled?await o.reserveSoloSession():void 0;try{let n=await t.api.sessions.create({workspaceId:e,...r===void 0?{}:{sessionId:r}});if(!n.result.ok)throw Error(`new shared session failed: ${n.result.error.code}: ${n.result.error.message}`);let i=n.result.value.sessionId;if(r!==void 0&&String(i)!==r)throw Error(`native Session id does not match its Solo reservation`);return o.registerNewSession(String(i)),i}catch(e){throw r!==void 0&&await o.releaseSoloSession(r),e}}),`chatroom: distinct native New Session`),e.effect(()=>{document.documentElement.setAttribute(`data-dsh-chatroom-installed`,``),a!==void 0&&document.documentElement.setAttribute(`data-dsh-chatroom-branch-frame`,``);let r=()=>{a!==void 0&&document.querySelector(`[data-shell-overlay]`)?.parentElement?.setAttribute(`data-dsh-chatroom-branch-shell`,``)},i=a===void 0?void 0:new MutationObserver(r);i?.observe(document.body,{childList:!0,subtree:!0}),r();let s=document.createElement(`style`);s.dataset.dshChatroomStyles=``,s.textContent=`
...
`,document.head.append(s);let c=_s(t),l=ul(e.get(`settingsScope`)),u=ss(t.api,o),d=rc(o,n),f=us(o),p=a,m=!1,h=()=>{let e=p;if(e===void 0||m)return;let t=n.list.getSnapshot();ae(e,{current:t.current===void 0?void 0:String(t.current),byId:t.byId},e=>{n.open(e)})&&(m=!0,ne(e.parentSessionId),oe(e))},g=e=>{if(a===void 0||e.origin!==globalThis.location.origin||e.source!==globalThis.parent)return;let t=k(e.data);if(t!==void 0){if(p!==void 0&&te(p,t)){h();return}p=t,m=!1,le(),o.switchBranchFrame(t),h()}};globalThis.addEventListener(`message`,g);let _=()=>{h(),o.resumeOpen();let e=n.list.getSnapshot(),t=e.current,r=t===void 0?void 0:e.byId[t];o.activateSession(t===void 0?void 0:String(t),r?.displayTitle??`新会话`,a===void 0&&r?.origin!==`subagent`,r?.parentId===void 0?void 0:String(r.parentId));let i=o.getSnapshot();if(t!==void 0&&i.auth.enabled&&i.phase!==`loading`&&(i.phase!==`ready`||o.roomForSession(String(t))===void 0&&!o.canPromptNativeSession(String(t)))){n.clear();return}t!==void 0&&r?.blank===!0&&r.origin!==`subagent`&&o.roomForSession(String(t))===void 0&&o.newSessionMode(String(t))===void 0&&o.registerNewSession(String(t))},v=n.list.subscribe(_),y=o.getSnapshot().phase,b=o.subscribe(()=>{let e=o.getSnapshot().phase;e!==y&&(y=e,_())});return o.start().then(async()=>{if(_(),typeof location>`u`)return;let e=E(location,a);e!==void 0&&await o.selectRoom(e)}),()=>{v(),b(),globalThis.removeEventListener(`message`,g),u(),f(),d(),l(),c(),o.stop(),s.remove(),i?.disconnect(),document.documentElement.removeAttribute(`data-dsh-chatroom-installed`),a!==void 0&&(le(),document.documentElement.removeAttribute(`data-dsh-chatroom-branch-frame`))}},`chatroom: browser state and styles`);let s=hl(o),c=gl(o);e.effect(()=>i.registerSource(s),`chatroom: AI mention source`),e.effect(()=>i.registerSource(c),`chatroom: member mention source`),e.slots.inject(`shell.overlay`,()=>e.slots.register({name:`shell.overlay`,id:`chatroom`,order:0,inject:()=>({hooks:{chatroom:o},openRoom:o.openRoom,closeRoom:o.closeRoom,join:o.join,login:o.login,register:o.register,logout:o.logout,openAccount:o.openAccount,closeAccount:o.closeAccount,changePassword:o.changePassword,selectRoom:o.selectRoom,createRoom:o.createRoom,resetIdentity:o.resetIdentity,retry:o.retry,closeMembers:o.closeMembers,renameRoom:o.renameRoom,setMemberRole:o.setMemberRole,addRoomMembers:o.addRoomMembers,setRoomAutoTrigger:o.setRoomAutoTrigger,closeThread:o.closeThread,setThreadReply:o.setThreadReply,clearThreadReply:o.clearThreadReply,sendThreadMessage:o.sendThreadMessage,enableSystemNotifications:o.enableSystemNotifications,dismissToast:o.dismissToast,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,closeForward:o.closeForward,forwardSelected:o.forwardSelected,toggleMessageSelection:o.toggleMessageSelection,clearMessageSelection:o.clearMessageSelection,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect,toggleDirectReaction:o.toggleDirectReaction,quickDirectMeeting:o.quickDirectMeeting,loadWecomAuthorization:o.loadWecomAuthorization,startWecomAuthorization:o.startWecomAuthorization,disconnectWecomAuthorization:o.disconnectWecomAuthorization,rebindWecomAuthorization:o.rebindWecomAuthorization,closeSearch:o.closeSearch,searchAll:o.searchAll,openSearchResult:o.openSearchResult})},go)),e.slots.inject(`settings.section`,()=>e.slots.register({name:`settings.section`,id:`chatroom`,order:30,label:()=>`群聊与账号`,inject:()=>({hooks:{chatroom:o},closeAccount:o.closeAccount,changePassword:o.changePassword,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect,quickDirectMeeting:o.quickDirectMeeting,loadWecomAuthorization:o.loadWecomAuthorization,startWecomAuthorization:o.startWecomAuthorization,disconnectWecomAuthorization:o.disconnectWecomAuthorization,rebindWecomAuthorization:o.rebindWecomAuthorization})},_t)),e.effect(()=>sl(()=>`群聊与账号`),`chatroom: settings navigation icon`),e.slots.inject(`conversation.session.header.actions`,()=>e.slots.register({name:`conversation.session.header.actions`,id:`chatroom-identity`,order:-5,inject:()=>({hooks:{chatroom:o},openMembers:o.openMembers})},xs)),e.slots.inject(`conversation.input.left`,()=>e.slots.register({name:`conversation.input.left`,id:`chatroom-files`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},lt)),e.slots.inject(`conversation.input.right`,()=>e.slots.register({name:`conversation.input.right`,id:`chatroom-session-controls`,order:-30,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),stopRoomSession:o.stopRoomSession,newRoomSession:o.newRoomSession,quickMeeting:o.quickMeeting,quickThreadMeeting:o.quickThreadMeeting})},ut)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-group-setup`,order:-30,inject:()=>({hooks:{chatroom:o},registerNewSession:o.registerNewSession,newSessionMode:o.newSessionMode,chooseNewSessionMode:o.chooseNewSessionMode})},gs)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-composition`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,updateQueuedPrompt:o.updateQueuedPrompt,resolveTarget:o.agentTargetForSession.bind(o)})},dt)),e.slots.inject(`conversation.input.attachments`,()=>pl(()=>e.slots.entries(`conversation.input.attachments`).find(e=>(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.input.attachments`,t),t=>e.slots.register({name:`conversation.input.attachments`,priority:-10,locale:`conversation`,inject:()=>({hooks:{chatroom:o},nativeAttachmentsView:t,clearReply:o.clearReply,resolveTarget:o.agentTargetForSession.bind(o)})},ht))),e.slots.inject(`conversation.chat.assistant-actions`,()=>e.slots.register({name:`conversation.chat.assistant-actions`,id:`chatroom-reply`,order:5,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),setReply:o.setReply,openThread:o.openThread,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,openForward:o.openForward,toggleMessageSelection:o.toggleMessageSelection})},Co)),e.slots.inject(`conversation.chat.node`,()=>pl(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`assistant-step`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`assistant-step`,priority:-10,locale:`conversation`,inject:()=>({hooks:{chatroom:o},nativeMessageView:t,resolveTarget:o.agentTargetForSession.bind(o),setReply:o.setReply,openThread:o.openThread,toggleReaction:o.toggleReaction,recallMessage:o.recallMessage,updateQueuedPrompt:o.updateQueuedPrompt,openForward:o.openForward,toggleMessageSelection:o.toggleMessageSelection})},Do))),e.slots.inject(`conversation.chat.node`,()=>pl(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`user`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`user`,priority:-10,locale:`conversation`,inject:()=>ml(o,t)},Ao))),e.slots.inject(`conversation.chat.node`,()=>pl(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`steering`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`steering`,priority:-10,locale:`conversation`,inject:()=>ml(o,t)},jo)))}function ul(e){if(!dl(e))return()=>void 0;let t=e.describe();return!fl(t)||t.persistence!==`memory`?()=>void 0:(t.persistence=`host`,t.load(),()=>{t.persistence===`host`&&(t.persistence=`memory`)})}function dl(e){return typeof e==`object`&&!!e&&typeof e.describe==`function`}function fl(e){return typeof e==`object`&&!!e&&(e.persistence===`host`||e.persistence===`memory`)&&typeof e.load==`function`}function pl(e,t,n){let r,i,a=()=>{let t=e();if(t===r)return;let a=i;i=void 0,r=void 0,a?.(),t!==void 0&&(r=t,i=n(t))},o=t(a);return a(),()=>{o(),i?.(),i=void 0,r=void 0}}function ml(e,t){return{hooks:{chatroom:e},resolveTarget:e.agentTargetForSession.bind(e),nativeMessageView:t,setReply:e.setReply,openThread:e.openThread,toggleReaction:e.toggleReaction,recallMessage:e.recallMessage,openForward:e.openForward,toggleMessageSelection:e.toggleMessageSelection}}function hl(e){return{trigger:`@`,name:`AI 助手`,order:-100,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];let a=[{name:vl(r?.aiDisplayName??`DeepSeek`),icon:`✦`,description:r===void 0?`创建群聊后立即回复`:`提及后回复`}],o=n.toLocaleLowerCase();return a.filter(e=>e.name.toLocaleLowerCase().includes(o))},lexicon(t){let n=e.roomForSession(String(t.sessionId));return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[`AI`,`DeepSeek`]:[]:[...new Set([`AI`,n.aiDisplayName])]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${yl(e.name)} `}}}}function gl(e){return{trigger:`@`,name:`群聊成员`,order:-90,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];i&&e.getSnapshot().directPeers.length===0&&await e.loadDirectDirectory();let a=e.getSnapshot(),o=r===void 0?a.directPeers.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:Wo(e,a.directPeers),icon:_(e.avatarId,e.participantId).emoji,description:`创建群聊时自动邀请 · @${e.username}`})):a.members.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:e.displayName,icon:_(e.avatarId,e.participantId).emoji,description:e.online?`在线成员`:`群成员`})),s=n.toLocaleLowerCase();return o.filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t).filter(e=>e.name.toLocaleLowerCase().includes(s))},lexicon(t){let n=e.roomForSession(String(t.sessionId)),r=e.getSnapshot();return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[...new Set(r.directPeers.filter(e=>e.participantId!==r.identity?.participantId).map(e=>Wo(e,r.directPeers)))]:[]:[...new Set(r.members.filter(e=>e.participantId!==r.identity?.participantId).map(e=>e.displayName))]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${e.name} `}}}}let _l=`（AI 助手）`;function vl(e){return`${e}${_l}`}function yl(e){return e.endsWith(_l)?e.slice(0,-7):e}var bl={inject:cl,apply:ll};return n.activateRemoteSettingsMirror=ul,n.apply=ll,n.createChatroomAiSource=hl,n.createChatroomMemberSource=gl,n.default=bl,n.inject=cl,n.mountAfterNativeMessageView=pl,t.exports}});
