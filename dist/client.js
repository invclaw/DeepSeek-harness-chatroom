...
`,t),r=n<0?e.length:n;return Un=e,Wn=t,Gn=r,r}function Z(e,t){let n=X(e,t);return n<e.length?n+1:n}function Kn(e,t,n){for(;t<n;){let n=e.charCodeAt(t);if(n!==F&&n!==I)break;t++}return t}function qn(e,t){let n=Z(e,t);for(;n<e.length;){let t=X(e,n);if(Zn(e,n,t))return n;n=Z(e,n)}return e.length}function Jn(e,t,n,r){let i=0;for(;t+i<n&&e.charCodeAt(t+i)===r;)i++;return i}var Yn=0,Q=0;function Xn(e,t,n){for(Yn=0,Q=0;t+Q<n;){let n=e.charCodeAt(t+Q);if(n===I)Yn+=4-Yn%4;else if(n===F)Yn++;else break;Q++}}function Zn(e,t,n){return Kn(e,t,n)>=n}function Qn(e,t){if(!e)return e;var n=t.v||=Object.create(null),r=n[e];if(r===void 0)return n[e]=0,e;for(var i=r+1,a=`${e}-${i}`;n[a]!==void 0;)i++,a=`${e}-${i}`;return n[e]=i,n[a]=0,a}function $n(e,t,n,r){let i=X(e,t);if(Xn(e,t,i),Yn>3)return null;let a=t+Q;if(e.charCodeAt(a)!==Te)return null;let o=Jn(e,a,i,35);if(o<1||o>6||(a+=o,a<i&&e.charCodeAt(a)!==F&&e.charCodeAt(a)!==I))return null;a=Kn(e,a,i);for(var s=i;s>a&&e.charCodeAt(s-1)===F;)s--;for(var c=s;s>a&&e.charCodeAt(s-1)===Te;)s--;if(s<c){if(s===a||e.charCodeAt(s-1)===F)for(;s>a&&e.charCodeAt(s-1)===F;)s--;else s=c}let l=Dr(e.slice(a,s),!1,n,r);return{node:{type:Y.heading,level:o,children:l,id:``},end:Z(e,i)}}function er(e,t,n){var r=e.charCodeAt(t);if(r!==De&&r!==V)return!1;for(var i=t;i<n&&e.charCodeAt(i)===r;)i++;for(;i<n&&(e.charCodeAt(i)===F||e.charCodeAt(i)===I);)i++;return i>=n}function tr(e,t){let n=X(e,t);if(Xn(e,t,n),Yn>3)return null;let r=t+Q,i=e.charCodeAt(r);if(i!==V&&i!==Oe&&i!==ke)return null;let a=0;for(;r<n;){let t=e.charCodeAt(r);if(t===i)a++;else if(t!==F&&t!==I)return null;r++}return a<3?null:{node:{type:Y.breakThematic},end:Z(e,n)}}var nr=0,rr=0,ir=``;function ar(e,t,n){let r=X(e,t);if(Xn(e,t,r),Yn>3)return null;let i=Yn,a=t+Q,o=e.charCodeAt(a);if(o!==R&&o!==Ce)return null;let s=Jn(e,a,r,o);if(s<3)return null;a+=s;let c=Kn(e,a,r),l=r;if(o===R){for(let t=c;t<r;t++)if(e.charCodeAt(t)===R)return null}for(;l>c&&(e.charCodeAt(l-1)===F||e.charCodeAt(l-1)===I);)l--;let u=e.slice(c,l),d=``,f=``,p=u.indexOf(` `);p===-1?d=u:(d=u.slice(0,p),f=u.slice(p+1).trim()),d=Hn(d);var m;if(f){Sn.lastIndex=0;for(var h;(h=Sn.exec(f))!=null;)m||={},m[h[1]]=h[2]===void 0?h[3]:h[2]}let g=Z(e,r),_=e.length,v=e.length;var y;o===nr&&s===rr?y=ir:(y=String.fromCharCode(o).repeat(s),nr=o,rr=s,ir=y);for(var b=g;b<e.length;){var x=e.indexOf(y,b);if(x===-1)break;for(var S=x,C=0;S>0&&C<4&&e.charCodeAt(S-1)===F;)S--,C++;if(C<=3&&(S===0||e.charCodeAt(S-1)===L)){for(var w=x+s;w<e.length&&e.charCodeAt(w)===o;)w++;var T=X(e,w);if(Zn(e,w,T)){_=S,v=Z(e,T);break}}b=x+1}var E;if(i===0)E=_>g&&e.charCodeAt(_-1)===L?e.slice(g,_-1):e.slice(g,_);else{E=``;for(var D=g;D<_;){var O=X(e,D);Xn(e,D,O);var ee=Math.min(Q,i);E+=`${e.slice(D+ee,O)}
`,D=Z(e,O)}E.length>0&&E.charCodeAt(E.length-1)===L&&(E=E.slice(0,-1))}return{node:{type:Y.codeBlock,lang:d||void 0,text:E,infoString:f||void 0,attrs:m},end:v}}function or(e,t,n){for(var r=0,i=t;i<n&&r<4;)e.charCodeAt(i)===I?r+=4-r%4:r++,i++;if(r<4)return``;for(var a=``,o=4;o<r;o++)a+=` `;return a+e.slice(i,n)}function sr(e,t){if(Xn(e,t,X(e,t)),Yn<4)return null;let n=``,r=t;for(;r<e.length;){let t=X(e,r);if(Xn(e,r,t),Zn(e,r,t)){for(var i=`${or(e,r,t)}
`,a=Z(e,t);a<e.length;){var o=X(e,a);if(Zn(e,a,o)){i+=`${or(e,a,o)}
`,a=Z(e,o);continue}Xn(e,a,o),Yn>=4&&(n+=i,r=a);break}if(r!==a)break;continue}if(Yn<4)break;let d=0,f=0;var s=0;for(let n=r;n<t&&f<4;n++){if(e.charCodeAt(n)===I){var c=4-f%4;f+c>4&&(s=f+c-4),f+=c}else f++;d++}var l=``;if(s>0)for(var u=0;u<s;u++)l+=` `;l+=e.slice(r+d,t),n+=`${l}
`,r=Z(e,t)}for(;n.length>0&&n.charCodeAt(n.length-1)===L;)n=n.slice(0,-1);return n?{node:{type:Y.codeBlock,lang:void 0,text:n,infoString:void 0,attrs:void 0},end:r}:null}function cr(e,t,n,r){if(Xn(e,t,X(e,t)),Yn>3)return null;let i=t+Q;if(e.charCodeAt(i)!==B)return null;let a=``,o=t,s,c=!1,l=!1,u=!1;for(;o<e.length;){let t=X(e,o);Xn(e,o,t);let n=o+Q;if(e.charCodeAt(n)===B){let r=n+1;var d=Yn+1,f=!1;if(r<t){var p=e.charCodeAt(r);p===F?(r++,d++,f=!0):p===I&&(f=!0)}for(var m=``,h=!1,g=r;g<t;g++)if(e.charCodeAt(g)===I){h=!0;break}if(h){var _=d;if(f&&r<t&&e.charCodeAt(r)===I){for(var v=4-_%4,y=0;y<v-1;y++)m+=` `;_+=v,r++}for(var b=r;b<t;b++)if(e.charCodeAt(b)===I){for(var x=4-_%4,S=0;S<x;S++)m+=` `;_+=x}else m+=e[b],_++}else m=e.slice(r,t);if(!(a||s)){let n=m.match(/^\[!([A-Za-z]+)\]\s*$/);if(n){s=n[1].toUpperCase(),o=Z(e,t);continue}}a+=`${m}
`;var C=m.trimStart();C.startsWith("```")||C.startsWith(`~~~`)?u=!u:(m.startsWith(`    `)||m.startsWith(`	`))&&(u=!0),l=C.length>0,o=Z(e,t)}else if(a&&!Zn(e,o,t)&&l){if(Yn<4){var w=o+Q,T=w<t?e.charCodeAt(w):0;if(T===Te||T===B||T===R||T===Ce||T===Ae||(T===V||T===Oe||T===ke)&&tr(e,o)||(T===V||T===Oe||T===Qe)&&w+1<t&&(e.charCodeAt(w+1)===F||e.charCodeAt(w+1)===I))break;if(T>=W&&T<=G){for(var E=w;E<t&&e.charCodeAt(E)>=W&&e.charCodeAt(E)<=G;)E++;if(E<t&&(e.charCodeAt(E)===Je||e.charCodeAt(E)===nt))break}}if(u)break;a+=`${e.slice(o,t)}
`,c=!0,o=Z(e,t)}else break}if(!(a||s))return null;var{inBlockQuote:D,l:O}=n;n.inBlockQuote=!0,c&&(n.l=!0);var ee=n.i;n.i=ee||!Zn(e,o,e.length);let k=fi(a||``,n,r);return n.i=ee,n.inBlockQuote=D,n.l=O,{node:{type:Y.blockQuote,children:k,alert:s||void 0},end:o}}function lr(e,t,n){for(var r=0,i=t;i<n;i++)e.charCodeAt(i)===I?r+=4-r%4:r++;return r}function ur(e,t,n){if(Xn(e,t,n),Yn>3)return null;var r=t+Q;if(r>=n)return null;var i=e.charCodeAt(r),a=Yn,o=r,s=r;if(i===V||i===Oe||i===Qe){if(o=r+1,o<n&&e.charCodeAt(o)!==F&&e.charCodeAt(o)!==I&&e.charCodeAt(o)!==L)return null}else if(i>=W&&i<=G){for(;s<n&&s-r<9;){var c=e.charCodeAt(s);if(c<W||c>G)break;s++}if(s>r&&s<n){var l=e.charCodeAt(s);if(l===Je||l===nt){if(o=s+1,o<n&&e.charCodeAt(o)!==F&&e.charCodeAt(o)!==I&&e.charCodeAt(o)!==L)return null}else return null}else return null}else return null;var u=o,d=lr(e,t,o),f=0,p=u,m=d;if(u>=n)return{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:u,contentCol:d+1,markerCol:a,isEmpty:!0};for(;p<n&&(e.charCodeAt(p)===F||e.charCodeAt(p)===I);){if(e.charCodeAt(p)===I){var h=4-m%4;m+=h}else m++;p++,f++}var g=p>=n,_=m-d;return g||_>4?(m=d+1,p=u+1,f=1):f===0&&(m=d+1,p=u,f=1),{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:p,contentCol:m,markerCol:a,isEmpty:g}}var dr=0;function fr(e,t,n,r){var i=0,a=t;for(dr=0;a<n&&i<r;){var o=e.charCodeAt(a);if(o===I){var s=4-i%4;if(i+s>r){dr=i+s-r,a++,i=r;break}i+=s}else if(o===F)i++;else break;a++}return a}function pr(e,t,n,r){var i=X(e,t),a=ur(e,t,i);if(!a)return null;var o=[],s=t,c=a.contentCol,l=``,u=a.isEmpty,d=!1,f=!1;if(!a.isEmpty){for(var p=!1,m=a.contentStart;m<i;m++)if(e.charCodeAt(m)===I){p=!0;break}if(p){var h=``,g=lr(e,t,a.contentStart),_=g-a.contentCol;if(_>0)for(var v=0;v<_;v++)h+=` `;for(var y=a.contentStart;y<i;y++)if(e.charCodeAt(y)===I){for(var b=4-g%4,x=0;x<b;x++)h+=` `;g+=b}else h+=e[y],g++;l=`${h}
`}else l=`${e.slice(a.contentStart,i)}
`}for(s=Z(e,i);s<e.length;){var S=X(e,s);Xn(e,s,S);var C=e.charCodeAt(s+Q);if(Yn<c&&(C===V||C===Oe||C===ke)&&Yn<=3&&tr(e,s))break;var w=ur(e,s,S);if(w&&w.ordered===a.ordered&&w.marker===a.marker&&w.markerCol<c){o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),d&&(f=!0),c=w.contentCol,u=w.isEmpty,d=!1,l=w.isEmpty?``:`${e.slice(w.contentStart,S)}
`,s=Z(e,S);continue}if(Zn(e,s,S)){var T=fr(e,s,S,c);if(dr>0||T<S){for(var E=``,D=0;D<dr;D++)E+=` `;l+=`${E+e.slice(T,S)}
`}else l+=`
`;s=Z(e,S);for(var O=!1,ee=0;ee<l.length;ee++){var k=l.charCodeAt(ee);if(k!==L&&k!==Se&&k!==F&&k!==I){O=!0;break}}if(u&&!O){if(s<e.length){var te=X(e,s),ne=ur(e,s,te);if(!ne||ne.ordered!==a.ordered||ne.marker!==a.marker)break;d=!0}else break}if(s<e.length){var re=X(e,s);Xn(e,s,re);var ie=e.charCodeAt(s+Q);if((ie===V||ie===Oe||ie===ke)&&Yn<=3&&tr(e,s))break;var ae=ur(e,s,re);if(ae&&ae.ordered===a.ordered&&ae.marker===a.marker&&ae.markerCol<c){d=!0;continue}if(!Zn(e,s,re)&&Yn<c)break}continue}if(Yn>=c){var oe=fr(e,s,S,c);if(dr>0){for(var se=``,ce=c,le=0;le<dr;le++)se+=` `,ce++;for(var A=oe;A<S;A++)if(e.charCodeAt(A)===I){for(var j=4-ce%4,M=0;M<j;M++)se+=` `;ce+=j}else se+=e[A],ce++;l+=`${se}
`}else l+=`${e.slice(oe,S)}
`;s=Z(e,S);continue}for(var ue=!1,de=0;de<l.length;de++){var fe=l.charCodeAt(de);if(fe!==L&&fe!==Se&&fe!==F&&fe!==I){ue=!0;break}}if(!d&&ue&&!u){var N=s+Q,P=e.charCodeAt(N);if(!(P===Te||P===B||P===Ae||P===R||P===Ce||(P===V||P===Oe||P===ke||P===Qe)&&(tr(e,s)!=null||ur(e,s,S)!=null)||P>=W&&P<=G&&ur(e,s,S)!=null)){l+=`${e.slice(N,S)}
