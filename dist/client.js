...
`&&t++,Et(e,`---`,r))return{endPos:t,hasValidYaml:n};if(!n){let t=Ht(e,r,i);if(t<i){let r=e.charCodeAt(t);if(r>=J&&r<=ut||r>=K&&r<=q||r>=W&&r<=G||r===ke){for(t++;t<i&&(r=e.charCodeAt(t),r>=J&&r<=ut||r>=K&&r<=q||r>=W&&r<=G||r===ke||r===V||r===Je);)t++;t<i&&e.charCodeAt(t)===Fe&&(t++,t>=i?n=!0:(r=e.charCodeAt(t),(r===F||r===I)&&(n=!0)))}}}}return null}var mt=/&([a-zA-Z0-9]+|#[0-9]{1,7}|#x[0-9a-fA-F]{1,6});/gi,ht={class:`className`,for:`htmlFor`,allowfullscreen:`allowFullScreen`,allowtransparency:`allowTransparency`,autocomplete:`autoComplete`,autofocus:`autoFocus`,autoplay:`autoPlay`,cellpadding:`cellPadding`,cellspacing:`cellSpacing`,charset:`charSet`,classid:`classId`,colspan:`colSpan`,contenteditable:`contentEditable`,contextmenu:`contextMenu`,crossorigin:`crossOrigin`,enctype:`encType`,formaction:`formAction`,formenctype:`formEncType`,formmethod:`formMethod`,formnovalidate:`formNoValidate`,formtarget:`formTarget`,frameborder:`frameBorder`,hreflang:`hrefLang`,inputmode:`inputMode`,keyparams:`keyParams`,keytype:`keyType`,marginheight:`marginHeight`,marginwidth:`marginWidth`,maxlength:`maxLength`,mediagroup:`mediaGroup`,minlength:`minLength`,novalidate:`noValidate`,radiogroup:`radioGroup`,readonly:`readOnly`,rowspan:`rowSpan`,spellcheck:`spellCheck`,srcdoc:`srcDoc`,srclang:`srcLang`,srcset:`srcSet`,tabindex:`tabIndex`,usemap:`useMap`,viewbox:`viewBox`},gt={};function _t(e){if(!e)return gt;var t={};for(var n in e){var r=ht[n.toLowerCase()];if(r)t[r]=e[n];else{var i=n.indexOf(`:`);i===-1?t[n]=e[n]:t[n.slice(0,i)+n[i+1].toUpperCase()+n.slice(i+2)]=e[n]}}return t}var vt=/(\n|^[-*]\s|^#|^ {2,}|^-{2,}|^>\s|^<(div|p|h[1-6]|ul|ol|li|blockquote|pre|table|thead|tbody|tr|td|th|dl|dt|dd|hr|address|article|aside|details|dialog|figure|figcaption|footer|form|header|main|menu|nav|section|summary|textarea|fieldset|legend|center|dir|hgroup|marquee|search|output|template)\b)/i;function yt(e){return e.indexOf(`&`)===-1?e:e.replace(mt,(e,t)=>{var n=xe(t);if(n)return n;if(t[0]===`#`){var r=t[1]===`x`||t[1]===`X`?Number.parseInt(t.slice(2),16):Number.parseInt(t.slice(1),10);return r===0||r>=55296&&r<=57343||r>1114111?`�`:r<=65535?String.fromCharCode(r):String.fromCharCode(55296+(r-65536>>10),56320+(r-65536&1023))}return e})}var bt=/(javascript|vbscript|data(?!:image)):/i;function xt(e){if(bt.test(e))return null;if(e.indexOf(`%`)===-1)return e;try{let t=decodeURIComponent(e).replace(/[^A-Za-z0-9/:]/g,``);if(bt.test(t))return null}catch{return null}return e}var St={},Ct,wt;for(Ct=[192,193,194,195,196,197,224,225,226,227,228,229,230,198],wt=0;wt<Ct.length;wt++)St[Ct[wt]]=`a`;for(St[231]=St[199]=`c`,St[240]=St[208]=`d`,Ct=[200,201,202,203,233,232,234,235],wt=0;wt<Ct.length;wt++)St[Ct[wt]]=`e`;for(Ct=[207,239,206,238,205,237,204,236],wt=0;wt<Ct.length;wt++)St[Ct[wt]]=`i`;for(St[209]=St[241]=`n`,Ct=[248,216,339,338,213,245,212,244,211,243,210,242],wt=0;wt<Ct.length;wt++)St[Ct[wt]]=`o`;for(Ct=[220,252,219,251,218,250,217,249],wt=0;wt<Ct.length;wt++)St[Ct[wt]]=`u`;St[376]=St[255]=St[221]=St[253]=`y`;function Tt(e){for(var t=``,n=-1,r=e.length,i=0;i<r;i++){var a=e.charCodeAt(i);if(a>=J&&a<=ut||a>=W&&a<=G){n<0&&(n=i);continue}if(a>=K&&a<=q){n>=0&&(t+=e.slice(n,i),n=-1),t+=String.fromCharCode(a+ft);continue}if(a===F||a===V){n>=0&&(t+=e.slice(n,i),n=-1),t+=`-`;continue}n>=0&&(t+=e.slice(n,i),n=-1);var o=St[a];o&&(t+=o)}return n>=0&&(t+=e.slice(n)),t}function Et(e,t,n){return e.startsWith(t,n)}var Dt=new Set([`area`,`base`,`br`,`col`,`embed`,`hr`,`img`,`input`,`link`,`meta`,`param`,`source`,`track`,`wbr`,`circle`,`ellipse`,`line`,`path`,`polygon`,`polyline`,`rect`,`use`,`stop`,`animate`,`set`]);function Ot(e){let t=e.toLowerCase();if(Dt.has(t))return!0;let n=t.indexOf(`:`);return n!==-1&&(t=t.slice(n+1),Dt.has(t))}var kt=1,At=2,jt=4,Mt=8,Nt=16,Pt=32,Ft=64,It=(()=>{var e=new Uint8Array(128),t;for(e[I]=kt,e[L]=kt|At,e[We]=kt,e[Se]=kt|At,e[F]=kt,t=Ne;t<=Ye;t++)e[t]=jt;for(t=Fe;t<=je;t++)e[t]=jt;for(t=we;t<=R;t++)e[t]=jt;for(t=$e;t<=Ce;t++)e[t]=jt;for(t=W;t<=G;t++)e[t]=Nt;for(t=K;t<=q;t++)e[t]=Mt;for(t=J;t<=ut;t++)e[t]=Mt;return e})(),Lt=/[\p{P}\p{S}]/u,Rt=/\p{Zs}/u,zt=[];function Bt(e){var t=e.indexOf(`\r`),n=e.indexOf(`\0`);if(t===-1&&n===-1)return e;var r=e.length;zt.length=0;var i=0,a=0;for(a=t===-1?n:n===-1||t<n?t:n;a<r;a++){var o=e.charCodeAt(a);o===Se?(i<a&&zt.push(e.slice(i,a)),a+1<r&&e.charCodeAt(a+1)===L&&a++,zt.push(`
`),i=a+1):o===0&&(i<a&&zt.push(e.slice(i,a)),zt.push(`�`),i=a+1)}return i<r&&zt.push(e.slice(i)),zt.join(``)}function Vt(e){return e.replace(/>\s+</g,`><`).replace(/\n+/g,` `).trim()}function Ht(e,t,n){let r=n??e.length;for(;t<r&&(e[t]===` `||e[t]===`	`);)t++;return t}function Ut(e){if(!e)return!1;for(var t in e)return!0;return!1}function Wt(e){return{attrs:{},children:[{type:Y.text,text:e}],c:!0,type:Y.htmlBlock,tag:`header`}}var Gt=/^\n+/;function Kt(e){for(var t=e.length;t>0&&(e[t-1]===`
`||e[t-1]===`\r`);)t--;return`${e.slice(0,t).replace(Gt,``)}

`}function qt(e){if((e.type===Y.htmlSelfClosing||e.type===Y.htmlBlock)&&e.a)return[];if(e.type===Y.paragraph){var t=e.children;return t?t.flatMap(qt):[]}return e.type===Y.text?e.text?.trim()?[e]:[]:e.type===Y.htmlBlock&&e.children?[{...e,children:e.children?.flatMap(qt)}]:[e]}function Jt(e){for(var t=0;t<e.length;t++){if(e[t].type===Y.htmlBlock){var n=e[t],r=!1;if(n.c&&t===e.length-1){var i=n.j===void 0?n.a?n.e||``:(n.e||``)+(n.h||``):n.j,a=`</${String(n.tag).toLowerCase()}>`,o=i.toLowerCase().indexOf(a);o!==-1&&i.slice(o+a.length).replace(/<\/[a-z][a-z0-9-]*\s*>/gi,``).trim()&&(r=!0)}r||(n.c=!1)}`children`in e[t]&&e[t].children&&Jt(e[t].children)}}function Yt(e,t){for(var n=0;n<e.length;n++){var r=e[n];if(r.type===Y.paragraph&&r.children)for(var i=r.children,a=0;a<i.length;a++){var o=i[a];if(o.type===Y.htmlSelfClosing&&o.a&&o.tag.toLowerCase()===t){var s=e.slice(0,n);a>0&&s.push({type:Y.paragraph,children:i.slice(0,a)});var c=[];if(a+1<i.length){var l=i.slice(a+1).filter(e=>!(e.type===Y.htmlSelfClosing&&e.a));l.length>0&&(c=l)}return c=c.concat(e.slice(n+1)),{found:!0,beforeClose:s,afterClose:c}}}if((r.type===Y.htmlSelfClosing||r.type===Y.htmlBlock)&&r.a&&r.tag.toLowerCase()===t)return{found:!0,beforeClose:e.slice(0,n),afterClose:e.slice(n+1)}}return{found:!1,beforeClose:e,afterClose:[]}}function Xt(e){var t=``;for(var n in e){var r=e[n];r===!0?t+=` ${n}`:r!==void 0&&r!=null&&r!==!1&&(t+=` ${n}="${String(r)}"`)}return t}function Zt(e,t,n,r){var i;return i=t===void 0?Xt(n):t.length>0&&t.charCodeAt(0)>F?` ${t}`:t,`<${e}${i}${r}`}function Qt(e){var t=e.tag,n=e.type===Y.htmlSelfClosing,r=e,i=r.b,a=`</${t}>`;if(!n&&r.a)return{kind:`literal`,literal:(r.h||a)+(r.e||``)};if(n){var o=e;return o.a?{kind:`literal`,literal:o.h||a}:o.m?{kind:`literal`,literal:o.m}:{kind:`literal`,literal:Zt(t,i,e.attrs,` />`)}}var s=Zt(t,i,e.attrs,`>`),c=r.children,l=c!=null&&c.length>0;if(r.c&&r.j!==void 0)return l?{kind:`sandwich`,open:s,close:a}:{kind:`literal`,literal:r.j};if(r.c&&!l)return{kind:`literal`,literal:s+(r.e||``)+(r.h||a)};if(c!=null&&c.length>0){for(var u=``,d=0;d<c.length;d++){var f=c[d];if(f.type!==Y.text)return{kind:`sandwich`,open:s,close:a};u+=f.text}return{kind:`literal`,literal:s+u+a}}var p=r.e||``;return p&&p.indexOf(a)!==-1?{kind:`literal`,literal:s+p}:{kind:`literal`,literal:s+p+a}}function $t(e,t,n){var r=[],i=e,a=n;if(i&&r.push(i),Array.isArray(t))for(var o=0;o<t.length;o++)r.push(t[o]);else t!=null&&r.push(t);a&&r.push(a);for(var s=[],c=0;c<r.length;c++){var l=r[c];typeof l==`string`&&s.length>0&&typeof s.at(-1)==`string`?s[s.length-1]=s.at(-1)+l:s.push(l)}return s}function en(e){return e==null||e.tagfilter!==!1}function tn(e,t,n,r){var i=t(e,n,r);return i===null?null:an(i)}function nn(e){var t=[];if(!e)return t;for(var n in e)n.charCodeAt(0)===94&&t.push({identifier:n,footnote:e[n].target});return t}function rn(e,t,n){if(t.indexOf(`.`)===-1)return e?.[t]||n;for(var r=e,i=t.split(`.`),a=0;a<i.length&&(r=r?.[i[a]],r!==void 0);)a++;return r||n}function an(e){for(var t=!1,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r<=F||r===Ze||r===Ee||r===Ae||r===B||r===we||r===H||r===Me||r===z||r===R||r>=123){t=!0;break}}if(!t)return e;for(var i=``,n=0;n<e.length;n++){var r=e.charCodeAt(n);if(r===Ee&&n+2<e.length){var a=e.charCodeAt(n+1),o=e.charCodeAt(n+2);if((a>=W&&a<=G||a>=K&&a<=Ie||a>=J&&a<=Le)&&(o>=W&&o<=G||o>=K&&o<=Ie||o>=J&&o<=Le)){i+=e[n]+e[n+1]+e[n+2],n+=2;continue}}if(r>=55296&&r<=57343){if(r<=56319&&n+1<e.length){var s=e.charCodeAt(n+1);if(s>=56320&&s<=57343){i+=encodeURI(e[n]+e[n+1]),n++;continue}}i+=e[n];continue}i+=encodeURI(e[n])}return i}function on(...e){return e.filter(Boolean).join(` `)}var sn=new Set([`title`,`textarea`,`style`,`xmp`,`iframe`,`noembed`,`noframes`,`script`,`plaintext`]),cn=/<(\/?)(title|textarea|style|xmp|iframe|noembed|noframes|script|plaintext)(\s|>|\/)/gi;function ln(e){return sn.has(e.toLowerCase())}function un(e){return cn.lastIndex=0,cn.test(e)}function dn(e){return cn.lastIndex=0,e.replace(cn,(e,t,n,r)=>`&lt;${t}${n}${r}`)}function fn(e,t){var n=e||{},r=n.slugify,i;if(r){var a=r;i=e=>a(e,Tt)}else i=Tt;return{disableAutoLink:n.disableAutoLink,disableFrontmatter:n.disableFrontmatter,disableParsingRawHTML:n.disableParsingRawHTML,enforceAtxHeadings:n.enforceAtxHeadings,evalUnserializableExpressions:n.evalUnserializableExpressions,forceBlock:n.forceBlock,forceInline:t===void 0?n.forceInline:t,ignoreHTMLBlocks:n.ignoreHTMLBlocks,optimizeForStreaming:n.optimizeForStreaming,preserveFrontmatter:n.preserveFrontmatter,sanitizer:n.sanitizer||xt,slugify:i,tagfilter:en(n)}}var pn=/^<([a-zA-Z][a-zA-Z0-9-]*)\s[^>]*>/,mn=/^<[A-Z]/,hn=[`script`,`pre`,`style`,`textarea`],gn=new Set(hn),_n=/<(?:pre|script|style|textarea)\b/i,vn=/<(?:pre|script|style|textarea)\b/iy,yn=/^(\s{0,3}#[#\s]|\s{0,3}[-*+]\s|\s{0,3}\d+\.\s|\s{0,3}>\s|\s{0,3}```)/m,bn=/^<([a-z][^ >/\n\r]*) ?([^>]*?)>/im,xn=new Uint8Array(128);(()=>{for(var e=[R,Oe,ke,Ce,De,we,Ne,Ae,H,Pe,L,Re,ze,Le],t=0;t<e.length;t++)xn[e[t]]=1})();var Sn=/([a-zA-Z_][a-zA-Z0-9_-]*)=(?:"([^"]*)"|'([^']*)')/g;function Cn(e){return gn.has(e)}function wn(e){return _n.test(e)}function Tn(e,t,n){for(var r=t,i=n;r<i&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;if(r>=i)return!1;e.charCodeAt(r)===U&&r++;for(var a=0;r<i;){for(;r<i&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;if(r>=i)break;if(e.charCodeAt(r)===U&&a>0){for(var o=r+1;o<i&&(e.charCodeAt(o)===F||e.charCodeAt(o)===I);)o++;if(o>=i)return!0}if(e.charCodeAt(r)===Fe&&r++,r>=i||e.charCodeAt(r)!==V)return!1;for(;r<i&&e.charCodeAt(r)===V;)r++;for(r<i&&e.charCodeAt(r)===Fe&&r++,a++;r<i&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;if(r<i){if(e.charCodeAt(r)===U)r++;else return!1}}return a>0}var En=/[\u0000-\u001F\u007F]/g,Dn={action:1,background:1,cite:1,data:1,formaction:1,href:1,longdesc:1,poster:1,src:1,"xlink:href":1},On=/&#(x[0-9a-f]+|[0-9]+);?/gi;function kn(e){return e.indexOf(`&#`)===-1?e:e.replace(On,(e,t)=>{var n=t.charCodeAt(0)===st||t.charCodeAt(0)===ct?Number.parseInt(t.slice(1),16):Number.parseInt(t,10);return n>0&&n<=1114111?String.fromCodePoint(n):e})}function An(e,t,n){if(n&&t.charCodeAt(0)===$e)return!1;var r=e.charCodeAt(0),i=e.charCodeAt(1);if((r===ot||r===at)&&(i===it||i===rt))return!(n&&t===``);var a=e.toLowerCase();if(a===`srcdoc`)return!0;if(a===`style`)return/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(t);if(Dn[a]===1){var o=kn(yt(t));if(xt(o)===null)return!0;var s=o.replace(En,``);return s!==o&&xt(s)===null}return!1}function jn(e){return`<`+(e.f?`/`:``)+e.tag+e.g+e.b+(e.n?e.r?` />`:`/>`:`>`)}function Mn(e,t,n,r){for(var i=[],a=t,o=0;o<r.length;o+=2){var s=r[o];if(s>a){var c=e.slice(a,s).trim();c&&i.push(c)}a=r[o+1]}if(a<n){var l=e.slice(a,n).trim();l&&i.push(l)}return i.join(` `)}function Nn(e,t){if(e.charCodeAt(t)!==Ae)return null;let n=t+1,r=e.length,i=!1;e.charCodeAt(n)===Ye&&(n++,i=!0);let a=n,o=e.charCodeAt(n);if(!(o>=J&&o<=ut||o>=K&&o<=q))return null;for(;n<r&&(e.charCodeAt(n)>=J&&e.charCodeAt(n)<=ut||e.charCodeAt(n)>=K&&e.charCodeAt(n)<=q||e.charCodeAt(n)>=W&&e.charCodeAt(n)<=G||e.charCodeAt(n)===V);)n++;let s=e.slice(a,n);if(!s)return null;let c=s.charCodeAt(0),l=c>=K&&c<=q||s.indexOf(`-`)!==-1,u=n;for(;n<r&&(e.charCodeAt(n)===F||e.charCodeAt(n)===I||e.charCodeAt(n)===L);)n++;let d=e.slice(u,n);if(n===u&&n<r){var f=e.charCodeAt(n);if(f!==B&&f!==Ye)return null}let p=n,m={},h=!1;for(var g=null;n<r;){let t=e.charCodeAt(n);if(t===B){let t=g?Mn(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!1,g:d,attrs:m,end:n+1,tag:s}}if(t===F||t===I||t===L){n++;continue}if(t===Ye&&n+1<r&&e.charCodeAt(n+1)===B){h=n>p&&e.charCodeAt(n-1)===F;let t=g?Mn(e,p,n,g):e.slice(p,n);return{r:h,u:l,f:i,b:t,q:g!=null,n:!0,g:d,attrs:m,end:n+2,tag:s}}var _=n,v=e.charCodeAt(n);if(!(v>=J&&v<=ut||v>=K&&v<=q||v===ke||v===Fe))return null;for(n++;n<r;){var y=e.charCodeAt(n);if(y>=J&&y<=ut||y>=K&&y<=q||y>=W&&y<=G||y===ke||y===Je||y===Fe||y===V)n++;else break}for(var b=e.slice(_,n),x=n;n<r&&(e.charCodeAt(n)===F||e.charCodeAt(n)===I);)n++;var S,C;if(e.charCodeAt(n)===De){for(n++;n<r&&(e.charCodeAt(n)===F||e.charCodeAt(n)===I);)n++;var w=e.charCodeAt(n);if(w===Ze||w===Xe){n++;for(var T=n;n<r&&e.charCodeAt(n)!==w;)n++;if(n>=r)return null;if(S=e.slice(T,n),n++,n<r){var E=e.charCodeAt(n);if(E!==F&&E!==I&&E!==L&&E!==B&&E!==Ye)return null}C=n}else if(w===$e){var D=1,T=n;for(n++;n<r&&D>0;){var y=e.charCodeAt(n);y===$e?D++:y===et&&D--,n++}S=e.slice(T,n),C=n}else{for(var T=n;n<r;){var O=e.charCodeAt(n);if(O===F||O===I||O===B||O===L||O===Ze||O===Xe||O===De||O===Ae||O===R)break;n++}if(n===T)return null;S=e.slice(T,n),C=n}}else S=``,C=x;An(b,S,l)?(g===null&&(g=[]),g.push(_,C)):m[b]=S}return null}function Pn(e){var t=e.indexOf(`<`);if(t===-1)return e;for(var n=``,r=0,i=!1;t!==-1;){var a=Nn(e,t);a?(a.q&&(n+=e.slice(r,t)+jn(a),r=a.end,i=!0),t=e.indexOf(`<`,a.end)):t=e.indexOf(`<`,t+1)}return i?n+e.slice(r):e}function Fn(e,t,n){if(!n.optimizeForStreaming&&e.indexOf(`[`)===-1)return!1;for(var r=0,i=e.length,a=!1,o=!1;r<i;){for(var s=e.indexOf(`
`,r),c=s<0?i:s,l=r,u=0;l<c&&u<4;)if(e.charCodeAt(l)===F)u++,l++;else if(e.charCodeAt(l)===I)u+=4,l++;else break;if(l>=c){a=!1,r=s<0?i:s+1;continue}if(u<4){var d=e.charCodeAt(l);if(d===R||d===Ce){for(var f=d,p=0,m=l;m<c&&e.charCodeAt(m)===f;)p++,m++;if(p>=3){var h=!0;if(f===R){for(var g=m;g<c;g++)if(e.charCodeAt(g)===R){h=!1;break}}if(h){a=!1;for(var _=s<0?i:s+1;_<i;){for(var v=_,y=0;v<i&&y<4;){var b=e.charCodeAt(v);if(b===F)y++,v++;else if(b===I)y+=4,v++;else break}if(y<4&&v<i&&e.charCodeAt(v)===f){for(var x=0;v<i&&e.charCodeAt(v)===f;)x++,v++;if(x>=p){for(;v<i&&(e.charCodeAt(v)===F||e.charCodeAt(v)===I);)v++;if(v>=i||e.charCodeAt(v)===L){r=v>=i?i:v+1;break}}}for(;_<i&&e.charCodeAt(_)!==L;)_++;_<i&&_++}_>=i&&(r=i,o=!0);continue}}}}for(var S=l;S<c&&e.charCodeAt(S)===B;){S++,S<c&&e.charCodeAt(S)===F&&S++;for(var C=0;S<c&&C<4;)if(e.charCodeAt(S)===F)C++,S++;else if(e.charCodeAt(S)===I)C+=4,S++;else break;if(C>=4)break;a=!1}if(!a&&u<4&&S<c&&e.charCodeAt(S)===we&&!(S+1<i&&e.charCodeAt(S+1)===z)){var w=In(e,S,t);if(w){r=w,a=!1;continue}}var T=e.charCodeAt(l);if(T===Te&&u<4)a=!1;else if(u<4&&(T===V||T===Oe||T===ke)){for(var E=l,D=0;E<c;){var O=e.charCodeAt(E);if(O===T)D++;else if(O!==F&&O!==I)break;E++}a=!(D>=3&&E>=c)}else a=!0;r=s<0?i:s+1}return o}function In(e,t,n){let r=e.length;if(e.charCodeAt(t)!==we)return null;let i=t+1<r&&e.charCodeAt(t+1)===z,a=t+1;for(;a<r;){var o=e.charCodeAt(a);if(o===Me){a++;break}if(o===we)return null;o===H&&a+1<r&&a++,a++}if(a>r||e.charCodeAt(a-1)!==Me)return null;let s=e.slice(t+1,a-1);if(s.length>999)return null;let c=Bn(s);if(!c||a>=r||e.charCodeAt(a)!==Fe)return null;a++;let l=!1;for(;a<r;){let t=e.charCodeAt(a);if(t===F||t===I)a++;else if(t===L&&!l)l=!0,a++;else break}if(i){let t=e.indexOf(`
`,a),i=t<0?r:t;return n[c]={target:e.slice(a,i).trim(),title:void 0},t<0?r:t+1}var u;if(a<r&&e.charCodeAt(a)===Ae){a++;for(var d=a;a<r&&e.charCodeAt(a)!==B&&e.charCodeAt(a)!==L;)e.charCodeAt(a)===H&&a+1<r&&a++,a++;if(a>=r||e.charCodeAt(a)!==B)return null;u=e.slice(d,a),a++;for(var f=e.indexOf(`
`,a),p=f<0?r:f,m=a;m<p&&(e.charCodeAt(m)===F||e.charCodeAt(m)===I);)m++;if(m<p){if(m===a)return null;var h=e.charCodeAt(m);if(h!==Ze&&h!==Xe&&h!==tt)return null}}else{for(var d=a,g=0;a<r;){var o=e.charCodeAt(a);if(o===tt)g++;else if(o===nt){if(g===0)break;g--}else{if(o===F||o===I||o===L)break;o===H&&a+1<r&&a++}a++}if(u=e.slice(d,a),!u)return null}for(;a<r&&(e.charCodeAt(a)===F||e.charCodeAt(a)===I);)a++;var _=e.indexOf(`
`,a),v=_<0?r:_,y,b=!1,x=a,S=a;if(a===v&&a<r)for(S=a+1;S<r&&(e.charCodeAt(S)===F||e.charCodeAt(S)===I);)S++;if(S<r){var C=e.charCodeAt(S);if(C===Ze||C===Xe||C===tt){for(var w=C===tt?41:C,T=S+1,E=T;T<r;){var D=e.charCodeAt(T);if(D===w){for(var O=T+1;O<r&&(e.charCodeAt(O)===F||e.charCodeAt(O)===I);)O++;(O>=r||e.charCodeAt(O)===L)&&(y=e.slice(E,T),b=!0,x=O<r?O+1:r);break}if(D===H&&T+1<r){T+=2;continue}if(D===L&&T+1<r&&e.charCodeAt(T+1)===L)break;T++}if(!b&&S===a)return null}}if(b)return n[c]||(n[c]={target:yt(Hn(u)),title:y===void 0?y:yt(Hn(y))}),x;for(;a<v&&(e.charCodeAt(a)===F||e.charCodeAt(a)===I);)a++;return a<v?null:(n[c]||(n[c]={target:yt(Hn(u)),title:y}),_<0?r:_+1)}var Ln=new Uint8Array(It);for(Ln[Te]|=Pt,Ln[B]|=Pt,Ln[V]|=Pt|Ft,Ln[Qe]|=Pt,Ln[Oe]|=Pt|Ft,Ln[ke]|=Pt|Ft,Ln[R]|=Pt|Ft,Ln[Ce]|=Pt|Ft,Ln[Ae]|=Pt|Ft,Ln[we]|=Ft,Ln[Ne]|=Ft,Ln[U]|=Pt,Rn=W;Rn<=G;Rn++)Ln[Rn]|=Pt;var Rn;function zn(e){if(e.indexOf(`[`)<0&&e.indexOf(`]`)<0)return!1;for(var t=0;t<e.length;t++){if(e.charCodeAt(t)===H){t++;continue}if(e.charCodeAt(t)===we||e.charCodeAt(t)===Me)return!0}return!1}function Bn(e){for(var t=e.length,n=!0,r=t>0,i=0;i<t;i++){var a=e.charCodeAt(i);if(a===F){if(n){r=!1;break}n=!0}else if(a<33||a>126||a>=K&&a<=q){r=!1;break}else n=!1}if(r&&!n)return e;var o=e.replace(/\s+/g,` `).trim();return o.indexOf(`ẞ`)===-1?o.toLowerCase():o.replace(/\u1E9E/g,`ss`).toLowerCase()}function Vn(e){return e<dt?Ln[e]:e===Ue?kt:0}function Hn(e){return e.indexOf(`\\`)===-1?e:e.replace(/\\([!"#$%&'()*+,\-./:;<=>?@[\\\]^_`{|}~])/g,`$1`)}var Un=null,Wn=-1,Gn=-1;function X(e,t){if(t>=Wn&&t<=Gn&&e===Un)return Gn;var n=e.indexOf(`
`,t),r=n<0?e.length:n;return Un=e,Wn=t,Gn=r,r}function Z(e,t){let n=X(e,t);return n<e.length?n+1:n}function Kn(e,t,n){for(;t<n;){let n=e.charCodeAt(t);if(n!==F&&n!==I)break;t++}return t}function qn(e,t){let n=Z(e,t);for(;n<e.length;){let t=X(e,n);if(Xn(e,n,t))return n;n=Z(e,n)}return e.length}function Jn(e,t,n,r){let i=0;for(;t+i<n&&e.charCodeAt(t+i)===r;)i++;return i}var Q=0,$=0;function Yn(e,t,n){for(Q=0,$=0;t+$<n;){let n=e.charCodeAt(t+$);if(n===I)Q+=4-Q%4;else if(n===F)Q++;else break;$++}}function Xn(e,t,n){return Kn(e,t,n)>=n}function Zn(e,t){if(!e)return e;var n=t.v||=Object.create(null),r=n[e];if(r===void 0)return n[e]=0,e;for(var i=r+1,a=`${e}-${i}`;n[a]!==void 0;)i++,a=`${e}-${i}`;return n[e]=i,n[a]=0,a}function Qn(e,t,n,r){let i=X(e,t);if(Yn(e,t,i),Q>3)return null;let a=t+$;if(e.charCodeAt(a)!==Te)return null;let o=Jn(e,a,i,35);if(o<1||o>6||(a+=o,a<i&&e.charCodeAt(a)!==F&&e.charCodeAt(a)!==I))return null;a=Kn(e,a,i);for(var s=i;s>a&&e.charCodeAt(s-1)===F;)s--;for(var c=s;s>a&&e.charCodeAt(s-1)===Te;)s--;if(s<c){if(s===a||e.charCodeAt(s-1)===F)for(;s>a&&e.charCodeAt(s-1)===F;)s--;else s=c}let l=Er(e.slice(a,s),!1,n,r);return{node:{type:Y.heading,level:o,children:l,id:``},end:Z(e,i)}}function $n(e,t,n){var r=e.charCodeAt(t);if(r!==De&&r!==V)return!1;for(var i=t;i<n&&e.charCodeAt(i)===r;)i++;for(;i<n&&(e.charCodeAt(i)===F||e.charCodeAt(i)===I);)i++;return i>=n}function er(e,t){let n=X(e,t);if(Yn(e,t,n),Q>3)return null;let r=t+$,i=e.charCodeAt(r);if(i!==V&&i!==Oe&&i!==ke)return null;let a=0;for(;r<n;){let t=e.charCodeAt(r);if(t===i)a++;else if(t!==F&&t!==I)return null;r++}return a<3?null:{node:{type:Y.breakThematic},end:Z(e,n)}}var tr=0,nr=0,rr=``;function ir(e,t,n){let r=X(e,t);if(Yn(e,t,r),Q>3)return null;let i=Q,a=t+$,o=e.charCodeAt(a);if(o!==R&&o!==Ce)return null;let s=Jn(e,a,r,o);if(s<3)return null;a+=s;let c=Kn(e,a,r),l=r;if(o===R){for(let t=c;t<r;t++)if(e.charCodeAt(t)===R)return null}for(;l>c&&(e.charCodeAt(l-1)===F||e.charCodeAt(l-1)===I);)l--;let u=e.slice(c,l),d=``,f=``,p=u.indexOf(` `);p===-1?d=u:(d=u.slice(0,p),f=u.slice(p+1).trim()),d=Hn(d);var m;if(f){Sn.lastIndex=0;for(var h;(h=Sn.exec(f))!=null;)m||={},m[h[1]]=h[2]===void 0?h[3]:h[2]}let g=Z(e,r),_=e.length,v=e.length;var y;o===tr&&s===nr?y=rr:(y=String.fromCharCode(o).repeat(s),tr=o,nr=s,rr=y);for(var b=g;b<e.length;){var x=e.indexOf(y,b);if(x===-1)break;for(var S=x,C=0;S>0&&C<4&&e.charCodeAt(S-1)===F;)S--,C++;if(C<=3&&(S===0||e.charCodeAt(S-1)===L)){for(var w=x+s;w<e.length&&e.charCodeAt(w)===o;)w++;var T=X(e,w);if(Xn(e,w,T)){_=S,v=Z(e,T);break}}b=x+1}var E;if(i===0)E=_>g&&e.charCodeAt(_-1)===L?e.slice(g,_-1):e.slice(g,_);else{E=``;for(var D=g;D<_;){var O=X(e,D);Yn(e,D,O);var ee=Math.min($,i);E+=`${e.slice(D+ee,O)}
`,D=Z(e,O)}E.length>0&&E.charCodeAt(E.length-1)===L&&(E=E.slice(0,-1))}return{node:{type:Y.codeBlock,lang:d||void 0,text:E,infoString:f||void 0,attrs:m},end:v}}function ar(e,t,n){for(var r=0,i=t;i<n&&r<4;)e.charCodeAt(i)===I?r+=4-r%4:r++,i++;if(r<4)return``;for(var a=``,o=4;o<r;o++)a+=` `;return a+e.slice(i,n)}function or(e,t){if(Yn(e,t,X(e,t)),Q<4)return null;let n=``,r=t;for(;r<e.length;){let t=X(e,r);if(Yn(e,r,t),Xn(e,r,t)){for(var i=`${ar(e,r,t)}
`,a=Z(e,t);a<e.length;){var o=X(e,a);if(Xn(e,a,o)){i+=`${ar(e,a,o)}
`,a=Z(e,o);continue}Yn(e,a,o),Q>=4&&(n+=i,r=a);break}if(r!==a)break;continue}if(Q<4)break;let d=0,f=0;var s=0;for(let n=r;n<t&&f<4;n++){if(e.charCodeAt(n)===I){var c=4-f%4;f+c>4&&(s=f+c-4),f+=c}else f++;d++}var l=``;if(s>0)for(var u=0;u<s;u++)l+=` `;l+=e.slice(r+d,t),n+=`${l}
`,r=Z(e,t)}for(;n.length>0&&n.charCodeAt(n.length-1)===L;)n=n.slice(0,-1);return n?{node:{type:Y.codeBlock,lang:void 0,text:n,infoString:void 0,attrs:void 0},end:r}:null}function sr(e,t,n,r){if(Yn(e,t,X(e,t)),Q>3)return null;let i=t+$;if(e.charCodeAt(i)!==B)return null;let a=``,o=t,s,c=!1,l=!1,u=!1;for(;o<e.length;){let t=X(e,o);Yn(e,o,t);let n=o+$;if(e.charCodeAt(n)===B){let r=n+1;var d=Q+1,f=!1;if(r<t){var p=e.charCodeAt(r);p===F?(r++,d++,f=!0):p===I&&(f=!0)}for(var m=``,h=!1,g=r;g<t;g++)if(e.charCodeAt(g)===I){h=!0;break}if(h){var _=d;if(f&&r<t&&e.charCodeAt(r)===I){for(var v=4-_%4,y=0;y<v-1;y++)m+=` `;_+=v,r++}for(var b=r;b<t;b++)if(e.charCodeAt(b)===I){for(var x=4-_%4,S=0;S<x;S++)m+=` `;_+=x}else m+=e[b],_++}else m=e.slice(r,t);if(!(a||s)){let n=m.match(/^\[!([A-Za-z]+)\]\s*$/);if(n){s=n[1].toUpperCase(),o=Z(e,t);continue}}a+=`${m}
`;var C=m.trimStart();C.startsWith("```")||C.startsWith(`~~~`)?u=!u:(m.startsWith(`    `)||m.startsWith(`	`))&&(u=!0),l=C.length>0,o=Z(e,t)}else if(a&&!Xn(e,o,t)&&l){if(Q<4){var w=o+$,T=w<t?e.charCodeAt(w):0;if(T===Te||T===B||T===R||T===Ce||T===Ae||(T===V||T===Oe||T===ke)&&er(e,o)||(T===V||T===Oe||T===Qe)&&w+1<t&&(e.charCodeAt(w+1)===F||e.charCodeAt(w+1)===I))break;if(T>=W&&T<=G){for(var E=w;E<t&&e.charCodeAt(E)>=W&&e.charCodeAt(E)<=G;)E++;if(E<t&&(e.charCodeAt(E)===Je||e.charCodeAt(E)===nt))break}}if(u)break;a+=`${e.slice(o,t)}
`,c=!0,o=Z(e,t)}else break}if(!(a||s))return null;var{inBlockQuote:D,l:O}=n;n.inBlockQuote=!0,c&&(n.l=!0);var ee=n.i;n.i=ee||!Xn(e,o,e.length);let k=di(a||``,n,r);return n.i=ee,n.inBlockQuote=D,n.l=O,{node:{type:Y.blockQuote,children:k,alert:s||void 0},end:o}}function cr(e,t,n){for(var r=0,i=t;i<n;i++)e.charCodeAt(i)===I?r+=4-r%4:r++;return r}function lr(e,t,n){if(Yn(e,t,n),Q>3)return null;var r=t+$;if(r>=n)return null;var i=e.charCodeAt(r),a=Q,o=r,s=r;if(i===V||i===Oe||i===Qe){if(o=r+1,o<n&&e.charCodeAt(o)!==F&&e.charCodeAt(o)!==I&&e.charCodeAt(o)!==L)return null}else if(i>=W&&i<=G){for(;s<n&&s-r<9;){var c=e.charCodeAt(s);if(c<W||c>G)break;s++}if(s>r&&s<n){var l=e.charCodeAt(s);if(l===Je||l===nt){if(o=s+1,o<n&&e.charCodeAt(o)!==F&&e.charCodeAt(o)!==I&&e.charCodeAt(o)!==L)return null}else return null}else return null}else return null;var u=o,d=cr(e,t,o),f=0,p=u,m=d;if(u>=n)return{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:u,contentCol:d+1,markerCol:a,isEmpty:!0};for(;p<n&&(e.charCodeAt(p)===F||e.charCodeAt(p)===I);){if(e.charCodeAt(p)===I){var h=4-m%4;m+=h}else m++;p++,f++}var g=p>=n,_=m-d;return g||_>4?(m=d+1,p=u+1,f=1):f===0&&(m=d+1,p=u,f=1),{ordered:i>=W&&i<=G,marker:i>=W&&i<=G?e[s]:e[r],start:i>=W&&i<=G?Number.parseInt(e.slice(r,s),10):void 0,contentStart:p,contentCol:m,markerCol:a,isEmpty:g}}var ur=0;function dr(e,t,n,r){var i=0,a=t;for(ur=0;a<n&&i<r;){var o=e.charCodeAt(a);if(o===I){var s=4-i%4;if(i+s>r){ur=i+s-r,a++,i=r;break}i+=s}else if(o===F)i++;else break;a++}return a}function fr(e,t,n,r){var i=X(e,t),a=lr(e,t,i);if(!a)return null;var o=[],s=t,c=a.contentCol,l=``,u=a.isEmpty,d=!1,f=!1;if(!a.isEmpty){for(var p=!1,m=a.contentStart;m<i;m++)if(e.charCodeAt(m)===I){p=!0;break}if(p){var h=``,g=cr(e,t,a.contentStart),_=g-a.contentCol;if(_>0)for(var v=0;v<_;v++)h+=` `;for(var y=a.contentStart;y<i;y++)if(e.charCodeAt(y)===I){for(var b=4-g%4,x=0;x<b;x++)h+=` `;g+=b}else h+=e[y],g++;l=`${h}
`}else l=`${e.slice(a.contentStart,i)}
`}for(s=Z(e,i);s<e.length;){var S=X(e,s);Yn(e,s,S);var C=e.charCodeAt(s+$);if(Q<c&&(C===V||C===Oe||C===ke)&&Q<=3&&er(e,s))break;var w=lr(e,s,S);if(w&&w.ordered===a.ordered&&w.marker===a.marker&&w.markerCol<c){o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),d&&(f=!0),c=w.contentCol,u=w.isEmpty,d=!1,l=w.isEmpty?``:`${e.slice(w.contentStart,S)}
`,s=Z(e,S);continue}if(Xn(e,s,S)){var T=dr(e,s,S,c);if(ur>0||T<S){for(var E=``,D=0;D<ur;D++)E+=` `;l+=`${E+e.slice(T,S)}
`}else l+=`
`;s=Z(e,S);for(var O=!1,ee=0;ee<l.length;ee++){var k=l.charCodeAt(ee);if(k!==L&&k!==Se&&k!==F&&k!==I){O=!0;break}}if(u&&!O){if(s<e.length){var te=X(e,s),ne=lr(e,s,te);if(!ne||ne.ordered!==a.ordered||ne.marker!==a.marker)break;d=!0}else break}if(s<e.length){var re=X(e,s);Yn(e,s,re);var ie=e.charCodeAt(s+$);if((ie===V||ie===Oe||ie===ke)&&Q<=3&&er(e,s))break;var ae=lr(e,s,re);if(ae&&ae.ordered===a.ordered&&ae.marker===a.marker&&ae.markerCol<c){d=!0;continue}if(!Xn(e,s,re)&&Q<c)break}continue}if(Q>=c){var oe=dr(e,s,S,c);if(ur>0){for(var se=``,ce=c,le=0;le<ur;le++)se+=` `,ce++;for(var A=oe;A<S;A++)if(e.charCodeAt(A)===I){for(var j=4-ce%4,M=0;M<j;M++)se+=` `;ce+=j}else se+=e[A],ce++;l+=`${se}
`}else l+=`${e.slice(oe,S)}
`;s=Z(e,S);continue}for(var ue=!1,de=0;de<l.length;de++){var fe=l.charCodeAt(de);if(fe!==L&&fe!==Se&&fe!==F&&fe!==I){ue=!0;break}}if(!d&&ue&&!u){var N=s+$,P=e.charCodeAt(N);if(!(P===Te||P===B||P===Ae||P===R||P===Ce||(P===V||P===Oe||P===ke||P===Qe)&&(er(e,s)!=null||lr(e,s,S)!=null)||P>=W&&P<=G&&lr(e,s,S)!=null)){l+=`${e.slice(N,S)}
`,s=Z(e,S);continue}}break}if(o.push({contentCol:c,raw:l,hasBlankAfter:d,isEmpty:u}),o.length===0)return null;var pe=f;if(!pe)for(var me=0;me<o.length;me++){if(o[me].hasBlankAfter&&me<o.length-1){pe=!0;break}if(!o[me].isEmpty){for(var he=o[me].raw,ge=he.length,_e=0,ve=!1,ye=!1,be=!1,xe=!1,z=0,Ee=0,De=-1;_e<ge;){var H=he.indexOf(`
`,_e);if(H<0&&(H=ge),xe){Yn(he,_e,H);for(var je=he.slice(_e+$,H),Ne=0;Ne<je.length&&je.charCodeAt(Ne)===z;)Ne++;Ne>=Ee&&je.slice(Ne).trim()===``&&(xe=!1),_e=H<ge?H+1:ge;continue}if(Xn(he,_e,H)){De>=0?be=!0:ve&&(ye=!0),_e=H<ge?H+1:ge;continue}if(Yn(he,_e,H),De>=0){if(Q>=De){_e=H<ge?H+1:ge;continue}var Pe=lr(he,_e,H);if(Pe&&Pe.markerCol<De&&Pe.contentCol<=De){_e=H<ge?H+1:ge;continue}if(Pe){_e=H<ge?H+1:ge;continue}De=-1,be&&=(ye=!0,!1)}var Fe=he.slice(_e+$,H),Ie=Fe.charCodeAt(0);if((Ie===R||Ie===Ce)&&Q<=3){for(var Le=0;Le<Fe.length&&Fe.charCodeAt(Le)===Ie;)Le++;if(Le>=3){if(ye&&ve){pe=!0;break}xe=!0,z=Ie,Ee=Le,ve=!0,_e=H<ge?H+1:ge;continue}}var Re=Q<=3?lr(he,_e,H):null;if(Re&&ve){if(ye){pe=!0;break}De=Re.contentCol,be=!1,_e=H<ge?H+1:ge,ve=!0;continue}if(ye){pe=!0;break}ve=!0,_e=H<ge?H+1:ge}if(pe)break}}for(var ze=[],Be=0;Be<o.length;Be++){for(var Ve=o[Be],He=Ve.raw,Ue=He.length;Ue>0&&He.charCodeAt(Ue-1)===L;)Ue--;var We=Ue<He.length?He.slice(0,Ue):He,Ge=null;if(We.length>=3&&We.charCodeAt(0)===we){var Ke=We[1];(Ke===` `||Ke===`x`||Ke===`X`)&&We.charCodeAt(2)===Me&&(Ge={type:Y.gfmTask,completed:Ke===`x`||Ke===`X`},We=We.slice(3))}var qe;if(Ve.isEmpty&&We.trim()===``)qe=[];else if(pe){var Je=n.inList;n.inList=!0;var Ye=n.i;n.i=Ye||Be!==o.length-1,qe=di(We,n,r),n.i=Ye,n.inList=Je}else{var Xe=n.inList;n.inList=!0;var Ze=n.i;if(n.i=Ze||Be!==o.length-1,qe=di(We,n,r),n.i=Ze,n.inList=Xe,qe.length===1&&qe[0].type===Y.paragraph)qe=qe[0].children;else if(n.p){var U=[];n.p.push({src:qe,dest:U,unwrap:!0}),qe=U}else{for(var $e=[],et=0;et<qe.length;et++)if(qe[et].type===Y.paragraph)for(var tt=qe[et].children,nt=0;nt<tt.length;nt++)$e.push(tt[nt]);else $e.push(qe[et]);qe=$e}}if(Ge){var rt=[Ge,{type:Y.text,text:` `}];if(n.p)n.p.push({src:qe,dest:rt,unwrap:!1});else for(var it=0;it<qe.length;it++)rt.push(qe[it]);ze.push(rt)}else ze.push(qe)}return{node:{type:a.ordered?Y.orderedList:Y.unorderedList,start:a.ordered?a.start:void 0,items:ze},end:s}}var pr=new Set(`address.article.aside.base.basefont.blockquote.body.caption.center.col.colgroup.dd.details.dialog.dir.div.dl.dt.fieldset.figcaption.figure.footer.form.frame.frameset.h1.h2.h3.h4.h5.h6.head.header.hr.html.iframe.legend.li.link.main.menu.menuitem.nav.noframes.ol.optgroup.option.p.param.search.section.summary.table.tbody.td.tfoot.th.thead.title.tr.track.ul`.split(`.`));function mr(e,t,n){let r={};for(let[o,s]of Object.entries(e)){let e=o.toLowerCase();if(e===`style`&&typeof s==`string`){let e={},t=[],n=0,i=0;for(let e=0;e<s.length;e++){let r=s.charCodeAt(e);r===tt?n++:r===nt?n--:r===Ke&&n===0&&(t.push(s.slice(i,e)),i=e+1)}i<s.length&&t.push(s.slice(i));let a=!1;t.forEach(t=>{let n=t.indexOf(`:`);if(n===-1)return;let r=t.slice(0,n).trim(),i=t.slice(n+1).trim();if(r&&i){if(/url\s*\(\s*(javascript|vbscript|data:(?!image\/))/i.test(i)){a=!0;return}let t=r.indexOf(`-`)===-1?r:r.replace(/-([a-z])/g,(e,t)=>t.toUpperCase());e[t]=i}}),!a&&Object.keys(e).length>0&&(r[o]=e)}else if((e===`href`||e===`src`)&&n?.sanitizer){let i=n.sanitizer(s,t,e);i!=null&&(r[o]=i)}else if(s===``)r[o]=!0;else if(s.length>=2&&s.charCodeAt(0)===$e&&s.charCodeAt(s.length-1)===et){var i=s.slice(1,-1);if(i.length>0){var a=i.charCodeAt(0);if(a===we||a===$e)try{r[o]=JSON.parse(i);continue}catch{}}if(i===`true`){r[o]=!0;continue}if(i===`false`){r[o]=!1;continue}if(n?.evalUnserializableExpressions)try{r[o]=(0,eval)(`(${i})`);continue}catch{}r[o]=i}else r[o]=s}return r}function hr(e,t,n){let r=t.length;if(r===0)return n;var i=t.charCodeAt(0);if(!(i>=K&&i<=q||i>=J&&i<=ut)){for(var a=String.fromCharCode(i),o=e.length-r,s=n;s<=o;){var c=e.indexOf(a,s);if(c===-1||c>o)return-1;for(var l=!0,u=1;u<r;u++){var d=e.charCodeAt(c+u),f=t.charCodeAt(u);if(d>=K&&d<=q&&(d+=ft),f>=K&&f<=q&&(f+=ft),d!==f){l=!1;break}}if(l)return c;s=c+1}return-1}i>=K&&i<=q&&(i+=ft);for(let a=n;a<=e.length-r;a++){var p=e.charCodeAt(a);if(p>=K&&p<=q&&(p+=ft),p!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(a+i),o=t.charCodeAt(i);if(r>=K&&r<=q&&(r+=ft),o>=K&&o<=q&&(o+=ft),r!==o){n=!1;break}}if(n)return a}return-1}function gr(e,t,n){let r=t.length;var i=t.charCodeAt(0);i>=K&&i<=q&&(i+=ft);for(let o=Math.min(n,e.length-r);o>=0;o--){var a=e.charCodeAt(o);if(a>=K&&a<=q&&(a+=ft),a!==i)continue;let n=!0;for(let i=1;i<r;i++){let r=e.charCodeAt(o+i),a=t.charCodeAt(i);if(r>=K&&r<=q&&(r+=ft),a>=K&&a<=q&&(a+=ft),r!==a){n=!1;break}}if(n)return o}return-1}var _r=-1;function vr(e,t,n){let r=n.toLowerCase(),i=`<${r}`,a=`</${r}`,o=1,s=t,c=e.length;for(_r=-1;s<c&&o>0;){let t=hr(e,i,s),n=hr(e,a,s);if(n===-1)return-1;if(t!==-1&&t<n){let n=Nn(e,t);n?(n.tag.toLowerCase()===r&&!n.f&&!n.n&&!Ot(n.tag)&&o++,s=n.end):s=t+1}else{var l=n+a.length,u=l<c?e.charCodeAt(l):62;if((u===B||u===F||u===I||u===L)&&(o--,o===0)){_r=n;let t=n+a.length;for(;t<c&&e.charCodeAt(t)!==B;)t++;return t+1}s=n+1}}return-1}function yr(e,t,n,r){if(r.ignoreHTMLBlocks||r.disableParsingRawHTML)return null;var i=X(e,t);if(Yn(e,t,i),Q>3&&!n.inHTML)return null;var a=t+$;if(e.charCodeAt(a)!==Ae)return null;var o=e.indexOf(`>`,a+1);if(o!==-1&&o<i){var s=e.slice(a+1,o);if(/^[a-zA-Z][a-zA-Z0-9+.-]*:/.test(s)||/^[^\s@]+@[^\s@]+$/.test(s))return null}var c=br(e,a);if(c>=1&&c<=5){var l=e.length;if(c===1){for(var u=e.length,d=0;d<hn.length;d++){var f=hr(e,`</${hn[d]}>`,a);f>=0&&f<u&&(u=f)}if(u<e.length){var p=e.indexOf(`>`,u);l=p>=0?Z(e,p+1):e.length}}else{var m=c===2?`-->`:c===3?`?>`:c===4?`>`:`]]>`,h=e.indexOf(m,a);h>=0&&(l=Z(e,h+m.length))}var g=e.slice(a,l);if(c>=2)return{node:{type:Y.htmlComment,text:g,s:!1,raw:!0},end:l};var _=`div`,v=g.match(/^<\/?([a-zA-Z][a-zA-Z0-9-]*)/);v&&(_=v[1]);var y=Nn(e,a),b={},x;y&&!y.f&&(b=mr(y.attrs,_,r),x=y.g+y.b);var S=[],C=hr(g,`</${_.toLowerCase()}`,0),w=``,T,E,D;if(y?.f){D=g.slice(0,y.end-a);for(var O=g.slice(y.end-a);O.length>0&&O.charCodeAt(O.length-1)===L;)O=O.slice(0,-1);O&&(E=Pn(O))}else if(y&&!y.f){var ee=y.end-a;if(C===-1){for(var k=g;k.length>0&&k.charCodeAt(k.length-1)===L;)k=k.slice(0,-1);T=Pn(k)}else{var te=ee;g.charCodeAt(te)===L&&te++;for(var ne=C;ne>te;){var re=g.charCodeAt(ne-1);if(re!==F&&re!==I&&re!==L&&re!==Se)break;ne--}var ie=g.slice(te,ne);ie&&(E=Pn(ie));for(var ae=g.slice(C);ae.length>0&&ae.charCodeAt(ae.length-1)===L;)ae=ae.slice(0,-1);D=Pn(ae),w=g.slice(ee,C).trim()}}var oe=y?y.f:!1;return{node:{type:Y.htmlBlock,tag:_,attrs:b,b:x,children:S,e:E,h:D,j:T,text:w,c:!0,a:oe},end:l}}if(c===6||c===7){var se=qn(e,t),ce=se<e.length?se:e.length,le=e.slice(a,ce),A=se<e.length?Z(e,se):e.length,j=Nn(e,a);if(j){var M=j.tag,ue=M.toLowerCase();if(j.f){var de=e.slice(j.end,ce);return{node:{type:Y.htmlBlock,tag:M,attrs:{},children:[],h:e.slice(a,j.end),e:de?Pn(de):void 0,text:de,c:!0,a:!0},end:A}}if(j.n||Ot(M))return{node:{type:Y.htmlBlock,tag:M,attrs:mr(j.attrs,M,r),b:j.g+j.b,children:[],text:``,c:!1,a:!1},end:j.end<e.length&&e.charCodeAt(j.end)===L?j.end+1:j.end};var fe=n.d||0,N=e.slice(a,ce),P=-1,pe=-1,me=!1;if(fe<10){for(var he=`</${ue}`,ge=j.end-a,_e=1,ve=ge;ve<N.length&&_e>0;){var ye=hr(N,`<${ue}`,ve),be=hr(N,he,ve);if(be===-1)break;if(ye!==-1&&ye<be){var xe=ye+ue.length+1;if(xe<N.length){var R=N.charCodeAt(xe);(R===F||R===I||R===L||R===B||R===Ye)&&_e++}ve=ye+1}else{var Ce=be+he.length;if(Ce<N.length){var we=N.charCodeAt(Ce);if((we===B||we===F||we===I||we===L)&&(_e--,_e===0)){P=be;for(var z=Ce;z<N.length&&N.charCodeAt(z)!==B;)z++;pe=z+1;break}}else if(_e--,_e===0){P=be,pe=N.length;break}ve=be+1}}if(P===-1&&!j.f&&(c===6||j.u)){var Te=vr(e,j.end,ue);if(Te!==-1){for(var Ee=_r,V=j.end,De=!1,H=!1,Oe=!1,ke=0,je=!1,Me=!1,Ne=V;Ne<Ee;){var Pe=e.charCodeAt(Ne);if(Pe===L)Me&&(De=!0),je||ke++,Me=!0,Ne++;else if(Pe===F||Pe===I)Ne++;else{if(!je&&(je=!0,ke>=2&&Pe===Ae)){Oe=!0;break}if(Me=!1,Pe===Ae){var Fe=e.charCodeAt(Ne+1)|32;if((Fe===Ve||Fe===He||Fe===Be)&&(vn.lastIndex=Ne,vn.test(e))){H=!0;break}}Ne++}}if(De&&!Oe&&!H){var Ie=X(e,Te);ce=Ie,A=Z(e,Ie),N=e.slice(a,ce),le=e.slice(a,ce),P=Ee-a,pe=Te-a,me=!0}}}}var Le=j.b.indexOf(`
`)!==-1||j.g.indexOf(`
`)!==-1,Re=!1;P!==-1&&(Re=N.slice(pe).trim().length===0);var ze=!1,Ue=ce,We=A;if(P!==-1){var Ge=a+pe,Ke=X(e,Ge-1);if(Ge<Ke){for(var qe=Ge;qe<Ke&&(e.charCodeAt(qe)===F||e.charCodeAt(qe)===I);)qe++;if(qe<Ke&&e.charCodeAt(qe)===Ae){var Je=Nn(e,qe);Je&&!Je.f&&(ze=!0,Ue=Ge,We=Ge,Re=!0)}}if(!ze){var Xe=Z(e,Ke);if(Xe<ce){for(var Ze=Xe;Ze<ce&&(e.charCodeAt(Ze)===F||e.charCodeAt(Ze)===I);)Ze++;Ze<ce&&e.charCodeAt(Ze)===Ae&&Nn(e,Ze)&&(ze=!0,Ue=Ke,We=Xe,Re=!0)}}!ze&&n.inHTML&&(ze=!0,Ue=Ke,We=Z(e,Ke),Re=e.slice(Ge,Ke).trim().length===0)}var Qe=[],U=``;if(P!==-1){U=N.slice(j.end-a,P);var $e=U.trim();if($e){var{inline:et,inHTML:tt,d:nt}=n;if(n.inHTML=!0,n.d=fe+1,ue===`p`)n.inline=!0,Qe=Er($e,!1,n,r);else{var rt=U.indexOf(`

`)!==-1,it=yn.test($e),at=bn.test($e),ot=rt||it||n.inHTML&&at;U.length>=2&&U.charCodeAt(0)===L&&U.charCodeAt(U.length-1)===L&&!rt&&!it&&!at?Qe=[{type:Y.text,text:$e}]:ot||at?(n.inline=!1,Qe=di(U,n,r)):(n.inline=!0,Qe=Er($e,!1,n,r))}n.inline=et,n.inHTML=tt,n.d=nt}}var st=!1;if(c===6&&P!==-1&&!n.inHTML&&!Le){var ct=/<[a-zA-Z][^>]*>/.test(U),lt=U.indexOf(`

`)!==-1||yn.test(U);ct&&!lt&&(st=!0)}if(!me&&(n.inHTML||c===7||Le||!Re||st)){var W,G,J=!1;if(P!==-1&&ze){var ut=!1;if(n.inHTML&&pe<N.length){for(var dt=pe;dt<N.length&&N.charCodeAt(dt)!==L;)dt++;var ft=N.slice(pe,dt).trim();ut=ft.length>1&&ft.charCodeAt(0)===Ae&&ft.charCodeAt(1)!==Ye}G=ut?N.slice(j.end-a):U,J=!0}else(c===7||n.inHTML)&&P!==-1?(G=N.slice(j.end-a),G.charCodeAt(0)===L&&(G=G.slice(1))):ze?W=e.slice(a,Ue):Le?W=le:(G=N.slice(j.end-a),G.charCodeAt(0)===L&&(G=G.slice(1)));var pt=W!==void 0,mt=Pn(W===void 0?G||``:W),ht={type:Y.htmlBlock,tag:M,attrs:mr(j.attrs,M,r),b:j.g+j.b,children:Qe,e:pt?void 0:mt,j:pt?mt:void 0,text:mt,c:!0,a:!1};return J&&(ht.x=!0),{node:ht,end:We}}var gt=Pn(U);return{node:{type:Y.htmlBlock,tag:M,attrs:mr(j.attrs,M,r),b:j.g+j.b,children:Qe,e:me?void 0:gt,text:gt,c:!1,a:!1},end:We}}var _t=le.match(/^<(\/?)([a-zA-Z][a-zA-Z0-9-]*)/),vt=_t?_t[2]:`div`,yt=_t?_t[1]===`/`:!1,bt,xt,St,Ct=``;if(yt){var wt=le.indexOf(`>`);wt===-1?bt=le:(bt=le.slice(0,wt+1),Ct=le.slice(wt+1),Ct&&(xt=Pn(Ct)))}else St=Pn(le);return{node:{type:Y.htmlBlock,tag:vt,attrs:{},children:[],e:xt,h:bt,j:St,text:yt?Ct:le,c:!0,a:yt},end:A}}var Tt=Nn(e,a);if(!Tt)return null;var Et=Tt.tag,Dt=Et.toLowerCase(),kt=Et.charCodeAt(0),At=kt>=K&&kt<=q;if(!(At||pr.has(Dt)||gn.has(Dt)||Dt.includes(`-`)))return null;if(Tt.f)return{node:{type:Y.htmlSelfClosing,tag:Et,attrs:{},h:e.slice(a,Tt.end),a:!0},end:Tt.end};var jt=vr(e,Tt.end,Et),Mt=[];if(jt!==-1){var Nt=_r,Pt=e.slice(Tt.end,Nt),Ft=Pt.trim();if(Ft){var It=Pt.indexOf(`

`)!==-1,Lt=yn.test(Ft),Rt=bn.test(Ft),zt=n.inline,Bt=n.inHTML,Vt=n.d;n.inHTML=!0,n.d=(n.d||0)+1,It||Lt||Rt?(n.inline=!1,Mt=di(Pt,n,r)):(n.inline=!0,Mt=Er(Ft,!1,n,r)),n.inline=zt,n.inHTML=Bt,n.d=Vt}var Ht=X(e,jt),Ut=e.slice(jt,Ht).trim()?jt:Z(e,jt),Wt=At?e.slice(a,jt):e.slice(a,Ut);return{node:{type:Y.htmlBlock,tag:Et,attrs:mr(Tt.attrs,Et,r),b:Tt.g+Tt.b,children:Mt,j:Pn(Wt),text:At?Pt:Wt,c:!0,a:!1},end:Ut}}var Gt=qn(e,Tt.end),Kt=Gt<e.length?Z(e,Gt):Gt,qt=e.slice(Tt.end,Gt);if(qt.trim()){var{inline:Jt,inHTML:Yt,d:Xt}=n;n.inline=!1,n.inHTML=!0,n.d=(n.d||0)+1,Mt=di(qt,n,r),n.inline=Jt,n.inHTML=Yt,n.d=Xt}var Zt=e.slice(Tt.end,Gt);return{node:{type:Y.htmlBlock,tag:Et,attrs:mr(Tt.attrs,Et,r),b:Tt.g+Tt.b,children:Mt,e:Pn(Zt),text:qt,c:!0,a:!1},end:Kt}}function br(e,t){if(e.charCodeAt(t)!==Ae)return 0;var n=t+1,r=e.length;if(e.charCodeAt(n)===Ne&&e.charCodeAt(n+1)===V&&e.charCodeAt(n+2)===V)return 2;if(e.charCodeAt(n)===qe)return 3;if(e.charCodeAt(n)===Ne){var i=e.charCodeAt(n+1);if(i>=K&&i<=q)return 4;if(e.slice(n+1,n+8)===`[CDATA[`)return 5}for(var a=e.charCodeAt(n)===Ye,o=a?n+1:n,s=o;s<r;){var c=e.charCodeAt(s);if(c>=K&&c<=q||c>=J&&c<=ut||c>=W&&c<=G||c===V)s++;else break}if(s===o)return 0;var l=e.slice(o,s);if(gn.has(l.toLowerCase())){if(a)return 0;var u=e.charCodeAt(s);return+(u===F||u===I||u===B||u===L||s>=r)}if(pr.has(l.toLowerCase())){if(a){for(var d=s;d<r&&(e.charCodeAt(d)===F||e.charCodeAt(d)===I);)d++;return d<r&&e.charCodeAt(d)===B?6:0}var f=s<r?e.charCodeAt(s):-1;return f===F||f===I||f===B||f===L||f===Ye||f===-1?6:0}if(a){for(var p=s;p<r&&(e.charCodeAt(p)===F||e.charCodeAt(p)===I);)p++;if(p<r&&e.charCodeAt(p)===B){var m=X(e,t);if(e.slice(p+1,m).trim()===``)return 7}}else{var h=X(e,t),g=Nn(e,t);if(g&&g.end<=h&&e.slice(g.end,h).trim()===``)return 7}return 0}function xr(e,t,n){for(var r=0,i=e.length;r<i&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;for(;i>r&&(e.charCodeAt(i-1)===F||e.charCodeAt(i-1)===I);)i--;r<i&&e.charCodeAt(r)===U&&r++,i>r&&e.charCodeAt(i-1)===U&&(i-2<r||e.charCodeAt(i-2)!==H)&&i--;for(var a=[],o=r,s=!1,c=[],l=r;l<i;){var u=e.charCodeAt(l);if(u===H&&l+1<i){e.charCodeAt(l+1)===U?(s||(s=!0,c=[]),c.push(e.slice(o,l)),c.push(`|`),l+=2,o=l):l+=2;continue}if(u===R){for(var d=0;l<i&&e.charCodeAt(l)===R;)d++,l++;for(var f=!1;l<i&&!f;){for(var p=0;l<i&&e.charCodeAt(l)===R;)p++,l++;p===d?f=!0:p===0&&l++}continue}if(u===U){var m=s?(c.push(e.slice(o,l)),c.join(``)):e.slice(o,l);a.push(m.trim()),l++,o=l,s=!1,c=[];continue}l++}var h=s?(c.push(e.slice(o,i)),c.join(``)):e.slice(o,i);return a.push(h.trim()),a.map(e=>{var r=e.indexOf(`\\|`)===-1?e:e.replace(/\\\|/g,`|`);return r?Er(r,!1,t,n):[]})}function Sr(e,t,n,r){let i=X(e,t);var a=e.indexOf(`|`,t);if(a<0||a>=i)return null;let o=Z(e,i);if(o>=e.length)return null;let s=X(e,o);if(!Tn(e,o,s))return null;let c=e.slice(t,i),l=e.slice(o,s);for(var u=[],d=0,f=l.length;d<f&&(l.charCodeAt(d)===F||l.charCodeAt(d)===I);)d++;for(d<f&&l.charCodeAt(d)===U&&d++;d<f;){for(;d<f&&(l.charCodeAt(d)===F||l.charCodeAt(d)===I);)d++;if(d>=f||l.charCodeAt(d)===U)break;var p=l.charCodeAt(d)===Fe;for(p&&d++;d<f&&l.charCodeAt(d)===V;)d++;var m=d<f&&l.charCodeAt(d)===Fe;for(m&&d++,u.push(p&&m?`center`:m?`right`:p?`left`:null);d<f&&(l.charCodeAt(d)===F||l.charCodeAt(d)===I);)d++;d<f&&l.charCodeAt(d)===U&&d++}let h=xr(c,n,r);if(u.length!==h.length)return null;let g=[],_=Z(e,s);for(;_<e.length;){let t=X(e,_),i=e.slice(_,t);if(Xn(e,_,t))break;if(Yn(e,_,t),Q<4){var v=e.charCodeAt(_+$);if(v===B||v===Te||(v===V||v===Oe||v===ke)&&er(e,_))break;if(v===R||v===Ce){for(var y=_+$,b=0;y<t&&e.charCodeAt(y)===v;)b++,y++;if(b>=3)break}}g.push(xr(i,n,r)),_=Z(e,t)}if(r.optimizeForStreaming&&g.length===0)return null;for(var x=h.length,S=0;S<g.length;S++)if(g[S].length<x)for(;g[S].length<x;)g[S].push([]);else g[S].length>x&&(g[S].length=x);return{node:{type:Y.table,header:h,cells:g,align:u},end:_}}function Cr(e,t,n){if(Yn(e,t,X(e,t)),Q>3)return null;var r=t+$;if(e.charCodeAt(r)!==we)return null;if(r+1<e.length&&e.charCodeAt(r+1)===z)return wr(e,r,n)||null;n.refs||={};var i=In(e,r,n.refs);return i===null?null:{node:{type:Y.refCollection},end:i}}function wr(e,t,n){var r=e.length;if(e.charCodeAt(t)!==we||t+1>=r||e.charCodeAt(t+1)!==z)return null;for(var i=t+2,a=i;i<r&&e.charCodeAt(i)!==Me;){if(e.charCodeAt(i)===L)return null;i++}if(i>=r)return null;var o=`^${e.slice(a,i)}`.toLowerCase();if(i++,i>=r||e.charCodeAt(i)!==Fe)return null;for(i++;i<r&&(e.charCodeAt(i)===F||e.charCodeAt(i)===I);)i++;if(i<r&&e.charCodeAt(i)===L)for(i++;i<r&&(e.charCodeAt(i)===F||e.charCodeAt(i)===I);)i++;var s=e.indexOf(`
`,i);s<0&&(s=r);for(var c=e.slice(i,s).trim(),l=s<r?s+1:r;l<r;){var u=X(e,l);if(Yn(e,l,u),Q>=2&&!Xn(e,l,u))c+=`
${e.slice(l,u)}`,l=Z(e,u);else if(Xn(e,l,u)){var d=Z(e,u);if(d<r&&(Yn(e,d,X(e,d)),Q>=2)){c+=`
`,l=Z(e,u);continue}break}else break}var f=n.refs;return f&&!f[o]&&(f[o]={target:c,title:void 0}),{node:{type:Y.footnote},end:l}}function Tr(e,t,n,r){let i=t,a=0,o=0,s=-1;for(;i<e.length;){let t=s>=0?s:X(e,i);if(s=-1,Xn(e,i,t))break;if(Yn(e,i,t),Q<4&&o>0&&!n.l){let n=e.charCodeAt(i+$);if(n===De||n===V){let r=i+$;for(;r<t&&e.charCodeAt(r)===n;)r++;for(;r<t&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;if(r>=t){a=n===De?1:2,i=Z(e,t);break}}}o=t;let x=Z(e,t);if(x<e.length){if(e.charCodeAt(x)===lt){var c=X(e,x);i=Z(e,c),o=c;continue}let t=X(e,x);if(s=t,Yn(e,x,t),Q<4){let a=e.charCodeAt(x+$);if(a===B){i=x;break}if(a===Te){for(var l=x+$,u=0;l<t&&e.charCodeAt(l)===Te&&u<=6;)u++,l++;if(u>=1&&u<=6&&(l>=t||e.charCodeAt(l)===F||e.charCodeAt(l)===I)){i=x;break}}if(a===R||a===Ce){for(var d=x+$,f=0;d<t&&e.charCodeAt(d)===a;)f++,d++;if(f>=3){i=x;break}}if(a===Ae){var p=x+$+1,m=p<t?e.charCodeAt(p):0,h=m===Ne||m===qe;if(!h&&m===Ye){for(var g=p+1,_=g;_<t&&(e.charCodeAt(_)>=K&&e.charCodeAt(_)<=q||e.charCodeAt(_)>=J&&e.charCodeAt(_)<=ut||e.charCodeAt(_)>=W&&e.charCodeAt(_)<=G||e.charCodeAt(_)===V);)_++;_>g&&(h=pr.has(e.slice(g,_).toLowerCase()))}else if(!h){for(var v=p;v<t&&(e.charCodeAt(v)>=K&&e.charCodeAt(v)<=q||e.charCodeAt(v)>=J&&e.charCodeAt(v)<=ut||e.charCodeAt(v)>=W&&e.charCodeAt(v)<=G||e.charCodeAt(v)===V);)v++;if(v>p){var y=e.slice(p,v).toLowerCase();h=pr.has(y)||gn.has(y)}}if(h&&yr(e,x,n,r)){i=x;break}}if(a===V||a===Oe||a===Qe){let n=x+$+1;if(n<t&&(e.charCodeAt(n)===F||e.charCodeAt(n)===I)&&Kn(e,n,t)<t&&!er(e,x)){i=x;break}}if(a>=W&&a<=G){let n=x+$;for(;n<t&&e.charCodeAt(n)>=W&&e.charCodeAt(n)<=G;)n++;if(n<t&&(e.charCodeAt(n)===Je||e.charCodeAt(n)===nt)&&n-(x+$)===1&&e.charCodeAt(x+$)===49){var b=n+1;if(b<t&&(e.charCodeAt(b)===F||e.charCodeAt(b)===I)&&Kn(e,b,t)<t){i=x;break}}}if(a===U){let n=Z(e,t);if(n<e.length&&Tn(e,n,X(e,n))){i=x;break}}if((a===V||a===Oe||a===ke)&&er(e,x)){if(a!==V){i=x;break}let n=0,r=x+$;for(;r<t&&e.charCodeAt(r)===V;)n++,r++;for(;r<t&&(e.charCodeAt(r)===F||e.charCodeAt(r)===I);)r++;if(r<t){i=x;break}}}}i=Z(e,t)}for(var x=a?o:i;x>t&&(e.charCodeAt(x-1)===L||e.charCodeAt(x-1)===Se||e.charCodeAt(x-1)===F||e.charCodeAt(x-1)===I);)x--;for(var S=t;S<x&&(e.charCodeAt(S)===F||e.charCodeAt(S)===I);)S++;if(S>=x)return null;for(var C=!1,w=S;w<x;w++)if(e.charCodeAt(w)===lt){C=!0;break}var T=C?e.slice(S,x).replace(/\u001E/g,``):e.slice(S,x);if(!T)return null;let E=Er(T,!0,n,r);return a?{node:{type:Y.heading,level:a,children:E,id:``},end:i}:{node:{type:Y.paragraph,children:E},end:i}}function Er(e,t,n,r){var i=n.t;if(!i){var a=n.k;n.k=t;var o=li(e,0,e.length,n,r);return n.k=a,o}var s=[];return i.push({dest:s,text:e,breaks:t,inline:n.inline,inAnchor:n.inAnchor,inHTML:n.inHTML,htmlDepth:n.d,inList:n.inList,inBlockQuote:n.inBlockQuote,noSetext:n.l,depth:n.o}),s}function Dr(e,t,n){if(e.charCodeAt(t)!==R)return null;let r=Jn(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return null;let o=Jn(e,a,n,96);if(o===r){let n=e.slice(t+r,a);return n.indexOf(`
`)!==-1&&(n=n.replace(/\n/g,` `)),n.length>0&&n[0]===` `&&n.at(-1)===` `&&n.trim().length>0&&(n=n.slice(1,-1)),{node:{type:Y.codeInline,text:n},end:a+o}}i=a+o}return null}function Or(e,t,n){if(e.charCodeAt(t)!==R)return t;let r=Jn(e,t,n,96),i=t+r;for(;i<n;){let a=e.indexOf("`",i);if(a<0||a>=n)return t;let o=Jn(e,a,n,96);if(o===r)return a+o;i=a+o}return t}function kr(e,t,n){if(e.charCodeAt(t)!==Ae)return t;if(t+1<n&&e.charCodeAt(t+1)===Ye){let r=t+2;for(;r<n&&e.charCodeAt(r)!==B;)r++;return r<n?r+1:t}if(t+3<n&&e.charCodeAt(t+1)===Ne&&e.charCodeAt(t+2)===V&&e.charCodeAt(t+3)===V){let n=e.indexOf(`-->`,t+4);return n>=0?n+3:t}let r=t+1,i=r;for(;r<n;){let t=e.charCodeAt(r);if(t>=K&&t<=q||t>=J&&t<=ut||t>=W&&t<=G||t===V)r++;else break}if(r===i)return t;let a=e.slice(i,r).toLowerCase(),o=!1;for(;r<n;){let i=e.charCodeAt(r);if(i===B){r++;break}if(i===Ye&&r+1<n&&e.charCodeAt(r+1)===B){r+=2,o=!0;break}if(i===Ze||i===Xe){var s=i;for(r++;r<n&&e.charCodeAt(r)!==s;)r++;r<n&&r++;continue}if(i===L)return t;r++}if(o||Ot(a))return r;let c=1;for(;r<n&&c>0;)if(e.charCodeAt(r)===Ae){if(r+1<n&&e.charCodeAt(r+1)===Ye){let t=r+2,i=t;for(;i<n&&(e.charCodeAt(i)>=K&&e.charCodeAt(i)<=q||e.charCodeAt(i)>=J&&e.charCodeAt(i)<=ut);)i++;if(e.slice(t,i).toLowerCase()===a){for(;i<n&&e.charCodeAt(i)!==B;)i++;if(i<n&&i++,c--,c===0)return i}r=i}else{let t=r+1,i=t;for(;i<n&&(e.charCodeAt(i)>=K&&e.charCodeAt(i)<=q||e.charCodeAt(i)>=J&&e.charCodeAt(i)<=ut);)i++;e.slice(t,i).toLowerCase()===a&&c++,r++}}else r++;return r}function Ar(e,t,n,r,i){if(e.charCodeAt(t)!==Ce||t+1>=n||e.charCodeAt(t+1)!==Ce)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===R){let t=Or(e,a,n);if(t>a){a=t;continue}}if(o===Ce&&e.charCodeAt(a+1)===Ce){let n=e.slice(t+2,a),o=li(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`del`,children:o},end:a+2}}o===H&&a+1<n&&a++,a++}return null}function jr(e,t,n,r,i){if(e.charCodeAt(t)!==De||t+1>=n||e.charCodeAt(t+1)!==De)return null;let a=t+2;for(;a+1<n;){let o=e.charCodeAt(a);if(o===R){let t=Or(e,a,n);if(t>a){a=t;continue}}if(o===De&&e.charCodeAt(a+1)===De&&a>t+2){let n=e.slice(t+2,a),o=li(n,0,n.length,r,i);return{node:{type:Y.textFormatted,tag:`mark`,children:o},end:a+2}}o===H&&a+1<n&&a++,a++}return null}function Mr(e,t,n){return e<dt?!!(Vn(e)&jt):Lt.test(t[n])}function Nr(e,t,n){return e<dt?!!(Vn(e)&kt):Rt.test(t[n])}function Pr(e,t,n){var r=e.charCodeAt(t);if(r!==Oe&&r!==ke)return null;var i=Jn(e,t,n,r);if(i===0)return null;var a=t>0?e.charCodeAt(t-1):32,o=t+i<n?e.charCodeAt(t+i):32,s=Nr(a,e,t-1),c=Nr(o,e,t+i),l=t>0&&Mr(a,e,t-1),u=t+i<n&&Mr(o,e,t+i),d=!c&&(!u||s||l),f=!s&&(!l||c||u),p,m;return r===Oe?(p=d,m=f):(p=d&&(!f||l),m=f&&(!d||u)),{len:i,canOpen:p,canClose:m}}function Fr(e,t,n,r){if(t.length!==0){for(var i=e.length,a=Array(i),o=null,s=null,c=0;c<i;c++){var l={node:e[c],prev:s,next:null};s?s.next=l:o=l,a[c]=l,s=l}for(var u=Array(t.length),d=0;d<t.length;d++)u[d]=a[t[d].idx];for(var f=[],p=0;p<12;p++)f[p]=-1;for(var m=0;m<t.length;){var h=t[m];if(!(h.active&&h.canClose)){m++;continue}for(var g=(h.ch===Oe?0:1)*6+h.len%3*2+ +!!h.canOpen,_=f[g]===void 0?-1:f[g],v=-1,y=m-1;y>_;y--){var b=t[y];if(!(!b.active||b.ch!==h.ch||!b.canOpen)&&!((h.canOpen||b.canClose)&&(b.len+h.len)%3==0&&b.len%3!=0)){v=y;break}}if(v<0){f[g]=m-1,!h.canOpen&&(h.active=!1),m++;continue}var x=t[v],S=x.len>=2&&h.len>=2,C=S?2:1;x.len-=C,h.len-=C;var w=u[v],T=u[m],E=w.node,D=T.node;E.text=E.text.slice(0,E.text.length-C),D.text=D.text.slice(C);for(var O=[],ee=w.next;ee&&ee!==T;)O.push(ee.node),ee=ee.next;var k={node:{type:Y.textFormatted,tag:S?`strong`:`em`,children:O},prev:w,next:T};w.next=k,T.prev=k;for(var te=v+1;te<m;te++)t[te].active=!1;if(x.len===0&&(x.active=!1,E.text===``)){var ne=w.prev;k.prev=ne,ne?ne.next=k:o=k}if(h.len===0){if(h.active=!1,D.text===``){var re=T.next;k.next=re,re&&(re.prev=k)}}else continue;m++}for(var ie=0,ae=o;ae;){var oe=ae.node;if(oe.type===Y.text){var se=oe;if(se.text===``){ae=ae.next;continue}if(ie>0&&e[ie-1].type===Y.text){e[ie-1].text+=se.text,ae=ae.next;continue}}e[ie++]=oe,ae=ae.next}e.length=ie}}function Ir(e,t,n,r){return t(e,n,r)===null?null:e}var Lr=0,Rr=0,zr=0,Br=0,Vr=0,Hr=0,Ur=0,Wr=0;function Gr(){return Ur===2147483647&&(Rr=0,Br=0,Hr=0,qr=0,Ur=0),++Ur}var Kr=null,qr=0,Jr=[],Yr=256;function Xr(e,t,n,r,i){let a=e.charCodeAt(t)===Ne,o=a?t+1:t;if(e.charCodeAt(o)!==we||Br===Wr&&o>=zr)return null;var s=qr===Wr?Kr:null,c=s===null?0:s[o];if(c<0)return null;var l=c;if(c===0){var u=e.indexOf(`]`,o+1);if(u<0||u>=n)return zr=o,Br=Wr,null;l=o+1;var d=0;Jr[d++]=o;for(var f=n-o>=Yr;l<n&&d>0;){var p=e.charCodeAt(l);if(p===H&&l+1<n){l+=2;continue}if(p===R){var m=Or(e,l,n);if(m>l){l=m;continue}}if(p===Ae){var h=Zr(e,l,n);if(h){l=h.end;continue}var g=kr(e,l,n);if(g>l){l=g;continue}}if(p===we)Jr[d++]=l;else if(p===Me){var _=Jr[--d];s===null&&f&&l-o>=Yr&&(s=Kr=new Int32Array(n),qr=Wr),s!==null&&(s[_]=l+1)}l++}if(d>0){if(s===null&&f&&l-o>=Yr&&(s=Kr=new Int32Array(n),qr=Wr),s!==null)for(;d>0;)s[Jr[--d]]=-1;return null}}var v=l-1,y=e.slice(o+1,v),b=l<n?e.charCodeAt(l):0,x=!1;if(b===tt){var S=!0;for(l++;l<n&&(e.charCodeAt(l)===F||e.charCodeAt(l)===L);)l++;var C=``,w=l;if(l<n&&e.charCodeAt(l)===Ae){for(l++,w=l;w<n&&e.charCodeAt(w)!==B;){if(e.charCodeAt(w)===H&&w+1<n){w+=2;continue}if(e.charCodeAt(w)===L){S=!1;break}w++}S&&(w>=n||e.charCodeAt(w)!==B)&&(S=!1),S&&(C=e.slice(l,w),w++)}else if(S){var T=Rr===Wr?Lr:-1;if(T>=0&&l>=T)S=!1;else{for(var E=0,D=!1;w<n;){var O=e.charCodeAt(w);if(O===H&&w+1<n){w+=2;continue}if(O===tt)E++;else if(O===nt){if(D=!0,E===0)break;E--}else if(O===F||O===L)break;w++}w>=n&&!D&&(T<0||l<T)&&(Lr=l,Rr=Wr),C=e.slice(l,w)}}if(S){for(l=w;l<n&&(e.charCodeAt(l)===F||e.charCodeAt(l)===L);)l++;var ee;if(l<n){var k=e.charCodeAt(l);if(k===Ze||k===Xe||k===tt){var te=k===tt?41:k;l++;for(var ne=l;l<n&&e.charCodeAt(l)!==te;)e.charCodeAt(l)===H&&l+1<n&&l++,l++;l>=n?S=!1:(ee=e.slice(ne,l),l++)}}if(S){for(;l<n&&(e.charCodeAt(l)===F||e.charCodeAt(l)===L);)l++;(l>=n||e.charCodeAt(l)!==nt)&&(S=!1)}}if(S){if(l++,C=yt(Hn(C)),ee!==void 0&&(ee=yt(Hn(ee))),a){var re=ni(li(y,0,y.length,r,i));return{node:{type:Y.image,target:Ir(C,i?.sanitizer||xt,`img`,`src`),alt:re,title:ee},end:l}}var ie=r.inAnchor;r.inAnchor=!0;var ae=ie?[{type:Y.text,text:y}]:li(y,0,y.length,r,i);return r.inAnchor=ie,!r.inAnchor&&ti(ae)?null:{node:{type:Y.link,target:Ir(C,i?.sanitizer||xt,`a`,`href`),title:ee,children:ae},end:l}}l=v+1,x=!0}var oe=``,se=l;if(!x&&b===we){var ce=l+1;se=ce;for(var le=!1;se<n&&e.charCodeAt(se)!==Me;){if(e.charCodeAt(se)===H&&se+1<n){se+=2;continue}if(e.charCodeAt(se)===we){le=!0;break}se++}if(le||se>=n)return null;var A=e.slice(ce,se);if(A.trim())oe=Bn(A);else{if(zn(y))return null;oe=Bn(y)}se+=1}else{if(zn(y))return null;oe=Bn(y)}var j=r.refs?.[oe];if(!j)return null;if(a)return{node:{type:Y.image,target:Ir(j.target,i?.sanitizer||xt,`img`,`src`),alt:ni(li(y,0,y.length,r,i)),title:j.title},end:se};var M=r.inAnchor;r.inAnchor=!0;var ae=M?[{type:Y.text,text:y}]:li(y,0,y.length,r,i);return r.inAnchor=M,!r.inAnchor&&ti(ae)?null:{node:{type:Y.link,target:Ir(j.target,i?.sanitizer||xt,`a`,`href`),title:j.title,children:ae},end:se}}function Zr(e,t,n){if(e.charCodeAt(t)!==Ae)return null;for(var r=t+1;r<n;){var i=e.charCodeAt(r);if(i===B)break;if(i===F||i===L||i===Se||i===Ae)return null;r++}if(r>=n||e.charCodeAt(r)!==B)return null;var a=e.slice(t+1,r);return a.match(/^([a-zA-Z][a-zA-Z0-9+.-]{1,31}):([^\x00-\x20]*)$/)?{node:{type:Y.link,target:a,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:a.indexOf(`@`)!==-1&&/^[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+@[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)*$/.test(a)?{node:{type:Y.link,target:`mailto:${a}`,title:void 0,children:[{type:Y.text,text:a}]},end:r+1}:null}function Qr(e,t,n,r){if(e.charCodeAt(t)!==we||t+1>=n||e.charCodeAt(t+1)!==z||Hr===Wr&&t>=Vr)return null;let i=t+2;for(;i<n&&e.charCodeAt(i)!==Me&&e.charCodeAt(i)!==L;)i++;if(i>=n)return Vr=t,Hr=Wr,null;if(e.charCodeAt(i)!==Me)return null;let a=e.slice(t+2,i);return a?{node:{type:Y.footnoteReference,target:`#${Tt(a)}`,text:a},end:i+1}:null}function $r(e,t,n,r){if(r.disableBareUrls)return null;var i=``,a=!1,o=e.charCodeAt(t);if(o===Re||o===72?t+8<=n&&e.charCodeAt(t+1)===Be&&e.charCodeAt(t+2)===Be&&e.charCodeAt(t+3)===Ve&&(e.charCodeAt(t+4)===He&&e.charCodeAt(t+5)===Fe&&e.charCodeAt(t+6)===Ye&&e.charCodeAt(t+7)===Ye?i=`https://`:e.charCodeAt(t+4)===Fe&&e.charCodeAt(t+5)===Ye&&e.charCodeAt(t+6)===Ye&&(i=`http://`)):o===Le||o===70?t+6<=n&&e.charCodeAt(t+1)===Be&&e.charCodeAt(t+2)===Ve&&e.charCodeAt(t+3)===Fe&&e.charCodeAt(t+4)===Ye&&e.charCodeAt(t+5)===Ye&&(i=`ftp://`):(o===ze||o===87)&&t+4<=n&&e.charCodeAt(t+1)===ze&&e.charCodeAt(t+2)===ze&&e.charCodeAt(t+3)===Je&&(i=`www.`,a=!0),!i)return null;let s=t+i.length;for(;s<n;){let t=e.charCodeAt(s);if(t===F||t===L||t===I||t===Se||t===Ae||t===B)break;s++}for(var c=0,l=0,u=t;u<s;u++){var d=e.charCodeAt(u);d===tt?c++:d===nt&&l++}let f=s;for(;f>t+i.length;){let n=e.charCodeAt(f-1);if(n===Je||n===Ge||n===Fe||n===Ne||n===qe||n===nt||n===Oe||n===ke||n===Ce){if(n===nt){if(c>=l)break;l--}f--}else if(n===Ke){for(var p=f-2;p>t&&(e.charCodeAt(p)>=K&&e.charCodeAt(p)<=q||e.charCodeAt(p)>=J&&e.charCodeAt(p)<=ut||e.charCodeAt(p)>=W&&e.charCodeAt(p)<=G);)p--;p>=t&&e.charCodeAt(p)===Pe?f=p:f--}else break}if(f<=t+i.length)return null;var m=t+(a?4:i.length),h=e.indexOf(`/`,m);if((h<0||h>f)&&(h=f),a&&e.indexOf(`.`,m)===-1)return null;for(var g=-1,_=-1,v=h-1;v>=m;v--)if(e.charCodeAt(v)===Je){if(g<0)g=v;else{_=v;break}}for(var v=_>=0?_+1:m;v<h;v++)if(e.charCodeAt(v)===ke)return null;var y=e.slice(t,f),b=a?`http://${y}`:y;return{node:{type:Y.link,target:b,title:void 0,children:[{type:Y.text,text:y}]},end:f}}function ei(e,t,n,r){if(r.disableBareUrls)return null;for(var i=t,a=i;i<n;){var o=e.charCodeAt(i);if(o>=K&&o<=q||o>=J&&o<=ut||o>=W&&o<=G||o===Je||o===Ne||o===Te||o===36||o===Ee||o===Pe||o===Xe||o===Oe||o===Qe||o===Ye||o===De||o===qe||o===z||o===ke||o===R||o===$e||o===U||o===et||o===Ce||o===V)i++;else break}if(i===a||i>=n||e.charCodeAt(i)!==je)return null;i++;for(var s=i,c=-1,l=i;i<n;){var o=e.charCodeAt(i);if(o>=K&&o<=q||o>=J&&o<=ut||o>=W&&o<=G)i++;else if((o===V||o===ke)&&i>s)i++;else if(o===Je){if(i===s)break;var u=e.charCodeAt(i-1);if(u===V||u===ke||i-l>63)break;if(i+1<n){var d=e.charCodeAt(i+1);if(d>=K&&d<=q||d>=J&&d<=ut||d>=W&&d<=G)c=i,l=i+1,i++;else break}else break}else break}if(i-l>63||c<0)return null;var f=e.charCodeAt(i-1);if(!(f>=K&&f<=q||f>=J&&f<=ut||f>=W&&f<=G)||i<=c+1)return null;for(var p=-1,m=c-1;m>=s;m--)if(e.charCodeAt(m)===Je){p=m;break}for(var m=p>=0?p+1:s;m<i;m++)if(e.charCodeAt(m)===ke)return null;var h=e.slice(t,i);return{node:{type:Y.link,target:`mailto:${h}`,title:void 0,children:[{type:Y.text,text:h}]},end:i}}function ti(e){for(var t=0;t<e.length;t++)if(e[t].type===Y.link||`children`in e[t]&&Array.isArray(e[t].children)&&ti(e[t].children))return!0;return!1}function ni(e,t){for(var n=``,r=0;r<e.length;r++){var i=e[r];i.type===Y.text?n+=i.text:i.type===Y.breakLine?n+=` `:i.type===Y.codeInline||i.type===Y.footnoteReference?n+=i.text:`children`in i&&Array.isArray(i.children)?n+=ni(i.children,t):!t&&i.type===Y.image&&(n+=i.alt||``)}return n}function ri(e,t,n){for(var r=0;r<e.length;r++){var i=e[r];if(i.type===Y.heading){var a=i;a.id=Zn(n(ni(a.children,!0)),t)}if(`children`in i){var o=i.children;Array.isArray(o)&&ri(o,t,n)}if((i.type===Y.orderedList||i.type===Y.unorderedList)&&Array.isArray(i.items))for(var s=i.items,c=0;c<s.length;c++)ri(s[c],t,n)}}function ii(e){return{type:Y.text,text:e}}function ai(e,t,n){var r=t+1;if(r>=n)return-1;if(e.charCodeAt(r)===Te){r++;var i=r<n&&(e.charCodeAt(r)===st||e.charCodeAt(r)===ct);i&&r++;for(var a=r,o=i?6:7;r<n&&r-a<=o;){var s=e.charCodeAt(r);if(!(s>=W&&s<=G||i&&(s>=K&&s<=Ie||s>=J&&s<=Le)))break;r++}return r===a||r-a>o?-1:r<n&&e.charCodeAt(r)===Ke?r+1:-1}for(var c=r;r<n&&r-c<48;){var l=e.charCodeAt(r);if(l>=K&&l<=q||l>=J&&l<=ut||l>=W&&l<=G){r++;continue}break}return r===c?-1:r<n&&e.charCodeAt(r)===Ke?r+1:-1}function oi(e,t,n,r,i){if(e.charCodeAt(t)!==Ae)return null;var a=t+1;if(a>=n)return null;var o=e.charCodeAt(a);if(o===Ne&&a+1<n&&e.charCodeAt(a+1)===V&&a+2<n&&e.charCodeAt(a+2)===V){var s=a+3;if(s<n&&e.charCodeAt(s)===B)return{node:{type:Y.htmlComment,text:``,s:!0},end:s+1};if(s+1<n&&e.charCodeAt(s)===V&&e.charCodeAt(s+1)===B)return{node:{type:Y.htmlComment,text:`-`,s:!0},end:s+2};var c=e.indexOf(`-->`,s);return c!==-1&&c<=n-3?{node:{type:Y.htmlComment,text:e.slice(t+4,c),s:!1},end:c+3}:null}if(o===qe){var l=e.indexOf(`?>`,a+1);return l!==-1&&l<n?{node:{type:Y.htmlSelfClosing,tag:`?`,attrs:{},m:e.slice(t,l+2),a:!1},end:l+2}:null}if(o===Ne&&a+1<n){var u=e.charCodeAt(a+1);if(u===we&&e.slice(a+1,a+8)===`[CDATA[`){var d=e.indexOf(`]]>`,a+8);return d!==-1&&d<n?{node:{type:Y.htmlSelfClosing,tag:`![CDATA[`,attrs:{},m:e.slice(t,d+3),a:!1},end:d+3}:null}if(u>=K&&u<=q){var f=e.indexOf(`>`,a+2);return f!==-1&&f<n?{node:{type:Y.htmlSelfClosing,tag:`!${e.slice(a+1,f)}`,attrs:{},m:e.slice(t,f+1),a:!1},end:f+1}:null}}if(o===Ye){var p=a+1;if(p>=n)return null;var m=e.charCodeAt(p);if(!(m>=K&&m<=q||m>=J&&m<=ut))return null;for(p++;p<n;){var h=e.charCodeAt(p);if(h>=K&&h<=q||h>=J&&h<=ut||h>=W&&h<=G||h===V)p++;else break}for(;p<n&&(e.charCodeAt(p)===F||e.charCodeAt(p)===I||e.charCodeAt(p)===L);)p++;if(p<n&&e.charCodeAt(p)===B){var g=e.slice(a+1,p).trim();return{node:{type:Y.htmlSelfClosing,tag:g,attrs:{},h:e.slice(t,p+1),a:!0},end:p+1}}return null}if(!(o>=K&&o<=q||o>=J&&o<=ut))return null;var _=Nn(e,t);if(!_)return null;var v=_.tag,y=v.toLowerCase();if(_.n||Ot(v))return{node:{type:Y.htmlSelfClosing,tag:v,attrs:mr(_.attrs,v,i),m:_.q?jn(_):e.slice(t,_.end),a:!1},end:_.end};var b=gn.has(y),x=vr(e.slice(0,n),_.end,v);if(x===-1)return{node:{type:Y.htmlSelfClosing,tag:v,attrs:mr(_.attrs,v,i),m:_.q?jn(_):e.slice(t,_.end),a:!1},end:_.end};var S=gr(e,`</${y}`,x),C=e.slice(_.end,S);if(b){var w=Pn(C);return{node:{type:Y.htmlBlock,tag:v,attrs:mr(_.attrs,v,i),b:_.g+_.b,children:[],e:w||void 0,h:e.slice(S,x),text:w,c:!0,a:!1},end:x}}var T=[],E=C.trim();if(E){var{inAnchor:D,inline:O,k:ee}=r;y===`a`&&(r.inAnchor=!0),r.k=!1,E.indexOf(`

`)!==-1||/^#{1,6}\s/.test(E)?(r.inline=!1,T=di(E,r,i)):T=li(E,0,E.length,r,i),r.inAnchor=D,r.inline=O,r.k=ee}return{node:{type:Y.htmlBlock,tag:v,attrs:mr(_.attrs,v,i),b:_.b,children:T,text:Pn(C),c:!1,a:!1},end:x}}var si=200,ci=0;function li(e,t,n,r,i){if(ci++,ci>si)return ci--,[{type:Y.text,text:e.slice(t,n)}];var a=Wr;Wr=Gr();let o=r;if(i.optimizeForStreaming){let r=function(e,t){for(var n=1,r=t+1;r<e.length;r++){var i=e.charCodeAt(r);if(i===we)n++;else if(i===Me&&(n--,n===0))return r}return-1},i=e.slice(t,n),a=i;for(var s=0,c=0,l=0,u=0,d=0,f=-1,p=-1,m=-1,h=-1,g=-1,_=0;_<i.length;_++){var v=i.charCodeAt(_);v===Oe?_+1<i.length&&i.charCodeAt(_+1)===Oe?(s++,f=_,_++):(c++,p=_):v===ke?_+1<i.length&&i.charCodeAt(_+1)===ke?(l++,m=_,_++):(u++,h=_):v===Ce&&_+1<i.length&&i.charCodeAt(_+1)===Ce&&(d++,g=_,_++)}var y=[];d%2==1&&g>=0&&y.push([g,2]),l%2==1&&m>=0&&y.push([m,2]),u%2==1&&h>=0&&y.push([h,1]),s%2==1&&f>=0&&y.push([f,2]),c%2==1&&p>=0&&y.push([p,1]),y.sort((e,t)=>t[0]-e[0]);for(var b=0;b<y.length;b++){var x=y[b][0],S=y[b][1];i=i.slice(0,x)+i.slice(x+S)}let o=0,A=-1;for(let e=0;e<i.length;e++)i.charCodeAt(e)===R&&(o++,A=e);if(o%2==1&&A!==-1){let e=!1,t=-1,n=0;for(;n<i.length;)i.charCodeAt(n)===R&&(e?(e=!1,t=-1):(t=n,e=!0)),n++;e&&t!==-1&&(i=i.slice(0,t))}for(var C=!0;C;){C=!1;for(var w=-1,T=-1,E=-1,D=!1,O=0;O<i.length;O++)if(i.charCodeAt(O)===we&&(O===0||i.charCodeAt(O-1)!==H)){var ee=O>0&&i.charCodeAt(O-1)===Ne,k=ee?O-1:O,te=r(i,O);if(te===-1)w=k,D=ee,T=O+1,E=i.length;else{var ne=te+1;if(ne>=i.length)w=k,D=ee,T=O+1,E=te;else if(i.charCodeAt(ne)===tt){var re=i.indexOf(`)`,ne+1);re===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=re}else if(i.charCodeAt(ne)===we){var ie=i.indexOf(`]`,ne+1);ie===-1?(w=k,D=ee,T=O+1,E=te,O=i.length):O=ie}else O=te}}if(w>=0){var ae=D?``:i.slice(T,E);i=i.slice(0,w)+ae,C=!0}}let j=i.match(/<([A-Z][A-Za-z0-9]*)(?:\s[^>]*)?>([^<]*)$/);if(j&&j.index!==void 0){var oe=j[0].length-j[2].length;if(!(oe>=2&&j[0].charCodeAt(oe-2)===Ye)){for(var se=!1,ce=0,le=0;le<j.index;le++)i.charCodeAt(le)===R&&ce++;if(se=ce%2==1,!se){let e=j[1];hr(i,`</${e}`,0)===-1&&(i=i.slice(0,j.index)+j[2])}}}i!==a&&(e=e.slice(0,t)+i,n=t+i.length)}let A=[];var j=[];let M=t;var ue=``,de=i.disableAutoLink||i.disableBareUrls||o.inAnchor?-1:e.indexOf(`@`,t);for(de>=n&&(de=-1);t<n;){let r=e.charCodeAt(t),a=null;if(r===R){if(a=Dr(e,t,n),!a){var fe=Jn(e,t,n,R);t+=fe-1}}else if(r===Oe||r===ke){var N=Pr(e,t,n);if(N){if(N.canOpen||N.canClose){(ue||t>M)&&(A.push(ii(ue+e.slice(M,t))),ue=``);var P=ii(e.slice(t,t+N.len));j.push({idx:A.length,ch:r,len:N.len,canOpen:N.canOpen,canClose:N.canClose,active:!0}),A.push(P),t+=N.len,M=t;continue}t+=N.len-1}}else if(r===Ce)a=Ar(e,t,n,o,i);else if(r===De)a=jr(e,t,n,o,i);else if(r===we)t+1<n&&e.charCodeAt(t+1)===z&&(a=Qr(e,t,n,o)),a||=Xr(e,t,n,o,i);else if(r===Ne&&t+1<n&&e.charCodeAt(t+1)===we)a=Xr(e,t,n,o,i);else if(r===Ae)a=Zr(e,t,n),!(a||i.disableParsingRawHTML||i.ignoreHTMLBlocks)&&(a=oi(e,t,n,o,i));else if(r===Pe){var pe=ai(e,t,n);if(pe!==-1){var me=e.slice(t,pe),he=yt(me);if(he!==me){ue=ue+e.slice(M,t)+he,t=pe,M=pe;continue}}}else if((r===Re||r===ze||r===Le)&&!o.inAnchor&&!i.disableAutoLink&&(t===0||e.charCodeAt(t-1)!==Ae)){var ge=t+1<n?e.charCodeAt(t+1):0;(r===Re&&ge===Be||r===Le&&ge===Be||r===ze&&ge===ze)&&(a=$r(e,t,n,i))}if(!a&&de>=0&&de-t<=64&&!o.inAnchor&&!i.disableAutoLink&&!i.disableBareUrls&&(r>=K&&r<=q||r>=J&&r<=ut||r>=W&&r<=G)&&(a=ei(e,t,n,i),!a&&t>=de&&(de=e.indexOf(`@`,t+1),de>=n&&(de=-1))),r===L&&o.k){var _e=!1,ve=0;if(t>M&&e.charCodeAt(t-1)===H)_e=!0,ve=1;else{for(var ye=0,be=t-1;be>=M&&e.charCodeAt(be)===F;)ye++,be--;ye>=2&&(_e=!0,ve=ye)}if(_e){for((ue||t-ve>M)&&(A.push(ii(ue+e.slice(M,t-ve))),ue=``),A.push({type:Y.breakLine}),t++;t<n&&e.charCodeAt(t)===F;)t++;M=t;continue}var xe=t>M&&e.charCodeAt(t-1)===F,I=t+1<n&&e.charCodeAt(t+1)===F;if(xe||I){for(var Se=t;Se>M&&e.charCodeAt(Se-1)===F;)Se--;for(ue+=`${e.slice(M,Se)}
`,t++;t<n&&e.charCodeAt(t)===F;)t++;M=t;continue}}if(a)(ue||t>M)&&(A.push(ii(ue+e.slice(M,t))),ue=``),A.push(a.node),t=a.end,M=t;else{if(r===H&&t+1<n&&Vn(e.charCodeAt(t+1))&jt){(ue||t>M)&&(A.push(ii(ue+e.slice(M,t))),ue=``),A.push(ii(e[t+1])),t+=2,M=t;continue}if(t++,de<0||de-t>64)for(;t<n&&!(de>=0&&de-t<=64);){var B=e.charCodeAt(t);if(B<dt&&!xn[B])t++;else break}}}return(ue||n>M)&&(A.push(ii(ue+e.slice(M,n))),ue=``),j.length>0&&Fr(A,j,r,i),Wr=a,ci--,A}var ui=500;function di(e,t,n){var r=t.o||0;if(r>ui)return[{type:Y.text,text:e}];if(t.o=r+1,n.optimizeForStreaming&&!(t.i||t.w)){for(var i=e.length;i>0&&e.charCodeAt(i-1)===L;)i--;for(var a=i;a>0&&e.charCodeAt(a-1)!==L;)a--;if(i>a&&e.charCodeAt(a)===U){for(var o=!1,s=a+1;s<i;s++){var c=e.charCodeAt(s);if(c!==F&&c!==I&&c!==U&&c!==Fe&&c!==V){o=!0;break}}for(var l=!1,u=!1,d=0,f=a,p=a-1;p>0;){for(var m=p;m>0&&e.charCodeAt(m-1)!==L;)m--;if(e.charCodeAt(m)!==U)break;f=m;for(var h=!0,g=!1,_=m;_<p;_++){var v=e.charCodeAt(_);if(v===V)g=!0;else if(v!==F&&v!==I&&v!==Fe&&v!==U){h=!1;break}}h&&g?(l=!0,u=!0):u||d++,p=m-1}o?l||(e=e.slice(0,a).trimEnd()):e=l&&d>0?e.slice(0,a).trimEnd():e.slice(0,f).trimEnd()}for(var y=-1,b=-1,x=-1,S=!1,C=e.length-1;C>=0;C--)if(e.charCodeAt(C)===Ae){for(var w=C+1<e.length?e.charCodeAt(C+1):0,T=w>=K&&w<=q||w>=J&&w<=ut,E=w===Ye&&C+2<e.length&&(e.charCodeAt(C+2)>=K&&e.charCodeAt(C+2)<=q||e.charCodeAt(C+2)>=J&&e.charCodeAt(C+2)<=ut),D=w===Ne||w===qe,O=e.length;O>C+1&&e.charCodeAt(O-1)===L;)O--;var ee=C+1>=O;if(T||E||D||ee){var k=C+1;if((E||T)&&(k=C+2),T||E)for(;k<e.length;){var te=e.charCodeAt(k);if(te>=K&&te<=q||te>=J&&te<=ut||te>=W&&te<=G)k++;else break}for(var ne=T||E?k:C+2;ne<e.length&&e.charCodeAt(ne)!==B;)ne++;if(ne>=e.length)y=C,S=!0;else if((T||E)&&e.charCodeAt(ne-1)!==Ye){for(var re=!1,ie=ne+1;ie<e.length;ie++)if(e.charCodeAt(ie)===Ae){re=!0;break}re||(y=C,b=k,x=ne+1)}}break}if(y>=0){for(var ae=0,oe=0;oe<y;oe++)e.charCodeAt(oe)===R&&ae++;if(ae%2==0){if(S)e=e.slice(0,y);else{var se=e.slice(y+1,b);hr(e,`</${se}`,0)===-1&&(e=e.slice(0,y)+e.slice(x))}}}for(var ce=e.length;ce>0&&e.charCodeAt(ce-1)===L;)ce--;if(ce>0){for(var le=ce;le>0&&e.charCodeAt(le-1)!==L;)le--;for(var A=le,j=0;A<ce&&e.charCodeAt(A)===F&&j<3;)A++,j++;if(le>0&&A<ce&&$n(e,A,ce)){for(var M=le-1,ue=M;ue>0&&e.charCodeAt(ue-1)!==L;)ue--;Xn(e,ue,M)||(e=e.slice(0,le).trimEnd())}}var de=e.length;if(de>0){for(var fe=e.lastIndexOf(`
`),N=fe===-1?0:fe+1,P=de,pe=N,me=0;pe<P&&e.charCodeAt(pe)===F&&me<3;)pe++,me++;if(pe<P){var he=e.charCodeAt(pe),ge=!1;if(he===Oe||he===V||he===Qe){var _e=pe+1;if(_e>=P||e.charCodeAt(_e)===F||e.charCodeAt(_e)===I){for(var ve=_e;ve<P&&(e.charCodeAt(ve)===F||e.charCodeAt(ve)===I);)ve++;ve>=P&&(ge=!0)}}else if(he>=W&&he<=G){for(var ye=pe;ye<P&&e.charCodeAt(ye)>=W&&e.charCodeAt(ye)<=G;)ye++;if(ye<P&&(e.charCodeAt(ye)===Je||e.charCodeAt(ye)===nt)){var be=ye+1;if(be>=P||e.charCodeAt(be)===F||e.charCodeAt(be)===I){for(var xe=be;xe<P&&(e.charCodeAt(xe)===F||e.charCodeAt(xe)===I);)xe++;xe>=P&&(ge=!0)}}}ge&&(e=e.slice(0,N).trimEnd())}}}if(t.inline)return li(e,0,e.length,t,n);let Se=[],z=0,Ee=e.length;if(z===0&&!n.disableFrontmatter&&e.startsWith(`---`)){let t=pt(e);if(t?.hasValidYaml){if(n.preserveFrontmatter!==!1){let n=e.slice(0,t.endPos).trimEnd();Se.push({type:Y.frontmatter,text:n})}z=t.endPos}}for(;z<Ee;){for(var De=e.indexOf(`
`,z),H=De<0?Ee:De;z<Ee&&Xn(e,z,H);)z=H<Ee?H+1:H,z<Ee&&(De=e.indexOf(`
`,z),H=De<0?Ee:De);if(z>=Ee)break;var je=e.charCodeAt(z)===lt;Yn(e,z,H);let r=null;if(Un=e,Wn=z,Gn=H,!je&&Q>=4&&!t.inHTML)r=or(e,z);else if(!je){let i=z+$,a=e.charCodeAt(i);a===Te?r=Qn(e,z,t,n):a===B?r=sr(e,z,t,n):a===R||a===Ce?r=ir(e,z,t):a===V||a===Oe||a===ke?(r=er(e,z),!r&&(r=fr(e,z,t,n))):a===Qe||a>=W&&a<=G?r=fr(e,z,t,n):a===Ae?r=yr(e,z,t,n):a===U?r=Sr(e,z,t,n):a===we&&(r=Cr(e,z,t))}if(!r){for(var Me=!1,Pe=z;Pe<H;Pe++)if(e.charCodeAt(Pe)===U){Me=!0;break}Me&&(r=Sr(e,z,t,n))}if(r||=Tr(e,z,t,n),r)r.node.type!==Y.refCollection&&Se.push(r.node),z=r.end;else{var Ie=e.indexOf(`
`,z);z=Ie<0?Ee:Ie+1}}return t.o=r,Se}function fi(e,t,n,r){var i=Nn(e,t);return i?{tagName:i.tag,tagLower:i.tag.toLowerCase(),attrs:i.b,whitespaceBeforeAttrs:i.g,isSelfClosing:i.n,hasSpaceBeforeSlash:i.r,isClosing:i.f,hasNewline:i.g.includes(`
`)||i.b.includes(`
`),endPos:i.end}:null}function pi(e,t,n){ci=0,e=Bt(e),!t.refs&&(t.refs={}),(n.optimizeForStreaming||t.inline)&&(t.w=Fn(e,t.refs,n));var r,i;t.t||(t.t=r=[],t.p=i=[]);let a=di(e,t,n);if(r&&i){for(var o=r,s={inline:t.inline,inAnchor:t.inAnchor,inHTML:t.inHTML,htmlDepth:t.d,inList:t.inList,inBlockQuote:t.inBlockQuote,noSetext:t.l,depth:t.o},c=0;c<o.length;c++){var l=o[c];t.inline=l.inline,t.inAnchor=l.inAnchor,t.inHTML=l.inHTML,t.d=l.htmlDepth,t.inList=l.inList,t.inBlockQuote=l.inBlockQuote,t.l=l.noSetext,t.o=l.depth,t.k=l.breaks;var u=li(l.text,0,l.text.length,t,n);t.k=!1;for(var d=0;d<u.length;d++)l.dest.push(u[d])}t.inline=s.inline,t.inAnchor=s.inAnchor,t.inHTML=s.inHTML,t.d=s.htmlDepth,t.inList=s.inList,t.inBlockQuote=s.inBlockQuote,t.l=s.noSetext,t.o=s.depth;for(var f=i,p=0;p<f.length;p++)for(var m=f[p],h=0;h<m.src.length;h++){var g=m.src[h];if(m.unwrap&&g.type===Y.paragraph)for(var _=g.children,v=0;v<_.length;v++)m.dest.push(_[v]);else m.dest.push(g)}t.t=void 0,t.p=void 0,ri(a,t,n.slugify)}return Ut(t.refs)?[{type:Y.refCollection,refs:t.refs},...a]:a}var mi;try{hi=d.createElement(`div`),mi=typeof hi==`object`&&hi&&`$$typeof`in hi&&typeof hi.$$typeof==`symbol`?hi.$$typeof:Symbol.for(`react.transitional.element`)}catch{mi=Symbol.for(`react.transitional.element`)}var hi;function gi(e,t,n){return{$$typeof:mi,type:e,key:n==null?null:String(n),ref:null,props:t,_owner:null,_store:{},_debugStack:null,_debugTask:null}}function _i(e,t){var n={key:e};if(t){var r=_t(t);for(var i in r)n[i]=r[i]}return n}var vi=typeof d.createContext>`u`?void 0:d.createContext(void 0);function yi(e,t,n,r,i,a,o,s,c){switch(e.type){case Y.blockQuote:{let i={key:n.key};return e.alert&&(i.className=`markdown-alert-${a(e.alert.toLowerCase(),Tt)}`,e.children.unshift(Wt(e.alert))),r(`blockquote`,i,t(e.children,n))}case Y.breakLine:return r(`br`,{key:n.key});case Y.breakThematic:return r(`hr`,{key:n.key});case Y.frontmatter:return s.preserveFrontmatter?r(`pre`,{key:n.key},e.text):null;case Y.codeBlock:{let t=e.lang?yt(e.lang):``;var l=e.attrs?_t(e.attrs):{};return l.className=t?`language-${t} lang-${t}`:``,r(`pre`,{key:n.key},r(`code`,l,e.text))}case Y.codeInline:return r(`code`,{key:n.key},e.text);case Y.footnoteReference:return r(`a`,{key:n.key,href:i(e.target,`a`,`href`)||void 0},r(`sup`,null,e.text));case Y.gfmTask:return r(`input`,{checked:e.completed,key:n.key,readOnly:!0,type:`checkbox`});case Y.heading:return r(`h${e.level}`,{id:e.id,key:n.key},t(e.children,n));case Y.htmlBlock:{let a=e;if(en(s)&&ln(a.tag)){var u=Qt(a);return u.kind===`literal`?r(`span`,{key:n.key},u.literal):r(`span`,{key:n.key},...$t(u.open,a.children?t(a.children,n):null,u.close))}let l=a.j,_=l!==void 0,v=_?l:a.a?a.e||``:(a.e||``)+(a.h||``);if(v&&a.c){let r=Cn(a.tag.toLowerCase()),u=a.children,y=u!=null&&u.length>0;if(r){let t=_?l:a.e||``,r=en(s)?dn(t):t;if(/<[a-z][^>]{0,100}>/i.test(v)){var f=_i(n.key,e.attrs);return f.dangerouslySetInnerHTML={__html:r},c(e.tag,f)}return c(e.tag,_i(n.key,e.attrs),r)}let b=RegExp(`^<${a.tag}(\\s|>)`,`i`);if(y&&!b.test(v)&&en(s)&&un(v))return c(e.tag,_i(n.key,e.attrs),t(u,n));if(wn(v)){let t=en(s)?dn(v):v;var p=_i(n.key,e.attrs);return p.dangerouslySetInnerHTML={__html:t},c(e.tag,p)}let x=fn({slugify:s.slugify,sanitizer:i,tagfilter:!0}),S=Vt(v);if(RegExp(`^<${a.tag}(\\s[^>]*)?>(\\s*</${a.tag}>)?$`,`i`).test(S))return a.children&&a.children.length>0?c(e.tag,_i(n.key,e.attrs),t(a.children,n)):c(e.tag,_i(n.key,e.attrs));let C=pi(S,{inline:!1,refs:o,inHTML:!1},x);Jt(C);let w=a.tag.toLowerCase(),T=_;if(T&&y)return c(e.tag,_i(n.key,e.attrs),t(u,n));if(T)return t(C.flatMap(qt),n);var m=Yt(C,w);if(m.found&&m.afterClose.length>0){var h=m.beforeClose.flatMap(qt),g=m.afterClose.flatMap(qt);return gi(d.Fragment,{children:[c(e.tag,_i(n.key,e.attrs),t(h,n)),t(g,n)]},n.key)}return c(e.tag,_i(n.key,e.attrs),t(C.flatMap(qt),n))}return Ot(e.tag)?c(e.tag,_i(n.key,e.attrs)):c(e.tag,_i(n.key,e.attrs),e.children?t(e.children,n):``)}case Y.htmlSelfClosing:{let t=e;if(en(s)&&ln(t.tag)){var _=Qt(t);return r(`span`,{key:n.key},_.kind===`literal`?_.literal:_.open+(_.close||``))}return c(e.tag,_i(n.key,e.attrs))}case Y.image:{let t=e.target===null?null:i(e.target,`img`,`src`);return r(`img`,{key:n.key,alt:e.alt&&e.alt.length>0?e.alt:void 0,title:e.title||void 0,src:t||void 0})}case Y.link:{let a={key:n.key};if(e.target!=null){let t=tn(e.target,i,`a`,`href`);t!=null&&(a.href=t)}return e.title&&(a.title=e.title),r(`a`,a,t(e.children,n))}case Y.table:{let i=e;return r(`table`,{key:n.key},r(`thead`,{key:`thead`},r(`tr`,null,i.header.map(function(e,a){return r(`th`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))),i.cells.length>0&&r(`tbody`,{key:`tbody`},i.cells.map(function(e,a){return r(`tr`,{key:a},e.map(function(e,a){return r(`td`,{key:a,style:i.align[a]===null?{}:{textAlign:i.align[a]}},t(e,n))}))})))}case Y.text:return e.text;case Y.textFormatted:return r(e.tag,{key:n.key},t(e.children,n));case Y.orderedList:case Y.unorderedList:return r(e.type===Y.orderedList?`ol`:`ul`,{key:n.key,start:e.type===Y.orderedList?e.start:void 0},e.items.map(function(e,i){return r(`li`,{key:i},t(e,n))}));case Y.paragraph:return r(`p`,{key:n.key},t(e.children,n));case Y.ref:return null;default:return null}}var bi=(e,t,n,r,i,a,o)=>{var s=e=>e.map(e=>`text`in e?e.text:``),c=(l,u={})=>{var d=Array.isArray(l)?l:[l],f=(u.renderDepth||0)+1;if(f>2500)return s(d);u.renderDepth=f;for(var p=u.key,m=[],h=!1,g=0;g<d.length;g++){u.key=g;var _=e?e(yi.bind(null,d[g],c,u,t,n,r,i,a,o),d[g],c,u):yi(d[g],c,u,t,n,r,i,a,o),v=typeof _==`string`;if(h&&typeof _==`string`){var y=m.at(-1);m[m.length-1]=(typeof y==`string`?y:``)+_}else if(_!=null){if(Array.isArray(_))for(var b=0;b<_.length;b++)m.push(_[b]);else m.push(_)}h=v}return u.key=p,u.renderDepth=f-1,m};return c},xi=(e,t)=>{let n=rn(t,e,void 0);return n?typeof n==`function`||typeof n==`object`&&`render`in n?n:rn(t,`${e}.component`,e):e};function Si(e,t){let n={...t||{}};n.overrides=n.overrides||{};let r=n.slugify||Tt,i=n.sanitizer||xt,a=n.createElement,o=Ut(n.overrides),s=e=>Ci(e,{...n,wrapper:null});function c(e){for(var t in e){var n=e[t];if(typeof n==`string`&&n.length>0&&n.charCodeAt(0)===Ae&&(pn.test(n)||mn.test(n)||fi(n,0))){var r=s(n.trim());e[t]=t===`innerHTML`&&Array.isArray(r)?r[0]:r}}}function l(e,t,...r){var i=t||{},s=e;if(o){var c=rn(n.overrides,`${e}.props`,{});s=xi(e,n.overrides),i={...i,...c,className:on(i.className,c.className)||void 0}}if(!a){var l=i.key;return l!=null&&delete i.key,r.length===1?i.children=r[0]:r.length>1&&(i.children=r),gi(s,i,l)}return a(s,i,...r)}function u(e,t,...n){return t&&c(t),l(e,t,...n)}let d=fn(n,n.forceInline),f=e[0]&&e[0].type===Y.refCollection?e[0].refs:{},p=bi(n.renderRule,l,i,r,f,n,u),m=p(e,{inline:n.forceInline,refs:f}),h=nn(f);if(h.length>0&&m.push(l(`footer`,{key:`footer`},h.map(function(e){let t=e.identifier.charCodeAt(0)===z?e.identifier.slice(1):e.identifier,n=pi(e.footnote,{inline:!0,refs:f},d);return l(`div`,{id:r(t,Tt),key:e.identifier},`${t}: `,p(n,{inline:!0,refs:f}))}))),n.wrapper===null)return m;let g=n.wrapper||(n.forceInline?`span`:`div`),_;if(m.length>1||n.forceWrapper)_=m;else return m.length===1?m[0]:null;var v=n.wrapperProps?{...n.wrapperProps}:{};return v.children=_,gi(g,v,`outer`)}function Ci(e=``,t={}){let n={...t||{}};n.overrides=n.overrides||{},n.slugify,n.sanitizer;function r(e){let t=n.forceInline||!(n.forceBlock||vt.test(e)),r=fn(n,t);return Si(pi(t?e:Kt(e),{inline:t,refs:i},r),{...n,forceInline:t})}let i={};return r(e)}function wi(e){let t=d.useRef(e),n=t.current;if(n!==e){var r=!0,i=0;for(var a in e)if(i++,!Object.is(n[a],e[a])){r=!1;break}if(r){var o=0;for(var s in n)o++;r=o===i}r||(t.current=e)}return t.current}var Ti=({children:e,options:t,...n})=>{if(!(typeof d.useContext<`u`)){let r={...t,overrides:{...t?.overrides},wrapperProps:{...t?.wrapperProps,...n}};return Ci(e??``,r)}let r=vi?d.useContext(vi):void 0,i=wi(n),a=d.useMemo(()=>({...r,...t,overrides:{...r?.overrides,...t?.overrides},wrapperProps:{...r?.wrapperProps,...t?.wrapperProps,...i}}),[r,t,i]),o=e??``;return d.useMemo(()=>Ci(o,a),[o,a])};function Ei({text:e}){return(0,p.jsx)(Ti,{options:{disableParsingRawHTML:!0,forceBlock:!0},children:e})}let Di=[`👍`,`❤️`,`😂`,`😮`,`😢`,`🎉`];async function Oi(e){if(navigator.clipboard?.writeText!==void 0)try{return await navigator.clipboard.writeText(e),!0}catch{return!1}if(typeof document.execCommand!=`function`)return!1;let t=document.createElement(`textarea`);t.value=e,t.style.position=`fixed`,t.style.left=`-9999px`,document.body.append(t),t.select();try{return document.execCommand(`copy`)}catch{return!1}finally{t.remove()}}function ki({tools:e}){let[t,n]=(0,d.useState)(!1),[r,i]=(0,d.useState)(!1),a=e.copyText,o=e.identity!==void 0,s=e.reactions.some(t=>t.messageId===e.message.messageId&&t.emoji===`👍`&&t.participantIds.includes(e.identity?.participantId??``));if((0,d.useEffect)(()=>{if(!r)return;let e=()=>{i(!1)},t=t=>{t.key===`Escape`&&e()};return document.addEventListener(`pointerdown`,e),document.addEventListener(`keydown`,t),()=>{document.removeEventListener(`pointerdown`,e),document.removeEventListener(`keydown`,t)}},[r]),a===void 0&&!o)return null;let c=()=>{a===void 0||t||Oi(a).then(e=>{e&&(n(!0),globalThis.setTimeout(()=>{n(!1)},1e3))})};return(0,p.jsxs)(`div`,{className:`dsh-chatroom-message-actions`,children:[e.onReply!==void 0&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`回复`,onClick:e.onReply,children:[`↩ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`回复`})]}),o&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":s?`取消点赞`:`点赞`,"aria-pressed":s,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,`👍`)},children:[`👍 `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:s?`已赞`:`点赞`})]}),e.onBranch!==void 0&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`分支`,onClick:e.onBranch,children:[`⑂ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`分支`})]}),o&&(0,p.jsxs)(`button`,{type:`button`,"aria-label":`转发`,onClick:()=>{e.openForward(e.roomId,e.message)},children:[`↗ `,(0,p.jsx)(`span`,{className:`dsh-chatroom-action-label`,children:`转发`})]}),(o||a!==void 0||e.onBranch!==void 0)&&(0,p.jsxs)(`span`,{className:`dsh-chatroom-inline-reaction-control`,children:[(0,p.jsx)(`button`,{type:`button`,"aria-label":`更多消息操作`,"aria-expanded":r,onClick:()=>{i(e=>!e)},children:`•••`}),r&&(0,p.jsxs)(`span`,{className:`dsh-chatroom-action-overflow`,role:`menu`,"aria-label":`更多消息操作`,onPointerDown:e=>{e.stopPropagation()},children:[o&&(0,p.jsx)(`span`,{className:`dsh-chatroom-inline-reactions`,"aria-label":`贴表情`,children:Di.map(t=>(0,p.jsx)(`button`,{type:`button`,"aria-label":`贴表情 ${t}`,title:`贴表情 ${t}`,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t),i(!1)},children:t},t))}),a!==void 0&&(0,p.jsx)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{c(),i(!1)},children:t?`✓ 已复制`:`▣ 复制`}),o&&(0,p.jsx)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.toggleSelection(e.roomId,e.message),i(!1)},children:e.selected?`✓ 取消选择`:`☑ 多选`})]})]})]})}function Ai({tools:e}){return e.selecting?(0,p.jsxs)(`label`,{className:`dsh-chatroom-selection-checkbox`,title:e.selected?`取消选择`:`选择消息`,children:[(0,p.jsx)(`input`,{type:`checkbox`,"aria-label":`${e.selected?`取消选择`:`选择`} ${e.message.displayName} 的消息`,checked:e.selected,onChange:()=>{e.toggleSelection(e.roomId,e.message)}}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:e.selected?`✓`:``})]}):null}function ji(){let[e,t]=(0,d.useState)();return(0,d.useEffect)(()=>{if(e===void 0)return;let n=()=>{t(void 0)},r=e=>{e.key===`Escape`&&n()};return document.addEventListener(`pointerdown`,n),document.addEventListener(`keydown`,r),()=>{document.removeEventListener(`pointerdown`,n),document.removeEventListener(`keydown`,r)}},[e]),{position:e,open:e=>{e.preventDefault(),e.stopPropagation(),t({x:Math.max(8,Math.min(e.clientX,globalThis.innerWidth-248)),y:Math.max(8,Math.min(e.clientY,globalThis.innerHeight-248))})},close:()=>{t(void 0)}}}function Mi(e){let t=e.reactions.filter(t=>t.messageId===e.message.messageId&&t.participantIds.length>0);return t.length===0?null:(0,p.jsx)(`div`,{className:`dsh-chatroom-reaction-bar`,children:t.map(t=>(0,p.jsxs)(`button`,{type:`button`,"aria-label":`${t.emoji} ${t.participantIds.length}`,"aria-pressed":t.participantIds.includes(e.identity?.participantId??``),disabled:e.identity===void 0,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t.emoji)},children:[(0,p.jsx)(`span`,{children:t.emoji}),(0,p.jsx)(`small`,{children:t.participantIds.length})]},t.emoji))})}function Ni({tools:e,position:t,close:n}){if(t===void 0||e.identity===void 0)return null;let r=e.copyText;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-context-menu`,style:{left:t.x,top:t.y},role:`menu`,onPointerDown:e=>{e.stopPropagation()},children:[(0,p.jsx)(`div`,{className:`dsh-chatroom-context-reactions`,"aria-label":`贴表情`,children:Di.map(t=>(0,p.jsx)(`button`,{type:`button`,title:`贴表情 ${t}`,onClick:()=>{e.toggleReaction(e.roomId,e.message.messageId,t),n()},children:t},t))}),r!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{Oi(r),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`▣`}),` 复制`]}),e.onReply!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.onReply?.(),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↩`}),` 回复`]}),(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.openForward(e.roomId,e.message),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↗`}),` 转发`]}),(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.toggleSelection(e.roomId,e.message),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:e.selected?`✓`:`☑`}),` `,e.selected?`取消选择`:`多选`]}),e.onBranch!==void 0&&(0,p.jsxs)(`button`,{type:`button`,role:`menuitem`,onClick:()=>{e.onBranch?.(),n()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⑂`}),` 分支`]})]})}let Pi=0,Fi=`dsh-chatroom:branch-frame-compatibility`;function Ii(e){let[t,n]=(0,d.useState)(),r=e.room.thread,i=r??t;return(0,d.useEffect)(()=>{r!==void 0&&n(r)},[r]),(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(zi,{toasts:e.room.toasts,dismiss:e.dismissToast}),(0,p.jsx)(de,{...e}),e.room.membersOpen&&(0,p.jsx)(Bi,{...e}),i!==void 0&&(0,p.jsx)(Vi,{...e,thread:i,open:r?.id===i.id}),e.room.selectionRoomId!==void 0&&(0,p.jsx)(Li,{...e}),e.room.forwardOpen&&(0,p.jsx)(Ri,{...e})]})}function Li(e){let t=e.room.selectionRoomId;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-selection-bar`,role:`toolbar`,"aria-label":`消息多选`,children:[(0,p.jsxs)(`strong`,{children:[`已选择 `,e.room.selectedMessages.length,` 条消息`]}),(0,p.jsx)(`button`,{type:`button`,disabled:e.room.selectedMessages.length===0,onClick:()=>{t!==void 0&&e.openForward(t)},children:`合并转发`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.clearMessageSelection,children:`取消`})]})}function Ri(e){let t=e.room.rooms.filter(t=>t.id!==e.room.selectionRoomId);return(0,p.jsx)(`div`,{className:`dsh-chatroom-dialog-layer dsh-chatroom-forward-layer`,"data-testid":`chatroom-forward-dialog`,children:(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-forward-dialog`,"aria-label":`转发到群聊`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭转发`,type:`button`,onClick:e.closeForward,children:`×`}),(0,p.jsx)(`h2`,{children:`转发到群聊`}),(0,p.jsxs)(`p`,{children:[`将选中的 `,e.room.selectedMessages.length,` 条消息合并成一张聊天记录卡片。`]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-targets`,children:[t.map(t=>(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.forwardBusy,onClick:()=>{e.forwardSelected(t.id)},children:[(0,p.jsx)(`span`,{children:`＃`}),(0,p.jsx)(`strong`,{children:t.title}),(0,p.jsxs)(`small`,{children:[`@`,t.aiDisplayName]})]},t.id)),t.length===0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-empty`,children:`请先新建另一个群聊，再进行转发。`})]}),e.room.forwardError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.forwardError})]})})}function zi({toasts:e,dismiss:t}){return e.length===0?null:(0,p.jsx)(`div`,{className:`dsh-chatroom-toast-stack`,role:`status`,"aria-live":`polite`,children:e.map(e=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-toast`,type:`button`,onClick:()=>{t(e.id)},children:[(0,p.jsxs)(`strong`,{children:[e.displayName,` `,(0,p.jsxs)(`small`,{children:[`· `,e.roomTitle,e.threadId===void 0?``:` · 分支`]})]}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})}function Bi(e){let[t,n]=(0,d.useState)(e.room.room?.title??``),[r,i]=(0,d.useState)(``),[a,o]=(0,d.useState)([]),s=e.room.members.find(t=>t.participantId===e.room.identity?.participantId)?.role??`member`,c=s===`owner`||s===`admin`,l=c||e.room.auth.account?.role===`super-admin`,u=r.trim().toLocaleLowerCase(`zh-CN`),f=e.room.memberCandidates.filter(e=>u===``||e.displayName.toLocaleLowerCase(`zh-CN`).includes(u)||e.username.toLocaleLowerCase(`zh-CN`).includes(u));return(0,d.useEffect)(()=>{let t=new Set(e.room.memberCandidates.map(e=>e.participantId));o(e=>e.filter(e=>t.has(e)))},[e.room.memberCandidates]),(0,p.jsxs)(`aside`,{className:`dsh-chatroom-member-card`,"data-testid":`chatroom-members`,"aria-label":`群管理`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭群管理`,type:`button`,onClick:e.closeMembers,children:`×`}),(0,p.jsx)(`h2`,{children:`群管理`}),(0,p.jsxs)(`p`,{children:[e.room.room?.title,` · `,e.room.members.length,` 位成员 · `,e.room.online,` 人在线`]}),l&&(0,p.jsxs)(`section`,{className:`dsh-chatroom-invite`,"aria-label":`添加群成员`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-heading`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`添加成员`}),(0,p.jsx)(`small`,{children:`从系统中尚未加入本群的启用账号里选择。`})]}),(0,p.jsxs)(`span`,{children:[a.length,` 位已选`]})]}),(0,p.jsx)(`input`,{type:`search`,value:r,placeholder:`搜索姓名或账号`,"aria-label":`搜索系统用户`,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-invite-list`,children:[f.map(t=>{let n=a.includes(t.participantId);return(0,p.jsxs)(`label`,{children:[(0,p.jsx)(`input`,{type:`checkbox`,checked:n,disabled:e.room.managementBusy,onChange:()=>{o(e=>n?e.filter(e=>e!==t.participantId):[...e,t.participantId])}}),(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:t.displayName}),(0,p.jsxs)(`small`,{children:[`@`,t.username]})]})]},t.participantId)}),f.length===0&&(0,p.jsx)(`p`,{children:e.room.managementBusy?`正在加载系统用户…`:u===``?`所有启用账号都已在群聊中。`:`没有匹配的系统用户。`})]}),(0,p.jsxs)(`button`,{type:`button`,disabled:e.room.managementBusy||a.length===0,onClick:async()=>{await e.addRoomMembers?.(a)&&o([])},children:[`添加选中的 `,a.length,` 位`]})]}),c&&(0,p.jsxs)(`form`,{className:`dsh-chatroom-manage-title`,onSubmit:n=>{n.preventDefault(),e.renameRoom?.(t)},children:[(0,p.jsx)(`input`,{value:t,maxLength:160,"aria-label":`群聊名称`,onChange:e=>{n(e.target.value)}}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.managementBusy||t.trim()===``||t.trim()===e.room.room?.title,children:`保存名称`})]}),(0,p.jsxs)(`section`,{className:`dsh-chatroom-auto-trigger`,"aria-label":`AI 自动回复`,children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`无需 @AI 自动回复`}),(0,p.jsx)(`small`,{children:`开启后，由设置中选择的判断模型决定普通消息是否需要 AI 回复。群内所有成员都可以修改。`})]}),(0,p.jsxs)(`label`,{className:`dsh-chatroom-switch`,children:[(0,p.jsx)(`input`,{type:`checkbox`,"aria-label":`无需 @AI 自动回复`,checked:e.room.room?.autoTriggerEnabled??!1,disabled:e.room.managementBusy,onChange:t=>{e.setRoomAutoTrigger?.(t.target.checked)}}),(0,p.jsx)(`span`,{"aria-hidden":!0})]})]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-member-list`,children:e.room.members.map(t=>(0,p.jsxs)(`div`,{className:`dsh-chatroom-member`,children:[(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,...t}),(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[t.displayName,` `,(0,p.jsx)(`em`,{children:t.role===`owner`?`群主`:t.role===`admin`?`管理员`:``})]}),(0,p.jsx)(`small`,{children:t.online?`在线`:`最近活跃 ${Zi(t.lastSeenAt)}`})]}),s===`owner`&&t.role!==`owner`?(0,p.jsx)(`button`,{className:`dsh-chatroom-member-role`,type:`button`,disabled:e.room.managementBusy,onClick:()=>{e.setMemberRole?.(t.participantId,t.role===`admin`?`member`:`admin`)},children:t.role===`admin`?`取消管理员`:`设为管理员`}):(0,p.jsx)(`i`,{"data-online":t.online})]},t.participantId))}),e.room.managementError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.managementError}),(0,p.jsx)(`button`,{className:`dsh-chatroom-notification-button`,type:`button`,disabled:e.room.notificationsEnabled,onClick:()=>{e.enableSystemNotifications()},children:e.room.notificationsEnabled?`✓ 系统消息提醒已开启`:`开启系统消息提醒`})]})}function Vi(e){let{thread:t}=e,n=e.room.room?.sessionId,r=(0,d.useRef)(null),i=(0,d.useRef)(),[a]=(0,d.useState)(()=>++Pi),[o,s]=(0,d.useState)(0),[c,l]=(0,d.useState)(-1),[u,f]=(0,d.useState)(!1),[m,h]=(0,d.useState)(qi);n!==void 0&&(i.current===void 0||i.current.parentSessionId!==n||i.current.thread.id!==t.id||i.current.thread.sessionId!==t.sessionId||i.current.thread.roomId!==t.roomId)&&(i.current={thread:t,parentSessionId:n}),(0,d.useLayoutEffect)(()=>{if(n===void 0)return;if(m){ne(n);return}re(t.sessionId),l(o);let e=globalThis.setTimeout(()=>{ne(n)},3e4);return()=>{globalThis.clearTimeout(e),ne(n)}},[o,m,n,t.sessionId]),(0,d.useEffect)(()=>{e.open||n===void 0||ne(n)},[n,e.open]),(0,d.useEffect)(()=>{if(m)return;f(!1);let e=!1,i,a,o=()=>{if(e)return;let o=r.current?.contentWindow;o!=null&&n!==void 0&&ee(o,O(t,n));try{let e=r.current?.contentDocument;if(e==null||!ce(e,t.sessionId,t.root.text))return}catch{return}e=!0,globalThis.clearInterval(i),globalThis.clearTimeout(a),f(!0)},s=e=>{e.origin===globalThis.location.origin&&e.source===r.current?.contentWindow&&Xi(e.data,t.id)&&o()};return globalThis.addEventListener(`message`,s),i=globalThis.setInterval(o,150),a=globalThis.setTimeout(()=>{e||(globalThis.clearInterval(i),n!==void 0&&ne(n),Ji(),h(!0))},8e3),o(),()=>{e=!0,globalThis.removeEventListener(`message`,s),globalThis.clearInterval(i),globalThis.clearTimeout(a)}},[o,m,n,t.id,t.root.text,t.sessionId]);let g=i.current,_=Ki(t.root.text),v=n===void 0?void 0:D(g?.thread??t,g?.parentSessionId??n,`${a}:${o}`);return(0,p.jsxs)(`aside`,{className:`dsh-chatroom-thread-panel`,"data-testid":`chatroom-thread-panel`,"data-open":e.open,"aria-hidden":!e.open,"aria-label":`分支回复`,children:[(0,p.jsxs)(`header`,{children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`strong`,{children:`分支回复`}),(0,p.jsxs)(`small`,{children:[`来自 `,e.room.room?.title??`群聊`,` · `,t.root.displayName,`：`,_]})]}),(0,p.jsx)(`button`,{"aria-label":`关闭分支`,type:`button`,onClick:e.closeThread,children:`×`})]}),n===void 0?(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-frame-error`,children:`无法确定父群聊会话。`}):m?(0,p.jsx)(Hi,{...e,thread:t,frameUrl:v,retry:()=>{i.current={thread:t,parentSessionId:n},Yi(),h(!1),s(e=>e+1)}}):(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-shell`,children:[c===o&&(0,p.jsx)(`iframe`,{className:`dsh-chatroom-thread-frame`,ref:r,title:`分支回复：${_}`,src:v,onLoad:()=>{try{if(r.current?.contentDocument!==null)return}catch{}ne(n),Ji(),h(!0)}},`${a}:${o}`),!u&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-frame-status`,role:`status`,children:[(0,p.jsx)(`span`,{children:o===0?`正在加载分支…`:`正在重新加载分支…`}),(0,p.jsx)(`small`,{children:`正在初始化原生 Harness 分支会话`})]})]}),e.room.threadError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.room.threadError})]})}function Hi(e){let[t,n]=(0,d.useState)(``),[r,i]=(0,d.useState)(),[a,o]=(0,d.useState)(0),s=(0,d.useRef)(null),c=(0,d.useRef)(null),l=(0,d.useMemo)(()=>[...[...new Set([`AI`,e.room.room?.aiDisplayName].filter(e=>e!==void 0))].map(e=>({name:e,description:`提及后在本分支触发 AI`,ai:!0})),...e.room.members.filter(t=>t.participantId!==e.room.identity?.participantId).map(e=>({name:e.displayName,description:e.online?`在线成员`:`群成员`,ai:!1}))].filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t),[e.room.identity?.participantId,e.room.members,e.room.room?.aiDisplayName]),u=r===void 0?[]:l.filter(e=>e.name.toLocaleLowerCase().includes(r.query.toLocaleLowerCase()));(0,d.useEffect)(()=>{typeof s.current?.scrollIntoView==`function`&&s.current.scrollIntoView({block:`end`})},[e.room.threadMessages.length]),(0,d.useEffect)(()=>{o(0)},[r?.query]);let f=(e,t)=>{i(Gi(e,t))},m=e=>{if(r===void 0)return;let a=c.current?.selectionStart??t.length,o=`${t.slice(0,r.start)}@${e} ${t.slice(a)}`,s=r.start+e.length+2;n(o),i(void 0),queueMicrotask(()=>{c.current?.focus(),c.current?.setSelectionRange(s,s)})};return(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-compatibility-notice`,role:`status`,children:[(0,p.jsx)(`span`,{children:`当前访问入口不允许嵌入完整 Agent，已切换到分支兼容模式。`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`a`,{href:e.frameUrl,target:`_blank`,rel:`noreferrer`,children:`在新标签打开完整 Agent`}),(0,p.jsx)(`button`,{type:`button`,onClick:e.retry,children:`重试嵌入`})]})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-root`,children:[(0,p.jsx)(`strong`,{children:e.thread.root.displayName}),(0,p.jsx)(`div`,{children:e.thread.root.role===`ai`?(0,p.jsx)(Ei,{text:e.thread.root.text}):e.thread.root.text})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-messages`,children:[e.room.threadMessages.length===0&&(0,p.jsxs)(`p`,{className:`dsh-chatroom-thread-empty`,children:[`从这里开始分支讨论。输入 `,(0,p.jsx)(`code`,{children:`@AI`}),` 只会在本分支触发 AI。`]}),e.room.threadMessages.map(t=>(0,p.jsx)(Ui,{message:t,roomId:e.thread.roomId,props:e},t.id)),(0,p.jsx)(`div`,{ref:s})]}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-thread-composer`,onSubmit:r=>{r.preventDefault();let i=t.trim();i!==``&&e.sendThreadMessage(i).then(e=>{e&&n(``)})},children:[e.room.threadReply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-composer-reply`,children:[(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.room.threadReply.displayName]}),e.room.threadReply.text]}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`取消引用`,onClick:e.clearThreadReply,children:`×`})]}),(0,p.jsx)(`textarea`,{ref:c,rows:3,placeholder:`回复分支；输入 @AI 让 AI 在本分支回答`,value:t,"aria-expanded":u.length>0,"aria-controls":`dsh-chatroom-thread-mentions`,onChange:e=>{n(e.target.value),f(e.target.value,e.target.selectionStart)},onClick:e=>{f(e.currentTarget.value,e.currentTarget.selectionStart)},onKeyDown:e=>{if(u.length>0){if(e.key===`ArrowDown`||e.key===`ArrowUp`){e.preventDefault();let t=e.key===`ArrowDown`?1:-1;o(e=>(e+t+u.length)%u.length);return}if(e.key===`Escape`){e.preventDefault(),i(void 0);return}if(e.key===`Tab`){e.preventDefault(),m(u[a]?.name??u[0].name);return}}if(!(e.key!==`Enter`||e.shiftKey)){if(u.length>0&&r?.query===``){e.preventDefault(),m(u[a]?.name??u[0].name);return}e.preventDefault(),e.currentTarget.form?.requestSubmit()}}}),u.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-mentions`,id:`dsh-chatroom-thread-mentions`,role:`listbox`,"aria-label":`提及成员`,children:u.map((e,t)=>(0,p.jsxs)(`button`,{type:`button`,role:`option`,"aria-label":e.name,"aria-selected":t===a,"data-active":t===a,onMouseDown:e=>{e.preventDefault()},onClick:()=>{m(e.name)},children:[(0,p.jsx)(`i`,{children:e.ai?`✦`:`●`}),(0,p.jsxs)(`span`,{children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:e.description})]})]},e.name))}),(0,p.jsx)(`button`,{type:`submit`,disabled:e.room.threadBusy||t.trim()===``,children:`发送`})]})]})}function Ui({message:e,roomId:t,props:n}){let r=e.participantId===n.room.identity?.participantId,i=n.room.members.find(t=>t.participantId===e.participantId),a=i?.avatarId??e.avatarId??g(e.participantId),o=i?.avatarUrl??e.avatarUrl,s=e.role===`ai`?{id:`ai`,emoji:`✦`}:_(a,e.participantId),c=Wi(e),l=n.room.identity===void 0?void 0:()=>{n.setThreadReply(c)},u={roomId:t,message:{...c,role:e.role,createdAt:e.createdAt},reactions:n.room.reactions,identity:n.room.identity,selecting:n.room.selectionRoomId===t,selected:n.room.selectionRoomId===t&&n.room.selectedMessages.some(t=>t.messageId===e.id),copyText:e.text,onReply:l,toggleReaction:n.toggleReaction,openForward:n.openForward,toggleSelection:n.toggleMessageSelection},d=ji();return(0,p.jsxs)(`article`,{className:`dsh-chatroom-thread-message`,"data-own":r,"data-role":e.role,"data-dsh-chatroom-selection-mode":u.selecting||void 0,"data-dsh-chatroom-selected":u.selected||void 0,onContextMenu:d.open,children:[(0,p.jsx)(Ai,{tools:u}),e.role===`ai`?(0,p.jsx)(`span`,{className:`dsh-chatroom-member-avatar`,"data-avatar":s.id,"aria-hidden":!0,children:s.emoji}):(0,p.jsx)(M,{className:`dsh-chatroom-member-avatar`,participantId:e.participantId,avatarId:a,...o===void 0?{}:{avatarUrl:o}}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-message-column`,children:[(0,p.jsxs)(`strong`,{children:[e.displayName,(0,p.jsx)(`time`,{children:Qi(e.createdAt)})]}),e.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-thread-reply-quote`,children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.reply.displayName]}),(0,p.jsx)(`span`,{children:e.reply.text})]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-message-body`,children:e.role===`ai`?(0,p.jsx)(Ei,{text:e.text}):(0,p.jsx)(`div`,{className:`dsh-chatroom-thread-literal-text`,children:e.text})}),(0,p.jsx)(Mi,{...u}),(0,p.jsx)(ki,{tools:u})]}),(0,p.jsx)(Ni,{tools:u,position:d.position,close:d.close})]})}function Wi(e){return{messageId:e.id,displayName:e.displayName,text:Ki(e.text,120)}}function Gi(e,t){let n=e.slice(0,t),r=/(?:^|\s)@([^\s@]*)$/u.exec(n);if(r!==null)return{start:n.length-r[1].length-1,query:r[1]}}function Ki(e,t=48){let n=e.replace(/```[\s\S]*?```/gu,` `).replace(/[`*_#>|\[\]]/gu,``).replace(/\s+/gu,` `).trim(),r=[...n];return r.length===0?`分支消息`:r.length<=t?n:`${r.slice(0,t).join(``)}…`}function qi(){try{return globalThis.sessionStorage?.getItem(Fi)===`1`}catch{return!1}}function Ji(){try{globalThis.sessionStorage?.setItem(Fi,`1`)}catch{}}function Yi(){try{globalThis.sessionStorage?.removeItem(Fi)}catch{}}function Xi(e,t){if(typeof e!=`object`||!e||Array.isArray(e))return!1;let n=e;return n.type===`dsh-chatroom-branch-ready`&&n.threadId===t}function Zi(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${t} 分钟前`:t<1440?`${Math.floor(t/60)} 小时前`:`${Math.floor(t/1440)} 天前`}function Qi(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}function $i(e){let t=e.useChatroom(e=>e);if(t.branchFrame!==void 0)return null;let n=(0,p.jsx)(Ii,{room:t,...e});return t.open?(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-dialog-layer`,"data-dsh-chatroom-entry":!0,"data-testid":`chatroom-dialog`,children:[t.phase===`auth-required`&&(0,p.jsx)(ea,{room:t,login:e.login,register:e.register}),t.phase===`identity-required`&&(0,p.jsx)(na,{room:t,join:e.join,close:e.closeRoom}),t.phase===`loading`&&(0,p.jsx)(ia,{title:`正在载入共享会话`,detail:`正在恢复此浏览器的身份与会话目录…`,close:e.closeRoom}),t.phase===`ready`&&t.identity!==void 0&&(0,p.jsx)(ra,{room:t,selectRoom:e.selectRoom,createRoom:e.createRoom,resetIdentity:e.resetIdentity,logout:e.logout,openAccount:e.openAccount,openAdmin:e.openAdmin,openDirect:e.openDirect,close:e.closeRoom}),t.phase===`error`&&(0,p.jsx)(ia,{title:`共享会话暂时不可用`,detail:t.error??`请稍后重试。`,action:`重试`,onAction:e.retry,close:e.closeRoom})]}),n]}):n}function ea({room:e,login:t,register:n}){let r=e.auth.bootstrapRequired||e.auth.allowSelfRegistration,[i,a]=(0,d.useState)(e.auth.bootstrapRequired?`register`:`login`),[o,s]=(0,d.useState)(``),[c,l]=(0,d.useState)(``),[u,f]=(0,d.useState)(``),[h,g]=(0,d.useState)(``),[_,v]=(0,d.useState)(m[0].id),y=typeof location>`u`?`/`:`${location.pathname}${location.search}`,b=e.auth.bootstrapRequired?void 0:e.auth.autoRedirectProvider,x=e.auth.authMode!==`dsh-auth-only`&&typeof location<`u`&&new URLSearchParams(location.search).get(`local`)===`1`;return(0,d.useEffect)(()=>{b===void 0||x||typeof location>`u`||location.assign(ta(b,y))},[b,x,y]),b!==void 0&&!x?(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,role:`status`,children:[(0,p.jsxs)(`h2`,{children:[`正在前往 `,b.label]}),(0,p.jsx)(`p`,{children:`正在打开企业统一登录…`})]}):(0,p.jsxs)(`section`,{className:`dsh-chatroom-card dsh-chatroom-auth-card`,"aria-label":`系统登录`,children:[(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-brand`,children:[(0,p.jsx)(`strong`,{children:`DeepSeek Harness`}),(0,p.jsx)(`span`,{children:`团队协作平台`})]}),(0,p.jsx)(`h2`,{children:i===`login`?`登录`:e.auth.bootstrapRequired?`创建超级管理员`:`注册账号`}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-auth-tabs`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":i===`login`,onClick:()=>{a(`login`)},children:`登录`}),r&&(0,p.jsx)(`button`,{type:`button`,"data-active":i===`register`,onClick:()=>{a(`register`)},children:`注册`})]}),(0,p.jsxs)(`form`,{onSubmit:r=>{r.preventDefault(),i===`login`?t(o,c):n({username:o,password:c,displayName:u,avatarId:_,...e.auth.bootstrapRequired?{bootstrapToken:h}:{}})},children:[(0,p.jsxs)(`label`,{children:[`账号`,(0,p.jsx)(`input`,{autoFocus:!0,autoComplete:`username`,value:o,onChange:e=>{s(e.target.value)}})]}),(0,p.jsxs)(`label`,{children:[`密码`,(0,p.jsx)(`input`,{type:`password`,autoComplete:i===`login`?`current-password`:`new-password`,value:c,onChange:e=>{l(e.target.value)}})]}),i===`register`&&(0,p.jsxs)(p.Fragment,{children:[(0,p.jsxs)(`label`,{children:[`显示名称`,(0,p.jsx)(`input`,{value:u,onChange:e=>{f(e.target.value)}})]}),e.auth.bootstrapRequired&&(0,p.jsxs)(`label`,{children:[`初始化口令`,(0,p.jsx)(`input`,{type:`password`,value:h,onChange:e=>{g(e.target.value)}})]}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===_,type:`button`,role:`radio`,"aria-checked":e.id===_,onClick:()=>{v(e.id)},children:e.emoji},e.id))})]})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`submit`,disabled:o.trim()===``||c===``||i===`register`&&u.trim()===``,children:i===`login`?`登录`:`创建账号`})]}),e.auth.providers.length>0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-sso-list`,children:[(0,p.jsx)(`span`,{children:`或使用企业账号`}),e.auth.providers.map(e=>(0,p.jsxs)(`a`,{href:ta(e,y),children:[`使用 `,e.label,` 登录`]},e.id))]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function ta(e,t){return v(y,e,t)}function na({room:e,join:t,close:n}){let[r,i]=(0,d.useState)(e.identity?.displayName??``),[a,o]=(0,d.useState)(e.identity?.avatarId??m[0].id);return(0,p.jsxs)(`form`,{className:`dsh-chatroom-card`,onSubmit:e=>{e.preventDefault(),t(r,a)},children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:n,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsx)(`p`,{children:`选择你在共享会话中显示的名字和头像。进入后继续使用 Harness 原生对话界面。`}),(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-identity-input`,autoFocus:!0,maxLength:80,placeholder:`你的名字`,value:r,onChange:e=>{i(e.target.value)}}),(0,p.jsxs)(`fieldset`,{className:`dsh-chatroom-avatar-fieldset`,children:[(0,p.jsx)(`legend`,{children:`选择头像`}),(0,p.jsx)(`div`,{className:`dsh-chatroom-avatar-grid`,role:`radiogroup`,"aria-label":`选择头像`,children:m.map(e=>(0,p.jsx)(`button`,{className:`dsh-chatroom-avatar-choice`,"data-avatar":e.id,"data-selected":e.id===a,type:`button`,role:`radio`,"aria-checked":e.id===a,"aria-label":e.label,onClick:()=>{o(e.id)},children:e.emoji},e.id))})]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,"data-testid":`chatroom-join`,type:`submit`,disabled:r.trim()===``,children:`继续`}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function ra({room:e,selectRoom:t,createRoom:n,resetIdentity:r,logout:i,openAccount:a,openAdmin:o,openDirect:s,close:c}){let[l,u]=(0,d.useState)(``);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card dsh-chatroom-room-card`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:c,children:`×`}),(0,p.jsx)(`h2`,{children:`共享会话`}),(0,p.jsxs)(`p`,{children:[`普通消息只在人类之间聊天；输入 `,(0,p.jsx)(`code`,{children:`@AI`}),` 或 `,(0,p.jsxs)(`code`,{children:[`@`,e.rooms[0]?.aiDisplayName??`DeepSeek`]}),` 才会触发 AI 回复。`]}),(0,p.jsx)(`div`,{className:`dsh-chatroom-room-list`,"data-testid":`chatroom-room-list`,children:e.rooms.map(n=>(0,p.jsxs)(`button`,{className:`dsh-chatroom-room-item`,"data-active":n.id===e.room?.id,"data-testid":`chatroom-room-${n.id}`,type:`button`,onClick:()=>{t(n.id)},children:[(0,p.jsx)(`span`,{children:n.title}),(0,p.jsxs)(`small`,{children:[`@`,n.aiDisplayName]})]},n.id))}),(0,p.jsxs)(`form`,{className:`dsh-chatroom-create`,onSubmit:e=>{e.preventDefault(),l.trim()!==``&&n(l)},children:[(0,p.jsx)(`input`,{className:`dsh-chatroom-name`,"data-testid":`chatroom-title-input`,maxLength:160,placeholder:`新共享会话名称`,value:l,onChange:e=>{u(e.target.value)}}),(0,p.jsx)(`button`,{className:`dsh-chatroom-create-button`,"data-testid":`chatroom-create`,type:`submit`,disabled:l.trim()===``,children:`新建`})]}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-card-footer`,children:[(0,p.jsxs)(`span`,{children:[`当前身份：`,e.identity===void 0?``:(0,p.jsxs)(p.Fragment,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.identity.avatarId,avatarUrl:e.identity.avatarUrl,seed:e.identity.participantId}),` `,e.identity.displayName]})]}),(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`button`,{type:`button`,onClick:()=>{s()},children:`私聊`}),e.auth.enabled&&(0,p.jsx)(`button`,{type:`button`,onClick:a,children:`账号设置`}),e.auth.account?.role===`super-admin`&&(0,p.jsx)(`button`,{type:`button`,onClick:()=>{o()},children:`系统管理`}),e.auth.enabled?(0,p.jsx)(`button`,{type:`button`,onClick:()=>{i()},children:`退出登录`}):(0,p.jsx)(`button`,{type:`button`,onClick:()=>{r()},children:`更换身份`})]})]}),e.error!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-error`,role:`alert`,children:e.error})]})}function ia({title:e,detail:t,action:n,onAction:r,close:i}){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-card`,role:`status`,children:[(0,p.jsx)(`button`,{className:`dsh-chatroom-close`,"aria-label":`关闭`,type:`button`,onClick:i,children:`×`}),(0,p.jsx)(`h2`,{children:e}),(0,p.jsx)(`p`,{children:t}),n!==void 0&&(0,p.jsx)(`button`,{className:`dsh-chatroom-button`,type:`button`,onClick:()=>{r?.()},children:n})]})}function aa({preview:e,open:t}){return e===void 0?null:(0,p.jsxs)(`button`,{className:`dsh-chatroom-thread-activity`,type:`button`,"aria-label":`打开分支，${e.totalMessages} 条回复`,disabled:t===void 0,onClick:t,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-thread-activity-heading`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`⑂`}),` 分支 · `,e.totalMessages,` 条回复`]}),(0,p.jsx)(`span`,{className:`dsh-chatroom-thread-activity-list`,children:e.recentMessages.map(e=>(0,p.jsxs)(`span`,{children:[(0,p.jsx)(A,{className:`dsh-chatroom-member-avatar`,avatarId:e.avatarId,avatarUrl:e.avatarUrl,seed:e.participantId}),(0,p.jsx)(`strong`,{children:e.displayName}),(0,p.jsx)(`span`,{children:e.text})]},e.id))})]})}function oa(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>t.sessionId===String(e.sessionId)),r=e.resolveTarget?.(String(e.sessionId))??(n===void 0?void 0:{kind:`room`,room:n}),i=r?.room,a=e.useSession(t=>t.nodes.find(t=>t.kind===`assistant`&&t.messageId===e.messageId)),o=(0,d.useRef)(null),s=ji(),c=t.selectionRoomId===i?.id&&t.selectedMessages.some(t=>t.messageId===String(e.messageId)),l=t.selectionRoomId===i?.id;if((0,d.useEffect)(()=>{let e=o.current?.closest(`[data-time-hover-root]`);if(e==null||i===void 0)return;let t=o.current?.parentElement;for(;t!=null&&t.parentElement!==null&&t.parentElement!==e;)t=t.parentElement;t?.setAttribute(`data-dsh-chatroom-native-actions`,``);let n=e=>{s.open(e)};return e.addEventListener(`contextmenu`,n),e.toggleAttribute(`data-dsh-chatroom-selected`,c),e.toggleAttribute(`data-dsh-chatroom-selection-mode`,l),()=>{e.removeEventListener(`contextmenu`,n),e.removeAttribute(`data-dsh-chatroom-selected`),e.removeAttribute(`data-dsh-chatroom-selection-mode`),t?.removeAttribute(`data-dsh-chatroom-native-actions`)}},[s.open,i,c,l]),i===void 0||a?.kind!==`assistant`)return null;let u=a.blocks.flatMap(e=>e.kind===`text`?[e.text]:[]).join(``).trim().replace(/\s+/gu,` `),f={messageId:String(e.messageId),displayName:i.aiDisplayName,text:[...u||`AI 回复`].slice(0,120).join(``)},m={...f,sourceSessionId:String(e.sessionId),sourceSeq:a.seq,role:`ai`,createdAt:a.time,content:a.blocks.reduce((e,t)=>(t.kind===`text`&&e.push({type:`text`,text:t.text,markdown:!0}),t.kind===`image`&&e.push({type:`image`,image:{...t.attachment,attachmentId:String(t.attachment.attachmentId)}}),e),[])},h={...f,role:`ai`,sourceSessionId:m.sourceSessionId,sourceSeq:m.sourceSeq},g={roomId:i.id,message:m,reactions:t.reactions,identity:t.identity,selecting:l,selected:c,copyText:u||`AI 回复`,onReply:()=>{e.setReply(i.id,f)},onBranch:r?.kind===`thread`?void 0:()=>{e.openThread(i.id,h)},toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection},_=t.threadPreviews.find(e=>e.thread.root.messageId===m.messageId&&e.thread.root.role===`ai`);return(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-tools`,ref:o,children:[(0,p.jsx)(Ai,{tools:g}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-actions`,children:[(0,p.jsx)(Mi,{...g}),(0,p.jsx)(ki,{tools:g})]}),r?.kind!==`thread`&&(0,p.jsx)(aa,{preview:_,open:()=>{e.openThread(i.id,h)}}),(0,p.jsx)(Ni,{tools:g,position:s.position,close:s.close})]})}let sa=new Set([`assistant-step`,`context`,`retry`,`tool-call`]);function ca(e){let t=e.nativeMessageView,n=(0,d.useRef)(null),[r,i]=(0,d.useState)(!1),a=e.node.data.finalNode,o=e.useTurnData(`turn-tail`),s=e.resolveTarget?.(String(e.sessionId))!==void 0&&a!==void 0&&o?.closing?.finalNode.seq===a.seq,c=e.useSession(t=>{if(!s)return``;let n=e.node.data.turn;return t.chat.order.flatMap(r=>{let i=t.chat.nodes.get(r);if(i===void 0||i.key===e.node.key)return[];let a=i.location;return(a.kind===`turn`||a.kind===`step`?a.turn.turn:void 0)===n&&sa.has(i.kind)?[i.key]:[]}).join(`\0`)}),l=(0,d.useMemo)(()=>c===``?[]:c.split(`\0`),[c]),u=s?e.node.data.blocks.filter(e=>e.kind===`reasoning`&&e.text.trim()!==``).length:0,f=l.length+u;return(0,d.useEffect)(()=>{let e=n.current,t=e?.closest(`[data-chat-flow]`);if(e===null||!s)return;let i=new Set(l),a=t==null?[]:[...t.querySelectorAll(`[data-chat-flow-key]`)].filter(e=>i.has(e.dataset.chatFlowKey??``)),o=[...e.querySelectorAll(`[data-variant="think"]`)],c=[...a,...o].map(e=>({row:e,hidden:e.hidden}));for(let{row:e}of c)e.dataset.dshChatroomProcessRow=``,e.hidden=!r;return()=>{for(let{row:e,hidden:t}of c)e.hidden=t,delete e.dataset.dshChatroomProcessRow}},[s,r,l]),(0,p.jsxs)(`div`,{className:`dsh-chatroom-assistant-turn`,ref:n,children:[s&&f>0&&(0,p.jsxs)(`button`,{type:`button`,className:`dsh-chatroom-process-toggle`,"aria-expanded":r,onClick:()=>{i(e=>!e)},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,className:`dsh-chatroom-process-chevron`,children:`⌄`}),(0,p.jsxs)(`span`,{children:[r?`收起执行过程`:`执行过程`,` · `,f,` 项`]})]}),(0,p.jsx)(t,{...e})]})}let la=[`😀`,`😄`,`😂`,`🥰`,`😍`,`🤔`,`😮`,`😭`,`😡`,`👍`,`👏`,`🙏`,`🎉`,`❤️`,`🔥`,`✨`,`✅`,`👀`];function ua(e){e.useChatroom(e=>e);let t=e.resolveTarget(String(e.sessionId))?.room,n=(0,d.useRef)(null),r=(0,d.useRef)(null),[i,a]=(0,d.useState)(!1);return(0,d.useEffect)(()=>{if(!i)return;let e=e=>{r.current?.contains(e.target)||a(!1)};return document.addEventListener(`pointerdown`,e),()=>{document.removeEventListener(`pointerdown`,e)}},[i]),t===void 0?null:(0,p.jsxs)(`div`,{className:`dsh-chatroom-composer-actions`,ref:r,children:[(0,p.jsxs)(`button`,{className:`dsh-chatroom-file-button`,type:`button`,title:`发送表情`,"aria-label":`发送表情`,"aria-expanded":i,onClick:()=>{a(e=>!e)},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`☺`}),(0,p.jsx)(`span`,{children:`表情`})]}),i&&(0,p.jsx)(`div`,{className:`dsh-chatroom-emoji-picker`,role:`dialog`,"aria-label":`选择表情`,children:la.map(t=>(0,p.jsx)(`button`,{type:`button`,"aria-label":`插入 ${t}`,onClick:()=>{e.inputActions.setDraft(`${e.input.draft}${t}`),a(!1)},children:t},t))}),(0,p.jsxs)(`button`,{className:`dsh-chatroom-file-button`,type:`button`,title:`发送图片或文件`,"aria-label":`发送图片或文件`,onClick:()=>{n.current?.click()},children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:`📎`}),(0,p.jsx)(`span`,{children:`附件`})]}),(0,p.jsx)(`input`,{ref:n,className:`dsh-chatroom-file-input`,"data-testid":`chatroom-file-input`,type:`file`,multiple:!0,onChange:n=>{let r=n.currentTarget.files;r!==null&&e.addFiles(t.id,[...r]),n.currentTarget.value=``}})]})}function da(e){let t=e.useChatroom(e=>e),n=e.resolveTarget(String(e.sessionId))?.room;if(n===void 0||t.composerRoomId!==n.id)return null;let r=t.pendingFiles.length>0;if(!r&&t.composerError===void 0)return null;let i=r&&e.input.draft.trim()===``&&e.input.imageIds.length===0;return(0,p.jsxs)(`div`,{className:`dsh-chatroom-composer-dock`,"data-testid":`chatroom-composer-dock`,children:[r&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-pending-files`,children:[t.pendingFiles.map(t=>(0,p.jsxs)(`span`,{className:`dsh-chatroom-pending-file`,children:[(0,p.jsx)(`span`,{"aria-hidden":!0,children:t.file.type.startsWith(`image/`)?`🖼️`:`📎`}),(0,p.jsx)(`span`,{title:t.file.name,children:t.file.name}),(0,p.jsx)(`button`,{type:`button`,"aria-label":`移除 ${t.file.name}`,onClick:()=>{e.removeFile(n.id,t.id)},children:`×`})]},t.id)),i?(0,p.jsx)(`button`,{className:`dsh-chatroom-send-files`,type:`button`,disabled:t.composerBusy,onClick:()=>{e.sendFiles(n.id)},children:t.composerBusy?`正在发送…`:`发送`}):(0,p.jsx)(`small`,{className:`dsh-chatroom-file-hint`,children:`文件将随当前消息发送`})]}),t.composerError!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-composer-error`,role:`alert`,children:t.composerError})]})}function fa(e){let t=e.useChatroom(e=>e),n=e.resolveTarget(String(e.sessionId))?.room?.id,r=e.nativeAttachmentsView,i=n!==void 0&&t.composerRoomId===n?t.reply:void 0;return(0,p.jsxs)(p.Fragment,{children:[i!==void 0&&n!==void 0&&(0,p.jsx)(pa,{reply:i,clear:()=>{e.clearReply(n)}}),(0,p.jsx)(r,{...e})]})}function pa({reply:e,clear:t}){return(0,p.jsxs)(`div`,{className:`dsh-chatroom-reply-preview`,children:[(0,p.jsx)(`button`,{type:`button`,"aria-label":`取消回复`,onClick:t,children:`×`}),(0,p.jsxs)(`span`,{children:[(0,p.jsxs)(`strong`,{children:[`回复 `,e.displayName,`：`]}),(0,p.jsx)(`small`,{children:e.text})]})]})}function ma(e){if(!e.startsWith(`⁣dsh-chatroom:`))return;let t=e.indexOf(`⁣`,14);if(t<0)return;let n=e.slice(14,t),r=n.indexOf(`|`),i=r<0?n:n.slice(0,r);if(i===``)return;let a=r<0?void 0:n.slice(r+1);return{participantId:i,avatarId:h(a)?a:g(i),length:t+1}}function ha(e){if(!e.startsWith(`⁣dsh-chatroom-reply:`))return{text:e};let t=e.indexOf(`⁣`,20);if(t<0)return{text:e};let n=wa(e.slice(20,t));if(!Ta(n))return{text:e};let r=e.slice(t+1),i=xa(n);return r.startsWith(i)&&(r=r.slice(i.length)),{text:r,reply:n}}function ga(e){let t=[],n=e;for(;;){let e=n.indexOf(`⁣dsh-chatroom-file:`);if(e<0)break;let r=n.indexOf(`⁣`,e+19);if(r<0)break;let i=wa(n.slice(e+19,r));if(!Ea(i))break;t.push(i);let a=n.slice(0,e).replace(/\n$/u,``),o=n.slice(r+1),s=Sa(i);o.startsWith(s)&&(o=o.slice(s.length)),n=`${a}${o}`}return{text:n,files:t}}function _a(e){if(!e.startsWith(`⁣dsh-chatroom-forward:`))return{text:e};let t=e.indexOf(`⁣`,22);if(t<0)return{text:e};let n=wa(e.slice(22,t));if(!Da(n))return{text:e};let r=e.slice(t+1),i=Ca(n);return r.startsWith(i)&&(r=r.slice(i.length)),{text:r,forward:n}}function va(e,t){let n=e.filter(e=>e.type===`text`).map(e=>e.text).join(`
`);return ba(t).test(n)}function ya(e){return e.find(e=>e.type===`text`)?.text.trimStart().startsWith(`/`)??!1}function ba(e){let t=e.replace(/[.*+?^${}()|[\]\\]/gu,`\\$&`);return RegExp(`@${t}(?=$|[^\\p{L}\\p{N}_])`,`iu`)}function xa(e){return`回复 ${e.displayName}「${e.text}」\n`}function Sa(e){return`文件：${e.name}`}function Ca(e){let t=e.items.map(e=>`${e.displayName}：${e.text}`);return`合并转发（${e.items.length} 条）\n${t.join(`
`)}`}function wa(e){try{return JSON.parse(decodeURIComponent(e))}catch{return}}function Ta(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.messageId==`string`&&typeof t.displayName==`string`&&typeof t.text==`string`}function Ea(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.id==`string`&&typeof t.name==`string`&&typeof t.mediaType==`string`&&typeof t.bytes==`number`}function Da(e){if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.sourceRoomId!=`string`||typeof t.sourceRoomTitle!=`string`||!Array.isArray(t.items)||t.items.length===0?!1:t.items.every(e=>{if(typeof e!=`object`||!e)return!1;let t=e;return typeof t.messageId==`string`&&(t.role===`human`||t.role===`ai`)&&typeof t.displayName==`string`&&typeof t.text==`string`&&typeof t.createdAt==`number`&&(t.sourceSessionId===void 0||typeof t.sourceSessionId==`string`)&&(t.sourceSeq===void 0||typeof t.sourceSeq==`number`)&&(t.content===void 0||Array.isArray(t.content)&&t.content.every(Oa))&&(t.reply===void 0||Ta(t.reply))&&(t.reactions===void 0||Array.isArray(t.reactions)&&t.reactions.every(e=>typeof e==`object`&&!!e&&typeof e.emoji==`string`&&typeof e.count==`number`))})}function Oa(e){if(typeof e!=`object`||!e)return!1;let t=e;if(t.type===`text`)return typeof t.text==`string`&&typeof t.markdown==`boolean`;if(t.type===`file`)return Ea(t.file);if(t.type!==`image`||t.image===null||typeof t.image!=`object`)return!1;let n=t.image;return typeof n.attachmentId==`string`&&typeof n.mediaType==`string`&&typeof n.bytes==`number`&&typeof n.width==`number`&&typeof n.height==`number`}function ka(e,t,n=[]){let r=!1,i=!1,a,o,s,c,l,u,d=[],f=[],p=[];for(let m of e.data.content){if(m.type!==`text`){p.push(m);continue}let e=m.text;if(!i){i=!0;let d=ma(e);e=d===void 0?e:e.slice(d.length);let f=/^([^：]{1,80})：/.exec(e);a=f?.[1],r=t!==void 0&&(d===void 0?a===t.displayName:d.participantId===t.participantId),o=d?.avatarId??g(a??d?.participantId??`participant`),s=d?.participantId;let p=n.find(e=>e.participantId===s);o=p?.avatarId??o,c=p?.avatarUrl,f!==null&&(e=e.slice(f[0].length));let m=ha(e);e=m.text,l=m.reply;let h=_a(e);e=h.text,u=h.forward}let h=ga(e);e=h.text,d.push(...h.files),e.trim()!==``&&f.push(e.trim()),e.trim()!==``&&p.push(e===m.text?m:{...m,text:e})}if((d.length>0||p.some(e=>e.type===`image`))&&f.length===1&&Aa(f[0])){f.length=0;for(let e=p.length-1;e>=0;--e){let t=p[e];t?.type===`text`&&Aa(t.text.trim())&&p.splice(e,1)}}return{node:i?{...e,data:{...e.data,content:p}}:e,own:r,avatarId:o??g(t?.participantId??`participant`),...s===void 0?{}:{participantId:s},files:d,text:f.join(`
`),...a===void 0?{}:{displayName:a},...c===void 0?t!==void 0&&r&&t.avatarUrl!==void 0?{avatarUrl:t.avatarUrl}:{}:{avatarUrl:c},...l===void 0?{}:{reply:l},...u===void 0?{}:{forward:u}}}function Aa(e){return e===`发送了文件。`||e===`发送了一张图片。`}let ja=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=ka(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=(0,p.jsx)(n,{...e,node:o.node}),c=i.room,l=La(String(e.sessionId),e.node,o),u=za(l),d=Ra(l),f=t.identity===void 0?void 0:()=>{e.setReply(c.id,u)},m=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(c.id,d)},h=Ba(e,t,c.id,l,l.text,f,m),g=Va(t.threadPreviews,l.messageId,`human`);return(0,p.jsx)(Na,{native:s,projection:o,tools:h,threadPreview:g,onReply:f,onThread:m})}),Ma=(0,d.memo)(function(e){let t=e.useChatroom(e=>e),n=e.nativeMessageView,r=t.rooms.find(t=>String(e.sessionId)===t.sessionId),i=e.resolveTarget?.(String(e.sessionId))??(r===void 0?void 0:{kind:`room`,room:r});if(i===void 0)return(0,p.jsx)(n,{...e});let a=ka(e.node,t.identity),o={...a,...t.members.find(e=>e.participantId===a.participantId)?.avatarUrl===void 0?{}:{avatarUrl:t.members.find(e=>e.participantId===a.participantId)?.avatarUrl}},s=(0,p.jsx)(n,{...e,node:o.node}),c=i.room,l=La(String(e.sessionId),e.node,o),u=za(l),d=Ra(l),f=t.identity===void 0?void 0:()=>{e.setReply(c.id,u)},m=t.identity===void 0||i.kind===`thread`?void 0:()=>{e.openThread(c.id,d)},h=Ba(e,t,c.id,l,l.text,f,m),g=Va(t.threadPreviews,l.messageId,`human`);return(0,p.jsx)(Na,{native:s,projection:o,tools:h,threadPreview:g,onReply:f,onThread:m})});function Na({native:e,projection:t,tools:n,threadPreview:r,onReply:i,onThread:a}){let o=ji();return(0,p.jsxs)(`div`,{className:`dsh-chatroom-participant-message`,"data-dsh-chatroom-own":t.own,"data-dsh-chatroom-selection-mode":n.selecting||void 0,"data-dsh-chatroom-selected":n.selected||void 0,onContextMenu:o.open,children:[(0,p.jsx)(Ai,{tools:n}),(0,p.jsx)(A,{avatarId:t.avatarId,avatarUrl:t.avatarUrl,seed:t.participantId??t.displayName??``}),(0,p.jsxs)(`div`,{className:`dsh-chatroom-message-column`,children:[t.displayName!==void 0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-display-name`,children:t.displayName}),t.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-reply-quote`,children:[(0,p.jsxs)(`strong`,{children:[`回复 `,t.reply.displayName]}),(0,p.jsx)(`span`,{children:t.reply.text})]}),t.node.data.content.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-native-message`,children:e}),t.files.map(e=>(0,p.jsx)(Pa,{file:e},e.id)),t.forward!==void 0&&(0,p.jsx)(Fa,{forward:t.forward}),(0,p.jsx)(Mi,{...n}),(0,p.jsx)(aa,{preview:r,open:a}),(0,p.jsx)(ki,{tools:n})]}),(0,p.jsx)(Ni,{tools:n,position:o.position,close:o.close})]})}function Pa({file:e}){return(0,p.jsxs)(`a`,{className:`dsh-chatroom-file-card`,href:`${y}/files/${encodeURIComponent(e.id)}`,download:e.name,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-file-icon`,"aria-hidden":!0,children:`📎`}),(0,p.jsxs)(`span`,{className:`dsh-chatroom-file-copy`,children:[(0,p.jsx)(`strong`,{children:e.name}),(0,p.jsx)(`small`,{children:Ua(e.bytes)})]}),(0,p.jsx)(`span`,{"aria-hidden":!0,children:`↓`})]})}function Fa({forward:e,depth:t=0}){return(0,p.jsxs)(`details`,{className:`dsh-chatroom-forward-card`,children:[(0,p.jsxs)(`summary`,{children:[(0,p.jsxs)(`strong`,{children:[`合并转发 · `,e.items.length,` 条消息`]}),(0,p.jsxs)(`small`,{children:[`来自 `,e.sourceRoomTitle]})]}),(0,p.jsx)(`div`,{children:e.items.map(n=>(0,p.jsxs)(`article`,{children:[(0,p.jsxs)(`strong`,{children:[n.displayName,(0,p.jsx)(`time`,{children:Ha(n.createdAt)})]}),n.reply!==void 0&&(0,p.jsxs)(`div`,{className:`dsh-chatroom-forward-reply`,children:[(0,p.jsxs)(`b`,{children:[`回复 `,n.reply.displayName]}),(0,p.jsx)(`span`,{children:n.reply.text})]}),(n.content??[{type:`text`,text:n.text,markdown:n.role===`ai`}]).map((t,r)=>{if(t.type===`text`)return t.markdown?(0,p.jsx)(Ei,{text:t.text},r):(0,p.jsx)(`p`,{className:`dsh-chatroom-forward-text`,children:t.text},r);if(t.type===`file`)return(0,p.jsx)(Pa,{file:t.file},`${t.file.id}:${r}`);let i=Ia(e.sourceRoomId,n,t.image);return i===void 0?(0,p.jsx)(`span`,{className:`dsh-chatroom-forward-image-error`,children:`图片来源不可用`},`${t.image.attachmentId}:${r}`):(0,p.jsx)(`img`,{className:`dsh-chatroom-forward-image`,src:i,alt:t.image.name??`转发图片`},`${t.image.attachmentId}:${r}`)}),n.forward!==void 0&&t<1&&(0,p.jsx)(Fa,{forward:n.forward,depth:t+1}),n.reactions!==void 0&&n.reactions.length>0&&(0,p.jsx)(`div`,{className:`dsh-chatroom-forward-reactions`,children:n.reactions.map(e=>(0,p.jsxs)(`span`,{children:[e.emoji,` `,e.count]},e.emoji))})]},n.messageId))})]})}function Ia(e,t,n){if(t.sourceSessionId!==void 0&&t.sourceSeq!==void 0)return`${y}/images/${encodeURIComponent(JSON.stringify({sourceRoomId:e,sourceSessionId:t.sourceSessionId,sourceSeq:t.sourceSeq,image:n}))}`}function La(e,t,n){let r=n.files.length===0?``:n.files.map(e=>e.name).join(`、`),i=n.forward===void 0?``:`合并转发 ${n.forward.items.length} 条消息`,a=(n.text.trim()||r||i||`图片消息`).replace(/\s+/gu,` `);return{messageId:`${t.kind}:${t.data.seq}`,sourceSessionId:e,sourceSeq:t.data.seq,role:`human`,displayName:n.displayName??`参与者`,text:[...a].slice(0,120).join(``),createdAt:t.data.time,content:[...n.text.trim()===``?[]:[{type:`text`,text:n.text,markdown:!1}],...n.node.data.content.flatMap(e=>e.type===`image`?[{type:`image`,image:{...e.attachment,attachmentId:String(e.attachment.attachmentId)}}]:[]),...n.files.map(e=>({type:`file`,file:e}))],...n.reply===void 0?{}:{reply:n.reply},...n.forward===void 0?{}:{forward:n.forward}}}function Ra(e){if(e.sourceSessionId===void 0||e.sourceSeq===void 0)throw Error(`chatroom branch target lost its source coordinates`);return{messageId:e.messageId,displayName:e.displayName,text:e.text,role:e.role,sourceSessionId:e.sourceSessionId,sourceSeq:e.sourceSeq}}function za(e){return{messageId:e.messageId,displayName:e.displayName,text:e.text}}function Ba(e,t,n,r,i,a,o){return{roomId:n,message:r,reactions:t.reactions,identity:t.identity,selecting:t.selectionRoomId===n,selected:t.selectionRoomId===n&&t.selectedMessages.some(e=>e.messageId===r.messageId),copyText:i,onReply:a,onBranch:o,toggleReaction:e.toggleReaction,openForward:e.openForward,toggleSelection:e.toggleMessageSelection}}function Va(e,t,n){return e.find(e=>e.thread.root.messageId===t&&e.thread.root.role===n)}function Ha(e){return new Date(e).toLocaleTimeString([],{hour:`2-digit`,minute:`2-digit`})}function Ua(e){return e<1024?`${e} B`:e<1048576?`${(e/1024).toFixed(1)} KB`:`${(e/1048576).toFixed(1)} MB`}function Wa(e,t){let n=e.displayName.trim(),r=n.localeCompare(`AI`,void 0,{sensitivity:`accent`})===0||n.localeCompare(`DeepSeek`,void 0,{sensitivity:`accent`})===0,i=t.some(t=>t.participantId!==e.participantId&&t.displayName.trim().localeCompare(n,void 0,{sensitivity:`accent`})===0);return n===``||r||i?e.username:n}var Ga=class{openSession;snapshot={branchFrame:void 0,open:!1,phase:`loading`,connection:`offline`,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1},online:0,members:[],memberCandidates:[],reactions:[],threadPreviews:[],membersOpen:!1,managementBusy:!1,managementError:void 0,error:void 0,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0,thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0,unreadCount:0,toasts:[],notificationsEnabled:Za()===`granted`,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0,accountOpen:!1,accountBusy:!1,accountError:void 0,adminOpen:!1,adminBusy:!1,adminOverview:void 0,adminError:void 0,automationBusy:!1,automationOverview:void 0,automationError:void 0,directOpen:!1,directBusy:!1,directPeers:[],directConversations:[],directConversation:void 0,directMessages:[],directError:void 0,newSessionModes:{}};listeners=new Set;eventSource;notificationSource;pendingOpenRoomId;identityPromptedRoomId;stopped=!1;compositionRevision=0;pendingFileSequence=0;originalTitle;activeNativeSession;roomEnsure;constructor(e=()=>!1,t){this.openSession=e,t!==void 0&&(this.snapshot={...this.snapshot,branchFrame:t})}getSnapshot=()=>this.snapshot;roomForSession(e){let t=this.snapshot.rooms.find(t=>t.sessionId===e);if(t!==void 0)return t;let n=this.snapshot.branchFrame;return n?.sessionId===e?this.snapshot.rooms.find(e=>e.id===n.roomId):void 0}agentTargetForSession(e){let t=this.roomForSession(e);if(t===void 0)return;let n=this.snapshot.branchFrame;return n?.sessionId===e?{kind:`thread`,room:t,threadId:n.threadId}:{kind:`room`,room:t}}registerNewSession=e=>{this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:`group`}})};newSessionMode=e=>this.snapshot.newSessionModes[e];chooseNewSessionMode=async(e,t)=>this.snapshot.newSessionModes[e]!==void 0&&(this.set({newSessionModes:{...this.snapshot.newSessionModes,[e]:t},error:void 0}),!0);ensurePromptTarget=async e=>{let t=this.agentTargetForSession(e);return t!==void 0||this.snapshot.newSessionModes[e]!==`group`||this.activeNativeSession?.id!==e?t:(await this.ensureActiveSessionRoom(),this.agentTargetForSession(e))};newGroupInvitees=e=>{let t=this.snapshot.directPeers.filter(e=>e.participantId!==this.snapshot.identity?.participantId);return t.filter(n=>{let r=Wa(n,t);return va(e,r)||r!==n.username&&va(e,n.username)}).map(e=>e.participantId)};switchBranchFrame(e){let t=this.snapshot.branchFrame;(t?.threadId!==e.threadId||t.sessionId!==e.sessionId||t.roomId!==e.roomId||t.parentSessionId!==e.parentSessionId)&&(this.compositionRevision+=1,this.set({branchFrame:e,composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0}))}subscribe=e=>(this.listeners.add(e),()=>{this.listeners.delete(e)});async start(){this.stopped=!1,typeof document<`u`&&(this.originalTitle=document.title),await this.loadSession()}stop(){this.stopped=!0,this.closeEvents(),this.closeNotifications(),this.updateActiveDocumentRoom(!1),this.updateDocumentTitle(0),this.listeners.clear()}openRoom=()=>{this.set({open:!0,error:void 0})};login=async(e,t)=>{this.set({phase:`loading`,error:void 0});try{let n=await io(`${y}/auth/login`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({username:e,password:t})});return this.acceptSession(n),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:so(e)}),!1}};register=async e=>{this.set({phase:`loading`,error:void 0});try{let t=await io(`${y}/auth/register`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)});return this.acceptSession(t),!0}catch(e){return this.set({phase:`auth-required`,open:!0,error:so(e)}),!1}};logout=async()=>{try{await ao(`${y}/auth/logout`,{method:`POST`})}finally{this.closeEvents(),this.closeNotifications();let e=this.snapshot.auth;this.set({phase:`auth-required`,open:!0,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:{enabled:e.enabled,authenticated:!1,providers:e.providers,allowSelfRegistration:e.allowSelfRegistration,bootstrapRequired:e.bootstrapRequired},accountOpen:!1,accountError:void 0,adminOpen:!1,adminOverview:void 0,directOpen:!1,directConversation:void 0,directMessages:[]})}};openAccount=()=>{!this.snapshot.auth.enabled||!this.snapshot.auth.authenticated||this.set({accountOpen:!0,accountBusy:!1,accountError:void 0,adminOpen:!1,directOpen:!1})};closeAccount=()=>{this.set({accountOpen:!1,accountBusy:!1,accountError:void 0})};changePassword=async(e,t)=>{this.set({accountBusy:!0,accountError:void 0});try{let n=await io(`${y}/account`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({action:`change-password`,currentPassword:e,newPassword:t})});return this.set({accountOpen:!1,accountBusy:!1,accountError:void 0,auth:{...this.snapshot.auth,account:n.account},identity:n.account}),!0}catch(e){return this.set({accountBusy:!1,accountError:so(e)}),!1}};openAdmin=async()=>{if(this.snapshot.auth.account?.role===`super-admin`){this.set({adminOpen:!0,adminBusy:!0,adminError:void 0,directOpen:!1,accountOpen:!1});try{let e=await io(`${y}/admin`);this.set({adminBusy:!1,adminOverview:e})}catch(e){this.set({adminBusy:!1,adminError:so(e)})}}};closeAdmin=()=>{this.set({adminOpen:!1,adminError:void 0})};loadAutomation=async()=>{if(!this.snapshot.automationBusy){this.set({automationBusy:!0,automationError:void 0});try{let e=await io(`${y}/automation`);this.set({automationBusy:!1,automationOverview:e})}catch(e){this.set({automationBusy:!1,automationError:so(e)})}}};saveAutomation=async(e,t,n,r)=>{if(this.snapshot.automationBusy)return!1;this.set({automationBusy:!0,automationError:void 0});try{let i=await io(`${y}/automation`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({provider:e,model:t,mainAgentPrompt:n,controllerPrompt:r})});return this.set({automationBusy:!1,automationOverview:i}),!0}catch(e){return this.set({automationBusy:!1,automationError:so(e)}),!1}};adminCreateUser=async e=>this.adminMutation({action:`create-user`,...e});adminUpdateUser=async(e,t)=>this.adminMutation({action:`update-user`,userId:e,...t});adminSetSelfRegistration=async e=>this.adminMutation({action:`settings`,allowSelfRegistration:e});adminSetAutoRedirectProvider=async e=>this.adminMutation({action:`settings`,autoRedirectProviderId:e??null});adminSaveProvider=async e=>this.adminMutation({action:`save-provider`,...e});adminDeleteProvider=async e=>this.adminMutation({action:`delete-provider`,providerId:e});openDirect=async e=>{this.set({directOpen:!0,directBusy:!0,directError:void 0,adminOpen:!1,accountOpen:!1});try{let t=e===void 0?await io(`${y}/direct`):await io(`${y}/direct`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({peerId:e})});this.set({directBusy:!1,directPeers:t.peers,directConversations:t.conversations,directConversation:t.conversation,directMessages:t.messages??[]})}catch(e){this.set({directBusy:!1,directError:so(e)})}};loadDirectDirectory=async()=>{if(this.snapshot.phase!==`ready`||this.snapshot.identity===void 0)return!1;try{let e=await io(`${y}/direct`);return this.set({directPeers:e.peers,directConversations:e.conversations,directError:void 0}),!0}catch(e){return this.set({directError:so(e)}),!1}};closeDirect=()=>{this.set({directOpen:!1,directError:void 0})};sendDirect=async(e,t=[])=>{let n=this.snapshot.directConversation;if(n===void 0||e.trim()===``&&t.length===0||this.snapshot.directBusy)return!1;this.set({directBusy:!0,directError:void 0});try{let r=await no(t),i=[...e.trim()===``?[]:[{type:`text`,text:e}],...r],a=await io(`${y}/direct/messages`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({conversationId:n.id,content:i})}),o=this.snapshot.directMessages.some(e=>e.id===a.message.id)?this.snapshot.directMessages:[...this.snapshot.directMessages,a.message];return this.set({directBusy:!1,directConversation:a.conversation,directMessages:o,directConversations:Xa(this.snapshot.directConversations,a.conversation)}),!0}catch(e){return this.set({directBusy:!1,directError:so(e)}),!1}};openMembers=()=>{if(this.snapshot.room===void 0)return;this.set({membersOpen:!0,memberCandidates:[],thread:void 0,threadMessages:[],threadReply:void 0,threadError:void 0});let e=this.snapshot.members.find(e=>e.participantId===this.snapshot.identity?.participantId)?.role;(e===`owner`||e===`admin`||this.snapshot.auth.account?.role===`super-admin`)&&this.loadRoomMemberCandidates()};loadRoomMemberCandidates=async()=>{let e=this.snapshot.room;if(!(e===void 0||this.snapshot.managementBusy)){this.set({managementBusy:!0,managementError:void 0});try{let t=await io(`${y}/rooms/manage?roomId=${encodeURIComponent(e.id)}`);this.snapshot.room?.id===e.id&&this.applyRoomManagement(t)}catch(e){this.set({managementBusy:!1,managementError:so(e)})}}};completeGroupSetup=async(e,t)=>{let n=this.snapshot.room;return n===void 0||e.trim()===``||t.length===0||e.trim()!==n.title&&!await this.renameRoom(e)?!1:await this.addRoomMembers(t)};closeMembers=()=>{this.set({membersOpen:!1,memberCandidates:[],managementError:void 0})};addRoomMembers=async e=>{let t=this.snapshot.room;if(t===void 0||e.length===0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await io(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`add-members`,participantIds:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:so(e)}),!1}};setRoomPinned=async(e,t)=>{try{let n=await io(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,action:`set-pinned`,pinned:t})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementError:so(e)}),!1}};setRoomAutoTrigger=async e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await io(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`set-auto-trigger`,enabled:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:so(e)}),!1}};renameRoom=async e=>{let t=this.snapshot.room;if(t===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let n=await io(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:t.id,action:`rename`,title:e})});return this.applyRoomManagement(n),!0}catch(e){return this.set({managementBusy:!1,managementError:so(e)}),!1}};setMemberRole=async(e,t)=>{let n=this.snapshot.room;if(n===void 0||this.snapshot.managementBusy)return!1;this.set({managementBusy:!0,managementError:void 0});try{let r=await io(`${y}/rooms/manage`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:n.id,action:`set-role`,participantId:e,role:t})});return this.applyRoomManagement(r),!0}catch(e){return this.set({managementBusy:!1,managementError:so(e)}),!1}};closeRoom=()=>{this.set(this.snapshot.phase===`identity-required`&&this.snapshot.identity!==void 0?{open:!1,phase:`ready`,error:void 0}:{open:!1})};resumeOpen=()=>{let e=this.pendingOpenRoomId;if(e===void 0)return;let t=this.snapshot.rooms.find(t=>t.id===e);t===void 0||!this.openSession(t.sessionId)||(this.pendingOpenRoomId=void 0,this.set({open:!1,error:void 0}))};activateSession=(e,t=`新会话`,n=!0)=>{this.activeNativeSession=e===void 0?void 0:{id:e,title:t,shareable:n};let r=e===void 0?void 0:this.roomForSession(e);if(r===void 0){this.closeEvents(),this.identityPromptedRoomId=void 0,this.updateActiveDocumentRoom(!1),this.set({room:void 0,roomEnsureSessionId:this.roomEnsure?.sessionId===e?e:void 0,connection:`offline`,online:0,members:[],memberCandidates:[],reactions:[],threadPreviews:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0});return}this.updateActiveDocumentRoom(!0),this.snapshot.identity===void 0&&this.identityPromptedRoomId!==r.id&&(this.identityPromptedRoomId=r.id,this.set({open:!0})),(this.snapshot.room?.id!==r.id||this.eventSource===void 0)&&(this.set({room:r,roomEnsureSessionId:void 0,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],threadPreviews:[],membersOpen:!1,thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,directOpen:!1,directError:void 0}),this.clearUnread(),this.openEvents(r))};join=async(e,t)=>{let n=this.snapshot.room,r=this.snapshot.connection,i=this.snapshot.online;this.set({phase:`loading`,error:void 0});try{let a=await io(`${y}/session`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({displayName:e,avatarId:t})});if(a.identity===null)throw Error(`服务端没有返回聊天室身份。`);let o=n===void 0?void 0:a.rooms.find(e=>e.id===n.id);this.set({phase:`ready`,open:!1,rooms:a.rooms,room:o,identity:a.identity,connection:o===void 0?`offline`:r,online:o===void 0?0:i,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.set({phase:`identity-required`,error:so(e)})}};addFiles=(e,t)=>{if(t.length===0)return;let n=this.compositionFor(e),r=t.map(e=>({id:`file-${++this.pendingFileSequence}`,file:e}));this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:[...n.files,...r],reply:n.reply,composerError:void 0})};removeFile=(e,t)=>{if(this.snapshot.composerRoomId!==e)return;let n=this.snapshot.pendingFiles.filter(e=>e.id!==t);n.length!==this.snapshot.pendingFiles.length&&(this.compositionRevision+=1,this.set({pendingFiles:n,composerError:void 0}))};setReply=(e,t)=>{let n=this.compositionFor(e);this.compositionRevision+=1,this.set({composerRoomId:e,pendingFiles:n.files,reply:t,composerError:void 0})};clearReply=e=>{this.snapshot.composerRoomId===e&&this.snapshot.reply!==void 0&&(this.compositionRevision+=1,this.set({reply:void 0,composerError:void 0}))};toggleReaction=async(e,t,n)=>{try{let r=await io(`${y}/reactions/toggle`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,messageId:t,emoji:n})});this.replaceReaction(r)}catch(e){this.set({composerError:so(e)})}};toggleMessageSelection=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=n.some(e=>e.messageId===t.messageId)?n.filter(e=>e.messageId!==t.messageId):[...n,t];this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!1,forwardError:void 0})};openForward=(e,t)=>{let n=this.snapshot.selectionRoomId===e?this.snapshot.selectedMessages:[],r=t===void 0||n.some(e=>e.messageId===t.messageId)?n:[t];r.length!==0&&this.set({selectionRoomId:e,selectedMessages:r,forwardOpen:!0,forwardError:void 0})};clearMessageSelection=()=>{this.set({selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,forwardBusy:!1,forwardError:void 0})};closeForward=()=>{this.set({forwardOpen:!1,forwardError:void 0})};forwardSelected=async e=>{let t=this.snapshot.selectionRoomId;if(t===void 0||this.snapshot.selectedMessages.length===0||this.snapshot.forwardBusy)return!1;this.set({forwardBusy:!0,forwardError:void 0});try{return await io(`${y}/forward`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sourceRoomId:t,targetRoomId:e,messages:this.snapshot.selectedMessages})}),this.clearMessageSelection(),!0}catch(e){return this.set({forwardBusy:!1,forwardError:so(e)}),!1}};composition=e=>{let t=this.compositionFor(e);return{roomId:e,revision:this.compositionRevision,files:t.files,reply:t.reply}};completeComposition=e=>{if(this.snapshot.composerRoomId!==e.roomId||this.compositionRevision!==e.revision){this.snapshot.composerBusy&&this.set({composerBusy:!1});return}this.compositionRevision+=1,this.set({composerRoomId:void 0,pendingFiles:[],reply:void 0,composerBusy:!1,composerError:void 0})};sendFiles=async e=>{let t=this.composition(e);if(!(t.files.length===0||this.snapshot.composerBusy)){this.set({composerBusy:!0,composerError:void 0});try{let n=await to(t.files),r=this.snapshot.branchFrame;r?.roomId===e?await eo({threadId:r.threadId,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}):await $a({roomId:e,mode:`queue`,content:n,...t.reply===void 0?{}:{reply:t.reply}}),this.completeComposition(t)}catch(e){this.set({composerBusy:!1,composerError:so(e)})}}};selectRoom=async e=>{this.set({error:void 0});try{let t=await io(`${y}/rooms/select`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:so(e)})}};createRoom=async e=>{this.set({error:void 0});try{let t=await io(`${y}/rooms`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({title:e})});this.selectAndOpen(t.room)}catch(e){this.set({phase:`ready`,error:so(e)})}};openThread=async(e,t)=>{this.set({membersOpen:!1,threadReply:void 0,threadBusy:!0,threadError:void 0});try{let n=await io(`${y}/threads/open`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({roomId:e,root:t})});this.set({thread:n.thread,threadMessages:n.messages,...n.messages.length===0?{}:{threadPreviews:Ka(this.snapshot.threadPreviews,{thread:n.thread,totalMessages:n.messages.length,recentMessages:n.messages.slice(-3)})},threadBusy:!1,threadError:void 0}),this.clearUnread()}catch(e){this.set({threadBusy:!1,threadError:so(e)})}};closeThread=()=>{this.set({thread:void 0,threadMessages:[],threadReply:void 0,threadBusy:!1,threadError:void 0})};setThreadReply=e=>{this.snapshot.thread!==void 0&&this.set({threadReply:e,threadError:void 0})};clearThreadReply=()=>{this.snapshot.threadReply!==void 0&&this.set({threadReply:void 0,threadError:void 0})};sendThreadMessage=async e=>{let t=this.snapshot.thread,n=this.snapshot.threadReply;if(t===void 0||this.snapshot.threadBusy||e.trim()===``)return!1;this.set({threadBusy:!0,threadError:void 0});try{return await io(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({threadId:t.id,mode:`queue`,content:[{type:`text`,text:e}],...n===void 0?{}:{reply:n}})}),this.set({threadReply:void 0,threadBusy:!1,threadError:void 0}),!0}catch(e){return this.set({threadBusy:!1,threadError:so(e)}),!1}};enableSystemNotifications=async()=>{if(typeof Notification>`u`)return;let e=await Notification.requestPermission();this.set({notificationsEnabled:e===`granted`})};dismissToast=e=>{this.set({toasts:this.snapshot.toasts.filter(t=>t.id!==e)})};resetIdentity=async()=>{this.set({open:!0,phase:`identity-required`,error:void 0})};retry=async()=>{this.set({phase:`loading`,error:void 0}),await this.loadSession()};async adminMutation(e){if(this.snapshot.adminBusy)return!1;this.set({adminBusy:!0,adminError:void 0});try{let t=await io(`${y}/admin`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e)}),n=`overview`in t?t.overview:t;return this.set({adminBusy:!1,adminOverview:n}),!0}catch(e){return this.set({adminBusy:!1,adminError:so(e)}),!1}}acceptSession(e){if(e.identity===null)throw Error(`服务端没有返回登录账号。`);this.set({phase:`ready`,open:!1,connection:`offline`,rooms:e.rooms,identity:e.identity,auth:Qa(e),error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}async ensureActiveSessionRoom(){let e=this.activeNativeSession;if(e===void 0||!e.shareable||this.snapshot.phase!==`ready`||this.snapshot.identity===void 0||this.snapshot.newSessionModes[e.id]!==`group`||this.roomForSession(e.id)!==void 0)return;if(this.roomEnsure?.sessionId===e.id)return await this.roomEnsure.promise;let t=(async()=>{this.set({roomEnsureSessionId:e.id,error:void 0});try{let t=await io(`${y}/rooms/ensure`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify({sessionId:e.id,title:e.title})}),n=this.snapshot.rooms.some(e=>e.id===t.room.id)?this.snapshot.rooms.map(e=>e.id===t.room.id?t.room:e):[...this.snapshot.rooms,t.room];this.set({rooms:n,error:void 0}),this.activeNativeSession?.id===e.id&&this.activateSession(e.id,e.title,e.shareable)}catch(t){this.activeNativeSession?.id===e.id&&this.set({roomEnsureSessionId:void 0,error:so(t)})}})();this.roomEnsure={sessionId:e.id,promise:t};try{await t}finally{this.roomEnsure?.promise===t&&(this.roomEnsure=void 0)}}selectAndOpen(e){let t=this.snapshot.rooms.some(t=>t.id===e.id)?this.snapshot.rooms.map(t=>t.id===e.id?e:t):[...this.snapshot.rooms,e];this.pendingOpenRoomId=e.id,this.set({phase:`ready`,rooms:t,room:e,connection:`connecting`,online:0,members:[],memberCandidates:[],reactions:[],threadPreviews:[],thread:void 0,threadMessages:[],threadReply:void 0,selectionRoomId:void 0,selectedMessages:[],forwardOpen:!1,error:void 0}),this.openEvents(e),this.resumeOpen()}compositionFor(e){return this.snapshot.composerRoomId===e?{files:this.snapshot.pendingFiles,reply:this.snapshot.reply}:{files:[],reply:void 0}}async loadSession(){try{let e=await io(`${y}/session`);if(this.stopped)return;let t=Qa(e);if(t.enabled&&!t.authenticated){this.closeEvents(),this.closeNotifications(),this.set({phase:`auth-required`,open:!0,connection:`offline`,rooms:[],room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}if(e.identity===null){this.closeEvents(),this.set({phase:`identity-required`,open:!0,connection:`offline`,rooms:e.rooms,room:void 0,roomEnsureSessionId:void 0,identity:void 0,auth:t,online:0,error:void 0});return}this.set({phase:`ready`,connection:`offline`,rooms:e.rooms,identity:e.identity,auth:t,error:void 0}),this.openNotifications(),this.ensureActiveSessionRoom()}catch(e){this.stopped||this.set({phase:`error`,connection:`offline`,error:so(e)})}}openEvents(e){if(this.closeEvents(),this.stopped||this.snapshot.identity===void 0)return;this.set({connection:`connecting`});let t=new EventSource(`${y}/events?roomId=${encodeURIComponent(e.id)}`);this.eventSource=t,t.onopen=()=>{this.eventSource===t&&this.set({connection:`online`,error:void 0})},t.onmessage=e=>{if(this.eventSource===t)try{this.receive(JSON.parse(e.data))}catch{this.set({error:`收到无法识别的聊天室同步消息。`})}},t.onerror=()=>{this.eventSource===t&&this.set({connection:`connecting`})}}openNotifications(){if(this.stopped||this.snapshot.identity===void 0||this.notificationSource!==void 0)return;let e=new EventSource(`${y}/notifications`);this.notificationSource=e,e.onmessage=t=>{if(this.notificationSource===e)try{let e=JSON.parse(t.data);e.type===`notification`?this.receiveNotification(e.notification):e.type===`direct-message`&&this.receiveDirectMessage(e)}catch{this.set({error:`收到无法识别的消息提醒。`})}}}closeEvents(){this.eventSource?.close(),this.eventSource=void 0}closeNotifications(){this.notificationSource?.close(),this.notificationSource=void 0}receive(e){switch(e.type){case`snapshot`:{let t=Ya(e.room,e.members),n=qa(this.snapshot.rooms,t);this.set({phase:`ready`,connection:`online`,rooms:n,room:t,identity:e.identity,online:e.online,members:e.members,reactions:e.reactions,threadPreviews:e.threadPreviews,error:void 0});return}case`presence`:{let t=this.snapshot.room===void 0?void 0:Ya(this.snapshot.room,e.members);this.set({online:e.online,members:e.members,...t===void 0?{}:{room:t,rooms:qa(this.snapshot.rooms,t)}});return}case`thread-message`:this.set({threadPreviews:Ka(this.snapshot.threadPreviews,e.preview),...this.snapshot.thread?.id!==e.message.threadId||this.snapshot.threadMessages.some(t=>t.id===e.message.id)?{}:{threadMessages:[...this.snapshot.threadMessages,e.message]}});return;case`reaction`:this.replaceReaction(e.reaction);return;case`room-updated`:this.applyRoomManagement({room:e.room,members:e.members});return}}replaceReaction(e){if(this.snapshot.room?.id!==e.roomId)return;let t=this.snapshot.reactions.filter(t=>t.messageId!==e.messageId||t.emoji!==e.emoji);this.set({reactions:e.participantIds.length===0?t:[...t,e]})}applyRoomManagement(e){let t=this.snapshot.rooms.find(t=>t.id===e.room.id),n=t?.pinned!==void 0&&e.room.pinned===void 0?{...e.room,pinned:t.pinned}:e.room,r=Ja(this.snapshot.rooms.map(e=>e.id===n.id?n:e)),i=new Set(e.members.map(e=>e.participantId));this.set({rooms:r,...this.snapshot.room?.id===n.id?{room:n,members:e.members}:{},memberCandidates:`candidates`in e?e.candidates:this.snapshot.memberCandidates.filter(e=>!i.has(e.participantId)),managementBusy:!1,managementError:void 0})}receiveNotification(e){if(e.participantId===this.snapshot.identity?.participantId)return;let t=[...this.snapshot.toasts.filter(t=>t.id!==e.id),e].slice(-4),n=typeof document<`u`&&document.visibilityState===`visible`,r=this.snapshot.room?.id===e.roomId&&(e.threadId===void 0||e.threadId===this.snapshot.thread?.id),i=n&&r?this.snapshot.unreadCount:this.snapshot.unreadCount+1,a=Ja(this.snapshot.rooms.map(t=>t.id===e.roomId?{...t,updatedAt:Math.max(t.updatedAt??0,e.createdAt)}:t));if(this.set({toasts:t,unreadCount:i,rooms:a}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!n)try{new Notification(`${e.displayName} · ${e.roomTitle}`,{body:e.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${so(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(e.id)},6e3)}receiveDirectMessage(e){let t=Xa(this.snapshot.directConversations,e.conversation),n=this.snapshot.directConversation?.id===e.conversation.id,r=!n||this.snapshot.directMessages.some(t=>t.id===e.message.id)?this.snapshot.directMessages:[...this.snapshot.directMessages,e.message],i=e.message.senderId===this.snapshot.identity?.participantId,a=typeof document<`u`&&document.visibilityState===`visible`,o=this.snapshot.directOpen&&n;if(this.set({directConversations:t,...n?{directConversation:e.conversation,directMessages:r}:{},unreadCount:i||a&&o?this.snapshot.unreadCount:this.snapshot.unreadCount+1}),!i){let t={id:e.message.id,roomId:`direct:${e.conversation.id}`,roomTitle:`私聊`,participantId:e.message.senderId,displayName:e.conversation.peer.displayName,role:`human`,text:e.message.text,createdAt:e.message.createdAt},n=[...this.snapshot.toasts.filter(e=>e.id!==t.id),t].slice(-4);if(this.set({toasts:n}),this.snapshot.notificationsEnabled&&typeof Notification<`u`&&!a)try{new Notification(`${e.conversation.peer.displayName} · 私聊`,{body:e.message.text})}catch(e){this.set({notificationsEnabled:!1,error:`系统消息提醒失败：${so(e)}`})}globalThis.setTimeout(()=>{this.dismissToast(t.id)},6e3)}}clearUnread(){this.snapshot.unreadCount!==0&&this.set({unreadCount:0})}updateDocumentTitle(e){typeof document>`u`||this.originalTitle===void 0||(document.title=e===0?this.originalTitle:`(${e}) ${this.originalTitle}`)}updateActiveDocumentRoom(e){typeof document>`u`||document.documentElement.toggleAttribute(`data-dsh-chatroom-active`,e)}set(e){if(!this.stopped){this.snapshot={...this.snapshot,...e},e.unreadCount!==void 0&&this.updateDocumentTitle(this.snapshot.unreadCount);for(let e of this.listeners)e()}}};function Ka(e,t){return[...e.filter(e=>e.thread.id!==t.thread.id),t]}function qa(e,t){return Ja(e.some(e=>e.id===t.id)?e.map(e=>e.id===t.id?t:e):[...e,t])}function Ja(e){return[...e].sort((e,t)=>Number(t.pinned===!0)-Number(e.pinned===!0)||(t.updatedAt??0)-(e.updatedAt??0)||e.id.localeCompare(t.id))}function Ya(e,t){if(e.memberAvatars!==void 0)return e;let n=t.slice(0,9);return{...e,memberAvatarIds:n.map(e=>e.avatarId),memberAvatars:n.map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}}))}}function Xa(e,t){return[t,...e.filter(e=>e.id!==t.id)].sort((e,t)=>t.updatedAt-e.updatedAt)}function Za(){return typeof Notification>`u`?`unsupported`:Notification.permission}function Qa(e){return e.auth??{enabled:!1,authenticated:!0,providers:[],allowSelfRegistration:!0,bootstrapRequired:!1}}async function $a(e,t){return await io(`${y}/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function eo(e,t){return await io(`${y}/threads/prompt`,{method:`POST`,headers:{"Content-Type":`application/json`},body:JSON.stringify(e),...t===void 0?{}:{signal:t}})}async function to(e){return await no(e.map(({file:e})=>e))}async function no(e){return await Promise.all(e.map(async e=>{let t=co(new Uint8Array(await e.arrayBuffer()));return e.type===`image/png`||e.type===`image/jpeg`||e.type===`image/webp`||e.type===`image/gif`?{type:`image`,name:e.name,mediaType:e.type,data:t}:{type:`file`,name:e.name,mediaType:e.type===``?`application/octet-stream`:e.type,data:t}}))}var ro=class extends Error{status;constructor(e,t){super(t),this.status=e}};async function io(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await oo(n);return await n.json()}async function ao(e,t){let n=await fetch(e,{...t,credentials:`same-origin`});if(!n.ok)throw await oo(n)}async function oo(e){let t=`聊天室请求失败（HTTP ${e.status}）。`;try{let n=await e.json();typeof n.error==`string`&&n.error!==``&&(t=n.error)}catch{}return new ro(e.status,t)}function so(e){return e instanceof Error?e.message:String(e)}function co(e){let t=``;for(let n=0;n<e.length;n+=32768)t+=String.fromCharCode(...e.subarray(n,n+32768));return btoa(t)}function lo(e,t){let n=e.sessions.prompt,r=async(e,r)=>{let i=String(e.sessionId);if(ya(e.content))return await n(e,r);let a=typeof t.agentTargetForSession==`function`?t.agentTargetForSession(String(e.sessionId)):(()=>{let n=t.roomForSession(String(e.sessionId));return n===void 0?void 0:{kind:`room`,room:n}})(),o=a===void 0&&typeof t.newSessionMode==`function`&&t.newSessionMode(i)===`group`;if(a===void 0&&typeof t.ensurePromptTarget==`function`&&(a=await t.ensurePromptTarget(i)),a===void 0)return await n(e,r);if(t.getSnapshot().identity===void 0)throw Error(`请先选择聊天室身份。`);if(o){let n=t.newGroupInvitees(e.content);if(n.length>0&&!await t.addRoomMembers(n))throw Error(t.getSnapshot().managementError??`无法把提及的成员加入新群聊。`)}let s=t.composition(a.room.id),c=await to(s.files),l=[...e.content,...c];return a.kind===`thread`?await eo({threadId:a.threadId,mode:e.mode,content:l,...s.reply===void 0?{}:{reply:s.reply}},r):await $a({roomId:a.room.id,mode:e.mode,content:l,...s.reply===void 0?{}:{reply:s.reply}},r),t.completeComposition(s),{rpcId:`chatroom-human-first`,result:{ok:!0,value:{accepted:!0}}}};return e.sessions.prompt=r,()=>{e.sessions.prompt===r&&(e.sessions.prompt=n)}}let uo=`button[id^="dsh-slash-option-群聊成员-"]`,fo=`dsh-chatroom-native-mention-avatar`;function po(e){let t=()=>{let t=mo(e.getSnapshot());for(let e of document.querySelectorAll(uo)){let n=e.firstElementChild,r=n?.nextElementSibling?.textContent?.trim();if(!(n instanceof HTMLElement)||r===void 0||r===``)continue;let i=t.get(r),a=n.querySelector(`:scope > img.${fo}`);if(i===void 0){a?.remove(),n.classList.remove(fo),delete n.dataset.dshChatroomAvatarFailed;continue}if(a?.src===i||(a?.remove(),n.dataset.dshChatroomAvatarFailed===i))continue;n.classList.add(fo);let o=document.createElement(`img`);o.alt=``,o.referrerPolicy=`no-referrer`,o.src=i,o.addEventListener(`error`,()=>{n.dataset.dshChatroomAvatarFailed=i,o.remove(),n.classList.remove(fo)},{once:!0}),n.prepend(o)}},n=new MutationObserver(t);n.observe(document.body,{childList:!0,subtree:!0});let r=e.subscribe(t);return t(),()=>{r(),n.disconnect();for(let e of document.querySelectorAll(`${uo} img.${fo}`)){let t=e.parentElement;e.remove(),t?.classList.remove(fo),t!=null&&delete t.dataset.dshChatroomAvatarFailed}}}function mo(e){let t=new Map;for(let n of e.members){let e=ho(n.avatarUrl);e!==void 0&&t.set(n.displayName,e)}for(let n of e.directPeers){let r=ho(n.avatarUrl);r!==void 0&&t.set(Wa(n,e.directPeers),r)}return t}function ho(e){if(e!==void 0)try{let t=new URL(e);return t.protocol===`https:`&&t.username===``&&t.password===``&&t.hash===``?t.href:void 0}catch{return}}function go(e,t,n){let r=e.startSession,i=new Set,a=!1,o=r=>{let o=e.list.getSnapshot(),s=t.list.getSnapshot().current,c=s===void 0?void 0:o.items.find(e=>e.sessionIds.includes(s))?.workspaceId,l=r??c??o.recentWorkspaceId;if(l===void 0){t.clear();return}n(l).then(e=>{if(!a){let n=_o(t,e,i);n!==void 0&&i.add(n)}},e=>{a||console.warn(`new shared session failed:`,e)})};return e.startSession=o,()=>{a=!0;for(let e of i)e();i.clear(),e.startSession===o&&(e.startSession=r)}}function _o(e,t,n){let r=!1,i=()=>void 0,a,o=()=>{r||(r=!0,i(),a!==void 0&&clearTimeout(a),n.delete(o))},s=()=>{r||e.list.getSnapshot().byId[t]===void 0||(o(),e.open(t))};if(e.list.getSnapshot().byId[t]!==void 0){e.open(t);return}return i=e.list.subscribe(s),a=setTimeout(()=>{o(),console.warn(`new shared session was not listed within 5000ms`)},5e3),s(),r?void 0:o}function vo(e){let t=e.useChatroom(e=>e),n=e.newSessionMode(String(e.sessionId)),[r,i]=(0,d.useState)(),a=e.session.composerPhase===`blank`&&e.session.nodes.length===0;if((0,d.useEffect)(()=>{a&&n===void 0&&e.registerNewSession(String(e.sessionId))},[a,n,e.registerNewSession,e.sessionId]),(0,d.useEffect)(()=>{if(!a||t.branchFrame!==void 0)return;let e=[...document.querySelectorAll(`span`)].find(e=>e.textContent?.trim()===`探索未至之境`),n=e?.parentElement,r=n?.parentElement,o=n?.nextElementSibling;if(!(o instanceof HTMLElement)||e===void 0||r==null)return;let s=e.textContent;return e.textContent=`今天有什么工作要处理？`,r.setAttribute(`data-dsh-chatroom-new-session-hero`,``),o.setAttribute(`data-dsh-chatroom-new-session-switch-host`,``),i(o),()=>{e.textContent=s,r.removeAttribute(`data-dsh-chatroom-new-session-hero`),o.removeAttribute(`data-dsh-chatroom-new-session-switch-host`)}},[a,e.sessionId,t.branchFrame]),(0,d.useEffect)(()=>{if(!a||r===void 0||n===void 0)return;let e=null,t=r;for(;t!==null&&e===null;)e=t.querySelector(`button[aria-label="选择工作区"]`),t=t.parentElement;let i=e?.querySelector(`span`);if(e===null||i==null)return;let o=i.textContent??``,s=n===`solo`?`Solo`:`群聊`;return i.textContent=s,e.title=o===``?`当前会话类型：${s}`:`当前会话类型：${s}；工作区：${o}`,e.setAttribute(`data-dsh-chatroom-session-mode`,n),()=>{i.textContent=o,e.removeAttribute(`title`),e.removeAttribute(`data-dsh-chatroom-session-mode`)}},[a,n,r]),!a||t.branchFrame!==void 0||n===void 0)return null;let o=n===`solo`?`solo`:`group`,s=(0,p.jsxs)(`div`,{className:`dsh-chatroom-new-mode-switch`,"data-mode":o,role:`group`,"aria-label":`新会话模式`,children:[(0,p.jsx)(`button`,{type:`button`,"data-active":o===`group`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`group`)},children:`群聊`}),(0,p.jsx)(`button`,{type:`button`,"data-active":o===`solo`,onClick:()=>{e.chooseNewSessionMode(String(e.sessionId),`solo`)},children:`Solo`})]});return r===void 0?(0,p.jsx)(`section`,{className:`dsh-chatroom-new-mode`,"aria-label":`选择新会话模式`,children:s}):(0,f.createPortal)(s,r)}function yo(e){if(e.isLoopback)return()=>void 0;let t=e.api,n=t.settings,r=t.credentials,i=t.llm,a={describe:(e,t)=>bo(`settings.describe`,e,t),openDocument:n.openDocument,update:(e,t)=>bo(`settings.update`,e,t),replace:(e,t)=>bo(`settings.replace`,e,t),mutate:(e,t)=>bo(`settings.mutate`,e,t)},o={describe:(e,t)=>bo(`credentials.describe`,e,t),set:(e,t)=>bo(`credentials.set`,e,t),unset:(e,t)=>bo(`credentials.unset`,e,t)},s={...i,discoverModels:(e,t)=>bo(`llm.discoverModels`,e,t)};return t.settings=a,t.credentials=o,t.llm=s,()=>{t.settings===a&&(t.settings=n),t.credentials===o&&(t.credentials=r),t.llm===s&&(t.llm=i)}}async function bo(e,t,n){let r=crypto.randomUUID(),i=await fetch(`${y}/configuration/${e}`,{method:`POST`,headers:{"content-type":`application/json`},body:JSON.stringify({type:`client-request`,rpcId:r,method:e,payload:t}),credentials:`same-origin`,...n===void 0?{}:{signal:n}});if(!i.ok)throw Error(await So(i));let a=xo(await i.json());if(a.rpcId!==r)throw Error(`远程模型设置响应编号不匹配：发送 ${r}，收到 ${String(a.rpcId)}`);return{rpcId:a.rpcId,result:a.result}}function xo(e){if(typeof e!=`object`||!e||Array.isArray(e))throw Error(`远程模型设置响应格式无效。`);let t=e;if(t.type!==`server-response`||typeof t.rpcId!=`string`||t.result===null||typeof t.result!=`object`||Array.isArray(t.result))throw Error(`远程模型设置响应格式无效。`);let n=t.result;if(n.ok!==!0&&n.ok!==!1)throw Error(`远程模型设置响应格式无效。`);return{rpcId:t.rpcId,result:n}}async function So(e){try{let t=await e.json();if(typeof t==`object`&&t&&!Array.isArray(t)){let e=t.error;if(typeof e==`string`&&e!==``)return e}}catch{}return`远程模型设置请求失败：HTTP ${e.status}`}function Co(e){let t=e.useChatroom(e=>e),n=t.rooms.find(t=>String(e.sessionId)===t.sessionId);if(n===void 0)return t.roomEnsureSessionId===String(e.sessionId)?(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,disabled:!0,children:`正在建立共享群…`}):null;let r=t.identity,i=t.room?.id===n.id,a=i&&t.connection===`online`?`${t.online} 人在线`:`共享会话`;return(0,p.jsxs)(`span`,{className:`dsh-chatroom-header-actions`,children:[(0,p.jsxs)(`span`,{className:`dsh-chatroom-identity-action`,title:`当前群聊身份`,children:[(0,p.jsx)(`span`,{className:`dsh-chatroom-presence-dot`,"data-online":i&&t.connection===`online`}),r?.displayName??`选择身份`,` · `,a]}),(0,p.jsx)(`button`,{className:`dsh-chatroom-manage-action`,type:`button`,onClick:e.openMembers,children:`群管理`})]})}let wo=`div[role="treeitem"][aria-selected]`,To=`data-dsh-chatroom-group-avatar`,Eo=`data-dsh-chatroom-solo-avatar`,Do=`data-dsh-chatroom-sidebar-category`,Oo=`data-dsh-chatroom-workspace-categories`,ko=`data-dsh-chatroom-category-header`,Ao=`data-dsh-chatroom-direct-row`,jo=`data-dsh-chatroom-category-wrapper`,Mo=`data-dsh-chatroom-branch-row`,No=`data-dsh-chatroom-branch-marker`,Po=`data-dsh-chatroom-branch-surface`,Fo=`data-dsh-chatroom-branch-replies`,Io=`data-dsh-chatroom-native-branch-title`,Lo=`data-dsh-chatroom-branch-count`,Ro=`chatroom-thread-v1-`,zo=`分支：`,Bo=`data-dsh-chatroom-native-group-section`,Vo=`data-dsh-chatroom-native-folder-wrapper`,Ho=new WeakMap,Uo,Wo;function Go(e,t){if(typeof document>`u`||typeof MutationObserver>`u`)return()=>void 0;let n=!1,r,i,a=()=>{n=!1;let a=t.list.getSnapshot(),s=e.getSnapshot();Ko(document,s,a.current,e.setRoomPinned,e.openDirect,e.closeDirect,a);let c=s.phase===`ready`?s.identity?.participantId:void 0;c===void 0?r=void 0:r!==c&&(r=c,e.loadDirectDirectory().then(e=>{e||r!==c||(r=void 0,i=setTimeout(o,2e3))}))},o=()=>{n||(n=!0,queueMicrotask(a))},s=new MutationObserver(o);s.observe(document.body,{childList:!0,subtree:!0,characterData:!0});let c=e.subscribe(o),l=t.list.subscribe(o);return o(),()=>{c(),l(),s.disconnect();let e=document.querySelectorAll(`${wo}, [${Mo}], [data-dsh-chatroom-session-id]`);for(let t of e)ms(t);i!==void 0&&clearTimeout(i);for(let e of document.querySelectorAll(`[${Do}]`))hs(e);for(let e of document.querySelectorAll(`[${Oo}]`))Ds(e)}}function Ko(e,t,n,r,i,a,o){let s=[...e.querySelectorAll(wo)].filter(e=>e.closest(`[${Ao}]`)===null),c=vs(e,s),l=[...t.rooms],u=[],d=[],f=0,p=0;for(let e of s){Yo(e,a);let r=e.getAttribute(`aria-selected`)===`true`,i=Zo(e)??(r?n:void 0),s=qo(o,i)??Jo(o,e),c=i===void 0?void 0:$o(l,e=>e.sessionId===i),d=c===void 0&&r&&t.room!==void 0?$o(l,e=>e.id===t.room?.id):void 0,f=c??d??es(l,e),p=ns(e,i,s,o,t,f);u.push({row:e,sessionId:i,summary:s,branch:p,room:f})}let m=new Map,h=new Set;if(o!==void 0)for(let e of Object.values(o.byId)){if(!rs(e)||e.parentId===void 0)continue;let t=String(e.id),n=String(e.parentId);h.add(t),m.set(n,(m.get(n)??0)+1)}for(let e of u){let t=e.branch;t!==void 0&&t.parentSessionId!==void 0&&(t.sessionId!==void 0&&h.has(t.sessionId)||t.sessionId===void 0&&o!==void 0&&Object.values(o.byId).some(e=>rs(e)&&e.displayTitle.trim()===t.displayTitle&&String(e.parentId??``)===t.parentSessionId)||m.set(t.parentSessionId,(m.get(t.parentSessionId)??0)+1))}for(let e of u){let{row:n,sessionId:i,branch:a,room:o}=e;if(o!==void 0){fs(n),as(n,o,ts(o,t),f++,r),ss(n,o.title,i===void 0?0:m.get(i)??0),gs(n,`group`),d.push(n);continue}if(ps(n),a!==void 0){fs(n),os(n,a),n.style.order=String(-1e4+f++),n.querySelector(`:scope > [${Eo}]`)?.remove(),gs(n,`group`),d.push(n);continue}if(fs(n),!Xo(n)){hs(n);continue}n.removeAttribute(Mo),_s(n,p++),gs(n,`solo`),d.push(n)}ys(e,c,d,t,i),ks(e,t,r)}function qo(e,t){if(e!==void 0&&t!==void 0)return e.byId[t]}function Jo(e,t){if(e===void 0)return;let n=ls(t)?.textContent?.trim();if(n===void 0||!n.startsWith(zo))return;let r=Object.values(e.byId).filter(e=>rs(e)&&e.displayTitle.trim()===n);return r.length===1?r[0]:void 0}function Yo(e,t){e.dataset.dshChatroomDirectCloseBound!==`true`&&(e.dataset.dshChatroomDirectCloseBound=`true`,e.addEventListener(`click`,e=>{e.target.closest(`button[aria-label]`)===null&&t?.()}))}function Xo(e){return!e.hasAttribute(`aria-expanded`)&&(e.getAttribute(`aria-selected`)===`true`||e.querySelector(`button[aria-label]`)!==null||e.dataset.dshChatroomRoomRow!==void 0)}function Zo(e){if(e.dataset.dshChatroomSessionId!==void 0)return e.dataset.dshChatroomSessionId;if(e.draggable!==!0)return;let t=e.ownerDocument.defaultView?.Event;if(t===void 0)return;let n=new Map,r={effectAllowed:`uninitialized`,dropEffect:`none`,setData:(e,t)=>n.set(e,t),getData:e=>n.get(e)??``,clearData:e=>e===void 0?n.clear():n.delete(e)},i;try{let a=new t(`dragstart`,{bubbles:!0,cancelable:!0});Object.defineProperty(a,"dataTransfer",{value:r}),e.dispatchEvent(a),i=n.get(`text/plain`)}catch{i=void 0}finally{try{let n=new t(`dragend`,{bubbles:!0});Object.defineProperty(n,"dataTransfer",{value:r}),e.dispatchEvent(n)}catch{}}if(i!==void 0&&i.length!==0)return e.dataset.dshChatroomSessionId=i,i}function Qo(e,t){return[...e.querySelectorAll(`span`)].some(e=>!e.closest(`[${Po}]`)&&e.childElementCount===0&&e.textContent?.trim()===t)}function $o(e,t){let n=e.findIndex(t);if(!(n<0))return e.splice(n,1)[0]}function es(e,t){let n=e.filter(e=>Qo(t,e.title));return n.length===1?$o(e,e=>e.id===n[0]?.id):void 0}function ts(e,t){return e.memberAvatars===void 0?e.memberAvatarIds===void 0?t.room?.id===e.id&&t.members.length>0?t.members.slice(0,9).map(e=>({participantId:e.participantId,avatarId:e.avatarId,...e.avatarUrl===void 0?{}:{avatarUrl:e.avatarUrl}})):[]:e.memberAvatarIds.slice(0,9).map((e,t)=>({participantId:String(t),avatarId:e})):e.memberAvatars.slice(0,9)}function ns(e,t,n,r,i,a){if(a!==void 0||t!==void 0&&i.rooms.some(e=>e.sessionId===t))return;let o=ls(e)?.textContent?.trim(),s=n?.displayTitle.trim(),c=t?.startsWith(Ro)===!0,l=s?.startsWith(zo)===!0||o?.startsWith(zo)===!0;if(n!==void 0&&!rs(n)&&!c)return;let u=n!==void 0&&rs(n);if(c&&o!==void 0&&!o.startsWith(zo)&&!u){e.dataset.dshChatroomSessionId===t&&delete e.dataset.dshChatroomSessionId;return}if(!c&&!l)return;let d=s??o??zo,f=is(d),p=t===void 0?void 0:(i.threadPreviews??[]).find(e=>e.thread.sessionId===t),m=p===void 0?void 0:i.rooms.find(e=>e.id===p.thread.roomId),h=n?.parentId===void 0?p?.thread.root.sourceSessionId??m?.sessionId:String(n.parentId),g=qo(r,h);return{sessionId:t,displayTitle:d,topic:f,parentSessionId:h,parentTitle:(h===void 0?void 0:i.rooms.find(e=>e.sessionId===h))?.title??g?.displayTitle??m?.title,replyCount:p!==void 0&&p.totalMessages>0?p.totalMessages:void 0}}function rs(e){return String(e.id).startsWith(Ro)||e.parentId!==void 0&&e.displayTitle.trim().startsWith(zo)}function is(e){let t=e.trim(),n=t.startsWith(zo)?t.slice(3).trim():t;return n===``?`未命名主题`:n}function as(e,t,n,r,i){e.dataset.dshChatroomRoomRow=``,e.dataset.dshChatroomRoomId=t.id,e.dataset.pinned=String(t.pinned===!0),e.style.order=String(-1e4+r),e.parentElement?.setAttribute(`data-dsh-chatroom-room-list`,``),Os(e,t),e.querySelector(`:scope > [${Eo}]`)?.remove();let a=n.map(e=>`${e.participantId}:${e.avatarId}:${e.avatarUrl??``}`).join(`|`)||`empty`,o=e.querySelector(`:scope > [${To}]`);if(o?.dataset.signature===a)return;o?.remove(),o=e.ownerDocument.createElement(`span`),o.setAttribute(To,``),o.dataset.count=String(Math.max(1,n.length)),o.dataset.signature=a,o.setAttribute(`aria-hidden`,`true`);let s=n.length===0?[{emoji:`✦`}]:n.map(e=>({...e,emoji:_(e.avatarId,e.participantId).emoji}));for(let t of s){let n=e.ownerDocument.createElement(`span`);if(t.avatarUrl===void 0)n.textContent=t.emoji;else{let r=e.ownerDocument.createElement(`img`);r.src=t.avatarUrl,r.alt=``,r.referrerPolicy=`no-referrer`,r.addEventListener(`error`,()=>{r.remove(),n.textContent=t.emoji},{once:!0}),n.append(r)}o.append(n)}e.prepend(o)}function os(e,t){e.dataset.dshChatroomBranchRow=``,t.sessionId===void 0?delete e.dataset.dshChatroomBranchSessionId:e.dataset.dshChatroomBranchSessionId=t.sessionId,t.parentSessionId===void 0?delete e.dataset.dshChatroomBranchParentSessionId:e.dataset.dshChatroomBranchParentSessionId=t.parentSessionId,e.dataset.dshChatroomBranchTopic=t.topic,t.parentTitle===void 0?delete e.dataset.dshChatroomBranchParentTitle:e.dataset.dshChatroomBranchParentTitle=t.parentTitle,t.replyCount===void 0?e.removeAttribute(Fo):e.setAttribute(Fo,String(t.replyCount));let n=t.parentTitle===void 0?`来自群聊`:`来自 ${t.parentTitle}`,r=t.replyCount===void 0?``:` · ${t.replyCount} 条回复`,i=t.parentTitle===void 0&&t.replyCount===void 0?`分支会话：${t.topic}`:`分支会话：${t.topic}，${n}${r}`;ds(e,i),e.setAttribute(`aria-label`,i),e.setAttribute(`title`,i);let a=ls(e,t.displayTitle);a?.setAttribute(Io,``);let o=e.querySelector(`:scope > [${No}]`);o===null&&(o=e.ownerDocument.createElement(`span`),o.setAttribute(No,``),o.setAttribute(`aria-hidden`,`true`),o.textContent=`↳`);let s=e.querySelector(`:scope > [${Po}]`);s===null&&(s=e.ownerDocument.createElement(`span`),s.setAttribute(Po,``),s.setAttribute(`aria-hidden`,`true`));let c=`${t.topic}|${t.parentTitle??``}|${t.replyCount??``}`;if(s.dataset.signature!==c){s.replaceChildren();let i=e.ownerDocument.createElement(`span`);i.setAttribute(`data-dsh-chatroom-branch-heading`,``);let a=e.ownerDocument.createElement(`span`);a.setAttribute(`data-dsh-chatroom-branch-badge`,``),a.textContent=`分支`;let o=e.ownerDocument.createElement(`span`);o.setAttribute(`data-dsh-chatroom-branch-topic`,``),o.textContent=t.topic,i.append(a,o);let l=e.ownerDocument.createElement(`span`);l.setAttribute(`data-dsh-chatroom-branch-parent`,``),l.textContent=`${n}${r}`,s.append(i,l),s.dataset.signature=c}a===void 0?(o.parentElement!==e||s.parentElement!==e)&&e.append(o,s):(a.previousElementSibling!==s||s.previousElementSibling!==o)&&a.before(o,s)}function ss(e,t,n){if(n===0){cs(e);return}e.dataset.dshChatroomHasBranches=``,e.dataset.dshChatroomBranchCount=String(n);let r=e.querySelector(`:scope > [${Lo}]`);if(r===null){r=e.ownerDocument.createElement(`span`),r.setAttribute(Lo,``);let n=ls(e,t);n===void 0?e.append(r):n.after(r)}let i=`分支 ${n}`;r.textContent!==i&&(r.textContent=i),r.setAttribute(`title`,`${n} 个分支`),r.setAttribute(`aria-label`,`${n} 个分支`)}function cs(e){delete e.dataset.dshChatroomHasBranches,delete e.dataset.dshChatroomBranchCount,e.querySelector(`:scope > [${Lo}]`)?.remove()}function ls(e,t){let n=[...e.querySelectorAll(`span`)].filter(e=>!e.closest(`[${Po}]`)&&!e.hasAttribute(No)&&!e.hasAttribute(Lo)&&e.childElementCount===0);if(t!==void 0){let e=n.find(e=>e.textContent?.trim()===t);if(e!==void 0)return e}return n.find(e=>e.textContent?.trim().startsWith(zo))??n.find(e=>e.dataset.dshChatroomNativeBranchTitle!==void 0)??n.filter(e=>{let t=e.textContent?.trim()??``;return t!==``&&!us(t)&&t!==`●`}).sort((e,t)=>(t.textContent?.trim().length??0)-(e.textContent?.trim().length??0))[0]}function us(e){return/^(?:刚刚|现在|now|\d+\s*(?:秒|分钟|小时|天|周|月|年|s|min|h|d|w))$/iu.test(e)}function ds(e,t){let n=Ho.get(e);if(n===void 0){Ho.set(e,{ariaLabel:e.getAttribute(`aria-label`),title:e.getAttribute(`title`),appliedAriaLabel:t,appliedTitle:t});return}let r=e.getAttribute(`aria-label`)===n.appliedAriaLabel?n.ariaLabel:e.getAttribute(`aria-label`),i=e.getAttribute(`title`)===n.appliedTitle?n.title:e.getAttribute(`title`);Ho.set(e,{ariaLabel:r,title:i,appliedAriaLabel:t,appliedTitle:t})}function fs(e){delete e.dataset.dshChatroomBranchRow,delete e.dataset.dshChatroomBranchSessionId,delete e.dataset.dshChatroomBranchParentSessionId,delete e.dataset.dshChatroomBranchTopic,delete e.dataset.dshChatroomBranchParentTitle,e.removeAttribute(Fo),e.querySelector(`:scope > [${No}]`)?.remove(),e.querySelector(`:scope > [${Po}]`)?.remove();for(let t of e.querySelectorAll(`[${Io}]`))t.removeAttribute(Io);let t=Ho.get(e);t!==void 0&&(e.getAttribute(`aria-label`)===t.appliedAriaLabel&&(t.ariaLabel===null?e.removeAttribute(`aria-label`):e.setAttribute(`aria-label`,t.ariaLabel)),e.getAttribute(`title`)===t.appliedTitle&&(t.title===null?e.removeAttribute(`title`):e.setAttribute(`title`,t.title)),Ho.delete(e))}function ps(e){delete e.dataset.dshChatroomRoomRow,delete e.dataset.dshChatroomRoomId,delete e.dataset.pinned,cs(e),e.querySelector(`:scope > [${To}]`)?.remove()}function ms(e){fs(e),ps(e),delete e.dataset.dshChatroomSessionId,delete e.dataset.dshChatroomBranchSessionId,e.style.removeProperty(`order`)}function hs(e){ms(e),e.removeAttribute(Do),e.removeAttribute(Mo),e.querySelector(`:scope > [${Eo}]`)?.remove();let t=e.parentElement;t?.removeAttribute(jo),t?.style.removeProperty(`order`)}function gs(e,t){e.setAttribute(Do,t);let n=e.closest(`[role="tree"]`),r=e.parentElement;n!==null&&r!==null&&r!==n&&(r.setAttribute(jo,t),r.style.order=e.style.order)}function _s(e,t){if(e.style.order=String(-6e3+t),e.querySelector(`:scope > [${Eo}]`)!==null)return;let n=e.ownerDocument.createElement(`span`);n.setAttribute(Eo,``),n.setAttribute(`aria-hidden`,`true`),n.textContent=`✦`,e.prepend(n)}function vs(e,t){return t.find(e=>e.closest(`[role="tree"]`)!==null)?.closest(`[role="tree"]`)??e.querySelector(`[role="tree"]`)??t[0]?.parentElement??void 0}function ys(e,t,n,r,i){for(let n of e.querySelectorAll(`[${Oo}]`))n!==t&&Ds(n);if(t===void 0)return;t.setAttribute(Oo,``),bs(t);let a=n.filter(e=>e.getAttribute(Do)===`group`).length,o=n.filter(e=>e.getAttribute(Do)===`solo`).length;Ss(t,`group`,`群聊`,a,-11e3),Ss(t,`solo`,`Solo`,o,-7e3);let s=Cs(r.directPeers??[],r.directConversations??[]);Ss(t,`direct`,`私聊`,s.length,-3e3),ws(t,s,r,i)}function bs(e){for(let t of e.querySelectorAll(`[${Bo}]`))t.removeAttribute(Bo);for(let t of e.querySelectorAll(`[${Vo}]`))t.removeAttribute(Vo),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`);for(let t of e.querySelectorAll(`div[role="treeitem"]`)){let n=xs(e,t);if(n!==void 0&&n!==t&&n.setAttribute(Bo,``),!t.hasAttribute(`aria-expanded`))continue;let r=t.parentElement;if(r===null)continue;let i=r.querySelectorAll(`div[role="treeitem"]`).length>1?t:r;i.setAttribute(Vo,``),i.dataset.hidden=`true`,t.getAttribute(`aria-expanded`)===`false`&&t.dataset.dshChatroomExpanding!==`true`&&(t.dataset.dshChatroomExpanding=`true`,t.click(),queueMicrotask(()=>{delete t.dataset.dshChatroomExpanding}))}}function xs(e,t){let n=t;for(;n?.parentElement!==null&&n.parentElement!==e;)n=n.parentElement;return n?.parentElement===e?n:void 0}function Ss(e,t,n,r,i){let a=e.querySelector(`:scope > [${ko}="${t}"]`);if(a===null){a=e.ownerDocument.createElement(`div`),a.setAttribute(ko,t);let n=e.ownerDocument.createElement(`button`);n.type=`button`,n.setAttribute(`aria-expanded`,`true`),n.innerHTML=`<span data-chevron aria-hidden>⌄</span><span data-folder-icon aria-hidden></span><strong></strong><small></small>`,n.onclick=()=>{let r=e.getAttribute(`data-dsh-chatroom-${t}-collapsed`)===`true`;e.setAttribute(`data-dsh-chatroom-${t}-collapsed`,String(!r)),n.setAttribute(`aria-expanded`,String(r));let i=n.querySelector(`[data-chevron]`);i!==null&&(i.textContent=r?`⌄`:`›`)},a.append(n),e.append(a)}a.style.order=String(i);let o=a.querySelector(`strong`),s=a.querySelector(`small`),c=a.querySelector(`[data-folder-icon]`);if(c!==null&&c.childElementCount===0){let t=e.querySelector(`div[role="treeitem"][aria-expanded] svg[width="16"]`);t!==null&&c.append(t.cloneNode(!0))}o?.textContent!==n&&(o.textContent=n);let l=String(r);s?.textContent!==l&&(s.textContent=l)}function Cs(e,t){let n=new Map(t.map(e=>[e.peer.participantId,e])),r=new Map(e.map(e=>[e.participantId,e]));for(let e of t)r.set(e.peer.participantId,e.peer);return[...r.values()].sort((e,t)=>{let r=n.get(e.participantId)?.updatedAt??0;return(n.get(t.participantId)?.updatedAt??0)-r||e.displayName.localeCompare(t.displayName,`zh-CN`)})}function ws(e,t,n,r){let i=new Map([...e.querySelectorAll(`:scope > [${Ao}]`)].map(e=>[e.dataset.peerId??``,e]));t.forEach((t,a)=>{let o=i.get(t.participantId);o===void 0&&(o=e.ownerDocument.createElement(`div`),o.setAttribute(Ao,``),o.dataset.peerId=t.participantId,o.innerHTML=`<button type="button"><span data-avatar></span><span><strong></strong><small></small></span></button>`,e.append(o)),i.delete(t.participantId),o.style.order=String(-2900+a),o.dataset.active=String(n.directConversation?.peer.participantId===t.participantId);let s=o.querySelector(`button`);s.setAttribute(`aria-label`,`与 ${t.displayName} 私聊`),s.onclick=()=>{r?.(t.participantId)};let c=o.querySelector(`strong`),l=o.querySelector(`small`);c.textContent!==t.displayName&&(c.textContent=t.displayName);let u=n.directConversations.find(e=>e.peer.participantId===t.participantId),d=u===void 0?`@${t.username}`:Es(u.updatedAt);l.textContent!==d&&(l.textContent=d),Ts(o.querySelector(`[data-avatar]`),t)});for(let e of i.values())e.remove()}function Ts(e,t){let n=`${t.participantId}:${t.avatarId}:${t.avatarUrl??``}`;if(e.dataset.signature===n)return;e.dataset.signature=n,e.replaceChildren();let r=_(t.avatarId,t.participantId).emoji;if(t.avatarUrl===void 0){e.textContent=r;return}let i=e.ownerDocument.createElement(`img`);i.src=t.avatarUrl,i.alt=``,i.referrerPolicy=`no-referrer`,i.addEventListener(`error`,()=>{i.remove(),e.textContent=r},{once:!0}),e.append(i)}function Es(e){let t=Math.max(0,Math.floor((Date.now()-e)/6e4));return t<1?`刚刚`:t<60?`${String(t)}分钟`:t<1440?`${String(Math.floor(t/60))}小时`:`${String(Math.floor(t/1440))}天`}function Ds(e){e.removeAttribute(Oo),e.removeAttribute(`data-dsh-chatroom-group-collapsed`),e.removeAttribute(`data-dsh-chatroom-solo-collapsed`),e.removeAttribute(`data-dsh-chatroom-direct-collapsed`);for(let t of e.querySelectorAll(`:scope > [${ko}], :scope > [${Ao}]`))t.remove();for(let t of e.querySelectorAll(`[${Bo}]`))t.removeAttribute(Bo);for(let t of e.querySelectorAll(`[${Vo}], [${jo}]`))t.removeAttribute(Vo),t.removeAttribute(jo),t.removeAttribute(`data-hidden`),t.style.removeProperty(`order`)}function Os(e,t){let n=e.querySelector(`button[aria-label]`);n!==null&&(n.dataset.dshChatroomNativeMenuRoomId=t.id,n.dataset.dshChatroomNativeMenuBound!==`true`&&(n.dataset.dshChatroomNativeMenuBound=`true`,n.addEventListener(`click`,()=>{Uo=n.dataset.dshChatroomNativeMenuRoomId,Wo=void 0})))}function ks(e,t,n){if(Wo!==void 0){Wo.isConnected||(Wo=void 0,Uo=void 0);return}let r=t.rooms.find(e=>e.id===Uo);if(r===void 0)return;let i=[...e.querySelectorAll(`[role="menu"]`)].at(-1)?.querySelector(`:scope > [role="presentation"]`),a=i?.querySelector(`:scope > *`),o=a?.querySelector(`:scope > button[role="menuitem"]`);if(i==null||a==null||o==null)return;let s=e.createElement(a.tagName.toLowerCase());s.className=a.className,s.dataset.dshChatroomPinMenuItem=``;let c=e.createElement(`button`);c.type=`button`,c.role=`menuitem`,c.className=o.className;let l=e.createElement(`span`);l.className=o.querySelector(`:scope > :first-child`)?.className??``;let u=e.createElementNS(`http://www.w3.org/2000/svg`,`svg`);u.setAttribute(`width`,`16`),u.setAttribute(`height`,`16`),u.setAttribute(`viewBox`,`0 0 16 16`);let d=e.createElementNS(`http://www.w3.org/2000/svg`,`path`);d.setAttribute(`d`,`M5 1.75h6l-1 4.1 2 2V9H8.65v5.25h-1.3V9H4V7.85l2-2-1-4.1Z`),d.setAttribute(`fill`,`currentColor`),u.append(d),l.append(u);let f=e.createElement(`span`);f.className=o.querySelector(`:scope > :last-child`)?.className??``,f.textContent=r.pinned===!0?`取消置顶`:`置顶群聊`,c.append(l,f),c.onclick=t=>{t.stopPropagation(),n?.(r.id,r.pinned!==!0),e.dispatchEvent(new KeyboardEvent(`keydown`,{key:`Escape`,bubbles:!0}))},s.append(c),i.append(s),Wo=s}let As=[`connection`,`inputTriggers`,`sessions`,`settingsScope`,`slots`,`workspaces`];function js(e){let t=e.get(`connection`);if(t===void 0)throw Error(`chatroom: client connection service unavailable`);let n=e.get(`sessions`);if(n===void 0)throw Error(`chatroom: client sessions service unavailable`);let r=e.get(`workspaces`);if(r===void 0)throw Error(`chatroom: client workspaces service unavailable`);let i=e.get(`inputTriggers`);if(i===void 0)throw Error(`chatroom: input trigger service unavailable`);let a=typeof location>`u`?void 0:T(location),o=new Ga(e=>{let t=e,r=n.list.getSnapshot();return r.current===t||r.byId[t]!==void 0&&(n.open(t),!0)},a);e.effect(()=>go(r,n,async e=>{let n=await t.api.sessions.create({workspaceId:e});if(!n.result.ok)throw Error(`new shared session failed: ${n.result.error.code}: ${n.result.error.message}`);let r=n.result.value.sessionId;return o.registerNewSession(String(r)),r}),`chatroom: distinct native New Session`),e.effect(()=>{a!==void 0&&document.documentElement.setAttribute(`data-dsh-chatroom-branch-frame`,``);let r=()=>{a!==void 0&&document.querySelector(`[data-shell-overlay]`)?.parentElement?.setAttribute(`data-dsh-chatroom-branch-shell`,``)},i=a===void 0?void 0:new MutationObserver(r);i?.observe(document.body,{childList:!0,subtree:!0}),r();let s=document.createElement(`style`);s.dataset.dshChatroomStyles=``,s.textContent=`
...
`,document.head.append(s);let c=yo(t),l=Ms(e.get(`settingsScope`)),u=lo(t.api,o),d=Go(o,n),f=po(o),p=a,m=!1,h=()=>{let e=p;if(e===void 0||m)return;let t=n.list.getSnapshot();ae(e,{current:t.current===void 0?void 0:String(t.current),byId:t.byId},e=>{n.open(e)})&&(m=!0,ne(e.parentSessionId),oe(e))},g=e=>{if(a===void 0||e.origin!==globalThis.location.origin||e.source!==globalThis.parent)return;let t=k(e.data);if(t!==void 0){if(p!==void 0&&te(p,t)){h();return}p=t,m=!1,le(),o.switchBranchFrame(t),h()}};globalThis.addEventListener(`message`,g);let _=()=>{h(),o.resumeOpen();let e=n.list.getSnapshot(),t=e.current,r=t===void 0?void 0:e.byId[t];t!==void 0&&r?.blank===!0&&r.origin!==`subagent`&&o.roomForSession(String(t))===void 0&&o.newSessionMode(String(t))===void 0&&o.registerNewSession(String(t)),o.activateSession(t===void 0?void 0:String(t),r?.displayTitle??`新会话`,a===void 0&&r?.origin!==`subagent`)},v=n.list.subscribe(_);return o.start().then(async()=>{if(_(),typeof location>`u`)return;let e=E(location,a);e!==void 0&&await o.selectRoom(e)}),()=>{v(),globalThis.removeEventListener(`message`,g),u(),f(),d(),l(),c(),o.stop(),s.remove(),i?.disconnect(),a!==void 0&&(le(),document.documentElement.removeAttribute(`data-dsh-chatroom-branch-frame`))}},`chatroom: browser state and styles`);let s=Ls(o),c=Rs(o);e.effect(()=>i.registerSource(s),`chatroom: AI mention source`),e.effect(()=>i.registerSource(c),`chatroom: member mention source`),e.slots.inject(`shell.overlay`,()=>e.slots.register({name:`shell.overlay`,id:`chatroom`,order:0,inject:()=>({hooks:{chatroom:o},openRoom:o.openRoom,closeRoom:o.closeRoom,join:o.join,login:o.login,register:o.register,logout:o.logout,openAccount:o.openAccount,closeAccount:o.closeAccount,changePassword:o.changePassword,selectRoom:o.selectRoom,createRoom:o.createRoom,resetIdentity:o.resetIdentity,retry:o.retry,closeMembers:o.closeMembers,renameRoom:o.renameRoom,setMemberRole:o.setMemberRole,addRoomMembers:o.addRoomMembers,setRoomAutoTrigger:o.setRoomAutoTrigger,closeThread:o.closeThread,setThreadReply:o.setThreadReply,clearThreadReply:o.clearThreadReply,sendThreadMessage:o.sendThreadMessage,enableSystemNotifications:o.enableSystemNotifications,dismissToast:o.dismissToast,toggleReaction:o.toggleReaction,openForward:o.openForward,closeForward:o.closeForward,forwardSelected:o.forwardSelected,toggleMessageSelection:o.toggleMessageSelection,clearMessageSelection:o.clearMessageSelection,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect})},$i)),e.slots.inject(`settings.section`,()=>e.slots.register({name:`settings.section`,id:`chatroom`,order:30,label:()=>`群聊与账号`,inject:()=>({hooks:{chatroom:o},closeAccount:o.closeAccount,changePassword:o.changePassword,openAdmin:o.openAdmin,closeAdmin:o.closeAdmin,adminCreateUser:o.adminCreateUser,adminUpdateUser:o.adminUpdateUser,adminSetSelfRegistration:o.adminSetSelfRegistration,adminSetAutoRedirectProvider:o.adminSetAutoRedirectProvider,adminSaveProvider:o.adminSaveProvider,adminDeleteProvider:o.adminDeleteProvider,loadAutomation:o.loadAutomation,saveAutomation:o.saveAutomation,openDirect:o.openDirect,closeDirect:o.closeDirect,sendDirect:o.sendDirect})},fe)),e.slots.inject(`conversation.session.header.actions`,()=>e.slots.register({name:`conversation.session.header.actions`,id:`chatroom-identity`,order:-5,inject:()=>({hooks:{chatroom:o},openMembers:o.openMembers})},Co)),e.slots.inject(`conversation.input.left`,()=>e.slots.register({name:`conversation.input.left`,id:`chatroom-files`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},ua)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-group-setup`,order:-30,inject:()=>({hooks:{chatroom:o},registerNewSession:o.registerNewSession,newSessionMode:o.newSessionMode,chooseNewSessionMode:o.chooseNewSessionMode})},vo)),e.slots.inject(`conversation.input.dock`,()=>e.slots.register({name:`conversation.input.dock`,id:`chatroom-composition`,order:-20,inject:()=>({hooks:{chatroom:o},addFiles:o.addFiles,removeFile:o.removeFile,clearReply:o.clearReply,sendFiles:o.sendFiles,resolveTarget:o.agentTargetForSession.bind(o)})},da)),e.slots.inject(`conversation.input.attachments`,()=>Fs(()=>e.slots.entries(`conversation.input.attachments`).find(e=>(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.input.attachments`,t),t=>e.slots.register({name:`conversation.input.attachments`,priority:-10,locale:`conversation`,inject:()=>({hooks:{chatroom:o},nativeAttachmentsView:t,clearReply:o.clearReply,resolveTarget:o.agentTargetForSession.bind(o)})},fa))),e.slots.inject(`conversation.chat.assistant-actions`,()=>e.slots.register({name:`conversation.chat.assistant-actions`,id:`chatroom-reply`,order:5,inject:()=>({hooks:{chatroom:o},resolveTarget:o.agentTargetForSession.bind(o),setReply:o.setReply,openThread:o.openThread,toggleReaction:o.toggleReaction,openForward:o.openForward,toggleMessageSelection:o.toggleMessageSelection})},oa)),e.slots.inject(`conversation.chat.node`,()=>Fs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`assistant-step`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`assistant-step`,priority:-10,locale:`conversation`,inject:()=>({nativeMessageView:t,resolveTarget:o.agentTargetForSession.bind(o)})},ca))),e.slots.inject(`conversation.chat.node`,()=>Fs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`user`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`user`,priority:-10,locale:`conversation`,inject:()=>Is(o,t)},ja))),e.slots.inject(`conversation.chat.node`,()=>Fs(()=>e.slots.entries(`conversation.chat.node`).find(e=>e.options.key===`steering`&&(e.options.priority??0)===0)?.component,t=>e.slots.subscribe(`conversation.chat.node`,t),t=>e.slots.register({name:`conversation.chat.node`,key:`steering`,priority:-10,locale:`conversation`,inject:()=>Is(o,t)},Ma)))}function Ms(e){if(!Ns(e))return()=>void 0;let t=e.describe();return!Ps(t)||t.persistence!==`memory`?()=>void 0:(t.persistence=`host`,t.load(),()=>{t.persistence===`host`&&(t.persistence=`memory`)})}function Ns(e){return typeof e==`object`&&!!e&&typeof e.describe==`function`}function Ps(e){return typeof e==`object`&&!!e&&(e.persistence===`host`||e.persistence===`memory`)&&typeof e.load==`function`}function Fs(e,t,n){let r,i,a=()=>{let t=e();if(t===r)return;let a=i;i=void 0,r=void 0,a?.(),t!==void 0&&(r=t,i=n(t))},o=t(a);return a(),()=>{o(),i?.(),i=void 0,r=void 0}}function Is(e,t){return{hooks:{chatroom:e},resolveTarget:e.agentTargetForSession.bind(e),nativeMessageView:t,setReply:e.setReply,openThread:e.openThread,toggleReaction:e.toggleReaction,openForward:e.openForward,toggleMessageSelection:e.toggleMessageSelection}}function Ls(e){return{trigger:`@`,name:`AI 助手`,order:-100,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];let a=[{name:Bs(r?.aiDisplayName??`DeepSeek`),icon:`✦`,description:r===void 0?`创建群聊后立即回复`:`提及后回复`}],o=n.toLocaleLowerCase();return a.filter(e=>e.name.toLocaleLowerCase().includes(o))},lexicon(t){let n=e.roomForSession(String(t.sessionId));return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[`AI`,`DeepSeek`]:[]:[...new Set([`AI`,n.aiDisplayName])]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${Vs(e.name)} `}}}}function Rs(e){return{trigger:`@`,name:`群聊成员`,order:-90,async candidates(t,{query:n}){let r=e.roomForSession(String(t.sessionId)),i=r===void 0&&e.newSessionMode(String(t.sessionId))===`group`;if(r===void 0&&!i)return[];i&&e.getSnapshot().directPeers.length===0&&await e.loadDirectDirectory();let a=e.getSnapshot(),o=r===void 0?a.directPeers.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:Wa(e,a.directPeers),icon:_(e.avatarId,e.participantId).emoji,description:`创建群聊时自动邀请 · @${e.username}`})):a.members.filter(e=>e.participantId!==a.identity?.participantId).map(e=>({name:e.displayName,icon:_(e.avatarId,e.participantId).emoji,description:e.online?`在线成员`:`群成员`})),s=n.toLocaleLowerCase();return o.filter((e,t,n)=>n.findIndex(t=>t.name===e.name)===t).filter(e=>e.name.toLocaleLowerCase().includes(s))},lexicon(t){let n=e.roomForSession(String(t.sessionId)),r=e.getSnapshot();return n===void 0?e.newSessionMode(String(t.sessionId))===`group`?[...new Set(r.directPeers.filter(e=>e.participantId!==r.identity?.participantId).map(e=>Wa(e,r.directPeers)))]:[]:[...new Set(r.members.filter(e=>e.participantId!==r.identity?.participantId).map(e=>e.displayName))]},subscribeLexicon(t,n){return e.subscribe(n)},onPick({candidate:e}){return{text:`@${e.name} `}}}}let zs=`（AI 助手）`;function Bs(e){return`${e}${zs}`}function Vs(e){return e.endsWith(zs)?e.slice(0,-7):e}var Hs={inject:As,apply:js};return n.activateRemoteSettingsMirror=Ms,n.apply=js,n.createChatroomAiSource=Ls,n.createChatroomMemberSource=Rs,n.default=Hs,n.inject=As,n.mountAfterNativeMessageView=Fs,t.exports}});
